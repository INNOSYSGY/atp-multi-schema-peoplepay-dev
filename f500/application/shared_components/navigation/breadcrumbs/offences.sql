...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(3796391491274684061)
,p_name=>'offences'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796390882010664611)
,p_parent_id=>wwv_flow_imp.id(3796391090624675789)
,p_short_name=>'Employee Offences'
,p_link=>'f?p=&APP_ID.:1424:&SESSION.::&DEBUG.:::'
,p_page_id=>1424
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796391090624675789)
,p_parent_id=>wwv_flow_imp.id(3796391286311677851)
,p_short_name=>'Create/Edit Offences'
,p_link=>'f?p=&APP_ID.:1423:&SESSION.::&DEBUG.:::'
,p_page_id=>1423
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796391286311677851)
