...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(3796393672882725997)
,p_name=>'activity'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796393069464715984)
,p_parent_id=>wwv_flow_imp.id(3796393296194718784)
,p_short_name=>'Create/Edit Activity Attendance Detail'
,p_link=>'f?p=&APP_ID.:1437:&SESSION.::&DEBUG.:::'
,p_page_id=>1437
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796393296194718784)
