...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3804040466043349947)
,p_name=>'load_oth_ent'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804040172381349947)
,p_load_table_id=>wwv_flow_imp.id(3804040466043349947)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3803949194805311974)
,p_load_table_id=>wwv_flow_imp.id(3804040466043349947)
