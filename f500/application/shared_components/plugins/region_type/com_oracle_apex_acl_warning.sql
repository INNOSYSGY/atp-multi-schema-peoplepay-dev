...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3852833195305095843)
...
,p_reference_id=>15274154870557312929
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3852833545489095845)
,p_plugin_id=>wwv_flow_imp.id(3852833195305095843)
