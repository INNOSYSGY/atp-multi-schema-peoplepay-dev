...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4810583054637198095)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885431700400210599)
,p_plugin_id=>wwv_flow_imp.id(4810583054637198095)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885432119181210600)
,p_plugin_id=>wwv_flow_imp.id(4810583054637198095)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885432475251210600)
,p_plugin_id=>wwv_flow_imp.id(4810583054637198095)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885432912025210600)
,p_plugin_id=>wwv_flow_imp.id(4810583054637198095)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885433827023210601)
,p_plugin_attribute_id=>wwv_flow_imp.id(5885432912025210600)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885433311435210600)
,p_plugin_attribute_id=>wwv_flow_imp.id(5885432912025210600)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885434249573210601)
,p_plugin_id=>wwv_flow_imp.id(4810583054637198095)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4269013994164424765)
,p_plugin_id=>wwv_flow_imp.id(4810583054637198095)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
