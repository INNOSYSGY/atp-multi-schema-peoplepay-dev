...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(5811044543647563862)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126336974518320033)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126337390546320033)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126337822004320033)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126338150625320033)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126338579515320034)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126338150625320033)
,p_display_sequence=>10
,p_display_value=>'Window'
,p_return_value=>'WINDOW'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126339085139320034)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126338150625320033)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126339631020320034)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126339982793320034)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126340353590320035)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126340817578320035)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126341157416320035)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126341614244320035)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126341971111320035)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126344389564320037)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126341971111320035)
,p_display_sequence=>10
,p_display_value=>'Number'
,p_return_value=>'NUMBER'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126343941426320036)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126341971111320035)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126342383440320035)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126341971111320035)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126342887639320036)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126341971111320035)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126343392884320036)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126341971111320035)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126344925271320037)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126347819050320039)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126348282204320040)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126349347688320040)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126349761144320041)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126348784676320040)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126350268583320041)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
,p_display_sequence=>80
,p_display_value=>'$14,435'
,p_return_value=>'$,.0f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126350794609320041)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
,p_display_sequence=>90
,p_display_value=>'$14435'
,p_return_value=>'$.0f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126346788801320039)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126351254114320042)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126347331144320039)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126351780526320042)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126352309756320042)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126352776620320042)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126353297140320043)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126345291045320037)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126345769030320038)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126346301255320038)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126353820780320043)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(6126344925271320037)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126354224550320043)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126354582126320044)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126354224550320043)
,p_display_sequence=>10
,p_display_value=>'Linear'
,p_return_value=>'linear'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126355129385320044)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126354224550320043)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126355639265320044)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126354224550320043)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126356070068320045)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126354224550320043)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126356609862320045)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126354224550320043)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126357140090320045)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126357537108320045)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126357140090320045)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126357958400320046)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126357140090320045)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126358538468320046)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126358864009320047)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>10
,p_display_value=>'14,435'
,p_return_value=>',.0f'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126359397669320047)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>20
,p_display_value=>'14435'
,p_return_value=>'.0f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126359929716320047)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>30
,p_display_value=>'14,435.49'
,p_return_value=>',.2f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126360390505320047)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>40
,p_display_value=>'14435.49'
,p_return_value=>'.2f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126360858477320047)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>50
,p_display_value=>'14.4k'
,p_return_value=>'.3s'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126361416308320048)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>60
,p_display_value=>'$14,435'
,p_return_value=>'$,.0f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126363356915320053)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>70
,p_display_value=>'$14435'
,p_return_value=>'$.0f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126361862182320048)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>80
,p_display_value=>'$14,435.49'
,p_return_value=>'$,.2f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126362420048320052)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>90
,p_display_value=>'$14435.49'
,p_return_value=>'$.2f'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126362904994320052)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_display_sequence=>100
,p_display_value=>'$14.4k'
,p_return_value=>'$.3s'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126363873655320053)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
,p_default_value=>'FRIENDLY'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(6126358538468320046)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'NULL'
,p_examples=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<ul>',
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126364294968320053)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(6126341971111320035)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126364743359320053)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>10
,p_display_value=>'Second'
,p_return_value=>'SECOND'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126365177254320053)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126365689637320054)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126366228708320055)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>40
,p_display_value=>'Day'
,p_return_value=>'DAY'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126366709427320055)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126367738974320055)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126368215221320056)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126368704020320056)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126369174123320056)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126369704059320056)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126370242486320057)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126370654499320057)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126371232730320057)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>130
,p_display_value=>'Month'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126367162494320055)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126364294968320053)
,p_display_sequence=>140
,p_display_value=>'Year'
,p_return_value=>'YEAR'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126371718971320057)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126372089492320057)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_display_sequence=>10
,p_display_value=>'Modern'
,p_return_value=>'MODERN'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126372643120320059)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126373088585320059)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126373615659320059)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126374566258320060)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126374096519320059)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126375081316320060)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
,p_show_in_wizard=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(6126371718971320057)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126375501556320060)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(6126375863831320060)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126375863831320060)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126376254606320061)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126375863831320060)
,p_display_sequence=>0
,p_display_value=>'Show series name'
,p_return_value=>'SERIES'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126376764331320061)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126375863831320060)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126377321659320061)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126375863831320060)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126377780998320061)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126375863831320060)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126378344465320062)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126378659546320062)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126379117677320063)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126379522626320063)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126379860049320063)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126379522626320063)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126380422475320063)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126379522626320063)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126380851923320063)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126381279787320064)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126380851923320063)
,p_display_sequence=>10
,p_display_value=>'X-Axis'
,p_return_value=>'X'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126381811709320065)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126380851923320063)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126382339545320065)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126382673399320066)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126383038576320066)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(6126382673399320066)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'NULL'
,p_help_text=>'Enter the name of the single data series which is shown on the legend.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6126383378552320066)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126383771019320067)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126383378552320066)
,p_display_sequence=>10
,p_display_value=>'Above chart'
,p_return_value=>'TOP'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6126384299312320067)
,p_plugin_attribute_id=>wwv_flow_imp.id(6126383378552320066)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(3806538815104445754)
,p_plugin_id=>wwv_flow_imp.id(5811044543647563862)
,p_name=>'SOURCE_SQL'
,p_sql_min_column_count=>2
