...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(662749361969327036)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662749659583327040)
,p_plugin_id=>wwv_flow_imp.id(662749361969327036)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662750057172327041)
,p_plugin_id=>wwv_flow_imp.id(662749361969327036)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662750478851327042)
,p_plugin_id=>wwv_flow_imp.id(662749361969327036)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662750851447327042)
,p_plugin_id=>wwv_flow_imp.id(662749361969327036)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(662751279201327042)
,p_plugin_attribute_id=>wwv_flow_imp.id(662750851447327042)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(662751762917327043)
,p_plugin_attribute_id=>wwv_flow_imp.id(662750851447327042)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(662752274216327043)
,p_plugin_attribute_id=>wwv_flow_imp.id(662750851447327042)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662752840239327043)
,p_plugin_id=>wwv_flow_imp.id(662749361969327036)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(662753459682327049)
,p_plugin_id=>wwv_flow_imp.id(662749361969327036)
,p_name=>'SOURCE_SQL'
