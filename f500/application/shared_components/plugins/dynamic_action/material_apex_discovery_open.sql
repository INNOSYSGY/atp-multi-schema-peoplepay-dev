...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3768045667746629657)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768045384096629655)
,p_plugin_id=>wwv_flow_imp.id(3768045667746629657)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768045018720629655)
,p_plugin_id=>wwv_flow_imp.id(3768045667746629657)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768044550588629655)
,p_plugin_id=>wwv_flow_imp.id(3768045667746629657)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768044245132629655)
,p_plugin_id=>wwv_flow_imp.id(3768045667746629657)
,p_attribute_scope=>'COMPONENT'
