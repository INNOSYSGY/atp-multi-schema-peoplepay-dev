...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3705745225513667027)
,p_lov_name=>'DEPT_MANAGED_INCOME'
,p_lov_query=>'.'||wwv_flow_imp.id(3705745225513667027)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3705745547584667033)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Payroll'
,p_lov_return_value=>'PAYROLL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3705745919740667034)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Human Resources'
,p_lov_return_value=>'HR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3705746318127667034)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'External Departments'
,p_lov_return_value=>'EXT_DEPT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3705746738105667034)
