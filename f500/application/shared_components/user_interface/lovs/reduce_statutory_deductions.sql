...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3200252190856893030)
,p_lov_name=>'REDUCE_STATUTORY_DEDUCTIONS'
,p_lov_query=>'.'||wwv_flow_imp.id(3200252190856893030)||'.'
,p_location=>'STATIC'
,p_version_scn=>41805887199447
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3200252544911893031)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Exclude Tax NIB / SS Total'
,p_lov_return_value=>'1'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3200252867207893034)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Exclude Tax Total'
,p_lov_return_value=>'2'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3200253261849893034)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Exclude NIB/SS Total'
,p_lov_return_value=>'3'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3200253664104893034)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'No Exclusions'
,p_lov_return_value=>'0'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(570449217319844160)
