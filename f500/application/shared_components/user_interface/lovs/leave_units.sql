...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3475243240419314182)
,p_lov_name=>'LEAVE_UNITS'
,p_lov_query=>'.'||wwv_flow_imp.id(3475243240419314182)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3475243471603314180)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Hours'
,p_lov_return_value=>'HOURS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3475243937881314178)
