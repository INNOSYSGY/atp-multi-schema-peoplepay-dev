...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3853945166883092899)
,p_lov_name=>'INTEREST_TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(3853945166883092899)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3853944730948092899)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Compound'
,p_lov_return_value=>'COMPOUND'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3853944405265092899)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'None'
,p_lov_return_value=>'NONE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3853943933069092897)
