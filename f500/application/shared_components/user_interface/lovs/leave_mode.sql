...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3722948936683903128)
,p_lov_name=>'LEAVE MODE'
,p_lov_query=>'.'||wwv_flow_imp.id(3722948936683903128)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3722948606714903127)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Cash'
,p_lov_return_value=>'CASH'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3722948214272903127)
