...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854025553698208363)
,p_lov_name=>'DEDUCTION_TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(3854025553698208363)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854025144815208361)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'EMPLOYEE'
,p_lov_return_value=>'EMPLOYEE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854024726143208361)
