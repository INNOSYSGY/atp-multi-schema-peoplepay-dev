...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3722950335786908811)
,p_lov_name=>'LEAVE STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(3722950335786908811)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3722949967887908806)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'None'
,p_lov_return_value=>'NONE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3722949637361908806)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Payment'
,p_lov_return_value=>'PAYMENT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3722949203368908806)
