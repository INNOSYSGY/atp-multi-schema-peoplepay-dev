...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854020515911208348)
,p_lov_name=>'DEPRECIATION_TYPES'
,p_lov_query=>'.'||wwv_flow_imp.id(3854020515911208348)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854020107197208348)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'STRAIGHT LINE METHOD'
,p_lov_return_value=>'SLM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854019649071208348)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'DECLINING BALANCE METHOD'
,p_lov_return_value=>'DBM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854019229009208348)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'SUM-OF-THE-YEARS''-DIGITS METHOD'
,p_lov_return_value=>'SYM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854018873382208346)
