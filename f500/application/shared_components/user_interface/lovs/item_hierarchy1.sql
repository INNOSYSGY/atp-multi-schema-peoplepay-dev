...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3832903568131939223)
,p_lov_name=>'ITEM_HIERARCHY1'
,p_lov_query=>'.'||wwv_flow_imp.id(3832903568131939223)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3832903129741939218)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'CATEGORY'
,p_lov_return_value=>'CATEGORY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3832902794846939214)
