...
wwv_flow_imp_page.create_page(
 p_id=>1002
,p_name=>'frmPURINVASSTMainPage'
,p_step_title=>'Purchase, Inventory and Asset Management'
...
,p_required_role=>wwv_flow_imp.id(3832057768034187422)
,p_page_component_map=>'18'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3693270909544364951)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3715276942510952486)
...
'and exists (select 1',
'            from HR_APU_TIPS',
'            where  MAIN_MODULES=''Purchasing, Inventory and Asset'')'))
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3792222890426327642)
,p_plug_name=>'PeoplePay Purchasing, Inventory & Assets'
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_source=>'Complete Paperless Office Management from Purchase to Disposal for General, Medical and Industrial Items'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3817896622491148527)
...
,p_header=>'<div style="overflow: auto; height: 560px">'
,p_footer=>'</div>'
,p_ajax_enabled=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3832047558666187372)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3832047936070187374)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3817903930737321279)
,p_plug_name=>'Total New Notifications: &P1002_NOT_SUM.'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3817904045080321279)
...
,p_detail_link=>'f?p=&APP_ID.:1328:&SESSION.::&DEBUG.::P1328_NOTIFICATION_DETAIL_ID,P1328_SOURCE:#NOTIFICATION_DETAIL_ID#,HRMIS'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#app_ui/img/icons/apex-edit-pencil-alt.png" class="apex-edit-pencil-alt" alt="">'
,p_owner=>'PUR_INV'
,p_internal_uid=>522352437974514880
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832048631350187387)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832048988283187388)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832049430296187389)
...
,p_rpt_named_lov=>wwv_flow_imp.id(3853792542071864587)
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832049857975187389)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832050224130187390)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832050646902187391)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832051013931187392)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832051412922187392)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3832051769948187393)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3817905141818324465)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'344644'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3846655030706678960)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3832057213785187418)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832052570904187398)
,p_name=>'P1002_NOT_SUM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3817903930737321279)
,p_use_cache_before_default=>'NO'
,p_item_default=>'0'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select val_count',
'from vw_purinvasst_notifysum'))
,p_source_type=>'QUERY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832053338014187401)
,p_name=>'P1002_MIN_TIP_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3846655030706678960)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select min(id)',
'from HR_APU_TIPS',
'where  MAIN_MODULES=''Purchasing, Inventory and Asset'''))
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832053736599187402)
,p_name=>'P1002_MAX_TIP_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3846655030706678960)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832054662553187404)
,p_name=>'P1002_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3715276942510952486)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3832055074306187409)
,p_name=>'set_holiday'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3832055575708187410)
,p_event_id=>wwv_flow_imp.id(3832055074306187409)
,p_event_result=>'TRUE'
...
'select LISTAGG(HOLIDAY_DESCRIP||'' set for ''||TO_CHAR(HOLIDAY_DATE,''DD-MON-YYYY'') ||'' its a''||',
'case when  tentative_status=1  then '' tentative holiday. Please remember to confirm it by removing this status and set it for calculation!'' ',
'     else '' confirmed holiday.'' end, '' '') WITHIN GROUP (ORDER BY holiday_date)  f',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3832056017691187410)
,p_name=>'set_tip'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3832056527309187411)
,p_event_id=>wwv_flow_imp.id(3832056017691187410)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1002_TIPS'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select messages',
'from HR_APU_TIPS',
'where id=floor(dbms_random.value(to_number(:P1002_MIN_TIP),to_number(:P1002_MAX_TIP)))',
'and rownum=1',
'and  MAIN_MODULES=''Purchasing, Inventory & Asset'''))
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
