...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3656969673075693128)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3656969572572693128)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3823625255212084158)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3823624898406084156)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3823624452307084155)
,p_db_column_name=>'ID'
,p_display_order=>3
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3823624052046084155)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3823623690381084155)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3823623278324084155)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3656968871690692783)
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(3823622564939084149)
,p_report_id=>wwv_flow_imp.id(3656968871690692783)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3657044167626199084)
,p_name=>'Audit'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696911566498827670)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696911671183827671)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696911789374827672)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696911900889827673)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696912044553827674)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696912087368827675)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696912213564827676)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(696912339047827677)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657129781920880376)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657029765660056553)
,p_plug_name=>' '
,p_region_name=>'second'
,p_parent_plug_id=>wwv_flow_imp.id(3657129781920880376)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657030572156077373)
,p_plug_name=>' '
,p_parent_plug_id=>wwv_flow_imp.id(3657129781920880376)
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--noIcon:t-Alert--danger'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3824142076316390014)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3674123737564652615)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3788693631838144928)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3852207894120492549)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267417079636627)
,p_name=>'DESCRIPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267547958636628)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267600370636629)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267712896636630)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267854970636631)
,p_name=>'START_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267941168636632)
,p_name=>'PAYMENT_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854267967992636633)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268140588636634)
,p_name=>'EXPENSE_CODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268249360636635)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268266816636636)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268417029636637)
,p_name=>'DEDUCTION_NO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268530250636638)
,p_name=>'PAY_SLIPNO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268605670636639)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3854268694134636640)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3854268784541636641)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3789993369256519988)
,p_interactive_grid_id=>wwv_flow_imp.id(3854268784541636641)
,p_static_id=>'690949'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3789993249458519988)
,p_report_id=>wwv_flow_imp.id(3789993369256519988)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3788303842610646207)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(3788693631838144928)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789962885113460373)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(3854267417079636627)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>10
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789974742585485877)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(3854267547958636628)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>103
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789975624163485879)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3854267600370636629)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>160
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789976558332485881)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(3854267712896636630)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>108
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789977407285485883)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3854267854970636631)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>115
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789978276263485886)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(3854267941168636632)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789986370067519971)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3854267967992636633)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789987354054519973)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3854268140588636634)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789988249476519975)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(3854268249360636635)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789989095944519977)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(3854268266816636636)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789990024824519979)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3854268417029636637)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>126
,p_break_order=>5
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789990912679519982)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3854268530250636638)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>76
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789991815489519984)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3854268605670636639)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>109
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3789992702976519986)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3854268694134636640)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3851627837563043425)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(3852207894120492549)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>15
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(3859087833809061065)
,p_view_id=>wwv_flow_imp.id(3789993249458519988)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(3854268266816636636)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3707347952455659498)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3707348285917659502)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707348362481659503)
,p_db_column_name=>'EXPENSE_ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Expense Code'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707348538948659504)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707348637903659505)
,p_db_column_name=>'ID'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Edit'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707348676738659506)
,p_db_column_name=>'DATESTART'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Datestart'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707348793533659507)
,p_db_column_name=>'DEDUCTION_AMOUNT'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Deduction Amount'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707348898651659508)
,p_db_column_name=>'DEDUCTION_NO'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Deduction No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707349198309659511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3707349322870659512)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3708040360128236441)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3708209594117513711)
,p_report_id=>wwv_flow_imp.id(3708040360128236441)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3708209995160513712)
,p_report_id=>wwv_flow_imp.id(3708040360128236441)
,p_name=>'zero_ded_amt'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3708210372301513712)
,p_report_id=>wwv_flow_imp.id(3708040360128236441)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3726592921475715140)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3727693230407259934)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727960280845362844)
,p_query_column_id=>1
,p_column_alias=>'No.'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727960653480362845)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727961087695362845)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727961493626362846)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727961836897362846)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727962279426362846)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3766408670100266767)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3763112350196933249)
,p_name=>'DESCRIPTION'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DESCRIPTION'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3766407181252266752)
,p_name=>'DED_YEAR'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3766407950820266760)
,p_name=>'DEDUCTION_TYPE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DEDUCTION_TYPE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3766408431007266764)
,p_name=>'EXPENSE_CODE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EXPENSE_CODE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3788693833054144930)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3788693925327144931)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3788694122040144933)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3788694244647144934)
,p_name=>'DEDUCTION_NO'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DEDUCTION_NO'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3766408631912266766)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3765936142368471622)
,p_interactive_grid_id=>wwv_flow_imp.id(3766408631912266766)
,p_static_id=>'270975'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3765935912861471621)
,p_report_id=>wwv_flow_imp.id(3765936142368471622)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3765923737194471596)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3766407181252266752)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>87.5
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3765930904599471608)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3766407950820266760)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>80
,p_break_order=>10
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3765934494118471614)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3766408431007266764)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>104
,p_break_order=>3.75
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3788353857669829464)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3788693833054144930)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3788386236354914841)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3788693925327144931)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>101
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3788534585438827147)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(3788694122040144933)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>78
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3788535523457827149)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3788694244647144934)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>190
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3793026940142446760)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3763112350196933249)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>146
,p_break_order=>2.5
...
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(3859085506146057499)
,p_view_id=>wwv_flow_imp.id(3765935912861471621)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(3788694122040144933)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3784890554128489530)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784495469502005247)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784495657174005248)
,p_name=>'PK_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784495748783005249)
,p_name=>'ENTRY_BY_AUD'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784495789205005250)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784495897110005251)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496054754005252)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496089039005253)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496197451005254)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496271589005255)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496457947005256)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496536369005257)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496608435005258)
,p_name=>'LEAVE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496662525005259)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496840720005260)
,p_name=>'SEQUENCE_NO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784496877896005261)
,p_name=>'ORGDTL_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497014350005262)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497146884005263)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497257962005264)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497281411005265)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497419664005216)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497522732005217)
,p_name=>'PK_TABLE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497607247005218)
,p_name=>'PK_VALUE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497682215005219)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497858976005220)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784497863161005221)
,p_name=>'PAYMENT_TYPE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'PAYMENT_TYPE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498032937005222)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498061837005223)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498188615005224)
,p_name=>'MIGRATE_PK'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498273800005225)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498399708005226)
,p_name=>'MIDDLE_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498465360005227)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498621769005228)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498670368005229)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498818144005230)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498948688005231)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784498965571005232)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499071348005233)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499214509005234)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499293406005235)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499428728005236)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499530387005237)
,p_name=>'SURNAME_HIST'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499611871005238)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499706884005239)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499835997005240)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784499936554005241)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500030678005242)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500110388005243)
,p_name=>'EMPLOYMENT_CLASS_HIST'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMPLOYMENT_CLASS_HIST'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500182374005244)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500273262005245)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500456116005246)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500472859005247)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500618581005248)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500685049005249)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500852249005250)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784500864172005251)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501004341005252)
,p_name=>'VERIFIED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501073766005253)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501227562005254)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501287352005255)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501382589005256)
,p_name=>'HOURLY_RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501490232005257)
,p_name=>'DEDUCTION_TYPE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DEDUCTION_TYPE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501621910005258)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501674584005259)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501827426005260)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784501923863005261)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784502032797005262)
,p_name=>'DEDUCTION_NO'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DEDUCTION_NO'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784502136989005263)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784502186318005264)
,p_name=>'APPROVED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784502269655005265)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889144387489516)
,p_name=>'CLOSED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889232632489517)
,p_name=>'DATE_CLOSE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889345732489518)
,p_name=>'PERIOD'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889378090489519)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889516734489520)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889629611489521)
,p_name=>'AMOUNT_OWING'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889717935489522)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889761459489523)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889887404489524)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784889993224489525)
,p_name=>'DATESTART'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784890061802489526)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784890167852489527)
,p_name=>'EXPENSE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3784890310795489528)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3784890403573489529)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3784491373213004145)
,p_interactive_grid_id=>wwv_flow_imp.id(3784890403573489529)
,p_static_id=>'745969'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3784491222283004145)
,p_report_id=>wwv_flow_imp.id(3784491373213004145)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784418030933003977)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3784495469502005247)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>71
,p_break_order=>5
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784418916617003979)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>81
,p_column_id=>wwv_flow_imp.id(3784495657174005248)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784419764240003981)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3784495748783005249)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>112
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784420722043003984)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3784495789205005250)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>149
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784421628491003986)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>81
,p_column_id=>wwv_flow_imp.id(3784495897110005251)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784422528006003988)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>79
,p_column_id=>wwv_flow_imp.id(3784496054754005252)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784423374941003990)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>78
,p_column_id=>wwv_flow_imp.id(3784496089039005253)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784424343916003992)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>77
,p_column_id=>wwv_flow_imp.id(3784496197451005254)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784425192158003994)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>76
,p_column_id=>wwv_flow_imp.id(3784496271589005255)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784426099721003996)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>75
,p_column_id=>wwv_flow_imp.id(3784496457947005256)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784426999374003998)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>74
,p_column_id=>wwv_flow_imp.id(3784496536369005257)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784427866286004000)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>73
,p_column_id=>wwv_flow_imp.id(3784496608435005258)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784428826827004002)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>72
,p_column_id=>wwv_flow_imp.id(3784496662525005259)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784429680031004004)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>71
,p_column_id=>wwv_flow_imp.id(3784496840720005260)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784430650057004006)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>70
,p_column_id=>wwv_flow_imp.id(3784496877896005261)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784431553537004008)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>69
,p_column_id=>wwv_flow_imp.id(3784497014350005262)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784432342994004010)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>68
,p_column_id=>wwv_flow_imp.id(3784497146884005263)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784433227747004012)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>67
,p_column_id=>wwv_flow_imp.id(3784497257962005264)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784434078119004014)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>66
,p_column_id=>wwv_flow_imp.id(3784497281411005265)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784435019535004016)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>65
,p_column_id=>wwv_flow_imp.id(3784497419664005216)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784435863155004018)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>64
,p_column_id=>wwv_flow_imp.id(3784497522732005217)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784436850462004020)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>63
,p_column_id=>wwv_flow_imp.id(3784497607247005218)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784437661863004022)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>63
,p_column_id=>wwv_flow_imp.id(3784497682215005219)
,p_is_visible=>false
,p_is_frozen=>false
,p_sort_order=>1
,p_sort_direction=>'DESC'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784438634267004024)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>61
,p_column_id=>wwv_flow_imp.id(3784497858976005220)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784439502176004026)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>60
,p_column_id=>wwv_flow_imp.id(3784497863161005221)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784440379886004028)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>59
,p_column_id=>wwv_flow_imp.id(3784498032937005222)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784441311797004030)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>58
,p_column_id=>wwv_flow_imp.id(3784498061837005223)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784442200444004032)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>57
,p_column_id=>wwv_flow_imp.id(3784498188615005224)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784443105541004034)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>56
,p_column_id=>wwv_flow_imp.id(3784498273800005225)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784444029662004036)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>55
,p_column_id=>wwv_flow_imp.id(3784498399708005226)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784444866118004038)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>54
,p_column_id=>wwv_flow_imp.id(3784498465360005227)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>30
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784445766789004040)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>53
,p_column_id=>wwv_flow_imp.id(3784498621769005228)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>109
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784446701452004042)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>52
,p_column_id=>wwv_flow_imp.id(3784498670368005229)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784447580873004044)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>51
,p_column_id=>wwv_flow_imp.id(3784498818144005230)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>35
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784448494864004046)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>50
,p_column_id=>wwv_flow_imp.id(3784498948688005231)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>40
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784449445575004049)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>49
,p_column_id=>wwv_flow_imp.id(3784498965571005232)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784450349460004051)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>48
,p_column_id=>wwv_flow_imp.id(3784499071348005233)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784451206966004053)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>47
,p_column_id=>wwv_flow_imp.id(3784499214509005234)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784452103635004055)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>46
,p_column_id=>wwv_flow_imp.id(3784499293406005235)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784452978491004057)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>45
,p_column_id=>wwv_flow_imp.id(3784499428728005236)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>25
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784453904936004059)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>44
,p_column_id=>wwv_flow_imp.id(3784499530387005237)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>20
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784454817857004061)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>43
,p_column_id=>wwv_flow_imp.id(3784499611871005238)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784455744225004063)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>42
,p_column_id=>wwv_flow_imp.id(3784499706884005239)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784456606949004065)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>41
,p_column_id=>wwv_flow_imp.id(3784499835997005240)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>10
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784457482213004067)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>40
,p_column_id=>wwv_flow_imp.id(3784499936554005241)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784458368160004069)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>39
,p_column_id=>wwv_flow_imp.id(3784500030678005242)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784459319424004072)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>38
,p_column_id=>wwv_flow_imp.id(3784500110388005243)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784460254876004074)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>37
,p_column_id=>wwv_flow_imp.id(3784500182374005244)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784461106481004076)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>36
,p_column_id=>wwv_flow_imp.id(3784500273262005245)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784462032854004078)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>35
,p_column_id=>wwv_flow_imp.id(3784500456116005246)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784462949253004080)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>34
,p_column_id=>wwv_flow_imp.id(3784500472859005247)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784463779676004082)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>33
,p_column_id=>wwv_flow_imp.id(3784500618581005248)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784464738097004084)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>32
,p_column_id=>wwv_flow_imp.id(3784500685049005249)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784465562385004086)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>31
,p_column_id=>wwv_flow_imp.id(3784500852249005250)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784466470646004088)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>30
,p_column_id=>wwv_flow_imp.id(3784500864172005251)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784467376963004091)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>29
,p_column_id=>wwv_flow_imp.id(3784501004341005252)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784468276766004093)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>28
,p_column_id=>wwv_flow_imp.id(3784501073766005253)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784469207725004095)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>27
,p_column_id=>wwv_flow_imp.id(3784501227562005254)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784470114084004096)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>26
,p_column_id=>wwv_flow_imp.id(3784501287352005255)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784470997572004098)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>25
,p_column_id=>wwv_flow_imp.id(3784501382589005256)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784471910750004100)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>24
,p_column_id=>wwv_flow_imp.id(3784501490232005257)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784472807588004102)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(3784501621910005258)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784473682539004105)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(3784501674584005259)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784474632710004107)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(3784501827426005260)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784475552232004109)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(3784501923863005261)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784476317707004111)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(3784502032797005262)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784477221465004113)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(3784502136989005263)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784478140354004115)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(3784502186318005264)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784479029137004117)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(3784502269655005265)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>73.75
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784479929911004119)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(3784889144387489516)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>71.5
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784480836483004121)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(3784889232632489517)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>76
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784481737988004122)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(3784889345732489518)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>54.75
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784482638720004124)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(3784889378090489519)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784483460672004127)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(3784889516734489520)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784484414020004128)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(3784889629611489521)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>97.5
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784485279121004131)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3784889717935489522)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784486194162004133)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3784889761459489523)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>91.75
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784487159294004135)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(3784889887404489524)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784488033014004137)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3784889993224489525)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784488938001004139)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3784890061802489526)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784489846712004141)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3784890167852489527)
,p_is_visible=>false
,p_is_frozen=>false
,p_break_order=>15
,p_break_is_enabled=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3784490683858004144)
,p_view_id=>wwv_flow_imp.id(3784491222283004145)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3784890310795489528)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3807021821041695162)
,p_plug_name=>'Notice'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3854268996254636643)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3962835990132558241)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764482537088582154)
,p_plug_name=>'<b> Bio Data </b>'
,p_parent_plug_id=>wwv_flow_imp.id(3962835990132558241)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3707348229655659501)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3707347952455659498)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3706890125785591325)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3764482537088582154)
,p_button_name=>'VIEW'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823647729293084200)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3726592921475715140)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823647352694084197)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823646994579084197)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823646524648084196)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823644585740084194)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823644968463084194)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3756753006715503889)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823646130784084195)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823645756888084195)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3823645372247084194)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3717993928279920826)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3707097829962339334)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3707097349387339329)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823606415201084115)
,p_branch_name=>'CREATE AGAIN'
,p_branch_action=>'f?p=&APP_ID.:1297:&SESSION.::&DEBUG.:1297::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3823646130784084195)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823606790496084115)
,p_branch_name=>'delete_branch'
,p_branch_action=>'f?p=&APP_ID.:1296:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3823647352694084197)
,p_branch_sequence=>2
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823608805148084117)
...
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3823645372247084194)
,p_branch_sequence=>3
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823608334923084117)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823607968693084116)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823607179319084115)
,p_branch_action=>'f?p=&APP_ID.:1297:&SESSION.::&DEBUG.::P1297_ID:&P1297_ID_PREV.'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3823644585740084194)
,p_branch_sequence=>1
,p_branch_comment=>'This button is needed for Get Next or Previous Primary Key Value process.'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3823607614631084116)
,p_branch_action=>'f?p=&APP_ID.:1297:&SESSION.::&DEBUG.::P1297_ID:&P1297_ID_NEXT.'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3823644968463084194)
,p_branch_sequence=>1
,p_branch_comment=>'This button is needed for Get Next or Previous Primary Key Value process.'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(660207178611221510)
,p_name=>'P1297_SUSPEND_DATE_START'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3657029765660056553)
,p_prompt=>'Start'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(660207316265221511)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3215358477531567898)
,p_name=>'P1297_DEDUCTION_PAYROLL'
,p_is_required=>true
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(3657030572156077373)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3565311636199530098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3691424051462647994)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694579685964785510)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3706889389372591314)
,p_name=>'P1297_PHOTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3962835990132558241)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3707348031199659499)
,p_name=>'P1297_LOAD_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3707347952455659498)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3707349027494659509)
,p_name=>'P1297_POST_EARN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3726592921475715140)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3707349080975659510)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766336694600262896)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3778155291302993066)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3779672412744841031)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3788693721311144929)
,p_name=>'P1297_DED_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3766408670100266767)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select description',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3822726585044480501)
,p_name=>'P1297_WORK_FLOW_COMMENT'
,p_item_sequence=>980
,p_item_plug_id=>wwv_flow_imp.id(3824142076316390014)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3822726890546478429)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823621329520084144)
,p_name=>'P1297_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3656969673075693128)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823621751253084146)
,p_name=>'P1297_LOAD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3656969673075693128)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823626009033084166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823626411330084166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823626801860084167)
,p_name=>'P1297_STATUS'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(3657029765660056553)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823627168749084167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823627615820084167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823627961142084167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823628393916084167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823628819197084168)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823629149523084168)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823629620117084169)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823630018395084169)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823630395314084169)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823630817709084170)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823631155892084170)
...
,p_lov=>'.'||wwv_flow_imp.id(3854027431601208365)||'.'
,p_lov_display_null=>'YES'
,p_lov_null_text=>'--null--'
,p_cHeight=>1
,p_colspan=>6
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823631836183084171)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823632275667084173)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823632718619084173)
,p_name=>'P1297_ORG_ID'
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_imp.id(3657030572156077373)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823633066460084173)
...
,p_lov=>'.'||wwv_flow_imp.id(3854025553698208363)||'.'
,p_lov_display_null=>'YES'
,p_lov_null_text=>'--null--'
,p_cHeight=>1
,p_grid_label_column_span=>3
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823633437212084173)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823633855795084174)
...
,p_lov=>'.'||wwv_flow_imp.id(3618946402930855682)||'.'
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823634292340084174)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823635214478084176)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823635586687084176)
,p_name=>'P1297_PERIOD'
,p_is_required=>true
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(3657030572156077373)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823635937265084176)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823636403683084176)
...
,p_lov=>'.'||wwv_flow_imp.id(3853945166883092899)||'.'
,p_cHeight=>1
,p_grid_label_column_span=>3
,p_field_template=>2526760615038828570
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823636743476084177)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823637158413084177)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823637597309084179)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823637941481084179)
,p_name=>'P1297_EMP_ID'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3657030572156077373)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823638373876084180)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823638738536084180)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823639425274084181)
,p_name=>'P1297_DOC_EXIST'
,p_item_sequence=>870
,p_item_plug_id=>wwv_flow_imp.id(3657044167626199084)
,p_use_cache_before_default=>'NO'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Select Id',
'From Media_Head',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823639891221084182)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823640312595084182)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823641918148084184)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823643371117084190)
,p_name=>'P1297_ID_PREV'
,p_item_sequence=>970
,p_item_plug_id=>wwv_flow_imp.id(3657129781920880376)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823643763233084190)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3823644144828084192)
,p_name=>'P1297_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3657129781920880376)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3824683750278485340)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3823620458644084139)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3823619675300084137)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3823620886454084140)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3843769838252022224)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3717744361449261834)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(660207714269221515)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(660207758972221516)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(660207919676221517)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823616580987084132)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823616094126084130)
,p_event_id=>wwv_flow_imp.id(3823616580987084132)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823615686430084129)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823614662872084128)
,p_event_id=>wwv_flow_imp.id(3823615686430084129)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823615150263084128)
,p_event_id=>wwv_flow_imp.id(3823615686430084129)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823614240126084128)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823613819054084128)
,p_event_id=>wwv_flow_imp.id(3823614240126084128)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823612430628084123)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823612004071084123)
,p_event_id=>wwv_flow_imp.id(3823612430628084123)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(666314710371281871)
,p_event_id=>wwv_flow_imp.id(3823612430628084123)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823613391340084123)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823612848969084123)
,p_event_id=>wwv_flow_imp.id(3823613391340084123)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3779672015059841027)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779671858033841026)
,p_event_id=>wwv_flow_imp.id(3779672015059841027)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779671779159841025)
,p_event_id=>wwv_flow_imp.id(3779672015059841027)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779671572713841023)
,p_event_id=>wwv_flow_imp.id(3779672015059841027)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823611615821084121)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823611052011084120)
,p_event_id=>wwv_flow_imp.id(3823611615821084121)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823610699173084120)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823610188305084119)
,p_event_id=>wwv_flow_imp.id(3823610699173084120)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3823609760674084119)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3823609225294084119)
,p_event_id=>wwv_flow_imp.id(3823609760674084119)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3822726348335482121)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3822725498851482122)
,p_event_id=>wwv_flow_imp.id(3822726348335482121)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3822725997601482122)
,p_event_id=>wwv_flow_imp.id(3822726348335482121)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3822725113839483881)
,p_name=>'show_comment'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3822724207824483882)
,p_event_id=>wwv_flow_imp.id(3822725113839483881)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3822724656453483882)
,p_event_id=>wwv_flow_imp.id(3822725113839483881)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3766337011094262899)
,p_name=>'New'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766337061683262900)
,p_event_id=>wwv_flow_imp.id(3766337011094262899)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3707097888409339335)
,p_name=>'reopen_deduction'
,p_event_sequence=>150
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3707097829962339334)
,p_condition_element=>'P1297_DEDUCT_STATUS'
,p_triggering_condition_type=>'EQUALS'
,p_triggering_expression=>'CL'
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3707098037347339336)
,p_event_id=>wwv_flow_imp.id(3707097888409339335)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3707346771266659487)
,p_event_id=>wwv_flow_imp.id(3707097888409339335)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3717744146903261831)
,p_name=>'set_close'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717744200815261832)
,p_event_id=>wwv_flow_imp.id(3717744146903261831)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717744275063261833)
,p_event_id=>wwv_flow_imp.id(3717744146903261831)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3779672253946841030)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779672063184841028)
,p_event_id=>wwv_flow_imp.id(3779672253946841030)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779672175380841029)
,p_event_id=>wwv_flow_imp.id(3779672253946841030)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3778155206577993065)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3778155003645993063)
,p_event_id=>wwv_flow_imp.id(3778155206577993065)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3778155093026993064)
,p_event_id=>wwv_flow_imp.id(3778155206577993065)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3779671490296841022)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779671398035841021)
,p_event_id=>wwv_flow_imp.id(3779671490296841022)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779671282943841020)
,p_event_id=>wwv_flow_imp.id(3779671490296841022)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3779671133806841019)
,p_event_id=>wwv_flow_imp.id(3779671490296841022)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3779671068922841018)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3778155364842993067)
,p_event_id=>wwv_flow_imp.id(3779671068922841018)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3778154747004993061)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3778154713133993060)
,p_event_id=>wwv_flow_imp.id(3778154747004993061)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3763112261736933248)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3763112168987933247)
,p_event_id=>wwv_flow_imp.id(3763112261736933248)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3656969673075693128)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3636011181413197068)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3636011247412197069)
,p_event_id=>wwv_flow_imp.id(3636011181413197068)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(666314989054281874)
,p_name=>'DY_SET'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(666315074525281875)
,p_event_id=>wwv_flow_imp.id(666314989054281874)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(660207436833221512)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(660207510042221513)
,p_event_id=>wwv_flow_imp.id(660207436833221512)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(660207587471221514)
,p_event_id=>wwv_flow_imp.id(660207436833221512)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682248415006480469)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682248506899480470)
,p_event_id=>wwv_flow_imp.id(682248415006480469)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3823619390223084137)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3823618123851084135)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3823618991680084137)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3823618589758084135)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3823647352694084197)
,p_internal_uid=>3180424039978475867
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3823617750464084134)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3823646994579084197)
,p_process_when=>'P1297_TRANSACTION_TYPE_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_internal_uid=>3180423200684475866
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3819727910847979120)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3840521921033928254)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3707097398972339330)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3707097349387339329)
