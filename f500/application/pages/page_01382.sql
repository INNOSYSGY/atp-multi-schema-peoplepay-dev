...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3778052803521062291)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3778054096957126115)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3852695681445743160)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3778052803521062291)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852694440406743153)
,p_name=>'P1382_MONTHS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3778052803521062291)
,p_prompt=>'Months'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852694859900743154)
,p_name=>'P1382_YEAR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3778052803521062291)
,p_prompt=>'Year'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852695301101743157)
