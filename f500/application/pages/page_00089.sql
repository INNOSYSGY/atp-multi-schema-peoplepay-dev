...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3796653569283395758)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3851799095320759353)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699066078327885548)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3796653569283395758)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699065754456885548)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699065324690885548)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(666757681724456610)
,p_name=>'P89_PARAMETERS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3796653569283395758)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699061715292885545)
,p_name=>'P89_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3796653569283395758)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699062103333885545)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699062505104885545)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699062885387885546)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699063319995885546)
...
,p_lov=>'.'||wwv_flow_imp.id(3717124850697604788)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699063732876885546)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699064148525885546)
,p_name=>'P89_ACTIVE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3796653569283395758)
,p_item_default=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699064557837885547)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699064927059885547)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705677167794903430)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699060956104885543)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699059907415885542)
,p_event_id=>wwv_flow_imp.id(3699060956104885543)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699060400276885542)
,p_event_id=>wwv_flow_imp.id(3699060956104885543)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699059495480885542)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3699065324690885548)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699059009987885541)
,p_event_id=>wwv_flow_imp.id(3699059495480885542)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699058476826885541)
,p_event_id=>wwv_flow_imp.id(3699059495480885542)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699058147269885541)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699057661557885540)
,p_event_id=>wwv_flow_imp.id(3699058147269885541)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699057117350885540)
,p_event_id=>wwv_flow_imp.id(3699058147269885541)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699056639211885540)
,p_event_id=>wwv_flow_imp.id(3699058147269885541)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699056227754885540)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3699065754456885548)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699055686134885539)
,p_event_id=>wwv_flow_imp.id(3699056227754885540)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699055231754885539)
,p_event_id=>wwv_flow_imp.id(3699056227754885540)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699054722376885539)
,p_event_id=>wwv_flow_imp.id(3699056227754885540)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699061327899885543)
...
,p_process_when_button_id=>wwv_flow_imp.id(3699065324690885548)
