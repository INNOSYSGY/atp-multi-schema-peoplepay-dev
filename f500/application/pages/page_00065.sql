...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(674136179722139356)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1005681397351036107)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(676329664215924698)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(676330082091924699)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(423025884773149123)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1008136682092457513)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1008137389481457615)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676332969018924719)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1008136682092457513)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676333385984924720)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676333731105924722)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676334214342924723)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676334995928924725)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676335408605924726)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(676358057125924822)
,p_branch_name=>'Delete'
,p_branch_action=>'f?p=&APP_ID.:65:&SESSION.::&DEBUG.:65::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(676333385984924720)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(423026324049149127)
,p_branch_name=>'STAY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025043183149114)
,p_name=>'P65_EXPENSE_CODE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(1008137389481457615)
,p_item_source_plug_id=>wwv_flow_imp.id(1008137389481457615)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025096804149115)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025248984149116)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025267055149117)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025359605149118)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025520987149119)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025589105149120)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025741381149121)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423025855192149122)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008144384209457663)
,p_name=>'P65_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008144805939457668)
,p_name=>'P65_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>40
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008145609132457672)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008152398608457692)
,p_name=>'P65_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(1008137389481457615)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676352938351924806)
,p_name=>'compute_totals_all'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(676334995928924725)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676353474240924808)
,p_event_id=>wwv_flow_imp.id(676352938351924806)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676354018680924809)
,p_event_id=>wwv_flow_imp.id(676352938351924806)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676354331778924810)
,p_name=>'sum_asat'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676354864692924812)
,p_event_id=>wwv_flow_imp.id(676354331778924810)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat_emp'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676355286708924813)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676355811942924815)
,p_event_id=>wwv_flow_imp.id(676355286708924813)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676356160891924816)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676356629981924818)
,p_event_id=>wwv_flow_imp.id(676356160891924816)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676357119833924819)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676357621025924820)
,p_event_id=>wwv_flow_imp.id(676357119833924819)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(423026089704149125)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(423026240478149126)
,p_event_id=>wwv_flow_imp.id(423026089704149125)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(676349677615924793)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(1008137389481457615)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(676350786374924797)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(678804307238372299)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(676333731105924722)
,p_internal_uid=>268506482546135971
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(676349243033924791)
