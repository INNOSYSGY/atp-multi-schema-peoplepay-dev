...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772850687367731444)
...
,p_list_id=>wwv_flow_imp.id(663274225310300614)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772695389890138296)
,p_plug_name=>'Chat Sent'
,p_parent_plug_id=>wwv_flow_imp.id(772850687367731444)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772893236302244370)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772895688672244394)
,p_plug_name=>'Forward'
,p_parent_plug_id=>wwv_flow_imp.id(772893236302244370)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772895763805244395)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772895865251244396)
,p_plug_name=>'Delete'
,p_parent_plug_id=>wwv_flow_imp.id(772893236302244370)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772893402209244371)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772897198289244409)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(772897609630244413)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776059406492366364)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776059454669366365)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776059557301366366)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776059671707366367)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776059788141366368)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(776066408784367295)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(781764785301121489)
,p_plug_name=>'Notice'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663208090120161915)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(772695389890138296)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663209854326161917)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(772895688672244394)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663211288115161919)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(772895763805244395)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663212686269161920)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(772895865251244396)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663213117494161920)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(772895865251244396)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772713848418138389)
,p_name=>'P4805_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772850687367731444)
,p_prompt=>'Recipient'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772714815303138383)
,p_name=>'P4805_ENTRY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772695389890138296)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772917536671244475)
,p_name=>'P4805_UTILITY_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772893236302244370)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772922209922244504)
,p_name=>'P4805_SENT_TO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(772895688672244394)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772922289861244505)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772922754940244485)
,p_name=>'P4805_GROUP_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772895763805244395)
,p_prompt=>'Group Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772925893696244517)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772928898961244515)
,p_name=>'P4805_MSG_TO_DELETE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772895865251244396)
,p_prompt=>'Message/s'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT COMMENT_TEXT||'' (''||initcap(a.user_name)||'')'' A, a.id B       ',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663228621681161958)
,p_name=>'SAVE_MSG'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663208090120161915)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663229058376161959)
,p_event_id=>wwv_flow_imp.id(663228621681161958)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663229604203161959)
,p_event_id=>wwv_flow_imp.id(663228621681161958)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(772850687367731444)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663230010764161959)
,p_name=>'refresh_chat'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663230509218161960)
,p_event_id=>wwv_flow_imp.id(663230010764161959)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663230993939161960)
,p_event_id=>wwv_flow_imp.id(663230010764161959)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663231434058161960)
,p_name=>'PURGE_CHAT'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663212686269161920)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663231914585161961)
,p_event_id=>wwv_flow_imp.id(663231434058161960)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663232428890161961)
,p_event_id=>wwv_flow_imp.id(663231434058161960)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663232822097161961)
,p_name=>'PURGE_CHAT_ALL'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663213117494161920)
,p_condition_element=>'P4805_RECIPIENT'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663233266922161961)
,p_event_id=>wwv_flow_imp.id(663232822097161961)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663233756987161962)
,p_event_id=>wwv_flow_imp.id(663232822097161961)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663234221541161962)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663234669769161962)
,p_event_id=>wwv_flow_imp.id(663234221541161962)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663208090120161915)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663235176068161962)
,p_event_id=>wwv_flow_imp.id(663234221541161962)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663235567263161963)
,p_name=>'dyn_forward'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663209854326161917)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663236080802161963)
,p_event_id=>wwv_flow_imp.id(663235567263161963)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663224478240161953)
,p_name=>'create_group'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663211288115161919)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663224990331161955)
,p_event_id=>wwv_flow_imp.id(663224478240161953)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663225448498161956)
,p_name=>'show_group'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663225945301161956)
,p_event_id=>wwv_flow_imp.id(663225448498161956)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663211288115161919)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663226414892161957)
,p_event_id=>wwv_flow_imp.id(663225448498161956)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663226772657161957)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663227661284161958)
,p_name=>'update_seen'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663228169680161958)
,p_event_id=>wwv_flow_imp.id(663227661284161958)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(663224140023161952)
