...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(696915563240827710)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3610982016374723096)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3610982188284723098)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3610982286517723099)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3610982369986723100)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3610982423476723101)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3610982526909723102)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3610982717629723103)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654149640310206054)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654149798409206055)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654149903218206056)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654149999877206057)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150058386206058)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150166201206059)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150287702206060)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150391063206061)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150447246206062)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150618257206063)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150685208206064)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150769469206065)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654150846387206066)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654151022236206067)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654151112850206068)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654151216100206069)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3654162964127210786)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3654173977690446866)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3654174151008446868)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174242421446869)
,p_db_column_name=>'REGNO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174324830446870)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174463447446871)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174539316446872)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174712659446873)
,p_db_column_name=>'SSN'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174731947446874)
,p_db_column_name=>'SURNAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174859632446875)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654174986841446876)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175045799446877)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175208046446878)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175322492446879)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175422176446880)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175427769446881)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175549681446882)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175654793446883)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175731802446884)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175910468446885)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654175979965446886)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654176044280446887)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654176152133446888)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654176271118446889)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654176399687446890)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3855283876143290803)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3855297484344724319)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3855297584860724319)
,p_name=>'eNIS Output'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699496924152267103)
,p_db_column_name=>'REGNO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699497351766267105)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699497758214267106)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699498133700267106)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699498585658267106)
,p_db_column_name=>'SSN'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699498906640267106)
,p_db_column_name=>'SURNAME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699499306906267107)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699499767726267107)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699500121897267107)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699500516547267108)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699500969602267108)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699501384242267108)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699501772426267109)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699502189477267109)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699502570002267109)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699502935479267109)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699503312880267110)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699503796391267110)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699504107403267110)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699504539424267111)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699504997593267111)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3855298567853729002)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3610982059898723097)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3610982016374723096)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3654174117355446867)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3654173977690446866)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699491472014267096)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(696915563240827710)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699491871203267097)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(696915563240827710)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699492223171267097)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(696915563240827710)
,p_button_name=>'PURGE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699492657632267097)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(696915563240827710)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699493024369267098)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(696915563240827710)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699505769563267115)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3855297484344724319)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3699507946047267118)
...
,p_branch_when_button_id=>wwv_flow_imp.id(3699492657632267097)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552069106334041249)
,p_name=>'P1403_W1'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552069277694041250)
,p_name=>'P1403_W2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
,p_prompt=>'Week 2'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552069372446041251)
,p_name=>'P1403_W3'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
,p_prompt=>'Week 3'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552069407599041252)
,p_name=>'P1403_W4'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
,p_prompt=>'Week 4'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552069565516041253)
,p_name=>'P1403_W5'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
,p_prompt=>'Week 5'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699493464405267098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699493837537267098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699494244712267098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699494627708267099)
,p_name=>'P1403_EYEAR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
,p_prompt=>'Year'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699495062744267099)
,p_name=>'P1403_MONTH'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3855283876143290803)
,p_prompt=>'Month'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699495452137267099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699495829494267099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699496297962267100)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699506956636267116)
,p_name=>'CS6 Form'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3699505769563267115)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699507428400267117)
,p_event_id=>wwv_flow_imp.id(3699506956636267116)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(552068916395041247)
,p_name=>'Clear'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(552069021887041248)
,p_event_id=>wwv_flow_imp.id(552068916395041247)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Clear'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699506147387267116)
...
,p_process_when_button_id=>wwv_flow_imp.id(3699491871203267097)
,p_process_success_message=>'Successful execution of eNIS.'
,p_internal_uid=>3056311597607658848
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699506602790267116)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3699492223171267097)
