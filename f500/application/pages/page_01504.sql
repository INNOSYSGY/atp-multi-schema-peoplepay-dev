...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(527980702459044139)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(527983356776044166)
,p_plug_name=>'Report'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(527980702459044139)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(527980811830044140)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(527980702459044139)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(527980857971044141)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(527981473755044147)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(527980702459044139)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527981914651044151)
,p_name=>'P1504_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(527980702459044139)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527981961633044152)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527982085505044153)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527982137902044154)
,p_name=>'P1504_YEAR'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(527980702459044139)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527982302601044155)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527982701427044159)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527982801952044160)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527983004080044162)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527983079519044163)
,p_name=>'P1504_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(527980702459044139)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527983176465044164)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(527983272408044165)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(527981001004044142)
,p_name=>'Preview_report_cloud'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(527980857971044141)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527981034045044143)
,p_event_id=>wwv_flow_imp.id(527981001004044142)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527981132301044144)
,p_event_id=>wwv_flow_imp.id(527981001004044142)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527981279967044145)
,p_event_id=>wwv_flow_imp.id(527981001004044142)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(527981572958044148)
,p_name=>'New'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(527981473755044147)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527981630008044149)
,p_event_id=>wwv_flow_imp.id(527981572958044148)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527981821770044150)
,p_event_id=>wwv_flow_imp.id(527981572958044148)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(527982357030044156)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527982451325044157)
,p_event_id=>wwv_flow_imp.id(527982357030044156)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(527982615507044158)
,p_event_id=>wwv_flow_imp.id(527982357030044156)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(527983569415044168)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(527983497062044167)
