...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3750286812595352196)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3717591079291785695)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3750286812595352196)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3701983334111285026)
,p_name=>'P37_USER_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3750286812595352196)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210231304726421)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210323076726422)
,p_name=>'P37_PK_KEY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3750286812595352196)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210401972726423)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210503766726424)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210600253726425)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210835851726427)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717210886487726428)
,p_name=>'P37_STATUS_M'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3750286812595352196)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717211984981726439)
,p_name=>'P37_PAGE_NUM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3750286812595352196)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717591477141785696)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3717211232701726431)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717211300788726432)
,p_event_id=>wwv_flow_imp.id(3717211232701726431)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717211363229726433)
,p_event_id=>wwv_flow_imp.id(3717211232701726431)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3717211821214726437)
,p_name=>'hide_record'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717211885246726438)
,p_event_id=>wwv_flow_imp.id(3717211821214726437)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3717590471121783067)
...
,p_process_when_button_id=>wwv_flow_imp.id(3717591079291785695)
