...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3696490617493195470)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(3696490688587195470)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3696490688587195470)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(547855749140622851)
,p_region_id=>wwv_flow_imp.id(3696490688587195470)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(547855835257622852)
,p_card_id=>wwv_flow_imp.id(547855749140622851)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(547962198530016673)
,p_card_id=>wwv_flow_imp.id(547855749140622851)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(547962346272016674)
,p_card_id=>wwv_flow_imp.id(547855749140622851)
,p_action_type=>'BUTTON'
,p_position=>'SECONDARY'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23673856317072009783)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23673856681308009786)
,p_plug_name=>'Search_top'
,p_parent_plug_id=>wwv_flow_imp.id(23673856317072009783)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697012728861356802)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(23673856681308009786)
,p_button_name=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3696474184837165531)
,p_name=>'P107_ENTRY_SCREEN'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(23673856681308009786)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3696475022729165531)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3696490095728195470)
,p_name=>'P107_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3696490617493195470)
,p_prompt=>'Search'
