...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5012479622350984623)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5012480627514984633)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(670872900083726332)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5012480627514984633)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(670872184181726332)
,p_name=>'P9914_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5012479622350984623)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(696685676509273377)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696686145578273378)
,p_event_id=>wwv_flow_imp.id(696685676509273377)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696686600949273378)
,p_event_id=>wwv_flow_imp.id(696685676509273377)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(670873290056726334)
...
,p_process_when_button_id=>wwv_flow_imp.id(670872900083726332)
