...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2080601100986507269)
,p_plug_name=>'Tabs'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2208847678413624175)
,p_plug_name=>'Income Benefits'
,p_parent_plug_id=>wwv_flow_imp.id(2080601100986507269)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208847878647624177)
,p_name=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208847931461624178)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848076113624179)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848198762624180)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848239515624181)
,p_name=>'START_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848373421624182)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848435179624183)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848500552624184)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848696624624185)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848706091624186)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848890952624187)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2208848923646624188)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(2208847766864624176)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(2244136612624916867)
,p_interactive_grid_id=>wwv_flow_imp.id(2208847766864624176)
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(2244136845824916867)
,p_report_id=>wwv_flow_imp.id(2244136612624916867)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244137388625916870)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(2208847878647624177)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244138281447916876)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(2208847931461624178)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244139191871916880)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(2208848076113624179)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>106.68799999999999
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244140030209916882)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(2208848198762624180)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244140950546916886)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(2208848239515624181)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244141804244916891)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(2208848373421624182)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244142729307916893)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(2208848435179624183)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244143642701916896)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(2208848500552624184)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244144513170916899)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(2208848696624624185)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244145408046916902)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(2208848706091624186)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2244146312391916905)
,p_view_id=>wwv_flow_imp.id(2244136845824916867)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(2208848890952624187)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3614889897678958606)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2080601292088507270)
,p_name=>'INCOME_CODE_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'INCOME_CODE_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(2084929188885090768)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614891711856958624)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614891863371958626)
,p_name=>'OPTION_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892079690958628)
,p_name=>'START_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'START_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892220233958629)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'END_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892293798958630)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892409669958631)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892455051958632)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892562657958633)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892732911958634)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892788463958635)
,p_name=>'ATTRIB_VALUE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892887694958636)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614892942244958637)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614893064830958638)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3614893174658958639)
,p_name=>'APEX$ROW_ACTION'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_ACTION'
,p_display_sequence=>20
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3615124301002848490)
,p_name=>'APEX$ROW_SELECTOR'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_SELECTOR'
,p_display_sequence=>10
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3614891600825958623)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3615074822058672589)
,p_interactive_grid_id=>wwv_flow_imp.id(3614891600825958623)
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3615075022903672590)
,p_report_id=>wwv_flow_imp.id(3615074822058672589)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2080875469097025346)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(2080601292088507270)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(2084949532430120695)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(2084929188885090768)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>116.3
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615075503977672592)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3614891711856958624)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615077304198672607)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3614891863371958626)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615079088025672614)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3614892079690958628)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>116
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615080007672672617)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(3614892220233958629)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615080932730672622)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(3614892293798958630)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>175
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615081783096672627)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(3614892409669958631)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615082651294672632)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(3614892455051958632)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615083598868672638)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(3614892562657958633)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615084455204672644)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(3614892732911958634)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615085355809672649)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3614892788463958635)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615086259575672654)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3614892887694958636)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>187
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615087148479672660)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3614892942244958637)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>157
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615088080516672665)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3614893064830958638)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3615130912717849639)
,p_view_id=>wwv_flow_imp.id(3615075022903672590)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3614893174658958639)
,p_is_visible=>true
,p_is_frozen=>true
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(5927537087782683412)
,p_name=>'Audit Record '
,p_parent_plug_id=>wwv_flow_imp.id(2080601100986507269)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(546797183426910933)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(546796777286910932)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(546796388174910931)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(546796012602910930)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(546795655103910929)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(546795251572910929)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5639799573431237842)
,p_plug_name=>'Configure Computation Factor'
,p_parent_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546778947265910881)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546779326858910883)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546778102369910879)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546777733610910878)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546778498990910880)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546777286546910877)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546776952956910877)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(546776474399910875)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(546746976937910802)
,p_branch_name=>'CREATE AGAIN'
,p_branch_action=>'f?p=&APP_ID.:4605:&SESSION.::&DEBUG.:4605::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(546778498990910880)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(546746599392910801)
,p_branch_name=>'delete_branch'
,p_branch_action=>'f?p=&APP_ID.:4604:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(546779326858910883)
,p_branch_sequence=>2
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(546746166318910801)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053888898481867395)
,p_name=>'P11_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
,p_item_source_plug_id=>wwv_flow_imp.id(5927540709975683422)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053889350779867396)
,p_name=>'P11_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053889687162867396)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053890090906867397)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053890525626867397)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053890958055867398)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053891347900867398)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053891698789867399)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053892664098867400)
,p_name=>'P11_PRORATE'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053893035104867401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053893441433867402)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053894315654867403)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053894735539867403)
...
,p_lov=>'.'||wwv_flow_imp.id(3705745225513667027)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_begin_on_new_field=>'N'
,p_field_template=>2318601014859922299
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053895184728867404)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053895994641867404)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053896409218867405)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053896809251867405)
,p_name=>'P11_END_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053897165515867430)
,p_name=>'P11_INCOME_TYPE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(5639799573431237842)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053897271464867406)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053897550080867431)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053897652212867406)
,p_name=>'P11_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053897968936867431)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053898076856867406)
,p_name=>'P11_ID_COUNT'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053898337081867432)
,p_name=>'P11_TAXABLE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(5639799573431237842)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053898422965867407)
,p_name=>'P11_REMARKS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053898761067867432)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053899158851867433)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053899518670867434)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053900433831867438)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053900781430867439)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053901695756867440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053902076487867441)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053923815731867481)
,p_name=>'P11_VERIFIED_BY'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(5927537087782683412)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053924621608867482)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2053925022187867483)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(546772342358910858)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(546772713859910859)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(546771547464910857)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(546771921836910858)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(546773106522910860)
...
,p_associated_item=>wwv_flow_imp.id(2053894315654867403)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546760709212910832)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546759742360910830)
,p_event_id=>wwv_flow_imp.id(546760709212910832)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546760162811910831)
,p_event_id=>wwv_flow_imp.id(546760709212910832)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546756468489910822)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546756036967910821)
,p_event_id=>wwv_flow_imp.id(546756468489910822)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546755477790910820)
,p_event_id=>wwv_flow_imp.id(546756468489910822)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546757441405910824)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546756941399910823)
,p_event_id=>wwv_flow_imp.id(546757441405910824)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546753170126910816)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546752177908910813)
,p_event_id=>wwv_flow_imp.id(546753170126910816)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546752737927910815)
,p_event_id=>wwv_flow_imp.id(546753170126910816)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546751782344910813)
,p_name=>'cascade_change'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(546776952956910877)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546751293182910811)
,p_event_id=>wwv_flow_imp.id(546751782344910813)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546750859752910810)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546750416078910809)
,p_event_id=>wwv_flow_imp.id(546750859752910810)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546749373368910807)
,p_event_id=>wwv_flow_imp.id(546750859752910810)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546749866553910808)
,p_event_id=>wwv_flow_imp.id(546750859752910810)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546748945493910806)
,p_event_id=>wwv_flow_imp.id(546750859752910810)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546748476551910806)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546747541697910804)
,p_event_id=>wwv_flow_imp.id(546748476551910806)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546747991013910805)
,p_event_id=>wwv_flow_imp.id(546748476551910806)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546755111252910819)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546754114191910817)
,p_event_id=>wwv_flow_imp.id(546755111252910819)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546754656388910818)
,p_event_id=>wwv_flow_imp.id(546755111252910819)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546753571753910816)
,p_event_id=>wwv_flow_imp.id(546755111252910819)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546759305159910829)
,p_name=>'gen_codes_inc'
,p_event_sequence=>90
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(546776474399910875)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546758800244910828)
,p_event_id=>wwv_flow_imp.id(546759305159910829)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546758290407910826)
,p_event_id=>wwv_flow_imp.id(546759305159910829)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_affected_region_id=>wwv_flow_imp.id(5639799573431237842)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546757827931910825)
,p_event_id=>wwv_flow_imp.id(546759305159910829)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5927540709975683422)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546763508609910838)
,p_name=>'append_NT_T_Description'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546763010972910837)
,p_event_id=>wwv_flow_imp.id(546763508609910838)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546762510200910836)
,p_event_id=>wwv_flow_imp.id(546763508609910838)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546762137383910835)
,p_name=>'append_NT_T_Description_1'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546761585653910834)
,p_event_id=>wwv_flow_imp.id(546762137383910835)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546761072795910833)
,p_event_id=>wwv_flow_imp.id(546762137383910835)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546765876377910843)
,p_name=>'Hide/Show Rate Amount'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546764917290910841)
,p_event_id=>wwv_flow_imp.id(546765876377910843)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DISABLE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546765363260910842)
,p_event_id=>wwv_flow_imp.id(546765876377910843)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546763937245910839)
,p_event_id=>wwv_flow_imp.id(546765876377910843)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546764360624910840)
,p_event_id=>wwv_flow_imp.id(546765876377910843)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546767345135910846)
,p_name=>'set_standard_hours'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546766260252910844)
,p_event_id=>wwv_flow_imp.id(546767345135910846)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546766844584910845)
,p_event_id=>wwv_flow_imp.id(546767345135910846)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546768705439910849)
,p_name=>'dy_hideshowproration'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546767679114910847)
,p_event_id=>wwv_flow_imp.id(546768705439910849)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546768245848910848)
,p_event_id=>wwv_flow_imp.id(546768705439910849)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(546769635659910852)
,p_name=>'Append_nontax_if_blank'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(546769148530910850)
,p_event_id=>wwv_flow_imp.id(546769635659910852)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546803048744910953)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(5927540709975683422)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546770774816910855)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546771246864910856)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(546778102369910879)
,p_internal_uid=>25563610209363663
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546770404797910854)
...
,p_attribute_04=>'4'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(546779326858910883)
,p_internal_uid=>25564452276363665
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546769973666910853)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(546778947265910881)
,p_internal_uid=>25564883407363666
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546779977486910884)
,p_process_sequence=>60
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(2208847678413624175)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(546803371881910955)
,p_process_sequence=>10
