...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657943546002377015)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657944556382377018)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3657943546002377015)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657945144618377019)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3657943546002377015)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657945554703377019)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3657945966629377020)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3657945554703377019)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694301919779770293)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3657943546002377015)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694305097396770301)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3657944556382377018)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694302359275770294)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694302706500770294)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3657943546002377015)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3694313297764770310)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694303159504770298)
,p_name=>'P402_REPORT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3657943546002377015)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694303572367770299)
,p_name=>'P402_URL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3657943546002377015)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694303963333770299)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694304327350770299)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694305473069770301)
,p_name=>'P402_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3657944556382377018)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694306503982770302)
,p_name=>'P402_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3657945554703377019)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694307166721770305)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3694302706500770294)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694307621824770306)
,p_event_id=>wwv_flow_imp.id(3694307166721770305)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3846734361088553123)
,p_event_id=>wwv_flow_imp.id(3694307166721770305)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694308027957770306)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694308510753770306)
,p_event_id=>wwv_flow_imp.id(3694308027957770306)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694309007821770307)
,p_event_id=>wwv_flow_imp.id(3694308027957770306)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694309424625770307)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694309923015770307)
,p_event_id=>wwv_flow_imp.id(3694309424625770307)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694310363245770307)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3694305097396770301)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694310858054770308)
,p_event_id=>wwv_flow_imp.id(3694310363245770307)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694311384065770308)
,p_event_id=>wwv_flow_imp.id(3694310363245770307)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694311707450770308)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694312260588770308)
,p_event_id=>wwv_flow_imp.id(3694311707450770308)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694312780610770309)
,p_event_id=>wwv_flow_imp.id(3694311707450770308)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
