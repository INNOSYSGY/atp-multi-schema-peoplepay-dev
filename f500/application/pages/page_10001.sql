...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4889844529755109798)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811846069476199920)
,p_region_id=>wwv_flow_imp.id(4889844529755109798)
,p_chart_type=>'pie'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811845534523199920)
,p_chart_id=>wwv_flow_imp.id(3811846069476199920)
,p_seq=>10
,p_name=>'Tasks'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4889845074102109803)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811844623210199920)
,p_region_id=>wwv_flow_imp.id(4889845074102109803)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811842971840199919)
,p_chart_id=>wwv_flow_imp.id(3811844623210199920)
,p_seq=>10
,p_name=>'Tasks'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811843613299199919)
,p_chart_id=>wwv_flow_imp.id(3811844623210199920)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811844169832199920)
,p_chart_id=>wwv_flow_imp.id(3811844623210199920)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4889845589930109808)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811842096430199919)
,p_region_id=>wwv_flow_imp.id(4889845589930109808)
,p_chart_type=>'donut'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811841538899199918)
,p_chart_id=>wwv_flow_imp.id(3811842096430199919)
,p_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5186118088425719634)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811847467762199921)
,p_region_id=>wwv_flow_imp.id(5186118088425719634)
,p_chart_type=>'funnel'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811846932999199921)
,p_chart_id=>wwv_flow_imp.id(3811847467762199921)
,p_seq=>10
,p_name=>'Tasks'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811840638354199917)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811840168607199917)
,p_event_id=>wwv_flow_imp.id(3811840638354199917)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4889845589930109808)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811839759380199917)
,p_name=>'Increase'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3830880543187790276)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811839230660199917)
,p_event_id=>wwv_flow_imp.id(3811839759380199917)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4889844529755109798)
,p_attribute_01=>'$("#pie1_jet").ojChart({legend:{size:''50%''}});'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811838901581199916)
,p_name=>'Decrease'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3966432303405706905)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811838418458199916)
,p_event_id=>wwv_flow_imp.id(3811838901581199916)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
