...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697374487155318470)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3633810493669043595)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3633810415309043562)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842045050344077641)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842045863184077644)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842046273387077647)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842046632927077647)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842045393487077642)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842046997317077649)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842047403541077649)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842047779507077651)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842044658863077640)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842048202384077664)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842044181078077640)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3633809289860042459)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842039382580077620)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
,p_name=>'Anniversary '
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842039856395077621)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
,p_name=>'Birthday '
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842040261813077622)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
,p_name=>'Confirmation'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842040585303077623)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
,p_name=>'Gratuity'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842041024348077623)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842041454739077624)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842041867923077625)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842042228009077626)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
,p_name=>'Retirement'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842042620324077627)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
,p_name=>'work permit'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842039068766077619)
,p_report_id=>wwv_flow_imp.id(3633809289860042459)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3666599393460512988)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842043465221077632)
,p_report_id=>wwv_flow_imp.id(3666599393460512988)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'DESCRIP'
,p_operator=>'='
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825172614049826127)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825251481871277046)
,p_plug_name=>'Listing of Notification Schedules'
,p_parent_plug_id=>wwv_flow_imp.id(3825172614049826127)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3825251357273277045)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825251313272277044)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825251201988277043)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825251076727277042)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825251013206277041)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825250893818277040)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825250810069277039)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825250653800277038)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825250589209277037)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825250520800277036)
,p_db_column_name=>'ID'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Edit'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825250215752277033)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3825145824179893662)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825251568757277047)
,p_plug_name=>'Audit'
,p_parent_plug_id=>wwv_flow_imp.id(3825172614049826127)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3843436053141718519)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825171868333826128)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3825172614049826127)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825171947850826128)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825250393062277035)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825172066151826128)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825172156170826128)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3825170291662826130)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825166339075826167)
,p_name=>'P308_LAST_CHANGED_BY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3825251568757277047)
,p_item_source_plug_id=>wwv_flow_imp.id(3825172614049826127)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825166812825826167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825167200431826167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825167599315826166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825167973888826166)
,p_name=>'P308_END_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3825172614049826127)
,p_item_source_plug_id=>wwv_flow_imp.id(3825172614049826127)
,p_use_cache_before_default=>'NO'
,p_prompt=>'End Date'
,p_source=>'END_DATE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825168417524826166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825168725510826166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825169189015826166)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825169878350826161)
,p_name=>'P308_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825250240468277034)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3825250023353277032)
...
,p_when_button_pressed=>wwv_flow_imp.id(3825172156170826128)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3825250019538277031)
...
,p_when_button_pressed=>wwv_flow_imp.id(3825172066151826128)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825165546642826167)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(3825172614049826127)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Fetch Row from HR_APU_NOTIFY_SCHEDULER'
,p_internal_uid=>3181970996863217899
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825165136678826168)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825164731035826168)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3825171947850826128)
