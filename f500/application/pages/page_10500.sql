...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33345239896276189246)
...
'    and time_stamp > current_date - to_number(:P10500_TIMEFRAME,''9999999990.99999999999'',''NLS_NUMERIC_CHARACTERS=''''.,'''''')',
'    and userid is not null',
'    and exists(select 1',
'           from TBLUSER X JOIN tbluserdetail w ON x.user_id = w.user_id',
'           where upper(L.userid) = upper(x.USER_NAME)',
'           AND  w.application_schema_name = :G_PARSING_SCHEMA',
'           and w.org_id=:APP_ORG_ID',
'           )',
'    group by lower(userid)) x'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P10500_TIMEFRAME'
,p_plug_display_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_plug_display_when_condition=>'P10500_VIEW_AS'
,p_plug_display_when_cond2=>'REPORT'
,p_plug_footer=>'<!--Remove activity-by-hour whitespace--><style>.t-fht-tbody td:nth-child(2){padding:0}span.hour:hover{background:#d0a9b0;color:white;}</style>'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(33345241428251189248)
,p_name=>'Top Users'
...
,p_internal_uid=>30003342785705380841
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852646373952683032)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852646018984683022)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852645541525683019)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852645174933683019)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852644766565683018)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852644354815683016)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852643926293683014)
,p_db_column_name=>'ERRORS'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'CA.ERRORS'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G999G999G990'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3852643587657683011)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(33345244932216189280)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'215985'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33345240053026189246)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33345240225908189246)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3852640635130682992)
,p_region_id=>wwv_flow_imp.id(33345240225908189246)
,p_chart_type=>'donut'
,p_height=>'600'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3852640174179682990)
,p_chart_id=>wwv_flow_imp.id(3852640635130682992)
,p_seq=>10
,p_name=>'Top Users'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3852642727939683002)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(33345239896276189246)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3852642356919683001)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852641247499682996)
,p_name=>'P10500_VIEW_AS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(33345240053026189246)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852641627623682997)
,p_name=>'P10500_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(33345240053026189246)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3852639603786682986)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10500_TIMEFRAME'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3852638560799682976)
,p_event_id=>wwv_flow_imp.id(3852639603786682986)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(33345239896276189246)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3852639058879682983)
,p_event_id=>wwv_flow_imp.id(3852639603786682986)
,p_event_result=>'TRUE'
