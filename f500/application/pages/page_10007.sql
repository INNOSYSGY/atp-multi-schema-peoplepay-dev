...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4311932231948934613)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3871612854002272400)
,p_plug_name=>'Transfer'
,p_parent_plug_id=>wwv_flow_imp.id(4311932231948934613)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811582593971143053)
,p_region_id=>wwv_flow_imp.id(3871612854002272400)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811580858805143053)
,p_chart_id=>wwv_flow_imp.id(3811582593971143053)
,p_seq=>10
,p_name=>'Transfer'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811581494358143053)
,p_chart_id=>wwv_flow_imp.id(3811582593971143053)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811582043441143053)
,p_chart_id=>wwv_flow_imp.id(3811582593971143053)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4311932381975934614)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811590345481143056)
,p_region_id=>wwv_flow_imp.id(4311932381975934614)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811588638485143056)
,p_chart_id=>wwv_flow_imp.id(3811590345481143056)
,p_seq=>10
,p_name=>'Promotion'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811589882657143056)
,p_chart_id=>wwv_flow_imp.id(3811590345481143056)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811589261822143056)
,p_chart_id=>wwv_flow_imp.id(3811590345481143056)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4349828359919817669)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811587795318143055)
,p_region_id=>wwv_flow_imp.id(4349828359919817669)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811586115511143055)
,p_chart_id=>wwv_flow_imp.id(3811587795318143055)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811586623954143055)
,p_chart_id=>wwv_flow_imp.id(3811587795318143055)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811587258426143055)
,p_chart_id=>wwv_flow_imp.id(3811587795318143055)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4349828905805817674)
,p_plug_name=>'Acting'
,p_parent_plug_id=>wwv_flow_imp.id(4311932231948934613)
,p_region_template_options=>'#DEFAULT#:i-h320:t-Region--noBorder:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811585198758143054)
,p_region_id=>wwv_flow_imp.id(4349828905805817674)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811583492957143054)
,p_chart_id=>wwv_flow_imp.id(3811585198758143054)
,p_seq=>10
,p_name=>'Acting'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811584688002143054)
,p_chart_id=>wwv_flow_imp.id(3811585198758143054)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811584093163143054)
,p_chart_id=>wwv_flow_imp.id(3811585198758143054)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3818992528390079126)
,p_name=>'P10007_END_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4311932231948934613)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3818992722635079127)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682583402886389090)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682583514686389091)
,p_event_id=>wwv_flow_imp.id(682583402886389090)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(4349828905805817674)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682583562985389092)
,p_event_id=>wwv_flow_imp.id(682583402886389090)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3871612854002272400)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682583700474389093)
,p_event_id=>wwv_flow_imp.id(682583402886389090)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4311932381975934614)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682583819768389094)
,p_event_id=>wwv_flow_imp.id(682583402886389090)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4349828359919817669)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682583947094389095)
,p_name=>'refresh_end'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682583955899389096)
,p_event_id=>wwv_flow_imp.id(682583947094389095)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'refresh_transfer'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682584214939389098)
,p_event_id=>wwv_flow_imp.id(682583947094389095)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682584265952389099)
,p_event_id=>wwv_flow_imp.id(682583947094389095)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682584384948389100)
,p_event_id=>wwv_flow_imp.id(682583947094389095)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
