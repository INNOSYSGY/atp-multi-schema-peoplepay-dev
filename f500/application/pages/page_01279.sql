...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3819732110677979162)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3819753914290485812)
...
,p_list_id=>wwv_flow_imp.id(3819716300386698079)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(3830601105509057924)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3819731754512979159)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3819732110677979162)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810116186451785060)
,p_name=>'P1279_SEARCH'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3819732110677979162)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819683340049250161)
,p_name=>'P1279_RANGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3819732110677979162)
,p_item_default=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3824236703231474313)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3824236725705474314)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825844961770356446)
,p_name=>'P1279_COUNT'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3819732110677979162)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3825844894756356445)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3825844799213356444)
,p_event_id=>wwv_flow_imp.id(3825844894756356445)
,p_event_result=>'TRUE'
