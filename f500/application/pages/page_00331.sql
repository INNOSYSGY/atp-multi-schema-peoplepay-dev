...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3827085602587790663)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3170267392458551168)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3827085602587790663)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3170267000732551167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170267764777551172)
,p_name=>'P331_ORGDTL_ID'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3827085602587790663)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170268209645551173)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170268625665551173)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170269025123551173)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170269417542551174)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170269793299551174)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170270209421551175)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170270617822551175)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170271045306551176)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170271447244551176)
,p_name=>'P331_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3827085602587790663)
,p_prompt=>'Remarks'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3170271785221551182)
,p_name=>'SHOW_HIDE'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170272314785551183)
,p_event_id=>wwv_flow_imp.id(3170271785221551182)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3170267000732551167)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170272761804551184)
,p_event_id=>wwv_flow_imp.id(3170271785221551182)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3170273207898551184)
,p_name=>'run_process'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3170267000732551167)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170274216192551185)
,p_event_id=>wwv_flow_imp.id(3170273207898551184)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170273685563551185)
,p_event_id=>wwv_flow_imp.id(3170273207898551184)
,p_event_result=>'TRUE'
