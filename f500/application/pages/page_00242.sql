...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(663470430161048882)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(663471330977048891)
,p_plug_name=>'File Export'
,p_parent_plug_id=>wwv_flow_imp.id(663470430161048882)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(663471530936048893)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663471579430048894)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663471735862048895)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663471843051048896)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663471936192048897)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663471957773048898)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663472060916048899)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663472185071048900)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(666747573225223930)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663470572620048884)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(663470430161048882)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663470507908048883)
,p_name=>'P242_EARNING_PERIOD_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(663470430161048882)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663470704068048885)
,p_name=>'P242_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(663470430161048882)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663470814193048886)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663470948292048887)
,p_event_id=>wwv_flow_imp.id(663470814193048886)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(665362295627497344)
,p_name=>'EXEUTE_DOWNLOAD'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663470572620048884)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(665362664298497345)
,p_event_id=>wwv_flow_imp.id(665362295627497344)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663471018559048888)
,p_name=>'showbutton'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663471137712048889)
,p_event_id=>wwv_flow_imp.id(663471018559048888)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663470572620048884)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663471200524048890)
,p_event_id=>wwv_flow_imp.id(663471018559048888)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663472330573048901)
,p_name=>'refresh'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P242_EARNING_PERIOD_ID'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663472355947048902)
,p_event_id=>wwv_flow_imp.id(663472330573048901)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(663471330977048891)
,p_attribute_01=>'N'
);
