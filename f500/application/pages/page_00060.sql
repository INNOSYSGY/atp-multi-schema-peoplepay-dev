...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3726557362914452002)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3726854859622956075)
,p_plug_name=>'TAB'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3730379705660387443)
,p_plug_name=>'Leave  Roster Gantt Chart'
,p_parent_plug_id=>wwv_flow_imp.id(3726854859622956075)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759692749289784452)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719128550402388504)
,p_plug_name=>'Employee Leave Calendar (select filter options above, Navigate to specific month)'
,p_parent_plug_id=>wwv_flow_imp.id(3759692749289784452)
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719588054245963194)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3831062986470746025)
,p_plug_name=>'Legend'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3726722396797496533)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3726557362914452002)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3727009269509633055)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3719588054245963194)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3725827710659671016)
,p_name=>'P60_LEAVE_STATUS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3719588054245963194)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3725827853520671017)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727009706344633062)
,p_name=>'P60_PERIOD_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3730379705660387443)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727010124936633067)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761078505744562023)
,p_name=>'P60_EMPLOYEE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3719588054245963194)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761078954915562036)
,p_name=>'P60_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3719588054245963194)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761079299245562037)
,p_name=>'P60_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3719588054245963194)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3726854534032956072)
,p_name=>'Submit'
,p_event_sequence=>50
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3726854566798956073)
,p_event_id=>wwv_flow_imp.id(3726854534032956072)
,p_event_result=>'TRUE'
