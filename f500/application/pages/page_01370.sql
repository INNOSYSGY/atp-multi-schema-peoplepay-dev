...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3712707735344269024)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3712708109250269025)
,p_name=>'Report'
,p_parent_plug_id=>wwv_flow_imp.id(3712707735344269024)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3712708771543269033)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3712709193959269033)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3712711130080269039)
,p_plug_name=>'Feedback'
,p_parent_plug_id=>wwv_flow_imp.id(3712707735344269024)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3712707013399269023)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_plug_query_num_rows=>15
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764766434440565731)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3846518778035743054)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3823359963953397744)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3858837189759293528)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3831708958702550330)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3836570646850058783)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854341680910584195)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
);
