...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3762887221269989184)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3846556702860687555)
,p_region_id=>wwv_flow_imp.id(3762887221269989184)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3846557148093687560)
,p_chart_id=>wwv_flow_imp.id(3846556702860687555)
,p_seq=>10
,p_name=>'DEDUCTIONS'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3846557746177687560)
,p_chart_id=>wwv_flow_imp.id(3846556702860687555)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_decimal_places=>0
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3846558314169687560)
,p_chart_id=>wwv_flow_imp.id(3846556702860687555)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3762888512406071778)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3846554658560687551)
,p_region_id=>wwv_flow_imp.id(3762888512406071778)
,p_chart_type=>'pie'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3846555050273687555)
,p_chart_id=>wwv_flow_imp.id(3846554658560687551)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3762889518956226302)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3852766674375957221)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3762889518956226302)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852765502921957215)
,p_name=>'P1381_PERIOD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3762889518956226302)
,p_prompt=>'Period'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852765917512957217)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3852766254041957220)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3843436379085718522)
,p_name=>'refresh'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3843436240978718521)
,p_event_id=>wwv_flow_imp.id(3843436379085718522)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3762888512406071778)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3843436147823718520)
,p_event_id=>wwv_flow_imp.id(3843436379085718522)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3762887221269989184)
,p_attribute_01=>'N'
);
