...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3774036319877898317)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822127796316377282)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849788789034454270)
,p_region_id=>wwv_flow_imp.id(3822127796316377282)
,p_chart_type=>'donut'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849788347689454267)
,p_chart_id=>wwv_flow_imp.id(3849788789034454270)
,p_seq=>10
,p_name=>'Series 1'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849787764842454264)
,p_chart_id=>wwv_flow_imp.id(3849788789034454270)
,p_seq=>20
,p_name=>'Series 2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822130549016377275)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849786811731454262)
,p_region_id=>wwv_flow_imp.id(3822130549016377275)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849785108196454259)
,p_chart_id=>wwv_flow_imp.id(3849786811731454262)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849784508430454258)
,p_chart_id=>wwv_flow_imp.id(3849786811731454262)
,p_seq=>20
,p_name=>'Series 2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849786378455454261)
,p_chart_id=>wwv_flow_imp.id(3849786811731454262)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849785743548454260)
,p_chart_id=>wwv_flow_imp.id(3849786811731454262)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822133180441377274)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849783660059454257)
,p_region_id=>wwv_flow_imp.id(3822133180441377274)
,p_chart_type=>'line'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849781325633454254)
,p_chart_id=>wwv_flow_imp.id(3849783660059454257)
,p_seq=>10
,p_name=>'Series1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849780689313454253)
,p_chart_id=>wwv_flow_imp.id(3849783660059454257)
,p_seq=>20
,p_name=>'Series2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849782527145454256)
,p_chart_id=>wwv_flow_imp.id(3849783660059454257)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849783083183454256)
,p_chart_id=>wwv_flow_imp.id(3849783660059454257)
,p_axis=>'y2'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849781910625454255)
,p_chart_id=>wwv_flow_imp.id(3849783660059454257)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822135869216377273)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849779818384454252)
,p_region_id=>wwv_flow_imp.id(3822135869216377273)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849778111181454247)
,p_chart_id=>wwv_flow_imp.id(3849779818384454252)
,p_seq=>10
,p_name=>'Series1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849777560950454247)
,p_chart_id=>wwv_flow_imp.id(3849779818384454252)
,p_seq=>20
,p_name=>'Series2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849778762398454248)
,p_chart_id=>wwv_flow_imp.id(3849779818384454252)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849779304267454249)
,p_chart_id=>wwv_flow_imp.id(3849779818384454252)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3849791133492454283)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3774036319877898317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849789485256454274)
,p_name=>'P3012_MONTH_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3774036319877898317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849789941788454275)
,p_name=>'P3012_YEAR_1'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3774036319877898317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849790355636454275)
,p_name=>'P3012_MONTH'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3774036319877898317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849790776229454278)
,p_name=>'P3012_YEAR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3774036319877898317)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3849776976645454232)
,p_name=>'REFRESHH_ALL'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849776511410454229)
,p_event_id=>wwv_flow_imp.id(3849776976645454232)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822127796316377282)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849775993949454228)
,p_event_id=>wwv_flow_imp.id(3849776976645454232)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822130549016377275)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849775521136454228)
,p_event_id=>wwv_flow_imp.id(3849776976645454232)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822133180441377274)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849774995576454227)
,p_event_id=>wwv_flow_imp.id(3849776976645454232)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822135869216377273)
,p_attribute_01=>'N'
);
