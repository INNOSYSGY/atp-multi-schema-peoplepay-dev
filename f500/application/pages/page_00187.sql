...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3762354539093028473)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3762354348939028471)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3762354539093028473)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3762354430311028472)
,p_name=>'P187_EARNINGS_PERIOD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3762354539093028473)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3762353811414028466)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3762353622490028464)
,p_event_id=>wwv_flow_imp.id(3762353811414028466)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3762354348939028471)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3762353745860028465)
,p_event_id=>wwv_flow_imp.id(3762353811414028466)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3762353485598028463)
...
,p_process_when_button_id=>wwv_flow_imp.id(3762354348939028471)
