...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3713174395298103931)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3713174490984103932)
,p_plug_name=>'NOTIFICATION'
,p_parent_plug_id=>wwv_flow_imp.id(3713174395298103931)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3780396652399121704)
,p_name=>'frmNotifier'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717391028552523258)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(575128243745120200)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717391820450523260)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717392169008523260)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(575128369977120201)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717393029144523261)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717393424136523261)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717393795193523261)
,p_query_column_id=>8
