...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(631096079830709158)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4155521031176291215)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4155521218017291215)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120310295013373786)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120311088556373786)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120311438080373787)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120311864639373787)
,p_db_column_name=>'ID'
,p_display_order=>8
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120312257649373788)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120312653435373788)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120313081765373789)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120313498902373789)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120313856735373790)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120314303848373790)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120314696766373791)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120315032078373791)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120315428641373792)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120315877905373792)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120316221224373793)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120309035247373784)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120309458856373785)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120309880984373785)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120316655655373793)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120317074695373794)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120317485950373794)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120317806555373795)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120318235815373795)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120319044110373796)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1106879396218941886)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1106879410683941887)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4155529138108294064)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4158947878578475230)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(575232876976386236)
,p_report_id=>wwv_flow_imp.id(4158947878578475230)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4158949024064484474)
,p_application_user=>'APXWS_ALTERNATIVE'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(575233845239386229)
,p_report_id=>wwv_flow_imp.id(4158949024064484474)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(575234242095386228)
,p_report_id=>wwv_flow_imp.id(4158949024064484474)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'EMP_ID'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4196628754775107991)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'Summary'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(575234928574386223)
,p_report_id=>wwv_flow_imp.id(4196628754775107991)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4186337163057746285)
,p_plug_name=>'Note'
,p_parent_plug_id=>wwv_flow_imp.id(4155521031176291215)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4158970686362060564)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4158972570541060583)
,p_name=>'EMP_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080172466074391)
,p_name=>'QUANTITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080257440074392)
,p_name=>'RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080347662074393)
,p_name=>'AMOUNT_PAID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080463956074394)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080560790074395)
,p_name=>'V_PERIOD_END'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080631554074396)
,p_name=>'PAY_OPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180080793695074397)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180081099517074400)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180081141385074401)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(4158970745736060565)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(4159207057459947292)
,p_interactive_grid_id=>wwv_flow_imp.id(4158970745736060565)
,p_static_id=>'389002'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(4159207315717947292)
,p_report_id=>wwv_flow_imp.id(4159207057459947292)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4159216795833947330)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(4158972570541060583)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>277
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185102302347203590)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(4180080172466074391)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185103701425203594)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(4180080257440074392)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185105096040203597)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(4180080347662074393)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185106477687203602)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(4180080463956074394)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185107885886203606)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(4180080560790074395)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185109239530203610)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(4180080631554074396)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185110721616203614)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(4180080793695074397)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185144797940374533)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(4180081099517074400)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185146159669374536)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(4180081141385074401)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(4120307335851373762)
,p_view_id=>wwv_flow_imp.id(4159207315717947292)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(4180080347662074393)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4158973948436060597)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4159458095604268211)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4115995250186438561)
,p_name=>'LEGACYCODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4115995396523438562)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4127142938070113548)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161288648193007163)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161288733315007164)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161289251270007169)
,p_name=>'INNOCODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161289361168007170)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161289439113007171)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(4161288532017007162)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(4161294732188013360)
,p_interactive_grid_id=>wwv_flow_imp.id(4161288532017007162)
,p_static_id=>'409879'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(4161295012498013360)
,p_report_id=>wwv_flow_imp.id(4161294732188013360)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4120414614647395432)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(4115995250186438561)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4120415541411395436)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(4115995396523438562)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4136548902749298147)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(4127142938070113548)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161295432308013362)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(4161288648193007163)
,p_is_visible=>true
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161299399714013375)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(4161289251270007169)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161300272048013378)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(4161289361168007170)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161301143306013380)
,p_view_id=>wwv_flow_imp.id(4161295012498013360)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(4161289439113007171)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4552675590123308674)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4552675681315308674)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120340813870373841)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120341298708373842)
,p_db_column_name=>'EMP_ID'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120341655049373842)
,p_db_column_name=>'EMPENT_ID'
,p_display_order=>3
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120342086610373843)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120342448537373844)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120342831049373845)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120343220658373846)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120343624815373846)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120344040970373847)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120344471825373848)
,p_db_column_name=>'PAY_STATUS'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Pay Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120344896249373849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120345209500373850)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120345651529373850)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120346092376373851)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120346408239373852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120346858132373852)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120347245863373853)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120347607720373853)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120348060597373854)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120348488841373855)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120340073647373840)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120340495184373841)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120339305410373839)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120339652625373840)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4552677891162308935)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9199868677333027140)
,p_plug_name=>'Errors'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(9199868969172027143)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952974409797093849)
,p_db_column_name=>'EARNINGS_PERIOD_ID'
,p_display_order=>30
,p_column_identifier=>'C'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952974840331093850)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952975170283093851)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952975622094093852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952976018762093852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952976450680093852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952976757580093853)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952977229222093853)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952977608490093854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952977958246093854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952978368958093855)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952978759379093855)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2952979193008093856)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(9202033498398758617)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575235410653386221)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4155521031176291215)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575242942045386182)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4158970686362060564)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575267152599386056)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(9199868677333027140)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575235789306386219)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575244133207386176)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4158970686362060564)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575267622413386055)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(9199868677333027140)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575243327708386179)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575243725481386178)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575259747947386098)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(4552675590123308674)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575260189389386097)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575222455740386289)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(631096079830709158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575222834240386287)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(631096079830709158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575223235409386286)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(631096079830709158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575223706121386285)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(631096079830709158)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(575292597356385949)
...
,p_branch_when_button_id=>wwv_flow_imp.id(575223235409386286)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(575292964417385947)
...
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(575222834240386287)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1107803123053749413)
,p_name=>'P1465_WORK_UNIT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4158973948436060597)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120364349654373722)
,p_name=>'P1465_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4155521031176291215)
,p_prompt=>'Start Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120364718996373724)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120365180211373724)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120398342069373694)
,p_name=>'P1465_START_DATE_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4158970686362060564)
,p_prompt=>'Start Date'
,p_display_as=>'NATIVE_DATE_PICKER_APEX'
,p_cSize=>12
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120398790538373694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120399139294373695)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120399543229373696)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120464200252373612)
,p_name=>'P1465_EARNINGSPERIOD_PAY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4552675590123308674)
,p_prompt=>'Earnings Period'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120464685515373613)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120465493726373614)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120465940970373614)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575270484241386040)
,p_name=>'dy_process_pay_data'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575235410653386221)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575270991863386038)
,p_event_id=>wwv_flow_imp.id(575270484241386040)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575271483762386036)
,p_event_id=>wwv_flow_imp.id(575270484241386040)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(4155521031176291215)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575271948225386034)
,p_event_id=>wwv_flow_imp.id(575270484241386040)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575272330770386033)
,p_name=>'dy_refresh'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575272921886386030)
,p_event_id=>wwv_flow_imp.id(575272330770386033)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575273320053386029)
,p_name=>'dy_refresh1'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575273737721386027)
,p_event_id=>wwv_flow_imp.id(575273320053386029)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575274137267386026)
,p_name=>'delete_data'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575235789306386219)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575274650745386023)
,p_event_id=>wwv_flow_imp.id(575274137267386026)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575275210761386021)
,p_event_id=>wwv_flow_imp.id(575274137267386026)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575275644906386019)
,p_event_id=>wwv_flow_imp.id(575274137267386026)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575275943250386018)
,p_name=>'reresh3'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575276436953386015)
,p_event_id=>wwv_flow_imp.id(575275943250386018)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575276824992386014)
,p_name=>'refresh1'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575277341331386012)
,p_event_id=>wwv_flow_imp.id(575276824992386014)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4158970686362060564)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575277751500386011)
,p_name=>'refresh2'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575278255491386009)
,p_event_id=>wwv_flow_imp.id(575277751500386011)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575278691176386008)
,p_name=>'refresh3'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575279216804386007)
,p_event_id=>wwv_flow_imp.id(575278691176386008)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575279597846386005)
,p_name=>'refresh4'
,p_event_sequence=>90
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575280036769386003)
,p_event_id=>wwv_flow_imp.id(575279597846386005)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575280485085386002)
,p_name=>'RESET_PROCESS'
,p_event_sequence=>100
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575242942045386182)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575280940902386000)
,p_event_id=>wwv_flow_imp.id(575280485085386002)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575281438721385998)
,p_event_id=>wwv_flow_imp.id(575280485085386002)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575281882127385997)
,p_name=>'GEN_ENTITLE'
,p_event_sequence=>110
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575244133207386176)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575282372509385995)
,p_event_id=>wwv_flow_imp.id(575281882127385997)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575282839336385993)
,p_event_id=>wwv_flow_imp.id(575281882127385997)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575283233000385992)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575283798901385990)
,p_event_id=>wwv_flow_imp.id(575283233000385992)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575284189338385989)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575284720225385986)
,p_event_id=>wwv_flow_imp.id(575284189338385989)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575285040483385985)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575285573179385983)
,p_event_id=>wwv_flow_imp.id(575285040483385985)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575285982649385982)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575286463676385979)
,p_event_id=>wwv_flow_imp.id(575285982649385982)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4552675590123308674)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575286890885385977)
,p_name=>'refresh_sum'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575287329691385975)
,p_event_id=>wwv_flow_imp.id(575286890885385977)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575287787010385973)
,p_name=>'import_Dept_Data'
,p_event_sequence=>180
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575259747947386098)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575288240290385970)
,p_event_id=>wwv_flow_imp.id(575287787010385973)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575288799806385967)
,p_event_id=>wwv_flow_imp.id(575287787010385973)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575289251823385964)
,p_event_id=>wwv_flow_imp.id(575287787010385973)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575289723202385963)
,p_name=>'delete_import'
,p_event_sequence=>190
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575260189389386097)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575290196030385960)
,p_event_id=>wwv_flow_imp.id(575289723202385963)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575290719860385958)
,p_event_id=>wwv_flow_imp.id(575289723202385963)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575291135963385956)
,p_event_id=>wwv_flow_imp.id(575289723202385963)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575291571012385954)
,p_name=>'SET_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575292067727385952)
,p_event_id=>wwv_flow_imp.id(575291571012385954)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(575269721481386045)
...
,p_process_when_button_id=>wwv_flow_imp.id(575235789306386219)
,p_process_success_message=>'System succcessfully deleted the data.'
,p_internal_uid=>164971896789149717
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(575251395216386143)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(4159458095604268211)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(575270039832386043)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(575243327708386179)
