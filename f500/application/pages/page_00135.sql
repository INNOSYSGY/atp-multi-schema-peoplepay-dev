...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709626097478324135)
,p_plug_name=>'Tabs'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709626180368324136)
,p_plug_name=>'RDS'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709626380403324138)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709626613918324141)
,p_plug_name=>'Results Double Time'
,p_parent_plug_id=>wwv_flow_imp.id(3709626380403324138)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3709626409564324139)
,p_name=>'Absent Time'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727074339563884112)
,p_query_column_id=>1
,p_column_alias=>'NULL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709626743636324142)
,p_plug_name=>'Results Absent Time'
,p_parent_plug_id=>wwv_flow_imp.id(3709626409564324139)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3709626520735324140)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727075425696884114)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727075774652884114)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727076152006884115)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727076559276884116)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727076973114884117)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727077379407884117)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727077748400884118)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727078212066884118)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727078543661884119)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709626817309324143)
,p_plug_name=>'Results Overtime'
,p_parent_plug_id=>wwv_flow_imp.id(3709626520735324140)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709627997059324154)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727079620407884120)
,p_name=>'P135_SEARH_OPTION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3709627997059324154)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727079972666884121)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727080433897884121)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727080824386884121)
