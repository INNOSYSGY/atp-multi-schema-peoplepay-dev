...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6473083776347875941)
,p_plug_name=>'Body'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7508045090178619862)
,p_plug_name=>'<span class = "title">Enterprise HRMIS  v9.0 </span>'
,p_region_name=>'custom'
,p_parent_plug_id=>wwv_flow_imp.id(6473083776347875941)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4822379879037889556)
,p_plug_name=>'spacer'
,p_parent_plug_id=>wwv_flow_imp.id(7508045090178619862)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6475208878434737433)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643367918113540345)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(7508045090178619862)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643368378055540345)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643368737851540345)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643373296033540341)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(6475208878434737433)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643369168691540344)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052550735411472488)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7508045090178619862)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052551127072472487)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052551595054472486)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052551971950472485)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052552365115472485)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052552782418472484)
,p_name=>'P101_CODE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(7508045090178619862)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052553181739472484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052554056441472483)
,p_name=>'P101_RESET'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(7508045090178619862)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643374382153540341)
...
,p_when_button_pressed=>wwv_flow_imp.id(643369168691540344)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643374717645540340)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643373956644540341)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643375156359540340)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643378293738540338)
,p_name=>'Reset'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643373296033540341)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643378749263540338)
,p_event_id=>wwv_flow_imp.id(643378293738540338)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643379236005540337)
,p_event_id=>wwv_flow_imp.id(643378293738540338)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643379738894540337)
,p_event_id=>wwv_flow_imp.id(643378293738540338)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643380166877540337)
,p_name=>'Reset_Account'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643367918113540345)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643380648901540337)
,p_event_id=>wwv_flow_imp.id(643380166877540337)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643381137002540336)
,p_event_id=>wwv_flow_imp.id(643380166877540337)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643381679860540336)
,p_event_id=>wwv_flow_imp.id(643380166877540337)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643382183334540336)
,p_event_id=>wwv_flow_imp.id(643380166877540337)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643382598806540336)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643368378055540345)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643383060832540336)
,p_event_id=>wwv_flow_imp.id(643382598806540336)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643383568882540335)
,p_event_id=>wwv_flow_imp.id(643382598806540336)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643384045216540335)
,p_event_id=>wwv_flow_imp.id(643382598806540336)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643384493596540335)
,p_name=>'send mfa code'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643368737851540345)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643384964996540335)
,p_event_id=>wwv_flow_imp.id(643384493596540335)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643385441329540334)
,p_event_id=>wwv_flow_imp.id(643384493596540335)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643385873510540334)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643386318885540334)
,p_event_id=>wwv_flow_imp.id(643385873510540334)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643386856500540334)
,p_event_id=>wwv_flow_imp.id(643385873510540334)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643387232083540334)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643387759093540333)
,p_event_id=>wwv_flow_imp.id(643387232083540334)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(643368737851540345)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643388305510540333)
,p_event_id=>wwv_flow_imp.id(643387232083540334)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643388620672540333)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643389162975540333)
,p_event_id=>wwv_flow_imp.id(643388620672540333)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643389592278540333)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643390043655540332)
,p_event_id=>wwv_flow_imp.id(643389592278540333)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643376621233540339)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643377101583540339)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(643369168691540344)
,p_internal_uid=>115966685660245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643375417077540340)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643377873557540338)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643375830774540339)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(643368378055540345)
,p_internal_uid=>115965414851245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643376252988540339)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643377495615540339)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
