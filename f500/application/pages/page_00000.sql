...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825110253442062032)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(351861398819809827)
,p_plug_name=>'Help Widget'
,p_region_name=>'HELP_WIDGET_REGION'
,p_parent_plug_id=>wwv_flow_imp.id(3825110253442062032)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(351861690361809830)
,p_name=>'P0_CURRENT_PAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3825110253442062032)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3808286472692752847)
,p_name=>'P0_HOMEPAGE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3825110253442062032)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819659220942874460)
,p_name=>'P0_IMG_SRC'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3825110253442062032)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825110184673062031)
,p_name=>'P0_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3825110253442062032)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3827998939351361861)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3827998831112361860)
,p_event_id=>wwv_flow_imp.id(3827998939351361861)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3819659050199874459)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3819658951812874458)
,p_event_id=>wwv_flow_imp.id(3819659050199874459)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3819658866935874457)
,p_event_id=>wwv_flow_imp.id(3819659050199874459)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3819654731656874416)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3819654714960874415)
,p_event_id=>wwv_flow_imp.id(3819654731656874416)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3808286376058752846)
,p_name=>'Set HomePage'
,p_event_sequence=>40
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3808286048116752843)
,p_event_id=>wwv_flow_imp.id(3808286376058752846)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3808286267034752845)
,p_event_id=>wwv_flow_imp.id(3808286376058752846)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3702376715201056819)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3702376790284056820)
,p_event_id=>wwv_flow_imp.id(3702376715201056819)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(351861500811809828)
,p_name=>'page_help'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(351861569987809829)
,p_event_id=>wwv_flow_imp.id(351861500811809828)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
