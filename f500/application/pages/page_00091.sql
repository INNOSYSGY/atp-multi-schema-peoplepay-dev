...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3717614728018941211)
,p_name=>'Audit'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(532672791694850195)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(532672874508850196)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(532798558641103247)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719515048104584377)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719566872815133190)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3719523053651584383)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3719566872815133190)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3719524565283584385)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3717614851870941212)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3717614900160941213)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3719524237859584384)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3719523768848584384)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3719524883956584385)
,p_branch_name=>'CREATE'
,p_branch_action=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.::P91_ID:&P91_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3719524565283584385)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3717615009158941214)
,p_branch_name=>'CREATE_AGAIN'
,p_branch_action=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.:RP,91::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3717614851870941212)
,p_branch_sequence=>11
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3717615162596941216)
,p_branch_name=>'SAVE'
,p_branch_action=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.:RP:P91_ID:&P91_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3719524237859584384)
,p_branch_sequence=>21
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3717615298137941217)
,p_branch_name=>'DELETE'
,p_branch_action=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.:RP,90::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3719523768848584384)
,p_branch_sequence=>31
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3702377205953056824)
,p_name=>'P91_URL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3719515048104584377)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717616018675941224)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719515323447584377)
,p_name=>'P91_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3719515048104584377)
,p_item_source_plug_id=>wwv_flow_imp.id(3719515048104584377)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719515753545584378)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719516072333584378)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719516491931584378)
,p_name=>'P91_SEVERITY'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>50
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719516951805584379)
,p_name=>'P91_CATEGORY'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>40
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719517319004584379)
,p_name=>'P91_END_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3719515048104584377)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3719611316382084193)
,p_name=>'P91_TITLE'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3719525787700584386)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3719515048104584377)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3719525448862584385)
,p_process_sequence=>10
