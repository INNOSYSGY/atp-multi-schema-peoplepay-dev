...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3858976670468456770)
,p_plug_name=>'Test'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3858976705960456771)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3858976670468456770)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3858976871715456772)
...
,p_process_when_button_id=>wwv_flow_imp.id(3858976705960456771)
