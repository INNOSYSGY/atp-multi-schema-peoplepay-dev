...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3883866982056074907)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4763795704246581603)
,p_plug_name=>'Medical History'
,p_parent_plug_id=>wwv_flow_imp.id(3883866982056074907)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5089279883854834396)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4763800909488611422)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3811755928194833447)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(5089279883854834396)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725486562380899727)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3883866982056074907)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3811755207623833445)
,p_name=>'P10004_START_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5089279883854834396)
,p_prompt=>'Start Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3811755578166833445)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811674476782315958)
,p_name=>'Submit Page'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811674365653315957)
,p_event_id=>wwv_flow_imp.id(3811674476782315958)
,p_event_result=>'TRUE'
