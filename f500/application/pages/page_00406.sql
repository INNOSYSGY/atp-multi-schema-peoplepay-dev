...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668823681790214147)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668824692170214150)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3668823681790214147)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668825280406214151)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3668823681790214147)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668825690491214151)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668826102417214152)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3668825690491214151)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654075251519445432)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3668823681790214147)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654079122780445445)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3668824692170214150)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654076115562445433)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654075671486445432)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3668823681790214147)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654076479468445433)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3668823681790214147)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(654094931674088688)
,p_name=>'P406_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3668823681790214147)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(654095234245092687)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705185504277607464)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705185917140607465)
,p_name=>'P406_URL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3668823681790214147)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705186308106607465)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705186672123607465)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705190416754607478)
,p_name=>'P406_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3668824692170214150)
,p_prompt=>'Select format'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'P_EXPORT_TYPE'
,p_lov=>'.'||wwv_flow_imp.id(3853855158914947374)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705192185167607480)
,p_name=>'P406_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3668825690491214151)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654083364473445463)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(654075671486445432)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654083900564445463)
,p_event_id=>wwv_flow_imp.id(654083364473445463)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654084376796445463)
,p_event_id=>wwv_flow_imp.id(654083364473445463)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654081113276445459)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654081595633445461)
,p_event_id=>wwv_flow_imp.id(654081113276445459)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654082119711445462)
,p_event_id=>wwv_flow_imp.id(654081113276445459)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654082466493445462)
,p_name=>'New_preview_report_1'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3750488809706565104)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654082983814445462)
,p_event_id=>wwv_flow_imp.id(654082466493445462)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654084819848445463)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(654079122780445445)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654085753616445464)
,p_event_id=>wwv_flow_imp.id(654084819848445463)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654085346934445464)
,p_event_id=>wwv_flow_imp.id(654084819848445463)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654086243796445464)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654086653473445465)
,p_event_id=>wwv_flow_imp.id(654086243796445464)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654087232718445465)
,p_event_id=>wwv_flow_imp.id(654086243796445464)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668946273110913381)
,p_name=>'New'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668946441668913382)
,p_event_id=>wwv_flow_imp.id(668946273110913381)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
