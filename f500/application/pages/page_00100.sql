...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669400333732641335)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3669400255372641302)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717399076353529615)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717399910420529615)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717400281410529616)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717400689208529617)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717399552055529615)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717401152756529617)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717401532267529617)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717401890359529617)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717398704952529612)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717402276974529618)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3705437591714994307)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3669399129923640199)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841484585858478959)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
,p_name=>'Anniversary '
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841485005954478960)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
,p_name=>'Birthday '
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841485389307478961)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
,p_name=>'Confirmation'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841485811013478962)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
,p_name=>'Gratuity'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841486214985478963)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841486612255478964)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841487003018478964)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841487406484478965)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
,p_name=>'Retirement'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841487827234478967)
,p_report_id=>wwv_flow_imp.id(3669399129923640199)
,p_name=>'work permit'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3702189233524110728)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3702189704093110737)
,p_report_id=>wwv_flow_imp.id(3702189233524110728)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3744799347087219388)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3744799442773219389)
,p_plug_name=>'NOTIFICATION'
,p_parent_plug_id=>wwv_flow_imp.id(3744799347087219388)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3704988873086899425)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3704987981247899423)
,p_event_id=>wwv_flow_imp.id(3704988873086899425)
,p_event_result=>'TRUE'
