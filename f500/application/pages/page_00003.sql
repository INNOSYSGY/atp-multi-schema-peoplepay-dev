...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(747987848922104069)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(747988536459104069)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668736801222693978)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(747988536459104069)
,p_button_name=>'Print'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668737228008693979)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668737610550693979)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668738011235693980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(351861886996809832)
,p_name=>'P3_ADDRESS_TO_TITLE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(747987848922104069)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(744604777963278386)
,p_name=>'P3_TITLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(747987848922104069)
,p_prompt=>'Title'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747993883095104132)
,p_name=>'P3_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(747987848922104069)
,p_item_source_plug_id=>wwv_flow_imp.id(747987848922104069)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747994270485104137)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747994707420104138)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747995000878104138)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747995331714104138)
,p_name=>'P3_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(747987848922104069)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747995730987104139)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(747996188543104139)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668742556953693995)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(668737228008693979)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668743142222693996)
,p_event_id=>wwv_flow_imp.id(668742556953693995)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668743452420693997)
,p_name=>'print_general_letter'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(668736801222693978)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668744019188693997)
,p_event_id=>wwv_flow_imp.id(668743452420693997)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668741394742693994)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(747987848922104069)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668741832181693994)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668742246461693995)
,p_process_sequence=>10
