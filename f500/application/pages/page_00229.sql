...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3194066583786120774)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3604026932641922069)
,p_plug_name=>'Panel Selected'
,p_parent_plug_id=>wwv_flow_imp.id(3194066583786120774)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4063740730389222731)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3194066933675120777)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3194066583786120774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3194066697598120775)
,p_name=>'P229_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3194066583786120774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3194067124515120779)
,p_name=>'P229_POSITION_CONFIG_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3604026932641922069)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3194770409323443281)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3194770935347449765)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3194771773390449767)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3194772869972453590)
,p_name=>'P229_FACTOR'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_imp.id(4063740730389222731)
,p_prompt=>'Factor'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3194067206220120780)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3194067282283120781)
,p_event_id=>wwv_flow_imp.id(3194067206220120780)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3215356549765567878)
,p_name=>'show_btn'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3215356602272567879)
,p_event_id=>wwv_flow_imp.id(3215356549765567878)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3194066933675120777)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3215356740626567880)
,p_event_id=>wwv_flow_imp.id(3215356549765567878)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3194067374615120782)
...
,p_process_when_button_id=>wwv_flow_imp.id(3194066933675120777)
