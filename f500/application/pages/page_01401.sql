...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(623952328006435075)
,p_plug_name=>'RS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(623952466981435076)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4099797442538609766)
,p_plug_name=>'Requirements Generation (Save the data entered in grid before generating)'
,p_parent_plug_id=>wwv_flow_imp.id(623952466981435076)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825000401772951)
,p_name=>'KEY_VALUE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825088364772952)
,p_name=>'RULE_OPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825234480772953)
,p_name=>'RULE_VALUE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825266980772954)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825349312772955)
,p_name=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825486691772956)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4021825592239772957)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(4021824857448772950)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(4024140780401527964)
,p_interactive_grid_id=>wwv_flow_imp.id(4021824857448772950)
,p_static_id=>'18206'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(4024140851848527964)
,p_report_id=>wwv_flow_imp.id(4024140780401527964)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4024141359501527970)
,p_view_id=>wwv_flow_imp.id(4024140851848527964)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(4021825000401772951)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>241
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4024141943441527978)
,p_view_id=>wwv_flow_imp.id(4024140851848527964)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(4021825088364772952)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>488
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4024142373654527983)
,p_view_id=>wwv_flow_imp.id(4024140851848527964)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(4021825234480772953)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>566
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4024142869071527986)
,p_view_id=>wwv_flow_imp.id(4024140851848527964)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(4021825266980772954)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>361.0001220703125
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4024143402222527990)
,p_view_id=>wwv_flow_imp.id(4024140851848527964)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(4021825349312772955)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4024143925560527995)
,p_view_id=>wwv_flow_imp.id(4024140851848527964)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(4021825486691772956)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4113868735023596006)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4113868934735596020)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4099656530142596853)
,p_plug_name=>'Exclusions From Search Results'
,p_parent_plug_id=>wwv_flow_imp.id(4113868934735596020)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4113890458825868852)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4114247137287822036)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(696840110989752314)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4181959349136766952)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4003485940852034896)
,p_plug_name=>'Existing Records Remuneration'
,p_parent_plug_id=>wwv_flow_imp.id(4181959349136766952)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4003486049819034897)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633245208321649521)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633245580605649521)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633246020764649522)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633246417387649523)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633246803520649523)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633247194041649524)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633247615402649524)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633248001133649525)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633248401248649526)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633248820536649526)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633249168262649527)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633249526577649528)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633250021291649528)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633250363755649529)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633250775679649530)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633251167337649530)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633251615926649531)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633251972492649532)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633252410579649532)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633252792900649533)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4004017253523870078)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4181959424259766953)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4181959535129766954)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633256832644649544)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633257280104649545)
,p_db_column_name=>'ENTITLEMENT_CURRENCY'
,p_display_order=>20
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633257707315649546)
,p_db_column_name=>'EMP_ID'
,p_display_order=>30
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633258082376649547)
,p_db_column_name=>'INCOME_TYPE'
,p_display_order=>40
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633258522433649548)
,p_db_column_name=>'INCOME_CODE_ID'
,p_display_order=>50
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633258914658649548)
,p_db_column_name=>'TAXABLE'
,p_display_order=>60
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633259246154649549)
,p_db_column_name=>'NIS_DEDUCTION'
,p_display_order=>70
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633259659590649550)
,p_db_column_name=>'AMOUNT'
,p_display_order=>80
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633260078190649550)
,p_db_column_name=>'EXPENSE_CODE_ID'
,p_display_order=>90
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633260438919649551)
,p_db_column_name=>'STD_DETAIL_KEY'
,p_display_order=>100
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633260848773649551)
,p_db_column_name=>'ADMIN_STATUS'
,p_display_order=>110
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633261258210649552)
,p_db_column_name=>'PERCENTAGE'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633261664958649553)
,p_db_column_name=>'REMARKS'
,p_display_order=>130
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633262037021649554)
,p_db_column_name=>'QUICK_ENTRY'
,p_display_order=>140
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633262498010649554)
,p_db_column_name=>'START_DATE'
,p_display_order=>150
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633262842674649555)
,p_db_column_name=>'END_DATE'
,p_display_order=>160
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633263256179649556)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>170
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633263696357649556)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>180
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633264101990649557)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>190
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633264454501649558)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>200
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633264776055649559)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4182385327579316722)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4182921207567937364)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4182921428396937366)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633266276102649562)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633266665754649562)
,p_db_column_name=>'EMP_ID'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633267078971649563)
,p_db_column_name=>'START_DATE'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633267517331649563)
,p_db_column_name=>'END_DATE'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'End Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633267884743649563)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633268239781649564)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633268626546649564)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633269082051649565)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633269440414649565)
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(3853986380748144139)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633269878557649566)
...
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(3853986025340144139)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4182997846321346347)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4204009035788565328)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4204009257856565330)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633271760453649569)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633272208292649570)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633272587686649571)
,p_db_column_name=>'EMP_ID'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633272931758649571)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633273337647649572)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633273746279649572)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633274215950649573)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633274564308649573)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633274941670649574)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633275358039649574)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633275737921649575)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633276194799649575)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633276557845649576)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633276923929649577)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633277396863649577)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633277734640649578)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633278172838649578)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633278621033649579)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633278974828649579)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>26
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633279369958649580)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633279732166649580)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>30
,p_column_identifier=>'AD'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633280137191649581)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633280592128649581)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633280999919649582)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633281422115649582)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633281726506649583)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633282134627649583)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633282623152649584)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633282958961649585)
,p_db_column_name=>'REMARKS'
,p_display_order=>40
,p_column_identifier=>'AN'
,p_column_label=>'Remarks'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633283352616649586)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>41
,p_column_identifier=>'AO'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633283752620649586)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633284189343649587)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>43
,p_column_identifier=>'AQ'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633284543262649587)
,p_db_column_name=>'MACHINE_INSERT'
,p_display_order=>44
,p_column_identifier=>'AR'
,p_column_label=>'Machine Insert'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633284981141649588)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633285388121649588)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633271327404649568)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4095134320071770447)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3633286160550649590)
,p_report_id=>wwv_flow_imp.id(4095134320071770447)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4204013036210566139)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4304750238108543976)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4304749948932543974)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633287279317649593)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>170
,p_column_identifier=>'AL'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633287719350649594)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>180
,p_column_identifier=>'AM'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633288096424649594)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>190
,p_column_identifier=>'AN'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633288444471649595)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>200
,p_column_identifier=>'AO'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633288902568649595)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633289311388649596)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633289700442649596)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633290096036649597)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633290486774649598)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633290827960649600)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633291289914649601)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633291688015649601)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3633292028655649602)
,p_db_column_name=>'ID'
,p_display_order=>290
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4302383636055024462)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633270654417649566)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4182921207567937364)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633211362278649469)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4099797442538609766)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633217016179649485)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4113868735023596006)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633227586808649497)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4113890458825868852)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633239127598649509)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4114247137287822036)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633265560137649560)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4181959424259766953)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633211798048649470)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633217347520649485)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4113868735023596006)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633227995064649497)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4113890458825868852)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633239608907649510)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4114247137287822036)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3633253885391649538)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4113868934735596020)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3633340667667649650)
...
,p_branch_when_button_id=>wwv_flow_imp.id(3633217347520649485)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3633341027709649650)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3633340239594649649)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633212171363649475)
,p_name=>'P1401_ORGANISATION_RULE'
,p_is_required=>true
,p_item_sequence=>400
,p_item_plug_id=>wwv_flow_imp.id(4099797442538609766)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633212619311649477)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633213012921649477)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633213409350649477)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633213787271649478)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633214152378649478)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633214600727649479)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633214938433649479)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633215386599649480)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633217765130649486)
,p_name=>'P1401_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4113868735023596006)
,p_item_default=>':APP_ORG_ID'
,p_item_default_type=>'EXPRESSION'
,p_item_default_language=>'PLSQL'
,p_prompt=>'Organisation'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633218170781649487)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633218591837649487)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633219002750649488)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633219375491649488)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633219782963649489)
...
,p_lov=>'.'||wwv_flow_imp.id(3853958504530092919)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_grid_label_column_span=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633220204036649489)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633220525797649489)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633220945058649490)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633221412150649490)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633221804781649491)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633222215290649491)
,p_name=>'P1401_AMOUNT'
,p_is_required=>true
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(4113868735023596006)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633223062339649492)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633223460271649493)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633223870704649493)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633224281170649493)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633225145709649494)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633225622442649495)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633226483471649495)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633226897899649496)
,p_name=>'P1401_EARNINGS_PERIOD'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(4181959349136766952)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633228337012649498)
,p_name=>'P1401_ORGANISATION_DED'
,p_is_required=>true
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(4113890458825868852)
,p_item_default=>':APP_ORG_ID'
,p_item_default_type=>'EXPRESSION'
,p_item_default_language=>'PLSQL'
,p_prompt=>'Organisation'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633228753140649498)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633229144388649499)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633229569763649499)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633229940113649499)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633230370333649500)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633230821793649500)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633231187120649501)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633231537844649501)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633232007517649502)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633232354856649502)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633232748832649502)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633233215765649503)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633233590287649503)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633233980674649504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633234350001649504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633234821066649504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633235189709649505)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633235595666649505)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633235998925649506)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633236921646649507)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633237238358649507)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633237719218649508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633238041055649508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633238455570649508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633239968106649510)
,p_name=>'P1401_STAGE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4114247137287822036)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633240358908649511)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633240725129649511)
...
,p_lov=>'.'||wwv_flow_imp.id(3806440765129778819)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_grid_label_column_span=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633241221400649511)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633241527306649512)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633242466157649513)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633243388315649514)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633243822427649514)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633244168693649515)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633254225716649539)
,p_name=>'P1401_POSITION_LOCATION'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4113868934735596020)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633254635166649540)
,p_name=>'P1401_STAY'
,p_item_sequence=>380
,p_item_plug_id=>wwv_flow_imp.id(4113868934735596020)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633255025597649540)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633255434723649540)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3633256133668649542)
,p_name=>'P1401_EXCLUSION'
,p_item_sequence=>390
,p_item_plug_id=>wwv_flow_imp.id(4099656530142596853)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3633292990623649606)
...
,p_when_button_pressed=>wwv_flow_imp.id(3633217347520649485)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633294827673649609)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633295413882649610)
,p_event_id=>wwv_flow_imp.id(3633294827673649609)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3633217347520649485)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633295824421649611)
,p_event_id=>wwv_flow_imp.id(3633294827673649609)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633296300732649611)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633296803421649612)
,p_event_id=>wwv_flow_imp.id(3633296300732649611)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4113868934735596020)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633297249248649612)
,p_event_id=>wwv_flow_imp.id(3633296300732649611)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633297777058649613)
,p_event_id=>wwv_flow_imp.id(3633296300732649611)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633298233757649613)
,p_event_id=>wwv_flow_imp.id(3633296300732649611)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633298647191649613)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633299172554649614)
,p_event_id=>wwv_flow_imp.id(3633298647191649613)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633299625169649614)
,p_event_id=>wwv_flow_imp.id(3633298647191649613)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633300218802649615)
,p_event_id=>wwv_flow_imp.id(3633298647191649613)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633300683853649615)
,p_event_id=>wwv_flow_imp.id(3633298647191649613)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633301023173649616)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633301587517649616)
,p_event_id=>wwv_flow_imp.id(3633301023173649616)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633301930468649616)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633302473271649617)
,p_event_id=>wwv_flow_imp.id(3633301930468649616)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3633211798048649470)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633303014330649617)
,p_event_id=>wwv_flow_imp.id(3633301930468649616)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633303349525649617)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633303854975649618)
,p_event_id=>wwv_flow_imp.id(3633303349525649617)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633304271515649618)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633304775276649619)
,p_event_id=>wwv_flow_imp.id(3633304271515649618)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633305250842649619)
,p_event_id=>wwv_flow_imp.id(3633304271515649618)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633305798200649620)
,p_event_id=>wwv_flow_imp.id(3633304271515649618)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633306300617649620)
,p_event_id=>wwv_flow_imp.id(3633304271515649618)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633306642397649621)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633307127889649621)
,p_event_id=>wwv_flow_imp.id(3633306642397649621)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4304750238108543976)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633307702040649621)
,p_event_id=>wwv_flow_imp.id(3633306642397649621)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4181959424259766953)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633308204070649622)
,p_event_id=>wwv_flow_imp.id(3633306642397649621)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4003485940852034896)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633308525403649622)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633309025517649623)
,p_event_id=>wwv_flow_imp.id(3633308525403649622)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633309554389649623)
,p_event_id=>wwv_flow_imp.id(3633308525403649622)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633310109251649623)
,p_event_id=>wwv_flow_imp.id(3633308525403649622)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633310459765649624)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633310976416649624)
,p_event_id=>wwv_flow_imp.id(3633310459765649624)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633311430756649625)
,p_event_id=>wwv_flow_imp.id(3633310459765649624)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633311940700649625)
,p_event_id=>wwv_flow_imp.id(3633310459765649624)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633312392110649625)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633312895807649626)
,p_event_id=>wwv_flow_imp.id(3633312392110649625)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633313391862649626)
,p_event_id=>wwv_flow_imp.id(3633312392110649625)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633313885896649627)
,p_event_id=>wwv_flow_imp.id(3633312392110649625)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633314288716649627)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633314753081649628)
,p_event_id=>wwv_flow_imp.id(3633314288716649627)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633315258391649628)
,p_event_id=>wwv_flow_imp.id(3633314288716649627)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633315628908649628)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633316203844649629)
,p_event_id=>wwv_flow_imp.id(3633315628908649628)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633316705796649629)
,p_event_id=>wwv_flow_imp.id(3633315628908649628)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633317094097649629)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633317591787649630)
,p_event_id=>wwv_flow_imp.id(3633317094097649629)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633318121912649630)
,p_event_id=>wwv_flow_imp.id(3633317094097649629)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633318503804649631)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633318924352649631)
,p_event_id=>wwv_flow_imp.id(3633318503804649631)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633319441133649631)
,p_event_id=>wwv_flow_imp.id(3633318503804649631)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633319851226649632)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633320408854649632)
,p_event_id=>wwv_flow_imp.id(3633319851226649632)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633320922655649633)
,p_event_id=>wwv_flow_imp.id(3633319851226649632)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633321297369649633)
,p_name=>'refresh_NIS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633321769108649633)
,p_event_id=>wwv_flow_imp.id(3633321297369649633)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633322299115649634)
,p_event_id=>wwv_flow_imp.id(3633321297369649633)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633322704070649634)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633323209586649635)
,p_event_id=>wwv_flow_imp.id(3633322704070649634)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633323566794649635)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633324094641649636)
,p_event_id=>wwv_flow_imp.id(3633323566794649635)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633324516549649636)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633324929604649636)
,p_event_id=>wwv_flow_imp.id(3633324516549649636)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633325336559649637)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633325826507649637)
,p_event_id=>wwv_flow_imp.id(3633325336559649637)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633326250365649637)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633326749980649638)
,p_event_id=>wwv_flow_imp.id(3633326250365649637)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633327133841649638)
,p_name=>'get_earn_prd'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633327717328649638)
,p_event_id=>wwv_flow_imp.id(3633327133841649638)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633328029235649639)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633328588863649639)
,p_event_id=>wwv_flow_imp.id(3633328029235649639)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633329103314649640)
,p_event_id=>wwv_flow_imp.id(3633328029235649639)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633329597067649640)
,p_event_id=>wwv_flow_imp.id(3633328029235649639)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633330007334649640)
,p_name=>'refresh_pool'
,p_event_sequence=>250
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4304750238108543976)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633330454598649641)
,p_event_id=>wwv_flow_imp.id(3633330007334649640)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633330879841649641)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633331358192649641)
,p_event_id=>wwv_flow_imp.id(3633330879841649641)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4099656530142596853)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633331838138649642)
,p_event_id=>wwv_flow_imp.id(3633330879841649641)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633332290296649642)
,p_name=>'refresh_existing'
,p_event_sequence=>270
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4003485940852034896)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633332765417649643)
,p_event_id=>wwv_flow_imp.id(3633332290296649642)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633333149376649643)
,p_name=>'refresh_results'
,p_event_sequence=>280
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4181959424259766953)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633333705190649643)
,p_event_id=>wwv_flow_imp.id(3633333149376649643)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633334045732649644)
,p_name=>'Execute_generators'
,p_event_sequence=>290
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3633217347520649485)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633334532132649644)
,p_event_id=>wwv_flow_imp.id(3633334045732649644)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633335087261649645)
,p_event_id=>wwv_flow_imp.id(3633334045732649644)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633335573295649645)
,p_event_id=>wwv_flow_imp.id(3633334045732649644)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633336044691649645)
,p_event_id=>wwv_flow_imp.id(3633334045732649644)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633336594259649646)
,p_event_id=>wwv_flow_imp.id(3633334045732649644)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633336939319649646)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633337518664649647)
,p_event_id=>wwv_flow_imp.id(3633336939319649646)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633337911343649647)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633338358537649647)
,p_event_id=>wwv_flow_imp.id(3633337911343649647)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633338892762649648)
,p_event_id=>wwv_flow_imp.id(3633337911343649647)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3633339247477649648)
,p_name=>'setup_lookup'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3633339777164649649)
,p_event_id=>wwv_flow_imp.id(3633339247477649648)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3535011715526511872)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3535011791903511873)
,p_event_id=>wwv_flow_imp.id(3535011715526511872)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3633293659857649607)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3633211798048649470)
,p_process_success_message=>'Successful generation of Employee rules.'
,p_internal_uid=>2990099482412041340
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3633294476630649608)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3633227995064649497)
,p_process_success_message=>'System successfully generated required data.'
,p_internal_uid=>2990098752600041339
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3633216273718649483)
,p_process_sequence=>70
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(4099797442538609766)
