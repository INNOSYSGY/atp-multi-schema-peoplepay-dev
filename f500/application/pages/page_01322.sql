...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(604110724073931273)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8355324138887635438)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8355330847758648939)
,p_name=>'Audit Record Verified by: &P1340_VERIFIED_BY.'
,p_parent_plug_id=>wwv_flow_imp.id(8355324138887635438)
...
,p_query_row_template=>wwv_flow_imp.id(1972246514018927824)
,p_query_num_rows=>15
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(565836218851325993)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(565836696781325994)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(565837114942325995)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(565837468815325996)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(565837821378325997)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(565838299816325998)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565824886016325955)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(604110724073931273)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565825220438325956)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565825626008325957)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565826053533325958)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565826472167325959)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565826861458325960)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(565827299476325961)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(565844977467326014)
,p_branch_name=>'CREATE AGAIN'
,p_branch_action=>'f?p=&APP_ID.:1322:&SESSION.::&DEBUG.:1322::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(565826472167325959)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(565844542589326013)
,p_branch_name=>'delete_branch'
,p_branch_action=>'f?p=&APP_ID.:1319:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(565825220438325956)
,p_branch_sequence=>2
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(565844153986326013)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420499351633019783)
,p_name=>'P1322_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(8355324138887635438)
,p_item_source_plug_id=>wwv_flow_imp.id(8355324138887635438)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420499803540019784)
,p_name=>'P1322_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>240
,p_item_plug_id=>wwv_flow_imp.id(8355324138887635438)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420500146541019785)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420500585299019786)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420500932164019786)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420501358291019787)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420502253934019789)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420504106047019790)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420504452340019791)
,p_name=>'P1322_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>340
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2420504926338019791)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(565839970183326002)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(565840345086326003)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(565839602989326001)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(565842249545326007)
,p_name=>'CANCEL DIALOG'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8355324138887635438)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(565842759660326009)
,p_event_id=>wwv_flow_imp.id(565842249545326007)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(565843164937326010)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(565843714882326011)
,p_event_id=>wwv_flow_imp.id(565843164937326010)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(565835528847325989)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8355324138887635438)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(565841464797326006)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(565825626008325957)
,p_process_when=>'P1322_TRANSACTION_TYPE_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_internal_uid=>38431048874031443
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(565841914907326007)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(565827299476325961)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(565841055599326005)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(565825220438325956)
,p_internal_uid=>38430639676031442
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(565840656682326004)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(565824886016325955)
,p_internal_uid=>38430240759031441
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(565835176778325988)
,p_process_sequence=>10
