...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4827735578123540250)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3397196486714215236)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4827735578123540250)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3397196870387215237)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3397203116186215250)
,p_branch_name=>'stay'
,p_branch_action=>'f?p=&APP_ID.:1346:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3397196870387215237)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3397197340043215238)
,p_name=>'P1346_JOB_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4827735578123540250)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3397197700272215240)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3397198110592215241)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3397199265731215245)
,p_name=>'SHOW_GEN'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397199845137215246)
,p_event_id=>wwv_flow_imp.id(3397199265731215245)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397200353944215247)
,p_event_id=>wwv_flow_imp.id(3397199265731215245)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3397200711662215248)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397201183451215248)
,p_event_id=>wwv_flow_imp.id(3397200711662215248)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397201705828215249)
,p_event_id=>wwv_flow_imp.id(3397200711662215248)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3397202149784215249)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397202631009215250)
,p_event_id=>wwv_flow_imp.id(3397202149784215249)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3397198474253215242)
...
,p_process_when_button_id=>wwv_flow_imp.id(3397196870387215237)
,p_process_success_message=>'Generated!'
,p_internal_uid=>2754003924473606974
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3397198943733215244)
