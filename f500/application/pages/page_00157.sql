...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3700755456138657279)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3700778608517682709)
,p_plug_name=>'Audit'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3700790573631729919)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709774209535666680)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3700790573631729919)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709776260217666681)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709775862863666681)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709775440039666680)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709775027721666680)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709774594211666680)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3709767701006666674)
,p_branch_name=>'create'
,p_branch_action=>'f?p=&APP_ID.:157:&SESSION.::&DEBUG.:RP:P157_ID:&P157_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3709776260217666681)
,p_branch_sequence=>11
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3709768542534666675)
,p_branch_name=>'save'
,p_branch_action=>'f?p=&APP_ID.:157:&SESSION.::&DEBUG.:RP:P157_ID:&P157_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3709775027721666680)
,p_branch_sequence=>21
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3709768112140666675)
,p_branch_name=>'create_again'
,p_branch_action=>'f?p=&APP_ID.:157:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3709775862863666681)
,p_branch_sequence=>31
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3709767291432666674)
,p_branch_name=>'delete'
,p_branch_action=>'f?p=&APP_ID.:156:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3709774594211666680)
,p_branch_sequence=>41
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709776898717666681)
,p_name=>'P157_LAST_CHANGED_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3700778608517682709)
,p_item_source_plug_id=>wwv_flow_imp.id(3700755456138657279)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709777370383666681)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709777679034666682)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709778113428666682)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709779588502666683)
,p_name=>'P157_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3700755456138657279)
,p_item_source_plug_id=>wwv_flow_imp.id(3700755456138657279)
,p_source=>'ORG_ID'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709780477441666684)
,p_name=>'P157_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3700755456138657279)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709781446142666684)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709782366613666685)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709783229472666685)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709784155769666686)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709785000133666686)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709785899635666687)
,p_name=>'P157_SUBJECT'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709786828782666688)
,p_name=>'P157_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709787233177666689)
,p_name=>'P157_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3709768914555666675)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_imp.id(3709782366613666685)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3709778830569666682)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3700755456138657279)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3709779219911666683)
,p_process_sequence=>10
