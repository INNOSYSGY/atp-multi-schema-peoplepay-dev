...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785009936635647039)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3835327338298808221)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3728584557387721438)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3835327338298808221)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3728584733386721440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728549987086574184)
,p_name=>'P47_EMPLOYEE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3835327338298808221)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728550341799574191)
,p_name=>'P47_PROCESS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3835327338298808221)
,p_prompt=>'Process'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728550686231574191)
,p_name=>'P47_START'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3835327338298808221)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728551074003574192)
,p_name=>'P47_END'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3835327338298808221)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728584855538721441)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3728558577851574251)
,p_name=>'New'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3728559124040574251)
,p_event_id=>wwv_flow_imp.id(3728558577851574251)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3728555888396574246)
,p_name=>'Submit'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3728556454031574248)
,p_event_id=>wwv_flow_imp.id(3728555888396574246)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
