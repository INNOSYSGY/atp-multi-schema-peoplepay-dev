...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709174839430897498)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3755495559522575872)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3755495729709575873)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709174643529897496)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3709174839430897498)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3755494824119575864)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3755495559522575872)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709174548686897495)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3755494639645575863)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3755495559522575872)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(559680456677323113)
,p_name=>'P79_ORGDTL_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3755495729709575873)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(591246297579104970)
,p_name=>'P79_LABEL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3755495729709575873)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(634572877690016171)
,p_name=>'P79_DEF_QUANTITY'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3709174839430897498)
,p_item_default=>'1'
,p_prompt=>'Quantity'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3369343450052731310)
,p_name=>'P79_QUANTITY'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3755495559522575872)
,p_item_default=>'1'
,p_prompt=>'Quantity'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>15
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3369343756503734011)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3708745870517918188)
,p_name=>'P79_RETURN'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3709174839430897498)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709174083691897491)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709174200929897492)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709174306163897493)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709174729860897497)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755194051306560814)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755194374158562857)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755495461791575871)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766409555858266776)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766409692059266777)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766409766496266778)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766410003557266780)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3709043735308615114)
,p_name=>'dy_all_eployeee'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3709174548686897495)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3709043330120615109)
,p_event_id=>wwv_flow_imp.id(3709043735308615114)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3709042874033615108)
,p_event_id=>wwv_flow_imp.id(3709043735308615114)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3766410424338266784)
,p_name=>'dy_all_eployeee_sel'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3755494639645575863)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766410251903266783)
,p_event_id=>wwv_flow_imp.id(3766410424338266784)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766410200967266782)
,p_event_id=>wwv_flow_imp.id(3766410424338266784)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3755495435775575870)
,p_name=>'SHOW_hide'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755495151799575868)
,p_event_id=>wwv_flow_imp.id(3755495435775575870)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3709174839430897498)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755495265211575869)
,p_event_id=>wwv_flow_imp.id(3755495435775575870)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3755495060401575867)
,p_name=>'SHOW_hide_1'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P79_POST_CATEGORY'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755494923141575865)
,p_event_id=>wwv_flow_imp.id(3755495060401575867)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3755495559522575872)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755494960151575866)
,p_event_id=>wwv_flow_imp.id(3755495060401575867)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3472582975960548371)
,p_name=>'set_clear'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3472583081929548372)
,p_event_id=>wwv_flow_imp.id(3472582975960548371)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(591246370408104971)
