...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10189147117546495056)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10189148122710495066)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(670890857830751639)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10189148122710495066)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(670890212824751638)
,p_name=>'P99993_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10189147117546495056)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(696691259732306632)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696691700758306632)
,p_event_id=>wwv_flow_imp.id(696691259732306632)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696692189436306633)
,p_event_id=>wwv_flow_imp.id(696691259732306632)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(670891253007751639)
...
,p_process_when_button_id=>wwv_flow_imp.id(670890857830751639)
