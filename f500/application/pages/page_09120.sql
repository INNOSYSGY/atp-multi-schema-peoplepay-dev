...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3119355573917896496)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3119356017055896496)
,p_name=>'P9120_BANK'
,p_item_sequence=>60
,p_item_display_point=>'LEGACY_ORPHAN_COMPONENTS'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3119356405014896497)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(537598944107602954)
