...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3849722100510188770)
,p_plug_name=>'Items'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3849722637236188775)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3849722100510188770)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3849722264463188771)
,p_name=>'Toggle State'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849722300744188772)
,p_event_id=>wwv_flow_imp.id(3849722264463188771)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3849722709911188776)
,p_name=>'Checkout'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3849722637236188775)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849722872620188777)
,p_event_id=>wwv_flow_imp.id(3849722709911188776)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
