...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(682584524183389101)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3773111667909732022)
,p_plug_name=>'Filter Bar'
,p_parent_plug_id=>wwv_flow_imp.id(682584524183389101)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3772652164066157332)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3783902394061154231)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(696718901075377098)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3773111667909732022)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3779352599391439850)
,p_name=>'P10005_ORG_STRUCTURE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3773111667909732022)
,p_prompt=>'Department'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3780532606999399861)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3814603700786330869)
,p_name=>'P10005_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3773111667909732022)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3814604045116330870)
,p_name=>'P10005_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3773111667909732022)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682584601654389102)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682584696947389103)
,p_event_id=>wwv_flow_imp.id(682584601654389102)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(3783902394061154231)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682584814589389104)
,p_event_id=>wwv_flow_imp.id(682584601654389102)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3772652164066157332)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682584926331389105)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682585035092389106)
,p_event_id=>wwv_flow_imp.id(682584926331389105)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682585112347389107)
,p_event_id=>wwv_flow_imp.id(682584926331389105)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
