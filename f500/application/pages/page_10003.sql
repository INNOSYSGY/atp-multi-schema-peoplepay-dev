...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4449161168315357447)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452508642221595598)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446341119804404738)
,p_region_id=>wwv_flow_imp.id(4452508642221595598)
,p_chart_type=>'dial'
,p_width=>'240'
,p_height=>'360'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446341577506404741)
,p_chart_id=>wwv_flow_imp.id(3446341119804404738)
,p_seq=>10
,p_name=>'Number Hired'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452509341523595605)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446342533702404744)
,p_region_id=>wwv_flow_imp.id(4452509341523595605)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446344783950404747)
,p_chart_id=>wwv_flow_imp.id(3446342533702404744)
,p_seq=>20
,p_name=>'Female'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446344191843404746)
,p_chart_id=>wwv_flow_imp.id(3446342533702404744)
,p_seq=>30
,p_name=>'Male'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3446343054010404744)
,p_chart_id=>wwv_flow_imp.id(3446342533702404744)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Age'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3446343638313404746)
,p_chart_id=>wwv_flow_imp.id(3446342533702404744)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452509636134595608)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446346257680404753)
,p_region_id=>wwv_flow_imp.id(4452509636134595608)
,p_chart_type=>'donut'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446346725822404754)
,p_chart_id=>wwv_flow_imp.id(3446346257680404753)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452511816376595630)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4670761106621226331)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3446340009902404735)
,p_name=>'P10003_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4449161168315357447)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3446340403041404736)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446347724725404756)
,p_name=>'refr_st'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446348182746404757)
,p_event_id=>wwv_flow_imp.id(3446347724725404756)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4670761106621226331)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446348611151404757)
,p_name=>'refresh_end'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446349088990404758)
,p_event_id=>wwv_flow_imp.id(3446348611151404757)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446349478910404758)
,p_name=>'refr_hr'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446350025689404758)
,p_event_id=>wwv_flow_imp.id(3446349478910404758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452508642221595598)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446350388459404759)
,p_name=>'refr_end'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_END_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446350904693404759)
,p_event_id=>wwv_flow_imp.id(3446350388459404759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446351351890404759)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446351775247404760)
,p_event_id=>wwv_flow_imp.id(3446351351890404759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452509341523595605)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446352255266404760)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446352752609404761)
,p_event_id=>wwv_flow_imp.id(3446352255266404760)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452509636134595608)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446353089716404761)
,p_name=>'refr_age_sex'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446353623463404761)
,p_event_id=>wwv_flow_imp.id(3446353089716404761)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446354043312404762)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446354541331404762)
,p_event_id=>wwv_flow_imp.id(3446354043312404762)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3446347346915404755)
