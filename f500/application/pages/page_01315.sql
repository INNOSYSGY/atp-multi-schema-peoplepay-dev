...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3712260639404992493)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3712258047859992486)
,p_name=>'Audit'
,p_parent_plug_id=>wwv_flow_imp.id(3712260639404992493)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(426763432293193407)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(426763829766193408)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(426764172309193409)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3734906521893404332)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3801376410191026421)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426764999251193411)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3734906521893404332)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426766370143193415)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3801376410191026421)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426766815056193416)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426767243432193417)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426767628114193418)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426768028796193418)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(426768395277193419)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(426773125611193431)
,p_branch_name=>'CREATE_AGAIN'
,p_branch_action=>'f?p=&APP_ID.:1315:&SESSION.::&DEBUG.:1315::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(426768028796193418)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(426773524987193432)
,p_branch_name=>'delete_branch'
,p_branch_action=>'f?p=&APP_ID.:1311:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(426766815056193416)
,p_branch_sequence=>2
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(426773893981193432)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3734914236141404355)
,p_name=>'P1315_START_PAID_FOR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3734906521893404332)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3734914362700404356)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800274962209808356)
,p_name=>'P1315_END_YEAR'
,p_source_data_type=>'DATE'
,p_is_required=>true
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(3712260639404992493)
,p_item_source_plug_id=>wwv_flow_imp.id(3712260639404992493)
,p_prompt=>'End Year'
,p_source=>'END_YEAR'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800275294790808356)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800275754677808357)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800276152429808359)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800276550493808364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800276958774808364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800277374879808366)
,p_name=>'P1315_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(3712260639404992493)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3800277701846808382)
,p_name=>'P1315_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(426770545372193425)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(426770073696193424)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(426769748601193423)
...
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_always_execute=>'Y'
,p_when_button_pressed=>wwv_flow_imp.id(426767628114193418)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(426771640693193427)
,p_name=>'generate_annual_periods'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(426764999251193411)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(426772151332193428)
,p_event_id=>wwv_flow_imp.id(426771640693193427)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(426772628094193430)
,p_event_id=>wwv_flow_imp.id(426771640693193427)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(426762672186193405)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3712260639404992493)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(426770827247193425)
...
,p_attribute_04=>'18'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(426766815056193416)
,p_internal_uid=>205368270665581731
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(426771215354193426)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(426766370143193415)
,p_internal_uid=>205368658772581732
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(426762312442193404)
,p_process_sequence=>10
