...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785556640655249043)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3785556448954249038)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875544828477591642)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875544448089591641)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875543999909591637)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875543676662591636)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875543291069591636)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875542849322591635)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875542395706591635)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875542057935591634)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875541593398591634)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875541262304591632)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875540831603591632)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875540454475591632)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875540050351591632)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875539606234591630)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875539200193591630)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875538881023591629)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3785554449195245921)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3853057740862809225)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3853057392469809222)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853057370345809221)
,p_db_column_name=>'FORWORD_LIST_ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Forword List Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853057258417809220)
,p_db_column_name=>'USER_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Sender'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853057149554809219)
,p_db_column_name=>'FORWARD_TO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Forward To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853057037729809218)
,p_db_column_name=>'FORWARD_MODE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Forward Mode'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056960550809217)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Created By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056812980809216)
,p_db_column_name=>'EFFECTIVE_FROM'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Effective From'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056721581809215)
,p_db_column_name=>'EFFECTIVE_TO'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Effective To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056674699809214)
,p_db_column_name=>'CREATION_DATE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Creation Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056499850809213)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Last Updated By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056424009809212)
,p_db_column_name=>'LAST_UPDATE_DATE'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'Last Update Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853056330634809211)
,p_db_column_name=>'IS_DEFAULT'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'Is Default'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851496941457582360)
,p_db_column_name=>'STAGE_NAME'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'Work Flow Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851496799882582359)
,p_db_column_name=>'REMARKS'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'Remarks'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851496729192582358)
,p_db_column_name=>'AUTO_CLOSE_ON_COMPLETE'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'Auto Close'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851496604296582357)
,p_db_column_name=>'STAGE_ID'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'Stage Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851496559246582356)
,p_db_column_name=>'WFL_STATUS_ID'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'Transaction Status'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3851486153014576671)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686290069075946901)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3785556640655249043)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686296381795946918)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3853057740862809225)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686290487967946902)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686296777287946918)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3853057740862809225)
