...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697374595097318471)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785112643305747846)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785113091512751803)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3832948708458007612)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3785112643305747846)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3832950126472007617)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3785113091512751803)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3708745711854918187)
,p_name=>'P1025_REPORT_TO_DEST'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3785112643305747846)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832947852223007610)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832948315219007612)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832949338078007613)
,p_name=>'P1025_CURRENT_MANAGER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3785113091512751803)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3832949816514007615)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3832947083016007608)
,p_name=>'set_visible'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3832946528263007604)
,p_event_id=>wwv_flow_imp.id(3832947083016007608)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3832948708458007612)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3832946105920007603)
,p_event_id=>wwv_flow_imp.id(3832947083016007608)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3832947442165007609)
...
,p_process_when_button_id=>wwv_flow_imp.id(3832948708458007612)
