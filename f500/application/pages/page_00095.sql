...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2386529227297085656)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2382223909766544641)
,p_plug_name=>'PositionChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(2386529227297085656)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662742409546327005)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2386529227297085656)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662742754361327006)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662743182193327006)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662743618171327010)
,p_name=>'P95_POSITION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2386529227297085656)
,p_prompt=>'Position'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662744024557327011)
,p_name=>'P95_FILTER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2386529227297085656)
,p_item_default=>'2'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662744662594327017)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662745241703327019)
,p_event_id=>wwv_flow_imp.id(662744662594327017)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2382223909766544641)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662745735245327019)
,p_event_id=>wwv_flow_imp.id(662744662594327017)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662746069205327019)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(662743182193327006)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662746587083327020)
,p_event_id=>wwv_flow_imp.id(662746069205327019)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
