...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3834994807010888088)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3834994700176888088)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853873005457078189)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853873173414078190)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853873279073078191)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853873313729078192)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853873473889078193)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3834990898338874692)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3853873494393078194)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3853892255467243898)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3853873494393078194)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3853864866798066441)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3853871909585066484)
,p_button_sequence=>10
,p_button_name=>'Return'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--primary:t-Button--iconRight'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3853865208007066442)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3853872376574066484)
,p_button_sequence=>20
,p_button_name=>'Search'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3853890559396177089)
,p_name=>'P8031_ORG_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3834994807010888088)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3853873658326078195)
,p_name=>'Refresh'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3853873715497078196)
,p_event_id=>wwv_flow_imp.id(3853873658326078195)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3834994807010888088)
,p_attribute_01=>'N'
);
