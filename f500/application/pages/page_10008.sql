...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3889000735066257340)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3889000840980257341)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3806353198116486290)
,p_region_id=>wwv_flow_imp.id(3889000840980257341)
,p_chart_type=>'bubble'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3806351576980486286)
,p_chart_id=>wwv_flow_imp.id(3806353198116486290)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3806352814129486287)
,p_chart_id=>wwv_flow_imp.id(3806353198116486290)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3806352184012486287)
,p_chart_id=>wwv_flow_imp.id(3806353198116486290)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5647219027990126644)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3806349385666486271)
,p_name=>'P10008_FILTER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5647219027990126644)
,p_item_default=>'5000'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3807536778750647221)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3806347650771486259)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3807536705309647220)
,p_event_id=>wwv_flow_imp.id(3806347650771486259)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3889000840980257341)
,p_attribute_01=>'N'
);
