...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788904938538413465)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1583371043026065164)
,p_plug_name=>'OrganisationChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(788904938538413465)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662757846189395186)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(788904938538413465)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662758154676395186)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662758957574395187)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662759394242395189)
,p_name=>'P1456_ORG_STRUCTURE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(788904938538413465)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662759815975395189)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662760206356395190)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662760863581395191)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662761407677395191)
,p_event_id=>wwv_flow_imp.id(662760863581395191)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1583371043026065164)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662761891387395192)
,p_event_id=>wwv_flow_imp.id(662760863581395191)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662762281841395192)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(662758957574395187)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662762766876395193)
,p_event_id=>wwv_flow_imp.id(662762281841395192)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
