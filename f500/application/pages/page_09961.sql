...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8462624598191980033)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8462625603355980043)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(670884883219740437)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8462625603355980043)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(670884206495740437)
,p_name=>'P9961_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8462624598191980033)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(697029018515057650)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(697029435257057650)
,p_event_id=>wwv_flow_imp.id(697029018515057650)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(697029882673057651)
,p_event_id=>wwv_flow_imp.id(697029018515057650)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(670885280659740438)
...
,p_process_when_button_id=>wwv_flow_imp.id(670884883219740437)
