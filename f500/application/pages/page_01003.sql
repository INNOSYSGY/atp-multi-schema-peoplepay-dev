...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697375204665318477)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3794448343433352083)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794438981908334054)
,p_name=>'SURNAME'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794443561032352077)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794445344484352077)
,p_name=>'FIRST_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794446010566352077)
,p_name=>'AMOUNT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794446575499352078)
,p_name=>'MOBILE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3803246386041798813)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3794447886940352082)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3794447449602352080)
,p_interactive_grid_id=>wwv_flow_imp.id(3794447886940352082)
,p_static_id=>'17878'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3794447346516352080)
,p_report_id=>wwv_flow_imp.id(3794447449602352080)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794387294200229586)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3794438981908334054)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794440997273346663)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3803246386041798813)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>130
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794443211799352076)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3794443561032352077)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>350
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794444946853352077)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3794445344484352077)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794445569445352077)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3794446010566352077)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>100
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794446188467352077)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3794446575499352078)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>124
);
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(3843934938643522869)
,p_view_id=>wwv_flow_imp.id(3794447346516352080)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(3794446010566352077)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3794439068979334055)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3794448343433352083)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3794439558256334060)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3794439448857334059)
,p_name=>'P1003_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3794448343433352083)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3794439644984334061)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3794439337262334058)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3794439314924334057)
,p_event_id=>wwv_flow_imp.id(3794439337262334058)
,p_event_result=>'TRUE'
