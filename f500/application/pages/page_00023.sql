...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(696840214981752315)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764441480170514404)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854350335269617652)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764793864515674519)
,p_plug_name=>'Query'
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854355768625617657)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3765113960559852453)
,p_plug_name=>'Tools'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--accent13:t-Region--noBorder:t-Region--hiddenOverflow:t-Form--noPadding'
,p_component_template_options=>'#DEFAULT#:u-colors:t-Cards--basic:t-Cards--5cols:t-Cards--animColorFill'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854363194158617675)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5486881846669182328)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854365400658617697)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5486881846669182328)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854364976720617692)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3854363456102617677)
