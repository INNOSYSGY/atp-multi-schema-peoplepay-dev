...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759693866751042905)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764869665654715380)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697710373716382044)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3759693866751042905)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697710055943382043)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697709650357382043)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3697711142269382048)
,p_name=>'P105_NEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3764869665654715380)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3697708288663382035)
,p_name=>'EXPAND_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3697710055943382043)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3697707775101382035)
,p_event_id=>wwv_flow_imp.id(3697708288663382035)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_TREE_EXPAND'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3759693866751042905)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3697709235696382036)
,p_name=>'CONTRACT_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3697710373716382044)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3697708744095382035)
,p_event_id=>wwv_flow_imp.id(3697709235696382036)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
