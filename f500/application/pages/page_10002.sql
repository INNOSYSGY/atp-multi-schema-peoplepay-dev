...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4952254902359718703)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811827606788990355)
,p_region_id=>wwv_flow_imp.id(4952254902359718703)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811827058734990355)
,p_chart_id=>wwv_flow_imp.id(3811827606788990355)
,p_seq=>10
,p_name=>'Position'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3818993504100079135)
,p_chart_id=>wwv_flow_imp.id(3811827606788990355)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3818993534306079136)
,p_chart_id=>wwv_flow_imp.id(3811827606788990355)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5248528461030328539)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811828946458990356)
,p_region_id=>wwv_flow_imp.id(5248528461030328539)
,p_chart_type=>'funnel'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811828499544990356)
,p_chart_id=>wwv_flow_imp.id(3811828946458990356)
,p_seq=>10
,p_name=>'Tasks'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811821187146990353)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811823917133990354)
,p_name=>'Increase'
,p_event_sequence=>40
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811823347230990353)
,p_event_id=>wwv_flow_imp.id(3811823917133990354)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4952254902359718703)
,p_attribute_01=>'$("#pie1_jet").ojChart({legend:{size:''50%''}});'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811822978230990353)
,p_name=>'Decrease'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811822434734990353)
,p_event_id=>wwv_flow_imp.id(3811822978230990353)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
