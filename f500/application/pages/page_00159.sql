...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3700820090016701671)
,p_plug_name=>'Audit'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3700853212567030051)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3700888137975170126)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709741587037647733)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3700888137975170126)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709741206318647733)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709740807463647732)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709740465633647732)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3709732782513647727)
,p_branch_name=>'save'
,p_branch_action=>'f?p=&APP_ID.:159:&SESSION.::&DEBUG.:RP:P159_ID:&P159_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3709740807463647732)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3709732404236647727)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709738551316647731)
,p_name=>'P159_LAST_CHANGED_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3700820090016701671)
,p_item_source_plug_id=>wwv_flow_imp.id(3700853212567030051)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709738884489647731)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709739355818647731)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709739738069647732)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709743110582647734)
,p_name=>'P159_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3700853212567030051)
,p_item_source_plug_id=>wwv_flow_imp.id(3700853212567030051)
,p_source=>'ORG_ID'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709743552291647734)
,p_name=>'P159_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3700853212567030051)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709743953276647734)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709744311217647735)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709744769190647735)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709745097004647735)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709745526285647735)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709745879759647736)
,p_name=>'P159_SUBJECT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3700853212567030051)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709746294341647736)
,p_name=>'P159_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3700853212567030051)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709746737625647736)
,p_name=>'P159_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3709733202785647727)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_imp.id(3709744311217647735)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3709742358168647733)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3700853212567030051)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3709742713806647734)
,p_process_sequence=>10
