...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759008650800168138)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764184449703840613)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725287008560500479)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3764184449703840613)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725287372349500481)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725287865378500481)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3711659215407940891)
,p_name=>'P1457_ORG_STRUCTURE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3759008650800168138)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3725288246891500512)
,p_name=>'CONTRACT_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3725287008560500479)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3725288755323500519)
,p_event_id=>wwv_flow_imp.id(3725288246891500512)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_TREE_COLLAPSE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3764184449703840613)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3725289135837500521)
,p_name=>'EXPAND_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3725287372349500481)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3725289626948500521)
,p_event_id=>wwv_flow_imp.id(3725289135837500521)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3708642850053166828)
,p_name=>'New'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3708642731367166827)
,p_event_id=>wwv_flow_imp.id(3708642850053166828)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
