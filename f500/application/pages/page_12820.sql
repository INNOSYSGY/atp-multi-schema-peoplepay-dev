...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(686484540234467775)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6382185650782253617)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3354063246822523844)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(686484540234467775)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3354065354024523852)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3354065792563523852)
,p_event_id=>wwv_flow_imp.id(3354065354024523852)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6382185650782253617)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3354064456054523848)
,p_name=>'refresh_end'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3354064890131523851)
,p_event_id=>wwv_flow_imp.id(3354064456054523848)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
