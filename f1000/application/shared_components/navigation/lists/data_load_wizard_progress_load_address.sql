...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3804705228668771280)
,p_name=>'Data Load Wizard Progress - load_address'
,p_list_status=>'PUBLIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3804704822892771280)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3804704456443771279)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3804704064042771279)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3804703639579771279)
