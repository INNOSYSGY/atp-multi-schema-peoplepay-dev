...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(3796672863374830298)
,p_name=>'offences'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796672254110810848)
,p_parent_id=>wwv_flow_imp.id(3796672462724822026)
,p_short_name=>'Employee Offences'
,p_link=>'f?p=&APP_ID.:1424:&SESSION.::&DEBUG.:::'
,p_page_id=>1424
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796672462724822026)
,p_parent_id=>wwv_flow_imp.id(3796672658411824088)
,p_short_name=>'Create/Edit Offences'
,p_link=>'f?p=&APP_ID.:1423:&SESSION.::&DEBUG.:::'
,p_page_id=>1423
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3796672658411824088)
