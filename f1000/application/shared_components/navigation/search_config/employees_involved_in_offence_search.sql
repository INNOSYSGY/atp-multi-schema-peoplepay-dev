prompt --application/shared_components/navigation/search_config/employees_involved_in_offence_search
begin
--   Manifest
--     SEARCH CONFIG: Employees_Involved_In_Offence_Search
--   Manifest End
...
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(534078789649328195)
,p_label=>'Employees_Involved_In_Offence_Search'
,p_static_id=>'employees_involved_in_offence_search'
...
'    ''Employees involved in offence'' Subtitle,',
'    listagg(''Offence: ''||off.DESCRIPTION || '', Offence Date: ''|| off.START_DATE || '', Incident Leading Up: '' || pkg_global_fnts.no_html(discipline.INCIDENT_LEADING_UP) || '', Date Disciplined: ''|| disemp.DATE_DISCIPLINED, '';'')',
'    within group(',
...
' join HR_GRI_DISCIPLINE discipline ON disemp.discipline_id = discipline.ID',
