...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854134465020093609)
,p_lov_name=>'P_PRODUCTIVITY_ACTION'
,p_lov_query=>'.'||wwv_flow_imp.id(3854134465020093609)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3709736898083310912)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'ALL'
,p_lov_return_value=>'ALL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854134040789093609)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Data Entry'
,p_lov_return_value=>'ENTRY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854133610748093608)
