prompt --application/shared_components/user_interface/lovs/inventory_item
begin
--   Manifest
--     INVENTORY_ITEM
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854224631916239134)
,p_lov_name=>'INVENTORY_ITEM'
...
'left outer join tbllotmanager d on  (d.id=c.lot_control_id and d.INVENTORY_ITEM_ID=c.inventory_item_id)',
...
'and a.organization_id =:P600_ORGANIZATION_ID',
