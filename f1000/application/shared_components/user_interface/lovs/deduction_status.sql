...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854308803701354602)
,p_lov_name=>'DEDUCTION_STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(3854308803701354602)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854308394973354601)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'IN PROCESS'
,p_lov_return_value=>'IP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854308006048354601)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'SUSPENDED'
,p_lov_return_value=>'SP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854307685472354600)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'CLOSED'
,p_lov_return_value=>'CL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854307196100354600)
