prompt --application/shared_components/user_interface/lovs/employment_class_full
begin
--   Manifest
--     EMPLOYMENT_CLASS_FULL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3844507227834308296)
,p_lov_name=>'EMPLOYMENT_CLASS_FULL'
...
,p_return_column_name=>'EMPLOYMENT_CLASS_ID'
