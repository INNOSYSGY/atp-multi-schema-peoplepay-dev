...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(579521024764397226)
,p_lov_name=>'ACH_FILETYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(579521024764397226)||'.'
,p_location=>'STATIC'
,p_version_scn=>44427420080246
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(579521290037397240)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'.ACH'
,p_lov_return_value=>'.ACH'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(579521739920397244)
