...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3802837986036313893)
,p_lov_name=>'QUALIFICATION_CLASS'
,p_lov_query=>'.'||wwv_flow_imp.id(3802837986036313893)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3802838353421313893)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Training'
,p_lov_return_value=>'TRAINING'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3802838721965313894)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Licence'
,p_lov_return_value=>'LICENCE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3802839133054313894)
