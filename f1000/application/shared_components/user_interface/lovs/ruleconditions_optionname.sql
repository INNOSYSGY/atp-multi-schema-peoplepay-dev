...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(678671524694927501)
,p_lov_name=>'RULECONDITIONS.OPTIONNAME'
,p_lov_query=>'.'||wwv_flow_imp.id(678671524694927501)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(678671912659927503)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Employment Class'
,p_lov_return_value=>'EMPLOYMENT_CLASS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(678672231460927505)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Compute Gross'
,p_lov_return_value=>'COMPUTE_GROSS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(678672704327927505)
