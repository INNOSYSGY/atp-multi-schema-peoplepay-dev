prompt --application/shared_components/user_interface/lovs/rpt_parameter_target
begin
--   Manifest
--     RPT_PARAMETER_TARGET
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3317776589850327539)
,p_lov_name=>'RPT_PARAMETER_TARGET'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if :P312_SEARCH_OPTION=''EMPLOYEE'' then',
'',
'return',
...
'order by 1'';',
'',
'ELSif :P312_SEARCH_OPTION=''GRADE_SCALE'' then',
'return',
...
'        order by grade_code'';',
'',
'elsif  :P312_SEARCH_OPTION=''ORG_STRUCT_LEVEL'' then',
'',
'return',
...
'order by 1'';',
'',
'elsif  :P312_SEARCH_OPTION=''POSITION'' then',
'',
'return',
...
'order by 1'';',
'',
'elsif  :P312_SEARCH_OPTION=''WORK_LOCATION'' then',
'',
'return',
...
'order by 1'';',
'',
'elsif  :P312_SEARCH_OPTION=''INCOME'' then',
'',
'return',
...
'',
'elsif  :P312_SEARCH_OPTION=''UNION'' then',
'return',
...
'    order by  1'';    ',
'',
'elsif  :P312_SEARCH_OPTION=''EMPLOYMENT_TYPE'' then',
'return',
...
'        where org_id = :APP_ORG_ID'';',
'        ',
'elsif  :P312_SEARCH_OPTION=''SEX'' then',
'return',
