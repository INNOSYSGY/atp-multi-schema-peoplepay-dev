...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3768327039846775894)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768326756196775892)
,p_plugin_id=>wwv_flow_imp.id(3768327039846775894)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768326390820775892)
,p_plugin_id=>wwv_flow_imp.id(3768327039846775894)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768325922688775892)
,p_plugin_id=>wwv_flow_imp.id(3768327039846775894)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768325617232775892)
,p_plugin_id=>wwv_flow_imp.id(3768327039846775894)
,p_attribute_scope=>'COMPONENT'
