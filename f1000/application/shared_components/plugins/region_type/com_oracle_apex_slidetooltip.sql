...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4810864426737344332)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885713072500356836)
,p_plugin_id=>wwv_flow_imp.id(4810864426737344332)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885713491281356837)
,p_plugin_id=>wwv_flow_imp.id(4810864426737344332)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885713847351356837)
,p_plugin_id=>wwv_flow_imp.id(4810864426737344332)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885714284125356837)
,p_plugin_id=>wwv_flow_imp.id(4810864426737344332)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885715199123356838)
,p_plugin_attribute_id=>wwv_flow_imp.id(5885714284125356837)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885714683535356837)
,p_plugin_attribute_id=>wwv_flow_imp.id(5885714284125356837)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885715621673356838)
,p_plugin_id=>wwv_flow_imp.id(4810864426737344332)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4269295366264571002)
,p_plugin_id=>wwv_flow_imp.id(4810864426737344332)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
