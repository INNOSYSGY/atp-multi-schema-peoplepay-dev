...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(663030734069473273)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(663031031683473277)
,p_plugin_id=>wwv_flow_imp.id(663030734069473273)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(663031429272473278)
,p_plugin_id=>wwv_flow_imp.id(663030734069473273)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(663031850951473279)
,p_plugin_id=>wwv_flow_imp.id(663030734069473273)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(663032223547473279)
,p_plugin_id=>wwv_flow_imp.id(663030734069473273)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(663032651301473279)
,p_plugin_attribute_id=>wwv_flow_imp.id(663032223547473279)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(663033135017473280)
,p_plugin_attribute_id=>wwv_flow_imp.id(663032223547473279)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(663033646316473280)
,p_plugin_attribute_id=>wwv_flow_imp.id(663032223547473279)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(663034212339473280)
,p_plugin_id=>wwv_flow_imp.id(663030734069473273)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(663034831782473286)
,p_plugin_id=>wwv_flow_imp.id(663030734069473273)
,p_name=>'SOURCE_SQL'
