...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3804414835737595927)
,p_name=>'load_salary'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804414520112595926)
,p_load_table_id=>wwv_flow_imp.id(3804414835737595927)
...
wwv_flow_imp_shared.create_load_table_rule(
 p_id=>wwv_flow_imp.id(3804414173400595925)
,p_load_table_id=>wwv_flow_imp.id(3804414835737595927)
