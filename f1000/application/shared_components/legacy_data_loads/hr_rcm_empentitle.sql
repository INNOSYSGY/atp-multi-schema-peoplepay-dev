...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3804321838143496184)
,p_name=>'load_oth_ent'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804321544481496184)
,p_load_table_id=>wwv_flow_imp.id(3804321838143496184)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804230566905458211)
,p_load_table_id=>wwv_flow_imp.id(3804321838143496184)
