...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709456211531043735)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3755776931622722109)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3755777101809722110)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709456015630043733)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3709456211531043735)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3755776196219722101)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3755776931622722109)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709455920787043732)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3755776011745722100)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3755776931622722109)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(559961828777469350)
,p_name=>'P79_ORGDTL_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3755777101809722110)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(591527669679251207)
,p_name=>'P79_LABEL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3755777101809722110)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(634854249790162408)
,p_name=>'P79_DEF_QUANTITY'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3709456211531043735)
,p_item_default=>'1'
,p_prompt=>'Quantity'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3369624822152877547)
,p_name=>'P79_QUANTITY'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3755776931622722109)
,p_item_default=>'1'
,p_prompt=>'Quantity'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>15
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3369625128603880248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709027242618064425)
,p_name=>'P79_RETURN'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3709456211531043735)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709455455792043728)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709455573030043729)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709455678264043730)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709456101961043734)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755475423406707051)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755475746258709094)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755776833891722108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766690927958413013)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766691064159413014)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766691138596413015)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766691375657413017)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3709325107408761351)
,p_name=>'dy_all_eployeee'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3709455920787043732)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3709324702220761346)
,p_event_id=>wwv_flow_imp.id(3709325107408761351)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3709324246133761345)
,p_event_id=>wwv_flow_imp.id(3709325107408761351)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3766691796438413021)
,p_name=>'dy_all_eployeee_sel'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3755776011745722100)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766691624003413020)
,p_event_id=>wwv_flow_imp.id(3766691796438413021)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766691573067413019)
,p_event_id=>wwv_flow_imp.id(3766691796438413021)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3755776807875722107)
,p_name=>'SHOW_hide'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755776523899722105)
,p_event_id=>wwv_flow_imp.id(3755776807875722107)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3709456211531043735)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755776637311722106)
,p_event_id=>wwv_flow_imp.id(3755776807875722107)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3755776432501722104)
,p_name=>'SHOW_hide_1'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P79_POST_CATEGORY'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755776295241722102)
,p_event_id=>wwv_flow_imp.id(3755776432501722104)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3755776931622722109)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755776332251722103)
,p_event_id=>wwv_flow_imp.id(3755776432501722104)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3472864348060694608)
,p_name=>'set_clear'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3472864454029694609)
,p_event_id=>wwv_flow_imp.id(3472864348060694608)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(591527742508251208)
