...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5012760994451130860)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5012761999615130870)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(671154272183872569)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5012761999615130870)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(671153556281872569)
,p_name=>'P9914_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5012760994451130860)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(696967048609419614)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696967517678419615)
,p_event_id=>wwv_flow_imp.id(696967048609419614)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696967973049419615)
,p_event_id=>wwv_flow_imp.id(696967048609419614)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(671154662156872571)
...
,p_process_when_button_id=>wwv_flow_imp.id(671154272183872569)
