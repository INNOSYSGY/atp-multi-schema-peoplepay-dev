...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3763168593370135421)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3846838074960833792)
,p_region_id=>wwv_flow_imp.id(3763168593370135421)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3846838520193833797)
,p_chart_id=>wwv_flow_imp.id(3846838074960833792)
,p_seq=>10
,p_name=>'DEDUCTIONS'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3846839118277833797)
,p_chart_id=>wwv_flow_imp.id(3846838074960833792)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_decimal_places=>0
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3846839686269833797)
,p_chart_id=>wwv_flow_imp.id(3846838074960833792)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3763169884506218015)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3846836030660833788)
,p_region_id=>wwv_flow_imp.id(3763169884506218015)
,p_chart_type=>'pie'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3846836422373833792)
,p_chart_id=>wwv_flow_imp.id(3846836030660833788)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3763170891056372539)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3853048046476103458)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3763170891056372539)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3853046875022103452)
,p_name=>'P1381_PERIOD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3763170891056372539)
,p_prompt=>'Period'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3853047289613103454)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3853047626142103457)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3843717751185864759)
,p_name=>'refresh'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3843717613078864758)
,p_event_id=>wwv_flow_imp.id(3843717751185864759)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3763169884506218015)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3843717519923864757)
,p_event_id=>wwv_flow_imp.id(3843717751185864759)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3763168593370135421)
,p_attribute_01=>'N'
);
