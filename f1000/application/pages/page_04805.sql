...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773132059467877681)
...
,p_list_id=>wwv_flow_imp.id(663555597410446851)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772976761990284533)
,p_plug_name=>'Chat Sent'
,p_parent_plug_id=>wwv_flow_imp.id(773132059467877681)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773174608402390607)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773177060772390631)
,p_plug_name=>'Forward'
,p_parent_plug_id=>wwv_flow_imp.id(773174608402390607)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773177135905390632)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773177237351390633)
,p_plug_name=>'Delete'
,p_parent_plug_id=>wwv_flow_imp.id(773174608402390607)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773174774309390608)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773178570389390646)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(773178981730390650)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776340778592512601)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776340826769512602)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776340929401512603)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776341043807512604)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776341160241512605)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(776347780884513532)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(782046157401267726)
,p_plug_name=>'Notice'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663489462220308152)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(772976761990284533)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663491226426308154)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(773177060772390631)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663492660215308156)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(773177135905390632)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663494058369308157)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(773177237351390633)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663494489594308157)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(773177237351390633)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772995220518284626)
,p_name=>'P4805_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773132059467877681)
,p_prompt=>'Recipient'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772996187403284620)
,p_name=>'P4805_ENTRY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772976761990284533)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773198908771390712)
,p_name=>'P4805_UTILITY_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773174608402390607)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773203582022390741)
,p_name=>'P4805_SENT_TO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(773177060772390631)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773203661961390742)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773204127040390722)
,p_name=>'P4805_GROUP_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773177135905390632)
,p_prompt=>'Group Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773207265796390754)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773210271061390752)
,p_name=>'P4805_MSG_TO_DELETE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773177237351390633)
,p_prompt=>'Message/s'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT COMMENT_TEXT||'' (''||initcap(a.user_name)||'')'' A, a.id B       ',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663509993781308195)
,p_name=>'SAVE_MSG'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663489462220308152)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663510430476308196)
,p_event_id=>wwv_flow_imp.id(663509993781308195)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663510976303308196)
,p_event_id=>wwv_flow_imp.id(663509993781308195)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(773132059467877681)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663511382864308196)
,p_name=>'refresh_chat'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663511881318308197)
,p_event_id=>wwv_flow_imp.id(663511382864308196)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663512366039308197)
,p_event_id=>wwv_flow_imp.id(663511382864308196)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663512806158308197)
,p_name=>'PURGE_CHAT'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663494058369308157)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663513286685308198)
,p_event_id=>wwv_flow_imp.id(663512806158308197)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663513800990308198)
,p_event_id=>wwv_flow_imp.id(663512806158308197)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663514194197308198)
,p_name=>'PURGE_CHAT_ALL'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663494489594308157)
,p_condition_element=>'P4805_RECIPIENT'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663514639022308198)
,p_event_id=>wwv_flow_imp.id(663514194197308198)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663515129087308199)
,p_event_id=>wwv_flow_imp.id(663514194197308198)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663515593641308199)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663516041869308199)
,p_event_id=>wwv_flow_imp.id(663515593641308199)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663489462220308152)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663516548168308199)
,p_event_id=>wwv_flow_imp.id(663515593641308199)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663516939363308200)
,p_name=>'dyn_forward'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663491226426308154)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663517452902308200)
,p_event_id=>wwv_flow_imp.id(663516939363308200)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663505850340308190)
,p_name=>'create_group'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663492660215308156)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663506362431308192)
,p_event_id=>wwv_flow_imp.id(663505850340308190)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663506820598308193)
,p_name=>'show_group'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663507317401308193)
,p_event_id=>wwv_flow_imp.id(663506820598308193)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663492660215308156)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663507786992308194)
,p_event_id=>wwv_flow_imp.id(663506820598308193)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663508144757308194)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663509033384308195)
,p_name=>'update_seen'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663509541780308195)
,p_event_id=>wwv_flow_imp.id(663509033384308195)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(663505512123308189)
