...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658224918102523252)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658225928482523255)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3658224918102523252)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658226516718523256)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3658224918102523252)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658226926803523256)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658227338729523257)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3658226926803523256)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694583291879916530)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3658224918102523252)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694586469496916538)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3658225928482523255)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694583731375916531)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694584078600916531)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3658224918102523252)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3694594669864916547)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694584531604916535)
,p_name=>'P402_REPORT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3658224918102523252)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694584944467916536)
,p_name=>'P402_URL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3658224918102523252)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694585335433916536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694585699450916536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694586845169916538)
,p_name=>'P402_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3658225928482523255)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694587876082916539)
,p_name=>'P402_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3658226926803523256)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694588538821916542)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3694584078600916531)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694588993924916543)
,p_event_id=>wwv_flow_imp.id(3694588538821916542)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3847015733188699360)
,p_event_id=>wwv_flow_imp.id(3694588538821916542)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694589400057916543)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694589882853916543)
,p_event_id=>wwv_flow_imp.id(3694589400057916543)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694590379921916544)
,p_event_id=>wwv_flow_imp.id(3694589400057916543)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694590796725916544)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694591295115916544)
,p_event_id=>wwv_flow_imp.id(3694590796725916544)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694591735345916544)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3694586469496916538)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694592230154916545)
,p_event_id=>wwv_flow_imp.id(3694591735345916544)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694592756165916545)
,p_event_id=>wwv_flow_imp.id(3694591735345916544)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694593079550916545)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694593632688916545)
,p_event_id=>wwv_flow_imp.id(3694593079550916545)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694594152710916546)
,p_event_id=>wwv_flow_imp.id(3694593079550916545)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
