...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785291308735793276)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3835608710398954458)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3728865929487867675)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3835608710398954458)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3728866105486867677)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728831359186720421)
,p_name=>'P47_EMPLOYEE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3835608710398954458)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728831713899720428)
,p_name=>'P47_PROCESS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3835608710398954458)
,p_prompt=>'Process'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728832058331720428)
,p_name=>'P47_START'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3835608710398954458)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728832446103720429)
,p_name=>'P47_END'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3835608710398954458)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3728866227638867678)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3728839949951720488)
,p_name=>'New'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3728840496140720488)
,p_event_id=>wwv_flow_imp.id(3728839949951720488)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3728837260496720483)
,p_name=>'Submit'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3728837826131720485)
,p_event_id=>wwv_flow_imp.id(3728837260496720483)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
