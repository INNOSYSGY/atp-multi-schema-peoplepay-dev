...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(528262074559190376)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(528264728876190403)
,p_plug_name=>'Report'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(528262074559190376)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(528262183930190377)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(528262074559190376)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(528262230071190378)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(528262845855190384)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(528262074559190376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528263286751190388)
,p_name=>'P1504_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(528262074559190376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528263333733190389)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528263457605190390)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528263510002190391)
,p_name=>'P1504_YEAR'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(528262074559190376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528263674701190392)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528264073527190396)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528264174052190397)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528264376180190399)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528264451619190400)
,p_name=>'P1504_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(528262074559190376)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528264548565190401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(528264644508190402)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(528262373104190379)
,p_name=>'Preview_report_cloud'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(528262230071190378)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528262406145190380)
,p_event_id=>wwv_flow_imp.id(528262373104190379)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528262504401190381)
,p_event_id=>wwv_flow_imp.id(528262373104190379)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528262652067190382)
,p_event_id=>wwv_flow_imp.id(528262373104190379)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(528262945058190385)
,p_name=>'New'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(528262845855190384)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528263002108190386)
,p_event_id=>wwv_flow_imp.id(528262945058190385)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528263193870190387)
,p_event_id=>wwv_flow_imp.id(528262945058190385)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(528263729130190393)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528263823425190394)
,p_event_id=>wwv_flow_imp.id(528263729130190393)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(528263987607190395)
,p_event_id=>wwv_flow_imp.id(528263729130190393)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(528264941515190405)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(528264869162190404)
