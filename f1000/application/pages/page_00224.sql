...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(670322177553599636)
,p_plug_name=>'bc'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(815349256255298879)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1408548580676696754)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1420775057177062878)
,p_plug_name=>'Income Details'
,p_region_name=>'emp_time_incomes'
,p_parent_plug_id=>wwv_flow_imp.id(1408548580676696754)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1389497455142516517)
,p_name=>'INCOME_CODE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1394246876195338687)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1400241197636655711)
,p_name=>'START_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1400241259376655712)
,p_name=>'END_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775271155062880)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775383219062881)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775531513062882)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775564505062883)
,p_name=>'ORGDTL_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775680216062884)
,p_name=>'EMPENT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775838110062886)
,p_name=>'RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420775947788062887)
,p_name=>'QUANTITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420776094042062888)
,p_name=>'AMOUNT_PAID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420776315864062890)
,p_name=>'PAYSTATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420776412543062891)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892279257553742)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892342766553743)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892485732553744)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892602896553745)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892757706553747)
,p_name=>'APPROVED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892926126553748)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420892955535553749)
,p_name=>'VERIFIED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420893128293553750)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420893172322553751)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420893327701553752)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1639695757627804465)
,p_name=>'WEEK_DAY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1420775178888062879)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1420897922216560748)
,p_interactive_grid_id=>wwv_flow_imp.id(1420775178888062879)
,p_static_id=>'306825'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1420898105918560748)
,p_report_id=>wwv_flow_imp.id(1420897922216560748)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1394251480398340939)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(1389497455142516517)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1394269474465340980)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1394246876195338687)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>157
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1405048494364676021)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1400241197636655711)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>162
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1405049400086676024)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1400241259376655712)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>183
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420898600711560749)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1420775271155062880)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420899522169560750)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1420775383219062881)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>117
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420900378001560753)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1420775531513062882)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>196
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420901321823560754)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1420775564505062883)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>275
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420902181551560756)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1420775680216062884)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>136
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420904028369560759)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(1420775838110062886)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420904911588560760)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1420775947788062887)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>74
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420905778777560762)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(1420776094042062888)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>94
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420907606641560765)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(1420776315864062890)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>84
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420908529622560766)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(1420776412543062891)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>102
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420909343930560767)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(1420892279257553742)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>225
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420910263596560769)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(1420892342766553743)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420911174990560770)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1420892485732553744)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420912020930560772)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(1420892602896553745)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420913745105560774)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(1420892757706553747)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420914674269560776)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(1420892926126553748)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420915614083560777)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>24
,p_column_id=>wwv_flow_imp.id(1420892955535553749)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420916439860560779)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>25
,p_column_id=>wwv_flow_imp.id(1420893128293553750)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420917349425560780)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(1420893172322553751)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>153
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420918325924560781)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(1420893327701553752)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>107
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1638839436846269669)
,p_view_id=>wwv_flow_imp.id(1420898105918560748)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1639695757627804465)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>71
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1422789656079356033)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1464050433029343099)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1400242096592655720)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461459831029435913)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461029948435925)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461107916435926)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461182619435927)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461258907435928)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461608007435931)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REMARKS'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461755310435933)
,p_name=>'PAY_STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461461860345435934)
,p_name=>'LEAVE_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461682034052597890)
,p_name=>'TRANSACTION_TYPE_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRANSACTION_TYPE_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461682061250597891)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'STATUS'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1464048992833343085)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1464049233209343087)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1464049349049343088)
,p_name=>'LEAVE_MODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1464050017553343095)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1464050083775343096)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1464050221202343097)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1465671958495855123)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1464050315182343098)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1461456256930434074)
,p_interactive_grid_id=>wwv_flow_imp.id(1464050315182343098)
,p_static_id=>'698710'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1461456101881434074)
,p_report_id=>wwv_flow_imp.id(1461456256930434074)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1406692998057302215)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1400242096592655720)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>92
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1459929783492642141)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1465671958495855123)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>103
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461435825032434034)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(1461461029948435925)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461436672106434036)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(1461461107916435926)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461437562140434037)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1461461182619435927)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461438460700434039)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1461461258907435928)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461441235055434043)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1461461608007435931)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>96
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461443018540434047)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1461461755310435933)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>82
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461443908046434049)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1461461860345435934)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>177
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461444821771434050)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(1464048992833343085)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461446634205434055)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1464049233209343087)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>128
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461447527534434057)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1464049349049343088)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461453789074434068)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1464050017553343095)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>222
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461454677501434069)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1464050083775343096)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>102
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461455554173434071)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(1464050221202343097)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461661010708137428)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(1461459831029435913)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>145
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1462005934769761755)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(1461682034052597890)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>115
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1462007260280761757)
,p_view_id=>wwv_flow_imp.id(1461456101881434074)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(1461682061250597891)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>83
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1464305176906189680)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1465314225761161384)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987721239712217839)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987720815964217839)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987720508584217838)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987720096401217838)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987719711076217837)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987719311393217837)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987718849803217837)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987718422767217836)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987718047367217836)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987722060529217840)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987721686180217839)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987717630462217835)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1465758139664159758)
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(1478721338428659701)
,p_report_id=>wwv_flow_imp.id(1465758139664159758)
,p_pivot_columns=>'DAY_NUMBERC'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(674782242379295177)
,p_pivot_id=>wwv_flow_imp.id(1478721338428659701)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1465196094453555442)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1465762168804188967)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987714833418217831)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987714447361217831)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Emp Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987714074097217830)
,p_db_column_name=>'EMP_COMPANY_NO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Emp Company No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987713672757217830)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Emp Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987713211818217829)
,p_db_column_name=>'WKLOCATION_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Work Location'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987712723114217829)
,p_db_column_name=>'DEPARTMENT'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987712386186217828)
,p_db_column_name=>'DESIGNATION'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Designation'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987711943358217828)
,p_db_column_name=>'PAYMENT_TYPE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Payment Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987715781952217832)
,p_db_column_name=>'DAY_NUMBERC'
,p_display_order=>90
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987715309808217831)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987711110667217827)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987711462240217827)
,p_db_column_name=>'CODE_QTY'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1465830053917195782)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(1478723414463664501)
,p_report_id=>wwv_flow_imp.id(1465830053917195782)
,p_pivot_columns=>'DAY_NUMBERC:INCOME_CODE'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(674787255479295182)
,p_pivot_id=>wwv_flow_imp.id(1478723414463664501)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1465710459372157975)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1465710592791157976)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987708339848217823)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987707949803217823)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Emp Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987707493934217822)
,p_db_column_name=>'EMP_COMPANY_NO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Emp Company No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987707061667217822)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Emp Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987706676744217821)
,p_db_column_name=>'WKLOCATION_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Work Location'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987706256688217821)
,p_db_column_name=>'DEPARTMENT'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987705863803217821)
,p_db_column_name=>'DESIGNATION'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Designation'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987705411727217820)
,p_db_column_name=>'PAYMENT_TYPE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Payment Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987704970494217820)
,p_db_column_name=>'ABS_CODE'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Abs Code'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987709210725217824)
,p_db_column_name=>'DAY_NUMBERC'
,p_display_order=>110
,p_column_identifier=>'AP'
,p_column_label=>'Day Numberc'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987708742939217824)
,p_db_column_name=>'ABSENCE_HOURS'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987704550199217819)
,p_db_column_name=>'CODE_QTY'
,p_display_order=>130
,p_column_identifier=>'AR'
,p_column_label=>'Code Qty'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1465829436677195775)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(1478722349232662436)
,p_report_id=>wwv_flow_imp.id(1465829436677195775)
,p_pivot_columns=>'ABS_CODE'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(674792250153295188)
,p_pivot_id=>wwv_flow_imp.id(1478722349232662436)
,p_display_seq=>1
,p_function_name=>'SUM'
,p_column_name=>'ABSENCE_HOURS'
,p_db_column_name=>'PFC1'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1485427245057671773)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1482128410572050573)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1482128467319050574)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1482128567103050575)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426288261671763)
,p_name=>'DATE_CREATED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426334961671764)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426520064671765)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426619140671766)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426722462671767)
,p_name=>'HOURS_WORKED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426820824671768)
,p_name=>'TIME_SOURCE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426860123671769)
,p_name=>'TIME_OUT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485426929895671770)
,p_name=>'TIME_IN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485427085259671771)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1485427127317671772)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1481483392422142850)
,p_interactive_grid_id=>wwv_flow_imp.id(1485427127317671772)
,p_static_id=>'335594'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1481483204924142849)
,p_report_id=>wwv_flow_imp.id(1481483392422142850)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1478159983663618033)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(1482128410572050573)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1478160894393618035)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1482128467319050574)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>141.1406
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1478161754372618038)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1482128567103050575)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>108.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481475500546142831)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1485426288261671763)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>145.141
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481476358737142833)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1485426334961671764)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481477263290142835)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1485426520064671765)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>154.14100000000002
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481478168014142837)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1485426619140671766)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>127.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481479054437142839)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1485426722462671767)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481479996370142841)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1485426820824671768)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>90.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481480883285142843)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1485426860123671769)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>148.5156
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481481744254142845)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(1485426929895671770)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>161.266
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481482700610142848)
,p_view_id=>wwv_flow_imp.id(1481483204924142849)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1485427085259671771)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.5156
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1494678876715996867)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1483853774502953968)
,p_name=>'OVERRIDE_LLH'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1483856190214953992)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494677923558996858)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494678086148996859)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494678156535996860)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494678315459996861)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494678448795996863)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494678592857996864)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494678694849996865)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1494678767087996866)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1484053187306117588)
,p_interactive_grid_id=>wwv_flow_imp.id(1494678767087996866)
,p_static_id=>'309896'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1484052931577117587)
,p_report_id=>wwv_flow_imp.id(1484053187306117588)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483386051090623897)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1483853774502953968)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483838873557832115)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1483856190214953992)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484046225140117568)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1494677923558996858)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484047163451117570)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1494678086148996859)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484048105184117572)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1494678156535996860)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484048940607117574)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1494678315459996861)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484050672005117578)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1494678448795996863)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484051552219117581)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(1494678592857996864)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1484052511599117583)
,p_view_id=>wwv_flow_imp.id(1484052931577117587)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1494678694849996865)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1427404156671946778)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1427404292200946779)
,p_plug_name=>'Master Records'
,p_region_name=>'fx'
,p_parent_plug_id=>wwv_flow_imp.id(1427404156671946778)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1457528607795427485)
,p_max_row_count=>'1000000'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987778079265217913)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987777646884217912)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987777212369217912)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987776788085217911)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987776352730217911)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987775932445217911)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987775531659217910)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987775085151217910)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987774650754217909)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987774269965217909)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987773837760217909)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987773440849217908)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987772934565217908)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987778475398217913)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987772537994217907)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987772203264217907)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987778849512217914)
,p_db_column_name=>'LH'
,p_display_order=>280
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987770063465217905)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987770432646217905)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987770847966217905)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987771312411217906)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987771725181217906)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987769659790217904)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987769201435217904)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1458169908187904889)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1427404356262946780)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1404048432665134989)
,p_name=>'TIME_SOURCE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_SOURCE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1408642752246109057)
,p_name=>'PKEY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428215323234667256)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428215543757667258)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428215611080667259)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428215683057667260)
,p_name=>'TIME_IN'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_IN'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428215752549667261)
,p_name=>'TIME_OUT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_OUT'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428216531951667268)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428216621210667269)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1455870786510394354)
,p_name=>'CALENDAR_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1458005495893527074)
,p_name=>'HOURS_WORKED'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'HOURS_WORKED'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1458128574552902864)
,p_name=>'WKDATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1482577569401005791)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1428215246625667255)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1428264885071688472)
,p_interactive_grid_id=>wwv_flow_imp.id(1428215246625667255)
,p_static_id=>'318730'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1428265052376688472)
,p_report_id=>wwv_flow_imp.id(1428264885071688472)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1408545981948669356)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(1404048432665134989)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1411091883252295285)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1408642752246109057)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>40
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428265551703688474)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1428215323234667256)
,p_is_visible=>false
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428267422097688479)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1428215543757667258)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428268308161688481)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1428215611080667259)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428269231718688483)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1428215683057667260)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>107
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428270055794688486)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1428215752549667261)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>94
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428276406438688502)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1428216531951667268)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>124
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428277336076688505)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1428216621210667269)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1459257640095135216)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(1458128574552902864)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461676335612561120)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(1455870786510394354)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1463712950579390167)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1458005495893527074)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>104
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1482455644709828164)
,p_view_id=>wwv_flow_imp.id(1428265052376688472)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1482577569401005791)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1465340652161160304)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674755994528295148)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(815349256255298879)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674803986891295199)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1427404156671946778)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674804417230295199)
...
,p_security_scheme=>wwv_flow_imp.id(3714351216858268637)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674804799444295199)
...
,p_security_scheme=>wwv_flow_imp.id(674438465294160326)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674820049220295216)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(1465340652161160304)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674820435241295217)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674820920260295217)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674821232605295217)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(676468270590556747)
,p_name=>'P224_REPORT_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(1465340652161160304)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973932671530394157)
,p_name=>'P224_L_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(815349256255298879)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973933171120397269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973933567351397269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973933987171397270)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987791639698217924)
,p_name=>'P224_OVERRIDE_LLH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1494678876715996867)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987821790008217957)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987822154980217958)
,p_name=>'P224_URL'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(1465340652161160304)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987822611493217958)
,p_name=>'P224_DYVP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(1465340652161160304)
,p_item_default=>'300'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987823014036217959)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987823415709217959)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987823925761217959)
,p_name=>'P224_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(1465340652161160304)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987824311262217960)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987824671066217960)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987825052653217961)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987825547959217961)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987826018256217962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987826374150217962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987829448699217971)
,p_name=>'P224_VWFLAG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1427404156671946778)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674827849874295225)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674828402324295226)
,p_event_id=>wwv_flow_imp.id(674827849874295225)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1427404292200946779)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674828869872295226)
,p_event_id=>wwv_flow_imp.id(674827849874295225)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674829355460295227)
,p_event_id=>wwv_flow_imp.id(674827849874295225)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674829819866295227)
,p_name=>'dy_get_mastergrid_data'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1427404292200946779)
,p_bind_type=>'live'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_IG|REGION TYPE|interactivegridselectionchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674830259399295227)
,p_event_id=>wwv_flow_imp.id(674829819866295227)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674830819385295227)
,p_event_id=>wwv_flow_imp.id(674829819866295227)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1427404356262946780)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674831133636295228)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674831696323295228)
,p_event_id=>wwv_flow_imp.id(674831133636295228)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674832044037295228)
,p_name=>'dy_calculate_hoursworked'
,p_event_sequence=>100
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1427404356262946780)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674832610327295228)
,p_event_id=>wwv_flow_imp.id(674832044037295228)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674832973239295229)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674833471448295229)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674833956580295229)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1420775057177062878)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674834479572295229)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1464050433029343099)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674834935372295230)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1464305176906189680)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674835443474295230)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674835995919295230)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1494678876715996867)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674836443304295230)
,p_event_id=>wwv_flow_imp.id(674832973239295229)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1485427245057671773)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674836825604295231)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674837372280295231)
,p_event_id=>wwv_flow_imp.id(674836825604295231)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674837770565295231)
,p_name=>'New'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674838232840295231)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674838794695295232)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674839227649295232)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674839751800295232)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674840293069295232)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1427404156671946778)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674840726327295233)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674841293969295233)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674841782341295233)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'FALSE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674842299669295234)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674842773459295234)
,p_event_id=>wwv_flow_imp.id(674837770565295231)
,p_event_result=>'FALSE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674843161893295234)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674843641631295235)
,p_event_id=>wwv_flow_imp.id(674843161893295234)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674844024795295235)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674844579491295235)
,p_event_id=>wwv_flow_imp.id(674844024795295235)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674845091062295235)
,p_event_id=>wwv_flow_imp.id(674844024795295235)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1465710459372157975)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674845585328295236)
,p_event_id=>wwv_flow_imp.id(674844024795295235)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1465196094453555442)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674846027743295236)
,p_event_id=>wwv_flow_imp.id(674844024795295235)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674846563186295236)
,p_event_id=>wwv_flow_imp.id(674844024795295235)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674847054817295236)
,p_event_id=>wwv_flow_imp.id(674844024795295235)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674847464717295237)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674847967951295237)
,p_event_id=>wwv_flow_imp.id(674847464717295237)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674848454094295237)
,p_event_id=>wwv_flow_imp.id(674847464717295237)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674848887360295237)
,p_name=>'dy_set_caldendar_id'
,p_event_sequence=>290
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1420775057177062878)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674849358507295238)
,p_event_id=>wwv_flow_imp.id(674848887360295237)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674849821151295238)
,p_name=>'set_focus'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674850292693295238)
,p_event_id=>wwv_flow_imp.id(674849821151295238)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674850717587295239)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674851125022295239)
,p_event_id=>wwv_flow_imp.id(674850717587295239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674851619668295239)
,p_name=>'refresh_emp_id_1'
,p_event_sequence=>350
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1464050433029343099)
,p_triggering_element=>'WORK_DATE'
,p_condition_element_type=>'COLUMN'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674852055684295239)
,p_event_id=>wwv_flow_imp.id(674851619668295239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674852425270295240)
,p_name=>'dy_set_value'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674852999066295240)
,p_event_id=>wwv_flow_imp.id(674852425270295240)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674853336835295240)
,p_name=>'TIMESHEET_TIMES_OnPreme'
,p_event_sequence=>370
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674820049220295216)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674853888118295240)
,p_event_id=>wwv_flow_imp.id(674853336835295240)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674854246970295240)
,p_name=>'TIMESHEET_SUMMARY_OnPreme'
,p_event_sequence=>380
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674820435241295217)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674854734358295241)
,p_event_id=>wwv_flow_imp.id(674854246970295240)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674855133451295241)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674855659193295241)
,p_event_id=>wwv_flow_imp.id(674855133451295241)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674856083314295242)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674856556103295242)
,p_event_id=>wwv_flow_imp.id(674856083314295242)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674856988247295242)
,p_name=>'ref_empid'
,p_event_sequence=>410
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1494678876715996867)
,p_triggering_element=>'WORK_DATE'
,p_condition_element_type=>'COLUMN'
,p_condition_element=>'ENTERED_BY'
,p_triggering_condition_type=>'NOT_NULL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674857500089295242)
,p_event_id=>wwv_flow_imp.id(674856988247295242)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674857881145295242)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674858361831295243)
,p_event_id=>wwv_flow_imp.id(674857881145295242)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674858882972295243)
,p_event_id=>wwv_flow_imp.id(674857881145295242)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674859265098295243)
,p_name=>'set_llh_val'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674859799144295244)
,p_event_id=>wwv_flow_imp.id(674859265098295243)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674860163728295244)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674860655323295244)
,p_event_id=>wwv_flow_imp.id(674860163728295244)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674861060799295244)
,p_name=>'dy_showhide'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674861482842295244)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674861936354295245)
,p_event_id=>wwv_flow_imp.id(674861482842295244)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674862411531295245)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674862844258295245)
,p_event_id=>wwv_flow_imp.id(674862411531295245)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674863315401295245)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674863758175295246)
,p_event_id=>wwv_flow_imp.id(674863315401295245)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674864274173295246)
,p_event_id=>wwv_flow_imp.id(674863315401295245)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674864800772295246)
,p_event_id=>wwv_flow_imp.id(674863315401295245)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674865199468295246)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674865708061295247)
,p_event_id=>wwv_flow_imp.id(674865199468295246)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674866152169295247)
,p_event_id=>wwv_flow_imp.id(674865199468295246)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674866634417295247)
,p_event_id=>wwv_flow_imp.id(674865199468295246)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674867107638295248)
,p_name=>'Preview_Report_Cloud_1_1'
,p_event_sequence=>520
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674820920260295217)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674867611221295248)
,p_event_id=>wwv_flow_imp.id(674867107638295248)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674868105928295248)
,p_event_id=>wwv_flow_imp.id(674867107638295248)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674868611376295248)
,p_event_id=>wwv_flow_imp.id(674867107638295248)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674868931812295249)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674869511105295249)
,p_event_id=>wwv_flow_imp.id(674868931812295249)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674869903019295249)
,p_name=>'REFRESH_MASTER'
,p_event_sequence=>540
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674803986891295199)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674870408963295249)
,p_event_id=>wwv_flow_imp.id(674869903019295249)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674870800390295250)
,p_name=>'dy_open_dialog'
,p_event_sequence=>550
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674821232605295217)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674871278395295250)
,p_event_id=>wwv_flow_imp.id(674870800390295250)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_OPEN_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(815349256255298879)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674827115791295223)
...
,p_process_when_button_id=>wwv_flow_imp.id(674804417230295199)
,p_process_success_message=>'Verifed Timesheet within selected period '
,p_internal_uid=>31351193911540718
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674827442661295224)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(674755994528295148)
,p_internal_uid=>31350767650540718
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674826268030295223)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674825830682295222)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674825505839295221)
