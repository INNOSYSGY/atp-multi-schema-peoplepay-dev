...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4449442540415503684)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452790014321741835)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446622491904550975)
,p_region_id=>wwv_flow_imp.id(4452790014321741835)
,p_chart_type=>'dial'
,p_width=>'240'
,p_height=>'360'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446622949606550978)
,p_chart_id=>wwv_flow_imp.id(3446622491904550975)
,p_seq=>10
,p_name=>'Number Hired'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452790713623741842)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446623905802550981)
,p_region_id=>wwv_flow_imp.id(4452790713623741842)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446626156050550984)
,p_chart_id=>wwv_flow_imp.id(3446623905802550981)
,p_seq=>20
,p_name=>'Female'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446625563943550983)
,p_chart_id=>wwv_flow_imp.id(3446623905802550981)
,p_seq=>30
,p_name=>'Male'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3446624426110550981)
,p_chart_id=>wwv_flow_imp.id(3446623905802550981)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Age'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3446625010413550983)
,p_chart_id=>wwv_flow_imp.id(3446623905802550981)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452791008234741845)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446627629780550990)
,p_region_id=>wwv_flow_imp.id(4452791008234741845)
,p_chart_type=>'donut'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446628097922550991)
,p_chart_id=>wwv_flow_imp.id(3446627629780550990)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452793188476741867)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4671042478721372568)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3446621382002550972)
,p_name=>'P10003_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4449442540415503684)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3446621775141550973)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446629096825550993)
,p_name=>'refr_st'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446629554846550994)
,p_event_id=>wwv_flow_imp.id(3446629096825550993)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4671042478721372568)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446629983251550994)
,p_name=>'refresh_end'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446630461090550995)
,p_event_id=>wwv_flow_imp.id(3446629983251550994)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446630851010550995)
,p_name=>'refr_hr'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446631397789550995)
,p_event_id=>wwv_flow_imp.id(3446630851010550995)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452790014321741835)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446631760559550996)
,p_name=>'refr_end'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_END_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446632276793550996)
,p_event_id=>wwv_flow_imp.id(3446631760559550996)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446632723990550996)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446633147347550997)
,p_event_id=>wwv_flow_imp.id(3446632723990550996)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452790713623741842)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446633627366550997)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446634124709550998)
,p_event_id=>wwv_flow_imp.id(3446633627366550997)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452791008234741845)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446634461816550998)
,p_name=>'refr_age_sex'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446634995563550998)
,p_event_id=>wwv_flow_imp.id(3446634461816550998)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446635415412550999)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446635913431550999)
,p_event_id=>wwv_flow_imp.id(3446635415412550999)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3446628719015550992)
