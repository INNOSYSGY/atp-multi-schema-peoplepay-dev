...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5430623312544747442)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3397490384739384310)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5430623312544747442)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3397490811234384310)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3397497022004384321)
,p_branch_name=>'stay'
,p_branch_action=>'f?p=&APP_ID.:1347:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3397490811234384310)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3397491150126384311)
,p_name=>'P1347_POSITION_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5430623312544747442)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3397491610494384312)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3397491954479384312)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3397493204203384316)
,p_name=>'SHOW_GEN'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397493664855384317)
,p_event_id=>wwv_flow_imp.id(3397493204203384316)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397494158338384317)
,p_event_id=>wwv_flow_imp.id(3397493204203384316)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3397494571821384318)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397495108515384318)
,p_event_id=>wwv_flow_imp.id(3397494571821384318)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397495595764384319)
,p_event_id=>wwv_flow_imp.id(3397494571821384318)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3397495968116384319)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3397496487750384320)
,p_event_id=>wwv_flow_imp.id(3397495968116384319)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3397492380676384314)
...
,p_process_when_button_id=>wwv_flow_imp.id(3397490811234384310)
,p_process_success_message=>'Generated!'
,p_internal_uid=>2754016458796629809
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3397492794107384315)
