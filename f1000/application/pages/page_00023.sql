...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697121587081898552)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764722852270660641)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854631707369763889)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3765075236615820756)
,p_plug_name=>'Query'
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854637140725763894)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3765395332659998690)
,p_plug_name=>'Tools'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--accent13:t-Region--noBorder:t-Region--hiddenOverflow:t-Form--noPadding'
,p_component_template_options=>'#DEFAULT#:u-colors:t-Cards--basic:t-Cards--5cols:t-Cards--animColorFill'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854644566258763912)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5487163218769328565)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854646772758763934)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5487163218769328565)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854646348820763929)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3854644828202763914)
