...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3665803354566123224)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3583850801239103408)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3665803354566123224)
,p_button_name=>'Send'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3583851195907103409)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3583851609186103413)
,p_name=>'P1234_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3665803354566123224)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3583852032311103415)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3583852479559103416)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3583852849283103425)
,p_name=>'Send'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3583850801239103408)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3583853881823103426)
,p_event_id=>wwv_flow_imp.id(3583852849283103425)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3583853324563103426)
,p_event_id=>wwv_flow_imp.id(3583852849283103425)
,p_event_result=>'TRUE'
