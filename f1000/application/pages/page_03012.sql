...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3774317691978044554)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822409168416523519)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3850070161134600507)
,p_region_id=>wwv_flow_imp.id(3822409168416523519)
,p_chart_type=>'donut'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850069719789600504)
,p_chart_id=>wwv_flow_imp.id(3850070161134600507)
,p_seq=>10
,p_name=>'Series 1'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850069136942600501)
,p_chart_id=>wwv_flow_imp.id(3850070161134600507)
,p_seq=>20
,p_name=>'Series 2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822411921116523512)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3850068183831600499)
,p_region_id=>wwv_flow_imp.id(3822411921116523512)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850066480296600496)
,p_chart_id=>wwv_flow_imp.id(3850068183831600499)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850065880530600495)
,p_chart_id=>wwv_flow_imp.id(3850068183831600499)
,p_seq=>20
,p_name=>'Series 2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850067750555600498)
,p_chart_id=>wwv_flow_imp.id(3850068183831600499)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850067115648600497)
,p_chart_id=>wwv_flow_imp.id(3850068183831600499)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822414552541523511)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3850065032159600494)
,p_region_id=>wwv_flow_imp.id(3822414552541523511)
,p_chart_type=>'line'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850062697733600491)
,p_chart_id=>wwv_flow_imp.id(3850065032159600494)
,p_seq=>10
,p_name=>'Series1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850062061413600490)
,p_chart_id=>wwv_flow_imp.id(3850065032159600494)
,p_seq=>20
,p_name=>'Series2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850063899245600493)
,p_chart_id=>wwv_flow_imp.id(3850065032159600494)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850064455283600493)
,p_chart_id=>wwv_flow_imp.id(3850065032159600494)
,p_axis=>'y2'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850063282725600492)
,p_chart_id=>wwv_flow_imp.id(3850065032159600494)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822417241316523510)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3850061190484600489)
,p_region_id=>wwv_flow_imp.id(3822417241316523510)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850059483281600484)
,p_chart_id=>wwv_flow_imp.id(3850061190484600489)
,p_seq=>10
,p_name=>'Series1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3850058933050600484)
,p_chart_id=>wwv_flow_imp.id(3850061190484600489)
,p_seq=>20
,p_name=>'Series2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850060134498600485)
,p_chart_id=>wwv_flow_imp.id(3850061190484600489)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3850060676367600486)
,p_chart_id=>wwv_flow_imp.id(3850061190484600489)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3850072505592600520)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3774317691978044554)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3850070857356600511)
,p_name=>'P3012_MONTH_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3774317691978044554)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3850071313888600512)
,p_name=>'P3012_YEAR_1'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3774317691978044554)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3850071727736600512)
,p_name=>'P3012_MONTH'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3774317691978044554)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3850072148329600515)
,p_name=>'P3012_YEAR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3774317691978044554)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3850058348745600469)
,p_name=>'REFRESHH_ALL'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3850057883510600466)
,p_event_id=>wwv_flow_imp.id(3850058348745600469)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822409168416523519)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3850057366049600465)
,p_event_id=>wwv_flow_imp.id(3850058348745600469)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822411921116523512)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3850056893236600465)
,p_event_id=>wwv_flow_imp.id(3850058348745600469)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822414552541523511)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3850056367676600464)
,p_event_id=>wwv_flow_imp.id(3850058348745600469)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822417241316523510)
,p_attribute_01=>'N'
);
