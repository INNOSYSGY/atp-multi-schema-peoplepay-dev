...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759290022900314375)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764465821803986850)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725568380660646716)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3764465821803986850)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725568744449646718)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725569237478646718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3711940587508087128)
,p_name=>'P1457_ORG_STRUCTURE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3759290022900314375)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3725569618991646749)
,p_name=>'CONTRACT_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3725568380660646716)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3725570127423646756)
,p_event_id=>wwv_flow_imp.id(3725569618991646749)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_TREE_COLLAPSE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3764465821803986850)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3725570507937646758)
,p_name=>'EXPAND_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3725568744449646718)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3725570999048646758)
,p_event_id=>wwv_flow_imp.id(3725570507937646758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3708924222153313065)
,p_name=>'New'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3708924103467313064)
,p_event_id=>wwv_flow_imp.id(3708924222153313065)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
