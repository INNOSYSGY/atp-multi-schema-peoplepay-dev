...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3884148354156221144)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4764077076346727840)
,p_plug_name=>'Medical History'
,p_parent_plug_id=>wwv_flow_imp.id(3884148354156221144)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5089561255954980633)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4764082281588757659)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3812037300294979684)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(5089561255954980633)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3725767934481045964)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3884148354156221144)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3812036579723979682)
,p_name=>'P10004_START_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5089561255954980633)
,p_prompt=>'Start Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3812036950266979682)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811955848882462195)
,p_name=>'Submit Page'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811955737753462194)
,p_event_id=>wwv_flow_imp.id(3811955848882462195)
,p_event_result=>'TRUE'
