...
,p_group_id=>wwv_flow_imp.id(3607155394042452625)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3129861531476230328)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1560314795782399747)
,p_plug_name=>'Multi Upload'
,p_parent_plug_id=>wwv_flow_imp.id(3129861531476230328)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1560315021590399749)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3130071868570390487)
,p_name=>'Audit'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(532287224549353747)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(532287118113353746)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(527942412907535608)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668727107432741383)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3130071868570390487)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668725134811741381)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1560315021590399749)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668725589403741382)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1560315021590399749)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668724140056741380)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1560314795782399747)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668717835018741373)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3129861531476230328)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668718249838741374)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668718635207741374)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668719059774741374)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(668736050004741391)
...
,p_branch_when_button_id=>wwv_flow_imp.id(668725134811741381)
,p_branch_sequence=>8
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(668735630115741390)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(668736514998741391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668719436352741374)
,p_name=>'P20_MEDIA_HD_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3129861531476230328)
,p_item_source_plug_id=>wwv_flow_imp.id(1560315021590399749)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668719863598741375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668720247517741375)
,p_name=>'P20_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668720639348741375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668721033010741375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668721445052741376)
,p_name=>'P20_STATUS'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668721853519741378)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668722250093741378)
,p_name=>'P20_REMARKS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3129861531476230328)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668722643326741378)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668723101332741379)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668723513559741379)
,p_name=>'P20_SERVER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(3129861531476230328)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668724559567741381)
,p_name=>'P20_FILE_DATA'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(1560314795782399747)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668726018576741382)
,p_name=>'P20_UPLOAD_DOCUMENT'
,p_source_data_type=>'BLOB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1560315021590399749)
,p_item_source_plug_id=>wwv_flow_imp.id(1560315021590399749)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668726364456741382)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(668727865896741383)
,p_name=>'P20_CREATED_BY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3130071868570390487)
,p_item_source_plug_id=>wwv_flow_imp.id(1560315021590399749)
,p_source=>'CREATED_BY'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668731892141741387)
,p_name=>'Execute JavaScript Code'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(668718635207741374)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668732355535741387)
,p_event_id=>wwv_flow_imp.id(668731892141741387)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668732795728741388)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668733241867741388)
,p_event_id=>wwv_flow_imp.id(668732795728741388)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668733786186741388)
,p_event_id=>wwv_flow_imp.id(668732795728741388)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668734199997741388)
,p_name=>'show_comment'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668734687360741389)
,p_event_id=>wwv_flow_imp.id(668734199997741388)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668735189387741389)
,p_event_id=>wwv_flow_imp.id(668734199997741388)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668731449604741387)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(1560315021590399749)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Fetch Row from MEDIA_DETAIL'
,p_internal_uid=>25255527724986882
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668731063350741387)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668730683596741386)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(668727107432741383)
,p_internal_uid=>25254761716986881
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668730314779741386)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(668718249838741374)
,p_process_when=>'P20_TRANSACTION_TYPE_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_internal_uid=>25254392899986881
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668729472720741385)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(668724140056741380)
,p_process_success_message=>'Files uploaded.'
,p_internal_uid=>25253550840986880
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668729832775741386)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(668717835018741373)
