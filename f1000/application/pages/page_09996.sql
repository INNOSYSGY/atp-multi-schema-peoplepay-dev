...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3850003472610335007)
,p_plug_name=>'Items'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3850004009336335012)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3850003472610335007)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3850003636563335008)
,p_name=>'Toggle State'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3850003672844335009)
,p_event_id=>wwv_flow_imp.id(3850003636563335008)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3850004082011335013)
,p_name=>'Checkout'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3850004009336335012)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3850004244720335014)
,p_event_id=>wwv_flow_imp.id(3850004082011335013)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
