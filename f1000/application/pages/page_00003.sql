...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(748269221022250306)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(748269908559250306)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(669018173322840215)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(748269908559250306)
,p_button_name=>'Print'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(669018600108840216)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(669018982650840216)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(669019383335840217)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(352143259096956069)
,p_name=>'P3_ADDRESS_TO_TITLE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(748269221022250306)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(744886150063424623)
,p_name=>'P3_TITLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(748269221022250306)
,p_prompt=>'Title'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748275255195250369)
,p_name=>'P3_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(748269221022250306)
,p_item_source_plug_id=>wwv_flow_imp.id(748269221022250306)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748275642585250374)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748276079520250375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748276372978250375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748276703814250375)
,p_name=>'P3_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(748269221022250306)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748277103087250376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748277560643250376)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(669023929053840232)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(669018600108840216)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(669024514322840233)
,p_event_id=>wwv_flow_imp.id(669023929053840232)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(669024824520840234)
,p_name=>'print_general_letter'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(669018173322840215)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(669025391288840234)
,p_event_id=>wwv_flow_imp.id(669024824520840234)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(669022766842840231)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(748269221022250306)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(669023204281840231)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(669023618561840232)
,p_process_sequence=>10
