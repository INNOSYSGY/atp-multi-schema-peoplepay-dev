...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697196935340973947)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3611263388474869333)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3611263560384869335)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611263658617869336)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611263742086869337)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611263795576869338)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611263899009869339)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611264089729869340)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431012410352291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431170509352292)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431275318352293)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431371977352294)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431430486352295)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431538301352296)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431659802352297)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431763163352298)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431819346352299)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654431990357352300)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654432057308352301)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654432141569352302)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654432218487352303)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654432394336352304)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654432484950352305)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654432588200352306)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3654444336227357023)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3654455349790593103)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3654455523108593105)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654455614521593106)
,p_db_column_name=>'REGNO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654455696930593107)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654455835547593108)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654455911416593109)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456084759593110)
,p_db_column_name=>'SSN'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456104047593111)
,p_db_column_name=>'SURNAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456231732593112)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456358941593113)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456417899593114)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456580146593115)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456694592593116)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456794276593117)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456799869593118)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654456921781593119)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457026893593120)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457103902593121)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457282568593122)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457352065593123)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457416380593124)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457524233593125)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457643218593126)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654457771787593127)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3855565248243437040)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3855578856444870556)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3855578956960870556)
,p_name=>'eNIS Output'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699778296252413340)
,p_db_column_name=>'REGNO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699778723866413342)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699779130314413343)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699779505800413343)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699779957758413343)
,p_db_column_name=>'SSN'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699780278740413343)
,p_db_column_name=>'SURNAME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699780679006413344)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699781139826413344)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699781493997413344)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699781888647413345)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699782341702413345)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699782756342413345)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699783144526413346)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699783561577413346)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699783942102413346)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699784307579413346)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699784684980413347)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699785168491413347)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699785479503413347)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699785911524413348)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699786369693413348)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3855579939953875239)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3611263431998869334)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3611263388474869333)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3654455489455593104)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3654455349790593103)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699772844114413333)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697196935340973947)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699773243303413334)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697196935340973947)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699773595271413334)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697196935340973947)
,p_button_name=>'PURGE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699774029732413334)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697196935340973947)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699774396469413335)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697196935340973947)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699787141663413352)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3855578856444870556)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3699789318147413355)
...
,p_branch_when_button_id=>wwv_flow_imp.id(3699774029732413334)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552350478434187486)
,p_name=>'P1403_W1'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552350649794187487)
,p_name=>'P1403_W2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
,p_prompt=>'Week 2'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552350744546187488)
,p_name=>'P1403_W3'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
,p_prompt=>'Week 3'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552350779699187489)
,p_name=>'P1403_W4'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
,p_prompt=>'Week 4'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552350937616187490)
,p_name=>'P1403_W5'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
,p_prompt=>'Week 5'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699774836505413335)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699775209637413335)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699775616812413335)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699775999808413336)
,p_name=>'P1403_EYEAR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
,p_prompt=>'Year'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699776434844413336)
,p_name=>'P1403_MONTH'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3855565248243437040)
,p_prompt=>'Month'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699776824237413336)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699777201594413336)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699777670062413337)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699788328736413353)
,p_name=>'CS6 Form'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3699787141663413352)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699788800500413354)
,p_event_id=>wwv_flow_imp.id(3699788328736413353)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(552350288495187484)
,p_name=>'Clear'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(552350393987187485)
,p_event_id=>wwv_flow_imp.id(552350288495187484)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Clear'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699787519487413353)
...
,p_process_when_button_id=>wwv_flow_imp.id(3699773243303413334)
,p_process_success_message=>'Successful execution of eNIS.'
,p_internal_uid=>3056311597607658848
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699787974890413353)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3699773595271413334)
