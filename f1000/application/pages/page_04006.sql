...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3687368061932193850)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3832503196174700983)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3691844011604900224)
,p_region_id=>wwv_flow_imp.id(3832503196174700983)
,p_chart_type=>'funnel'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3691843468815900217)
,p_chart_id=>wwv_flow_imp.id(3691844011604900224)
,p_seq=>10
,p_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3832504101462700992)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3691842652942900214)
,p_region_id=>wwv_flow_imp.id(3832504101462700992)
,p_chart_type=>'pie'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3691842179856900213)
,p_chart_id=>wwv_flow_imp.id(3691842652942900214)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3835978011692741722)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3835978163650741722)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691841281455900212)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691840853915900210)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691839720465900209)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691839266970900208)
...
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(3767773103414375725)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691838438655900208)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691838099038900207)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3691838874895900208)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3768641114924328522)
...
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_heading_alignment=>'LEFT'
,p_rpt_named_lov=>wwv_flow_imp.id(3767753571675954378)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3835999309278747613)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3691837269655900206)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3687368061932193850)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3691836887896900206)
