...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3726838735014598239)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3727136231723102312)
,p_plug_name=>'TAB'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3730661077760533680)
,p_plug_name=>'Leave  Roster Gantt Chart'
,p_parent_plug_id=>wwv_flow_imp.id(3727136231723102312)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759974121389930689)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719409922502534741)
,p_plug_name=>'Employee Leave Calendar (select filter options above, Navigate to specific month)'
,p_parent_plug_id=>wwv_flow_imp.id(3759974121389930689)
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719869426346109431)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3831344358570892262)
,p_plug_name=>'Legend'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3727003768897642770)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3726838735014598239)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3727290641609779292)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3719869426346109431)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3726109082759817253)
,p_name=>'P60_LEAVE_STATUS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3719869426346109431)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3726109225620817254)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727291078444779299)
,p_name=>'P60_PERIOD_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3730661077760533680)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727291497036779304)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761359877844708260)
,p_name=>'P60_EMPLOYEE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3719869426346109431)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761360327015708273)
,p_name=>'P60_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3719869426346109431)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761360671345708274)
,p_name=>'P60_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3719869426346109431)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3727135906133102309)
,p_name=>'Submit'
,p_event_sequence=>50
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3727135938899102310)
,p_event_id=>wwv_flow_imp.id(3727135906133102309)
,p_event_result=>'TRUE'
