...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3827366974687936900)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3170548764558697405)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3827366974687936900)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3170548372832697404)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170549136877697409)
,p_name=>'P331_ORGDTL_ID'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3827366974687936900)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170549581745697410)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170549997765697410)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170550397223697410)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170550789642697411)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170551165399697411)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170551581521697412)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170551989922697412)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170552417406697413)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170552819344697413)
,p_name=>'P331_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3827366974687936900)
,p_prompt=>'Remarks'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3170553157321697419)
,p_name=>'SHOW_HIDE'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170553686885697420)
,p_event_id=>wwv_flow_imp.id(3170553157321697419)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3170548372832697404)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170554133904697421)
,p_event_id=>wwv_flow_imp.id(3170553157321697419)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3170554579998697421)
,p_name=>'run_process'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3170548372832697404)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170555588292697422)
,p_event_id=>wwv_flow_imp.id(3170554579998697421)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170555057663697422)
,p_event_id=>wwv_flow_imp.id(3170554579998697421)
,p_event_result=>'TRUE'
