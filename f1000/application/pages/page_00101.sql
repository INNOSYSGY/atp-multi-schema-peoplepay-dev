...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6473365148448022178)
,p_plug_name=>'Body'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7508326462278766099)
,p_plug_name=>'<span class = "title">Enterprise HRMIS  v9.0 </span>'
,p_region_name=>'custom'
,p_parent_plug_id=>wwv_flow_imp.id(6473365148448022178)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4822661251138035793)
,p_plug_name=>'spacer'
,p_parent_plug_id=>wwv_flow_imp.id(7508326462278766099)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6475490250534883670)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643649290213686582)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(7508326462278766099)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643649750155686582)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643650109951686582)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643654668133686578)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(6475490250534883670)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643650540791686581)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052832107511618725)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7508326462278766099)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052832499172618724)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052832967154618723)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052833344050618722)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052833737215618722)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052834154518618721)
,p_name=>'P101_CODE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(7508326462278766099)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052834553839618721)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052835428541618720)
,p_name=>'P101_RESET'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(7508326462278766099)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643655754253686578)
...
,p_when_button_pressed=>wwv_flow_imp.id(643650540791686581)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643656089745686577)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643655328744686578)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643656528459686577)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643659665838686575)
,p_name=>'Reset'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643654668133686578)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643660121363686575)
,p_event_id=>wwv_flow_imp.id(643659665838686575)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643660608105686574)
,p_event_id=>wwv_flow_imp.id(643659665838686575)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643661110994686574)
,p_event_id=>wwv_flow_imp.id(643659665838686575)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643661538977686574)
,p_name=>'Reset_Account'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643649290213686582)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643662021001686574)
,p_event_id=>wwv_flow_imp.id(643661538977686574)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643662509102686573)
,p_event_id=>wwv_flow_imp.id(643661538977686574)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643663051960686573)
,p_event_id=>wwv_flow_imp.id(643661538977686574)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643663555434686573)
,p_event_id=>wwv_flow_imp.id(643661538977686574)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643663970906686573)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643649750155686582)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643664432932686573)
,p_event_id=>wwv_flow_imp.id(643663970906686573)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643664940982686572)
,p_event_id=>wwv_flow_imp.id(643663970906686573)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643665417316686572)
,p_event_id=>wwv_flow_imp.id(643663970906686573)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643665865696686572)
,p_name=>'send mfa code'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643650109951686582)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643666337096686572)
,p_event_id=>wwv_flow_imp.id(643665865696686572)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643666813429686571)
,p_event_id=>wwv_flow_imp.id(643665865696686572)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643667245610686571)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643667690985686571)
,p_event_id=>wwv_flow_imp.id(643667245610686571)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643668228600686571)
,p_event_id=>wwv_flow_imp.id(643667245610686571)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643668604183686571)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643669131193686570)
,p_event_id=>wwv_flow_imp.id(643668604183686571)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(643650109951686582)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643669677610686570)
,p_event_id=>wwv_flow_imp.id(643668604183686571)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643669992772686570)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643670535075686570)
,p_event_id=>wwv_flow_imp.id(643669992772686570)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643670964378686570)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643671415755686569)
,p_event_id=>wwv_flow_imp.id(643670964378686570)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643657993333686576)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643658473683686576)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(643650540791686581)
,p_internal_uid=>115966685660245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643656789177686577)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643659245657686575)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643657202874686576)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(643649750155686582)
,p_internal_uid=>115965414851245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643657625088686576)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643658867715686576)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
