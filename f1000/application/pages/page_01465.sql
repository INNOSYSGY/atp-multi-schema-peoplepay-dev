...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(631377451930855395)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4155802403276437452)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4155802590117437452)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120591667113520023)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120592460656520023)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120592810180520024)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120593236739520024)
,p_db_column_name=>'ID'
,p_display_order=>8
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120593629749520025)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120594025535520025)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120594453865520026)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120594871002520026)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120595228835520027)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120595675948520027)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120596068866520028)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120596404178520028)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120596800741520029)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120597250005520029)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120597593324520030)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120590407347520021)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120590830956520022)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120591253084520022)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120598027755520030)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120598446795520031)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120598858050520031)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120599178655520032)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120599607915520032)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120600416210520033)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1107160768319088123)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1107160782784088124)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4155810510208440301)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4159229250678621467)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(575514249076532473)
,p_report_id=>wwv_flow_imp.id(4159229250678621467)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4159230396164630711)
,p_application_user=>'APXWS_ALTERNATIVE'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(575515217339532466)
,p_report_id=>wwv_flow_imp.id(4159230396164630711)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(575515614195532465)
,p_report_id=>wwv_flow_imp.id(4159230396164630711)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'EMP_ID'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4196910126875254228)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'Summary'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(575516300674532460)
,p_report_id=>wwv_flow_imp.id(4196910126875254228)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4186618535157892522)
,p_plug_name=>'Note'
,p_parent_plug_id=>wwv_flow_imp.id(4155802403276437452)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4159252058462206801)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4159253942641206820)
,p_name=>'EMP_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180361544566220628)
,p_name=>'QUANTITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180361629540220629)
,p_name=>'RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180361719762220630)
,p_name=>'AMOUNT_PAID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180361836056220631)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180361932890220632)
,p_name=>'V_PERIOD_END'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180362003654220633)
,p_name=>'PAY_OPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180362165795220634)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180362471617220637)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4180362513485220638)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(4159252117836206802)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(4159488429560093529)
,p_interactive_grid_id=>wwv_flow_imp.id(4159252117836206802)
,p_static_id=>'389002'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(4159488687818093529)
,p_report_id=>wwv_flow_imp.id(4159488429560093529)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4159498167934093567)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(4159253942641206820)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>277
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185383674447349827)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(4180361544566220628)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185385073525349831)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(4180361629540220629)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185386468140349834)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(4180361719762220630)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185387849787349839)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(4180361836056220631)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185389257986349843)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(4180361932890220632)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185390611630349847)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(4180362003654220633)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185392093716349851)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(4180362165795220634)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185426170040520770)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(4180362471617220637)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4185427531769520773)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(4180362513485220638)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(4120588707951519999)
,p_view_id=>wwv_flow_imp.id(4159488687818093529)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(4180361719762220630)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4159255320536206834)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4159739467704414448)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4116276622286584798)
,p_name=>'LEGACYCODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4116276768623584799)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4127424310170259785)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161570020293153400)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161570105415153401)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161570623370153406)
,p_name=>'INNOCODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161570733268153407)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(4161570811213153408)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(4161569904117153399)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(4161576104288159597)
,p_interactive_grid_id=>wwv_flow_imp.id(4161569904117153399)
,p_static_id=>'409879'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(4161576384598159597)
,p_report_id=>wwv_flow_imp.id(4161576104288159597)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4120695986747541669)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(4116276622286584798)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4120696913511541673)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(4116276768623584799)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4136830274849444384)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(4127424310170259785)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161576804408159599)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(4161570020293153400)
,p_is_visible=>true
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161580771814159612)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(4161570623370153406)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161581644148159615)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(4161570733268153407)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(4161582515406159617)
,p_view_id=>wwv_flow_imp.id(4161576384598159597)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(4161570811213153408)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4552956962223454911)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4552957053415454911)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120622185970520078)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120622670808520079)
,p_db_column_name=>'EMP_ID'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120623027149520079)
,p_db_column_name=>'EMPENT_ID'
,p_display_order=>3
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120623458710520080)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120623820637520081)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120624203149520082)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120624592758520083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120624996915520083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120625413070520084)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120625843925520085)
,p_db_column_name=>'PAY_STATUS'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Pay Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120626268349520086)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120626581600520087)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120627023629520087)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120627464476520088)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120627780339520089)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120628230232520089)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120628617963520090)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120628979820520090)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120629432697520091)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120629860941520092)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120621445747520077)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120621867284520078)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120620677510520076)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(4120621024725520077)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4552959263262455172)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9200150049433173377)
,p_plug_name=>'Errors'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(9200150341272173380)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953255781897240086)
,p_db_column_name=>'EARNINGS_PERIOD_ID'
,p_display_order=>30
,p_column_identifier=>'C'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953256212431240087)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953256542383240088)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953256994194240089)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953257390862240089)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953257822780240089)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953258129680240090)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953258601322240090)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953258980590240091)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953259330346240091)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953259741058240092)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953260131479240092)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2953260565108240093)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(9202314870498904854)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575516782753532458)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4155802403276437452)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575524314145532419)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4159252058462206801)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575548524699532293)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(9200150049433173377)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575517161406532456)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575525505307532413)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(4159252058462206801)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575548994513532292)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(9200150049433173377)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575524699808532416)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575525097581532415)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575541120047532335)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(4552956962223454911)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575541561489532334)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575503827840532526)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(631377451930855395)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575504206340532524)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(631377451930855395)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575504607509532523)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(631377451930855395)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(575505078221532522)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(631377451930855395)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(575573969456532186)
...
,p_branch_when_button_id=>wwv_flow_imp.id(575504607509532523)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(575574336517532184)
...
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(575504206340532524)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1108084495153895650)
,p_name=>'P1465_WORK_UNIT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4159255320536206834)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120645721754519959)
,p_name=>'P1465_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4155802403276437452)
,p_prompt=>'Start Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120646091096519961)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120646552311519961)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120679714169519931)
,p_name=>'P1465_START_DATE_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4159252058462206801)
,p_prompt=>'Start Date'
,p_display_as=>'NATIVE_DATE_PICKER_APEX'
,p_cSize=>12
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120680162638519931)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120680511394519932)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120680915329519933)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120745572352519849)
,p_name=>'P1465_EARNINGSPERIOD_PAY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4552956962223454911)
,p_prompt=>'Earnings Period'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120746057615519850)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120746865826519851)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4120747313070519851)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575551856341532277)
,p_name=>'dy_process_pay_data'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575516782753532458)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575552363963532275)
,p_event_id=>wwv_flow_imp.id(575551856341532277)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575552855862532273)
,p_event_id=>wwv_flow_imp.id(575551856341532277)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(4155802403276437452)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575553320325532271)
,p_event_id=>wwv_flow_imp.id(575551856341532277)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575553702870532270)
,p_name=>'dy_refresh'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575554293986532267)
,p_event_id=>wwv_flow_imp.id(575553702870532270)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575554692153532266)
,p_name=>'dy_refresh1'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575555109821532264)
,p_event_id=>wwv_flow_imp.id(575554692153532266)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575555509367532263)
,p_name=>'delete_data'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575517161406532456)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575556022845532260)
,p_event_id=>wwv_flow_imp.id(575555509367532263)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575556582861532258)
,p_event_id=>wwv_flow_imp.id(575555509367532263)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575557017006532256)
,p_event_id=>wwv_flow_imp.id(575555509367532263)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575557315350532255)
,p_name=>'reresh3'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575557809053532252)
,p_event_id=>wwv_flow_imp.id(575557315350532255)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575558197092532251)
,p_name=>'refresh1'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575558713431532249)
,p_event_id=>wwv_flow_imp.id(575558197092532251)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4159252058462206801)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575559123600532248)
,p_name=>'refresh2'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575559627591532246)
,p_event_id=>wwv_flow_imp.id(575559123600532248)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575560063276532245)
,p_name=>'refresh3'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575560588904532244)
,p_event_id=>wwv_flow_imp.id(575560063276532245)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575560969946532242)
,p_name=>'refresh4'
,p_event_sequence=>90
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575561408869532240)
,p_event_id=>wwv_flow_imp.id(575560969946532242)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575561857185532239)
,p_name=>'RESET_PROCESS'
,p_event_sequence=>100
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575524314145532419)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575562313002532237)
,p_event_id=>wwv_flow_imp.id(575561857185532239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575562810821532235)
,p_event_id=>wwv_flow_imp.id(575561857185532239)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575563254227532234)
,p_name=>'GEN_ENTITLE'
,p_event_sequence=>110
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575525505307532413)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575563744609532232)
,p_event_id=>wwv_flow_imp.id(575563254227532234)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575564211436532230)
,p_event_id=>wwv_flow_imp.id(575563254227532234)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575564605100532229)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575565171001532227)
,p_event_id=>wwv_flow_imp.id(575564605100532229)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575565561438532226)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575566092325532223)
,p_event_id=>wwv_flow_imp.id(575565561438532226)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575566412583532222)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575566945279532220)
,p_event_id=>wwv_flow_imp.id(575566412583532222)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575567354749532219)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575567835776532216)
,p_event_id=>wwv_flow_imp.id(575567354749532219)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4552956962223454911)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575568262985532214)
,p_name=>'refresh_sum'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575568701791532212)
,p_event_id=>wwv_flow_imp.id(575568262985532214)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575569159110532210)
,p_name=>'import_Dept_Data'
,p_event_sequence=>180
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575541120047532335)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575569612390532207)
,p_event_id=>wwv_flow_imp.id(575569159110532210)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575570171906532204)
,p_event_id=>wwv_flow_imp.id(575569159110532210)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575570623923532201)
,p_event_id=>wwv_flow_imp.id(575569159110532210)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575571095302532200)
,p_name=>'delete_import'
,p_event_sequence=>190
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(575541561489532334)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575571568130532197)
,p_event_id=>wwv_flow_imp.id(575571095302532200)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575572091960532195)
,p_event_id=>wwv_flow_imp.id(575571095302532200)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575572508063532193)
,p_event_id=>wwv_flow_imp.id(575571095302532200)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(575572943112532191)
,p_name=>'SET_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(575573439827532189)
,p_event_id=>wwv_flow_imp.id(575572943112532191)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(575551093581532282)
...
,p_process_when_button_id=>wwv_flow_imp.id(575517161406532456)
,p_process_success_message=>'System succcessfully deleted the data.'
,p_internal_uid=>164971896789149717
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(575532767316532380)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(4159739467704414448)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(575551411932532280)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(575524699808532416)
