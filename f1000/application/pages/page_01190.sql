...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785838012755395280)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3785837821054395275)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875826200577737879)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875825820189737878)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875825372009737874)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875825048762737873)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875824663169737873)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875824221422737872)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875823767806737872)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875823430035737871)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875822965498737871)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875822634404737869)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875822203703737869)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875821826575737869)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875821422451737869)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875820978334737867)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875820572293737867)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3875820253123737866)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3785835821295392158)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3853339112962955462)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3853338764569955459)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338742445955458)
,p_db_column_name=>'FORWORD_LIST_ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Forword List Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338630517955457)
,p_db_column_name=>'USER_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Sender'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338521654955456)
,p_db_column_name=>'FORWARD_TO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Forward To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338409829955455)
,p_db_column_name=>'FORWARD_MODE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Forward Mode'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338332650955454)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Created By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338185080955453)
,p_db_column_name=>'EFFECTIVE_FROM'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Effective From'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338093681955452)
,p_db_column_name=>'EFFECTIVE_TO'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Effective To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853338046799955451)
,p_db_column_name=>'CREATION_DATE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Creation Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853337871950955450)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Last Updated By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853337796109955449)
,p_db_column_name=>'LAST_UPDATE_DATE'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'Last Update Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3853337702734955448)
,p_db_column_name=>'IS_DEFAULT'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'Is Default'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851778313557728597)
,p_db_column_name=>'STAGE_NAME'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'Work Flow Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851778171982728596)
,p_db_column_name=>'REMARKS'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'Remarks'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851778101292728595)
,p_db_column_name=>'AUTO_CLOSE_ON_COMPLETE'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'Auto Close'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851777976396728594)
,p_db_column_name=>'STAGE_ID'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'Stage Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3851777931346728593)
,p_db_column_name=>'WFL_STATUS_ID'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'Transaction Status'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3851767525114722908)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686571441176093138)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3785838012755395280)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686577753896093155)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3853339112962955462)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686571860068093139)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(686578149388093155)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3853339112962955462)
