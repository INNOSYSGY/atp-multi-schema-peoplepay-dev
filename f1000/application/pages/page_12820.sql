...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(686765912334614012)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6382467022882399854)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3354344618922670081)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(686765912334614012)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3354346726124670089)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3354347164663670089)
,p_event_id=>wwv_flow_imp.id(3354346726124670089)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(6382467022882399854)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3354345828154670085)
,p_name=>'refresh_end'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3354346262231670088)
,p_event_id=>wwv_flow_imp.id(3354345828154670085)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
