...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825391625542208269)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(352142770919956064)
,p_plug_name=>'Help Widget'
,p_region_name=>'HELP_WIDGET_REGION'
,p_parent_plug_id=>wwv_flow_imp.id(3825391625542208269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(352143062461956067)
,p_name=>'P0_CURRENT_PAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3825391625542208269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3808567844792899084)
,p_name=>'P0_HOMEPAGE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3825391625542208269)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819940593043020697)
,p_name=>'P0_IMG_SRC'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3825391625542208269)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825391556773208268)
,p_name=>'P0_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3825391625542208269)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3828280311451508098)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3828280203212508097)
,p_event_id=>wwv_flow_imp.id(3828280311451508098)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3819940422300020696)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3819940323913020695)
,p_event_id=>wwv_flow_imp.id(3819940422300020696)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3819940239036020694)
,p_event_id=>wwv_flow_imp.id(3819940422300020696)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3819936103757020653)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3819936087061020652)
,p_event_id=>wwv_flow_imp.id(3819936103757020653)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3808567748158899083)
,p_name=>'Set HomePage'
,p_event_sequence=>40
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3808567420216899080)
,p_event_id=>wwv_flow_imp.id(3808567748158899083)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3808567639134899082)
,p_event_id=>wwv_flow_imp.id(3808567748158899083)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3702658087301203056)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3702658162384203057)
,p_event_id=>wwv_flow_imp.id(3702658087301203056)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(352142872911956065)
,p_name=>'page_help'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(352142942087956066)
,p_event_id=>wwv_flow_imp.id(352142872911956065)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
