...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697655967197464708)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785394015405894083)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3785394463612898040)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3833230080558153849)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3785394015405894083)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3833231498572153854)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3785394463612898040)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709027083955064424)
,p_name=>'P1025_REPORT_TO_DEST'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3785394015405894083)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3833229224323153847)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3833229687319153849)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3833230710178153850)
,p_name=>'P1025_CURRENT_MANAGER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3785394463612898040)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3833231188614153852)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3833228455116153845)
,p_name=>'set_visible'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3833227900363153841)
,p_event_id=>wwv_flow_imp.id(3833228455116153845)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3833230080558153849)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3833227478020153840)
,p_event_id=>wwv_flow_imp.id(3833228455116153845)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3833228814265153846)
...
,p_process_when_button_id=>wwv_flow_imp.id(3833230080558153849)
