...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(789186310638559702)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1583652415126211401)
,p_plug_name=>'OrganisationChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(789186310638559702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663039218289541423)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(789186310638559702)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663039526776541423)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663040329674541424)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663040766342541426)
,p_name=>'P1456_ORG_STRUCTURE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(789186310638559702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663041188075541426)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663041578456541427)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663042235681541428)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663042779777541428)
,p_event_id=>wwv_flow_imp.id(663042235681541428)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1583652415126211401)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663043263487541429)
,p_event_id=>wwv_flow_imp.id(663042235681541428)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663043653941541429)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663040329674541424)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663044138976541430)
,p_event_id=>wwv_flow_imp.id(663043653941541429)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
