...
wwv_flow_imp_page.create_page(
 p_id=>3500
,p_name=>'frmGLMAINPAGE'
,p_step_title=>'PeoplePay General Ledger'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_imp.id(3825577533521148601)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3621923564522522399)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3698875284234994873)
,p_plug_name=>'PeoplePay General Ledger'
...
,p_plug_source=>'Complete Paperless Office Processes for General Ledger'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3857812265504703624)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3825720751155352177)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3825720338620352172)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3857819573750876376)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3857819688093876376)
...
,p_owner=>'PUR_INV'
,p_internal_uid=>515639673447921732
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825726154261352214)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825725776458352207)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825725367774352206)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825724908142352206)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825724547694352205)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825724120134352205)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825723788906352205)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825723364005352205)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825722978979352204)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3857820784831879562)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'488005'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3871496080373927443)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3825670263892213735)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825721425925352191)
,p_name=>'P3500_MAX_TIP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3871496080373927443)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
'from HR_APU_TIPS',
'WHERE MAIN_MODULES=''Project Management'''))
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825721865593352192)
,p_name=>'P3500_MIN_TIP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3871496080373927443)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select min(id)',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825727047492352251)
,p_name=>'P3500_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3621923564522522399)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3825719126075352121)
,p_name=>'set_tip'
,p_event_sequence=>20
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3825718679061352121)
,p_event_id=>wwv_flow_imp.id(3825719126075352121)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P3500_TIPS'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select messages',
'from HR_APU_TIPS',
'where id=floor(dbms_random.value(to_number(:P3500_MIN_TIP),to_number(:P3500_MAX_TIP)))',
'and rownum=1',
'AND MAIN_MODULES=''Project Management'''))
,p_attribute_07=>'P3500_MIN_TIP,P3500_MAX_TIP'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
