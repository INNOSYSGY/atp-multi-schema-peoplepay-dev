...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3756662554211159513)
,p_plug_name=>'Legend'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3756939206086487442)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3757397150111059500)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3811908268186679633)
,p_name=>'P10006_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3757397150111059500)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3811908639090679633)
,p_name=>'P10006_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3757397150111059500)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3811909487067679634)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3811907280689679630)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3811906783015679630)
,p_event_id=>wwv_flow_imp.id(3811907280689679630)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3756939206086487442)
,p_attribute_01=>'N'
);
