...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3889282107166403577)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3889282213080403578)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3806634570216632527)
,p_region_id=>wwv_flow_imp.id(3889282213080403578)
,p_chart_type=>'bubble'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3806632949080632523)
,p_chart_id=>wwv_flow_imp.id(3806634570216632527)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3806634186229632524)
,p_chart_id=>wwv_flow_imp.id(3806634570216632527)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3806633556112632524)
,p_chart_id=>wwv_flow_imp.id(3806634570216632527)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5647500400090272881)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3806630757766632508)
,p_name=>'P10008_FILTER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5647500400090272881)
,p_item_default=>'5000'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3807818150850793458)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3806629022871632496)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3807818077409793457)
,p_event_id=>wwv_flow_imp.id(3806629022871632496)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3889282213080403578)
,p_attribute_01=>'N'
);
