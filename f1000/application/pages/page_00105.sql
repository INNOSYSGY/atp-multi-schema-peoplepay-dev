...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759975238851189142)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3765151037754861617)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697991745816528281)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3759975238851189142)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697991428043528280)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697991022457528280)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3697992514369528285)
,p_name=>'P105_NEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3765151037754861617)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3697989660763528272)
,p_name=>'EXPAND_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3697991428043528280)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3697989147201528272)
,p_event_id=>wwv_flow_imp.id(3697989660763528272)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_TREE_EXPAND'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3759975238851189142)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3697990607796528273)
,p_name=>'CONTRACT_ALL'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3697991745816528281)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3697990116195528272)
,p_event_id=>wwv_flow_imp.id(3697990607796528273)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
