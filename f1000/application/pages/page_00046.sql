...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3859258042568603007)
,p_plug_name=>'Test'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3859258078060603008)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3859258042568603007)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3859258243815603009)
...
,p_process_when_button_id=>wwv_flow_imp.id(3859258078060603008)
