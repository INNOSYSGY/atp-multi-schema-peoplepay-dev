...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(682865896283535338)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3773393040009878259)
,p_plug_name=>'Filter Bar'
,p_parent_plug_id=>wwv_flow_imp.id(682865896283535338)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3772933536166303569)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3784183766161300468)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(697000273175523335)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3773393040009878259)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3779633971491586087)
,p_name=>'P10005_ORG_STRUCTURE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3773393040009878259)
,p_prompt=>'Department'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3780813979099546098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3814885072886477106)
,p_name=>'P10005_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3773393040009878259)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3814885417216477107)
,p_name=>'P10005_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3773393040009878259)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682865973754535339)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682866069047535340)
,p_event_id=>wwv_flow_imp.id(682865973754535339)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(3784183766161300468)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682866186689535341)
,p_event_id=>wwv_flow_imp.id(682865973754535339)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3772933536166303569)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682866298431535342)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682866407192535343)
,p_event_id=>wwv_flow_imp.id(682866298431535342)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682866484447535344)
,p_event_id=>wwv_flow_imp.id(682866298431535342)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
