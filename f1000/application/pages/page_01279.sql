...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3820013482778125399)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3820035286390632049)
...
,p_list_id=>wwv_flow_imp.id(3819997672486844316)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(3830882477609204161)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3820013126613125396)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3820013482778125399)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810397558551931297)
,p_name=>'P1279_SEARCH'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3820013482778125399)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819964712149396398)
,p_name=>'P1279_RANGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3820013482778125399)
,p_item_default=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3824518075331620550)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3824518097805620551)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3826126333870502683)
,p_name=>'P1279_COUNT'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3820013482778125399)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3826126266856502682)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3826126171313502681)
,p_event_id=>wwv_flow_imp.id(3826126266856502682)
,p_event_result=>'TRUE'
