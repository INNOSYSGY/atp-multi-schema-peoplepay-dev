...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2386810599397231893)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2382505281866690878)
,p_plug_name=>'PositionChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(2386810599397231893)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663023781646473242)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2386810599397231893)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663024126461473243)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663024554293473243)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663024990271473247)
,p_name=>'P95_POSITION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2386810599397231893)
,p_prompt=>'Position'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663025396657473248)
,p_name=>'P95_FILTER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2386810599397231893)
,p_item_default=>'2'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663026034694473254)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663026613803473256)
,p_event_id=>wwv_flow_imp.id(663026034694473254)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2382505281866690878)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663027107345473256)
,p_event_id=>wwv_flow_imp.id(663026034694473254)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663027441305473256)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663024554293473243)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663027959183473257)
,p_event_id=>wwv_flow_imp.id(663027441305473256)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
