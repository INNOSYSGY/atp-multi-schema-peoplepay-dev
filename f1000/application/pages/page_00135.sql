...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709907469578470372)
,p_plug_name=>'Tabs'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709907552468470373)
,p_plug_name=>'RDS'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709907752503470375)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709907986018470378)
,p_plug_name=>'Results Double Time'
,p_parent_plug_id=>wwv_flow_imp.id(3709907752503470375)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3709907781664470376)
,p_name=>'Absent Time'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727355711664030349)
,p_query_column_id=>1
,p_column_alias=>'NULL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709908115736470379)
,p_plug_name=>'Results Absent Time'
,p_parent_plug_id=>wwv_flow_imp.id(3709907781664470376)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3709907892835470377)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727356797797030351)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727357146753030351)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727357524107030352)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727357931377030353)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727358345215030354)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727358751508030354)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727359120501030355)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727359584167030355)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3727359915762030356)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709908189409470380)
,p_plug_name=>'Results Overtime'
,p_parent_plug_id=>wwv_flow_imp.id(3709907892835470377)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709909369159470391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727360992508030357)
,p_name=>'P135_SEARH_OPTION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3709909369159470391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727361344767030358)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727361805998030358)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727362196487030358)
