...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669105053890360384)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669106064270360387)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3669105053890360384)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669106652506360388)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3669105053890360384)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669107062591360388)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669107474517360389)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3669107062591360388)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654356623619591669)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3669105053890360384)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654360494880591682)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3669106064270360387)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654357487662591670)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654357043586591669)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3669105053890360384)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654357851568591670)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3669105053890360384)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(654376303774234925)
,p_name=>'P406_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3669105053890360384)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(654376606345238924)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705466876377753701)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705467289240753702)
,p_name=>'P406_URL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3669105053890360384)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705467680206753702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705468044223753702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705471788854753715)
,p_name=>'P406_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3669106064270360387)
,p_prompt=>'Select format'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'P_EXPORT_TYPE'
,p_lov=>'.'||wwv_flow_imp.id(3854136531015093611)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705473557267753717)
,p_name=>'P406_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3669107062591360388)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654364736573591700)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(654357043586591669)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654365272664591700)
,p_event_id=>wwv_flow_imp.id(654364736573591700)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654365748896591700)
,p_event_id=>wwv_flow_imp.id(654364736573591700)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654362485376591696)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654362967733591698)
,p_event_id=>wwv_flow_imp.id(654362485376591696)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654363491811591699)
,p_event_id=>wwv_flow_imp.id(654362485376591696)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654363838593591699)
,p_name=>'New_preview_report_1'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3750770181806711341)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654364355914591699)
,p_event_id=>wwv_flow_imp.id(654363838593591699)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654366191948591700)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(654360494880591682)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654367125716591701)
,p_event_id=>wwv_flow_imp.id(654366191948591700)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654366719034591701)
,p_event_id=>wwv_flow_imp.id(654366191948591700)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654367615896591701)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654368025573591702)
,p_event_id=>wwv_flow_imp.id(654367615896591701)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654368604818591702)
,p_event_id=>wwv_flow_imp.id(654367615896591701)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(669227645211059618)
,p_name=>'New'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(669227813769059619)
,p_event_id=>wwv_flow_imp.id(669227645211059618)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
