...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8462905970292126270)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8462906975456126280)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(671166255319886674)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8462906975456126280)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(671165578595886674)
,p_name=>'P9961_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8462905970292126270)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(697310390615203887)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(697310807357203887)
,p_event_id=>wwv_flow_imp.id(697310390615203887)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(697311254773203888)
,p_event_id=>wwv_flow_imp.id(697310390615203887)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(671166652759886675)
...
,p_process_when_button_id=>wwv_flow_imp.id(671166255319886674)
