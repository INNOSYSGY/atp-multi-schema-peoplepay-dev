...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3713183042060368828)
,p_name=>'Holiday'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3713183032376368827)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3708021554091328276)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3708021506759328275)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3708021397110328274)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3719608905940510970)
,p_name=>'Alert'
,p_template=>4501440665235496320
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719608975655510971)
,p_query_column_id=>1
,p_column_alias=>'ALERT_TITLE'
,p_column_display_sequence=>1
,p_column_heading=>'Alert Title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719609129256510972)
,p_query_column_id=>2
,p_column_alias=>'ALERT_DESC'
,p_column_display_sequence=>2
,p_column_heading=>'Alert Desc'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719071004492797754)
,p_query_column_id=>3
,p_column_alias=>'ALERT_ACTION'
,p_column_display_sequence=>4
,p_column_heading=>'Alert Action'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719892336581230427)
,p_query_column_id=>4
,p_column_alias=>'ALERT_TYPE'
,p_column_display_sequence=>3
,p_column_heading=>'Alert Type'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3762764285986258835)
,p_name=>'Tips'
,p_template=>4501440665235496320
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660487918714367740)
,p_query_column_id=>1
,p_column_alias=>'ALERT_DESC'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660488017426367741)
,p_query_column_id=>2
,p_column_alias=>'ALERT_ACTION'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660488118534367742)
,p_query_column_id=>3
,p_column_alias=>'ALERT_TYPE'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660488159109367743)
,p_query_column_id=>4
,p_column_alias=>'ALERT_TITLE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764848274269899260)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3806264738371465139)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3846760975503256324)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3839706979572552433)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3839666531647434554)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(3839706979572552433)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(624233103983581306)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3819209557887075699)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3839666531647434554)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3804717301449260675)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854798335057822982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(624233000776581305)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3831988784206696551)
,p_name=>'P1_IMG_SRC'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3839706979572552433)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3854680519781392217)
,p_name=>'P1_MAX_TIP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3806264738371465139)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
'from HR_APU_TIPS'))
,p_source_type=>'QUERY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3854680939713392218)
,p_name=>'P1_MIN_TIP'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3806264738371465139)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3721512989359906621)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3721512914454906620)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(671999877801465929)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(671999927915465930)
,p_event_id=>wwv_flow_imp.id(671999877801465929)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(624233250262581307)
...
,p_process_when_button_id=>wwv_flow_imp.id(624233103983581306)
