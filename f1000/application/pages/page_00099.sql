...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3713455767398250168)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3713455863084250169)
,p_plug_name=>'NOTIFICATION'
,p_parent_plug_id=>wwv_flow_imp.id(3713455767398250168)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3780678024499267941)
,p_name=>'frmNotifier'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717672400652669495)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(575409615845266437)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717673192550669497)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717673541108669497)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(575409742077266438)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717674401244669498)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717674796236669498)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3717675167293669498)
,p_query_column_id=>8
