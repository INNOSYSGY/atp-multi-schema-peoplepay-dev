...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4890125901855256035)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3812127441576346157)
,p_region_id=>wwv_flow_imp.id(4890125901855256035)
,p_chart_type=>'pie'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3812126906623346157)
,p_chart_id=>wwv_flow_imp.id(3812127441576346157)
,p_seq=>10
,p_name=>'Tasks'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4890126446202256040)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3812125995310346157)
,p_region_id=>wwv_flow_imp.id(4890126446202256040)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3812124343940346156)
,p_chart_id=>wwv_flow_imp.id(3812125995310346157)
,p_seq=>10
,p_name=>'Tasks'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3812124985399346156)
,p_chart_id=>wwv_flow_imp.id(3812125995310346157)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3812125541932346157)
,p_chart_id=>wwv_flow_imp.id(3812125995310346157)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4890126962030256045)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3812123468530346156)
,p_region_id=>wwv_flow_imp.id(4890126962030256045)
,p_chart_type=>'donut'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3812122910999346155)
,p_chart_id=>wwv_flow_imp.id(3812123468530346156)
,p_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5186399460525865871)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3812128839862346158)
,p_region_id=>wwv_flow_imp.id(5186399460525865871)
,p_chart_type=>'funnel'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3812128305099346158)
,p_chart_id=>wwv_flow_imp.id(3812128839862346158)
,p_seq=>10
,p_name=>'Tasks'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3812122010454346154)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3812121540707346154)
,p_event_id=>wwv_flow_imp.id(3812122010454346154)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4890126962030256045)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3812121131480346154)
,p_name=>'Increase'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3831161915287936513)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3812120602760346154)
,p_event_id=>wwv_flow_imp.id(3812121131480346154)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4890125901855256035)
,p_attribute_01=>'$("#pie1_jet").ojChart({legend:{size:''50%''}});'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3812120273681346153)
,p_name=>'Decrease'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3966713675505853142)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3812119790558346153)
,p_event_id=>wwv_flow_imp.id(3812120273681346153)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
