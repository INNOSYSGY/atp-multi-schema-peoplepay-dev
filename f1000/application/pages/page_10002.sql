...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4952536274459864940)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3812108978889136592)
,p_region_id=>wwv_flow_imp.id(4952536274459864940)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3812108430835136592)
,p_chart_id=>wwv_flow_imp.id(3812108978889136592)
,p_seq=>10
,p_name=>'Position'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3819274876200225372)
,p_chart_id=>wwv_flow_imp.id(3812108978889136592)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3819274906406225373)
,p_chart_id=>wwv_flow_imp.id(3812108978889136592)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5248809833130474776)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3812110318559136593)
,p_region_id=>wwv_flow_imp.id(5248809833130474776)
,p_chart_type=>'funnel'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3812109871645136593)
,p_chart_id=>wwv_flow_imp.id(3812110318559136593)
,p_seq=>10
,p_name=>'Tasks'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3812102559247136590)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3812105289234136591)
,p_name=>'Increase'
,p_event_sequence=>40
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3812104719331136590)
,p_event_id=>wwv_flow_imp.id(3812105289234136591)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4952536274459864940)
,p_attribute_01=>'$("#pie1_jet").ojChart({legend:{size:''50%''}});'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3812104350331136590)
,p_name=>'Decrease'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3812103806835136590)
,p_event_id=>wwv_flow_imp.id(3812104350331136590)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
