...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4312213604049080850)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3871894226102418637)
,p_plug_name=>'Transfer'
,p_parent_plug_id=>wwv_flow_imp.id(4312213604049080850)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811863966071289290)
,p_region_id=>wwv_flow_imp.id(3871894226102418637)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811862230905289290)
,p_chart_id=>wwv_flow_imp.id(3811863966071289290)
,p_seq=>10
,p_name=>'Transfer'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811862866458289290)
,p_chart_id=>wwv_flow_imp.id(3811863966071289290)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811863415541289290)
,p_chart_id=>wwv_flow_imp.id(3811863966071289290)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4312213754076080851)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811871717581289293)
,p_region_id=>wwv_flow_imp.id(4312213754076080851)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811870010585289293)
,p_chart_id=>wwv_flow_imp.id(3811871717581289293)
,p_seq=>10
,p_name=>'Promotion'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811871254757289293)
,p_chart_id=>wwv_flow_imp.id(3811871717581289293)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811870633922289293)
,p_chart_id=>wwv_flow_imp.id(3811871717581289293)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4350109732019963906)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811869167418289292)
,p_region_id=>wwv_flow_imp.id(4350109732019963906)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811867487611289292)
,p_chart_id=>wwv_flow_imp.id(3811869167418289292)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811868630526289292)
,p_chart_id=>wwv_flow_imp.id(3811869167418289292)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811867996054289292)
,p_chart_id=>wwv_flow_imp.id(3811869167418289292)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4350110277905963911)
,p_plug_name=>'Acting'
,p_parent_plug_id=>wwv_flow_imp.id(4312213604049080850)
,p_region_template_options=>'#DEFAULT#:i-h320:t-Region--noBorder:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811866570858289291)
,p_region_id=>wwv_flow_imp.id(4350110277905963911)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811864865057289291)
,p_chart_id=>wwv_flow_imp.id(3811866570858289291)
,p_seq=>10
,p_name=>'Acting'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811866060102289291)
,p_chart_id=>wwv_flow_imp.id(3811866570858289291)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811865465263289291)
,p_chart_id=>wwv_flow_imp.id(3811866570858289291)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819273900490225363)
,p_name=>'P10007_END_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4312213604049080850)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819274094735225364)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682864774986535327)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682864886786535328)
,p_event_id=>wwv_flow_imp.id(682864774986535327)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(4350110277905963911)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682864935085535329)
,p_event_id=>wwv_flow_imp.id(682864774986535327)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3871894226102418637)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682865072574535330)
,p_event_id=>wwv_flow_imp.id(682864774986535327)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4312213754076080851)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682865191868535331)
,p_event_id=>wwv_flow_imp.id(682864774986535327)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4350109732019963906)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682865319194535332)
,p_name=>'refresh_end'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682865327999535333)
,p_event_id=>wwv_flow_imp.id(682865319194535332)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'refresh_transfer'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682865587039535335)
,p_event_id=>wwv_flow_imp.id(682865319194535332)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682865638052535336)
,p_event_id=>wwv_flow_imp.id(682865319194535332)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682865757048535337)
,p_event_id=>wwv_flow_imp.id(682865319194535332)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
