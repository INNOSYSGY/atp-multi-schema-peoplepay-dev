...
wwv_flow_imp_page.create_page(
 p_id=>3700
,p_name=>'frmAccReceivMAINPAGE'
,p_step_title=>'PeoplePay Accounts Receivables'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_imp.id(3854654034649911467)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3643714728633991092)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3649940100553181526)
,p_plug_name=>'PeoplePay Accounts Receivables Management'
...
,p_plug_source=>'Complete Paperless Office Processes for Receivables Management'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3906747449186516971)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3825645687414132256)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3825645289286132256)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3906754757432689723)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3906754871775689723)
...
,p_owner=>'PUR_INV'
,p_internal_uid=>564574857129735079
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825651075590132268)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825650692608132268)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825650275870132267)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825649817751132267)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825649429379132266)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825649061919132262)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825648644801132262)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825648271129132261)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825647856543132261)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3906755968513692909)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'488756'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3920431264055740790)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3825624995609000906)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825646306559132258)
,p_name=>'P3700_MAX_TIP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3920431264055740790)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
'from HR_APU_TIPS',
'WHERE MAIN_MODULES=''Project Management'''))
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825646778002132259)
,p_name=>'P3700_MIN_TIP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3920431264055740790)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select min(id)',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825652089626132274)
,p_name=>'P3700_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3643714728633991092)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3825643916096132253)
,p_name=>'set_tip'
,p_event_sequence=>20
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3825643404230132253)
,p_event_id=>wwv_flow_imp.id(3825643916096132253)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P3700_TIPS'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select messages',
'from HR_APU_TIPS',
'where id=floor(dbms_random.value(to_number(:P3700_MIN_TIP),to_number(:P3700_MAX_TIP)))',
'and rownum=1',
'AND MAIN_MODULES=''Project Management'''))
,p_attribute_07=>'P3700_MIN_TIP,P3700_MAX_TIP'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
