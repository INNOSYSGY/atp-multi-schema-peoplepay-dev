...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669681705832787572)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3669681627472787539)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717680448453675852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717681282520675852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717681653510675853)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717682061308675854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717680924155675852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717682524856675854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717682904367675854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717683262459675854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717680077052675849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717683649074675855)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3705718963815140544)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3669680502023786436)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841765957958625196)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
,p_name=>'Anniversary '
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841766378054625197)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
,p_name=>'Birthday '
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841766761407625198)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
,p_name=>'Confirmation'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841767183113625199)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
,p_name=>'Gratuity'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841767587085625200)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841767984355625201)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841768375118625201)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841768778584625202)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
,p_name=>'Retirement'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841769199334625204)
,p_report_id=>wwv_flow_imp.id(3669680502023786436)
,p_name=>'work permit'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3702470605624256965)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3702471076193256974)
,p_report_id=>wwv_flow_imp.id(3702470605624256965)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3745080719187365625)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3745080814873365626)
,p_plug_name=>'NOTIFICATION'
,p_parent_plug_id=>wwv_flow_imp.id(3745080719187365625)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3705270245187045662)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3705269353348045660)
,p_event_id=>wwv_flow_imp.id(3705270245187045662)
,p_event_result=>'TRUE'
