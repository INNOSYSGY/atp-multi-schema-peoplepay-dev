...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(10766773638420877516)
,p_name=>'Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(193089374578689094)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Departmental Incomes'
,p_link=>'f?p=&APP_ID.:1400:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1400
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(200748905326394604)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
,p_short_name=>'Manage Address'
,p_link=>'f?p=&APP_ID.:1270:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1270
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(200784477446443789)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(200819284597480379)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(306336613098850617)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(308009091868955159)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(308628112228388579)
,p_short_name=>'frmfileoutput'
,p_link=>'f?p=&APP_ID.:219:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>219
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(334872899873856903)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
,p_short_name=>'Attribute Setup'
,p_link=>'f?p=&APP_ID.:3150:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>3150
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(337619761321689594)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(337820771526724907)
,p_parent_id=>wwv_flow_imp.id(337619761321689594)
,p_short_name=>'Manage Debug Payroll'
,p_link=>'f?p=&APP_ID.:1256:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1256
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(344436650184714306)
,p_parent_id=>wwv_flow_imp.id(387517465896713319)
,p_short_name=>'Manage Employee Holiday'
,p_link=>'f?p=&APP_ID.:1322:&SESSION.::&DEBUG.:::'
,p_page_id=>1322
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(353078455618871897)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(357390252974845270)
,p_short_name=>'Create/Edit Tax Rate'
,p_link=>'f?p=&APP_ID.:1314:&SESSION.::&DEBUG.:::'
,p_page_id=>1314
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(365573789455803596)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(365613774889541492)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(365613967275536934)
,p_parent_id=>wwv_flow_imp.id(365613774889541492)
,p_short_name=>'Setup Reports'
,p_link=>'f?p=&APP_ID.:401:&SESSION.::&DEBUG.:::'
,p_page_id=>401
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(369304010206450817)
,p_parent_id=>wwv_flow_imp.id(3504493647290211945)
,p_short_name=>'Create&#x2F;Edit New Employment'
,p_link=>'f?p=&APP_ID.:109:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>109
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(387517465896713319)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(392133150641574024)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Allowance Uploader'
,p_page_id=>1465
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(392629693384685217)
,p_parent_id=>wwv_flow_imp.id(3159850434165410517)
,p_short_name=>'Create&#x2F;Edit Remuneration'
,p_link=>'f?p=&APP_ID.:13001:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>13001
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(392727444126750516)
,p_parent_id=>wwv_flow_imp.id(3266872594370696348)
,p_short_name=>'Other Remuneration'
,p_link=>'f?p=&APP_ID.:1285:&SESSION.::&DEBUG.:::'
,p_page_id=>1285
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(422289110059420261)
,p_parent_id=>wwv_flow_imp.id(3504643035017505270)
,p_short_name=>'Manage Grade/Salary Scales'
,p_link=>'f?p=&APP_ID.:1309:&SESSION.::&DEBUG.:::'
,p_page_id=>1309
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(423417369705657702)
,p_short_name=>'Search Directory'
,p_link=>'f?p=&APP_ID.:103:&SESSION.::&DEBUG.:::'
,p_page_id=>103
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(423419250959595765)
,p_parent_id=>wwv_flow_imp.id(423417369705657702)
,p_short_name=>'Manage Directories'
,p_link=>'f?p=&APP_ID.:104:&SESSION.::&DEBUG.:::'
,p_page_id=>104
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(426298690350056131)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(426340065071935400)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(429538585551383876)
,p_parent_id=>wwv_flow_imp.id(3468437671722610690)
,p_short_name=>'Create&#x2F;Edit Contract Safety Gears'
,p_link=>'f?p=&APP_ID.:4077:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>4077
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(432592812160452625)
,p_parent_id=>wwv_flow_imp.id(435568092181000222)
,p_short_name=>'Create &#x2F;Edit Leave Policy'
,p_link=>'f?p=&APP_ID.:11998:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>11998
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(435568092181000222)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(439826648472977267)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(440438493100320421)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(440470567770558248)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(441902672113948092)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(448520564427326254)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(448520839847332797)
,p_parent_id=>wwv_flow_imp.id(448520564427326254)
,p_short_name=>'Configure Leave Types'
,p_link=>'f?p=&APP_ID.:221:&SESSION.::&DEBUG.:::'
,p_page_id=>221
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(448606853702239128)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(448622954157255416)
,p_parent_id=>wwv_flow_imp.id(448606853702239128)
,p_short_name=>'Manage Projects'
,p_link=>'f?p=&APP_ID.:1710:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1710
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(448646161138867806)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(450321909155860158)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(450440801872957248)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(450500208594084487)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(450845763606843402)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(451003225765950916)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(452160857295234049)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(452517726183305217)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453535966860797049)
,p_parent_id=>wwv_flow_imp.id(448648476974901472)
,p_short_name=>'Manage Org Structures'
,p_link=>'f?p=&APP_ID.:1294:&SESSION.::&DEBUG.:::'
,p_page_id=>1294
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453679877273141836)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453710295415272234)
,p_parent_id=>wwv_flow_imp.id(453679877273141836)
,p_short_name=>'Create/ Edit Staff Requisitions'
,p_link=>'f?p=&APP_ID.:2004:&SESSION.::&DEBUG.:::'
,p_page_id=>2004
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453771602692484685)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453778687875510489)
,p_parent_id=>wwv_flow_imp.id(453771602692484685)
,p_short_name=>'Manage Applicant References'
,p_link=>'f?p=&APP_ID.:9970:&SESSION.::&DEBUG.:::'
,p_page_id=>9970
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453779721589553421)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453780839613573832)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453781088458580180)
,p_parent_id=>wwv_flow_imp.id(453780839613573832)
,p_short_name=>'Interview Setup'
,p_link=>'f?p=&APP_ID.:2011:&SESSION.::&DEBUG.:::'
,p_page_id=>2011
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(453975782864806326)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(454015608276861030)
,p_parent_id=>wwv_flow_imp.id(453975782864806326)
,p_short_name=>'Manage Interviews'
,p_link=>'f?p=&APP_ID.:2006:&SESSION.::&DEBUG.:::'
,p_page_id=>2006
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(454023143803899309)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(454050435978075987)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(454717328654878506)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(454750270171908884)
,p_parent_id=>wwv_flow_imp.id(454717328654878506)
,p_short_name=>'Create/Edit Individuals'
,p_link=>'f?p=&APP_ID.:1261:&SESSION.::&DEBUG.::P1261_ID:&GLOBAL_IND.'
,p_page_id=>1261
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(454997699265315450)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(455005737901963241)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(455005879439966173)
,p_parent_id=>wwv_flow_imp.id(455005737901963241)
,p_short_name=>'Manage Employee Prior Deductions'
,p_link=>'f?p=&APP_ID.:65:&SESSION.::&DEBUG.:::'
,p_page_id=>65
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(455161223283072227)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(455896096411392774)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(455945271526911329)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456031757288625645)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456034740248848401)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456037342075861864)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456038713549872819)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456262869053383851)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456265548348435944)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456267136097485764)
,p_parent_id=>wwv_flow_imp.id(456265548348435944)
,p_short_name=>'Employee Offence'
,p_link=>'f?p=&APP_ID.:1421:&SESSION.::&DEBUG.:::'
,p_page_id=>1421
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456405063400252012)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456419720598295600)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456421420674319032)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456422373751339206)
,p_parent_id=>wwv_flow_imp.id(456421420674319032)
,p_short_name=>'Configure Mass Email'
,p_link=>'f?p=&APP_ID.:234:&SESSION.::&DEBUG.:::'
,p_page_id=>234
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456498005302207266)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456508139639234849)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456512946249538222)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456514981708553770)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456788398972023602)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456790318203497216)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456791501564573193)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456794468344677222)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456799396571718004)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456817678764772827)
,p_parent_id=>wwv_flow_imp.id(456799396571718004)
,p_short_name=>'Configure Insurance Categories'
,p_link=>'f?p=&APP_ID.:1407:&SESSION.::&DEBUG.:::'
,p_page_id=>1407
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456922319291114502)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(456923534562114507)
,p_parent_id=>wwv_flow_imp.id(456922319291114502)
,p_short_name=>'Create /Edit Holiday Policy'
,p_link=>'f?p=&APP_ID.:10101:&SESSION.::&DEBUG.:::'
,p_page_id=>10101
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(463309142179514009)
,p_parent_id=>wwv_flow_imp.id(452517726183305217)
,p_short_name=>'Manage Reference Entries'
,p_link=>'f?p=&APP_ID.:1201:&SESSION.::&DEBUG.:::'
,p_page_id=>1201
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(464930942077353690)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(465117589609968299)
,p_parent_id=>wwv_flow_imp.id(464930942077353690)
,p_short_name=>'Manage Workflow Forward Transactions'
,p_link=>'f?p=&APP_ID.:1390:&SESSION.::&DEBUG.:::'
,p_page_id=>1391
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(465212055018071991)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475476006111647349)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475476663231658717)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475531499466313147)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475541865085364044)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475549756499386865)
,p_parent_id=>wwv_flow_imp.id(475541865085364044)
,p_short_name=>'Create/Edit YTD Earning'
,p_link=>'f?p=&APP_ID.:1333:&SESSION.::&DEBUG.:::'
,p_page_id=>1333
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475561937787489969)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475581673202723445)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475584649625739181)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475586650345751457)
,p_parent_id=>wwv_flow_imp.id(475584649625739181)
,p_short_name=>'Employee Payslip'
,p_link=>'f?p=&APP_ID.:1356:&SESSION.::&DEBUG.:::'
,p_page_id=>1356
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475588663051783934)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Employees with Negative Netpay'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475591454247823779)
,p_parent_id=>wwv_flow_imp.id(308009091868955159)
,p_short_name=>'Employee Negative Netpay Summary'
,p_link=>'f?p=&APP_ID.:1507:&SESSION.::&DEBUG.:::'
,p_page_id=>1507
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475593563754842831)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475595474228977497)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475598387591032224)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475607619847062020)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
,p_short_name=>'eNIB'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475613186385096026)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475615707792109680)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475923747356556985)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475939571423440716)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475952786030541238)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475953841552544623)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475960848456558486)
,p_parent_id=>wwv_flow_imp.id(3504805836464786769)
,p_short_name=>'Configure Jobs'
,p_link=>'f?p=&APP_ID.:61:&SESSION.::&DEBUG.:::'
,p_page_id=>61
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475961056135561828)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475962924492579237)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475964149221587197)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475971791223705633)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475979303845744862)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475980074021775814)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475980711391838575)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475982845055957251)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475983510363965578)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475984269890971974)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475984991078004193)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475985782179011374)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475986786070045195)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475989513993065115)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475990591636075002)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(475996468889099535)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476000775228113812)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476010294541133548)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476169993793350620)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476200695893538781)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476214599048647766)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
,p_short_name=>'References'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476217712806655879)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476221949594673763)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476222835317688879)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476237149374940715)
,p_parent_id=>wwv_flow_imp.id(454750270171908884)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476336721752394860)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476339489662404236)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476340780003414532)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476350830688531604)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476357554060590349)
,p_parent_id=>wwv_flow_imp.id(476350830688531604)
,p_short_name=>'Configure Manual Timesheet'
,p_link=>'f?p=&APP_ID.:78:&SESSION.::&DEBUG.:::'
,p_page_id=>78
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476367585064657899)
,p_parent_id=>wwv_flow_imp.id(448681584154872661)
,p_short_name=>'Configure Employment History'
,p_link=>'f?p=&APP_ID.:544:&SESSION.::&DEBUG.:::'
,p_page_id=>544
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476367762287669622)
,p_parent_id=>wwv_flow_imp.id(448681584154872661)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476371216950698221)
,p_parent_id=>wwv_flow_imp.id(448681584154872661)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476373393287714303)
,p_parent_id=>wwv_flow_imp.id(448681584154872661)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476379637539751348)
,p_parent_id=>wwv_flow_imp.id(448681584154872661)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(476382028982772198)
,p_parent_id=>wwv_flow_imp.id(448681584154872661)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2967876935249408725)
,p_parent_id=>wwv_flow_imp.id(3505187951245079141)
,p_short_name=>'Deduction Code'
,p_link=>'f?p=&APP_ID.:1221:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1221
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3159824589572390096)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3159850434165410517)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3159873550943426526)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3159959928464475287)
,p_parent_id=>wwv_flow_imp.id(3159824589572390096)
,p_short_name=>'Create/Edit Employee Salary'
,p_link=>'f?p=&APP_ID.:13000:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>13000
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3160158072602565800)
,p_parent_id=>wwv_flow_imp.id(3159873550943426526)
,p_short_name=>'Create/Edit Employee Leave Entitlement'
,p_link=>'f?p=&APP_ID.:13002:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>13002
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3160403836418492457)
,p_short_name=>'Create/Edit Competency Levels'
,p_link=>'f?p=&APP_ID.:13022:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>13022
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3166955756668777751)
,p_parent_id=>wwv_flow_imp.id(3182767414431597516)
,p_short_name=>'Create/Edit Competency/Skill'
,p_link=>'f?p=&APP_ID.:13021:&SESSION.::&DEBUG.:::'
,p_page_id=>13021
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3175854272820658668)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3182694914236546221)
,p_parent_id=>wwv_flow_imp.id(3175854272820658668)
,p_short_name=>'Create/Edit Job Description Details'
,p_link=>'f?p=&APP_ID.:13011:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>13011
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3182767414431597516)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3183464431565705886)
,p_parent_id=>wwv_flow_imp.id(3504805836464786769)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3183612535304777696)
,p_parent_id=>wwv_flow_imp.id(3589137438433534257)
,p_short_name=>'Create/Edit Position'
,p_link=>'f?p=&APP_ID.:1301:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1301
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3183709983620971794)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3183794539116987388)
,p_parent_id=>wwv_flow_imp.id(3183709983620971794)
,p_short_name=>'Create/Edit Position Description Details'
,p_link=>'f?p=&APP_ID.:13016:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>13016
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3252479754262116796)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Listing of NetPay Disbursements'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3252480901627116792)
,p_parent_id=>wwv_flow_imp.id(3252479754262116796)
,p_short_name=>'Create/Edit NetPay Disbursement'
,p_link=>'f?p=&APP_ID.:9982:&SESSION.::&DEBUG.:::'
,p_page_id=>9982
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3256876796031282206)
,p_parent_id=>wwv_flow_imp.id(3356324283193169160)
,p_short_name=>'Create/Edit Shift Rotation'
,p_link=>'f?p=&FLOW_ID.:12816:&SESSION.'
,p_page_id=>12816
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3266872594370696348)
,p_parent_id=>wwv_flow_imp.id(3116912687489426542)
,p_short_name=>'  Create/Edit Employees'
,p_link=>'f?p=&APP_ID.:1281:&SESSION.::&DEBUG.:::'
,p_page_id=>1281
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3269572166478466792)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3269574776918476609)
,p_parent_id=>wwv_flow_imp.id(3269572166478466792)
,p_short_name=>'Create/Edit Activty'
,p_link=>'f?p=&FLOW_ID.:1436:&SESSION.'
,p_page_id=>1436
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3269806763171034960)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3356324283193169160)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3356474847674269834)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3356514694085288402)
,p_parent_id=>wwv_flow_imp.id(3356474847674269834)
,p_short_name=>'Create/Edit Swap Shifts'
,p_link=>'f?p=&APP_ID.:186:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>186
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3380092692503103766)
,p_short_name=>'ACH Master'
,p_link=>'f?p=&APP_ID.:201:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>201
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3380419519256217104)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3385506704024759248)
,p_parent_id=>wwv_flow_imp.id(3380419519256217104)
,p_short_name=>'Create/Edit ACH Configuration'
,p_link=>'f?p=&FLOW_ID.:218:&SESSION.'
,p_page_id=>218
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3388894800273602680)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3400333232108468771)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465683175586426351)
,p_parent_id=>wwv_flow_imp.id(3465683720904435918)
,p_short_name=>'Create/Edit Employee Accident Reports'
,p_link=>'f?p=&APP_ID.:4005:&SESSION.::&DEBUG.:::'
,p_page_id=>4005
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465683720904435918)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465695912929522075)
,p_parent_id=>wwv_flow_imp.id(3465697773395536446)
,p_short_name=>'Create/Edit Risk Assessment'
,p_link=>'f?p=&FLOW_ID.:4013:&SESSION.'
,p_page_id=>4013
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465697773395536446)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465707631562629870)
,p_parent_id=>wwv_flow_imp.id(3465708957251638933)
,p_short_name=>'Create/Edit COSHH Risk Assessment'
,p_link=>'f?p=&FLOW_ID.:4008:&SESSION.'
,p_page_id=>4008
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465708957251638933)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465732872927907544)
,p_parent_id=>wwv_flow_imp.id(3465733892802915859)
,p_short_name=>'Create/Edit Job Hazards Analysis'
,p_link=>'f?p=&FLOW_ID.:4009:&SESSION.'
,p_page_id=>4009
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3465733892802915859)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3466142878679340702)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3466164783485633871)
,p_parent_id=>wwv_flow_imp.id(3466303165726198573)
,p_short_name=>'Create/Edit PPE REGISTER'
,p_link=>'f?p=&FLOW_ID.:4081:&SESSION.'
,p_page_id=>4081
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3466303165726198573)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3466476990366974163)
,p_parent_id=>wwv_flow_imp.id(3466478285556987674)
,p_short_name=>'Create/Edit Incident'
,p_link=>'f?p=&APP_ID.:4051:&SESSION.::&DEBUG.:::'
,p_page_id=>4051
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3466478285556987674)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468377696483141461)
,p_parent_id=>wwv_flow_imp.id(3468036578140113212)
,p_short_name=>'Create/Edit Vehicle Accident Report'
,p_link=>'f?p=&APP_ID.:4014:&SESSION.::&DEBUG.:::'
,p_page_id=>4014
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468397745008300132)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468403529038358354)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468407529927383115)
,p_parent_id=>wwv_flow_imp.id(3468403529038358354)
,p_short_name=>'Create/ Edit Minor Vehicle Accident'
,p_link=>'f?p=&FLOW_ID.:4066:&SESSION.'
,p_page_id=>4066
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468420513648459467)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468422793581472724)
,p_parent_id=>wwv_flow_imp.id(3468420513648459467)
,p_short_name=>'Create/Edit Driver Assessment'
,p_link=>'f?p=&FLOW_ID.:4063:&SESSION.'
,p_page_id=>4063
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468437671722610690)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468501796678825517)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3468503106580919400)
,p_parent_id=>wwv_flow_imp.id(3468501796678825517)
,p_short_name=>'Create/Edit Oil And Chemical'
,p_link=>'f?p=&FLOW_ID.:4018:&SESSION.'
,p_page_id=>4018
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3470331805748934895)
,p_parent_id=>wwv_flow_imp.id(3468377696483141461)
,p_short_name=>'Create/Edit Accident Detail'
,p_link=>'f?p=&FLOW_ID.:4015:&SESSION.'
,p_page_id=>4015
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3470336286298004463)
,p_parent_id=>wwv_flow_imp.id(3468377696483141461)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3470343484607353780)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3471536483599935661)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3474193400234812707)
,p_parent_id=>wwv_flow_imp.id(3474192206137812706)
,p_short_name=>'Create/Edit User Manual Entries'
,p_link=>'f?p=&APP_ID.:134:&SESSION.::&DEBUG.:::'
,p_page_id=>134
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3482891881197050461)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3485051863127856398)
,p_short_name=>'Administration'
,p_link=>'f?p=&APP_ID.:101100:&SESSION.'
,p_page_id=>101100
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3488330928891036034)
,p_parent_id=>wwv_flow_imp.id(3488348094877044088)
,p_short_name=>'Create/Edit Employee Tasks (Per Employees)'
,p_link=>'f?p=&APP_ID.:159:&SESSION.'
,p_page_id=>159
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3488348094877044088)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3488366676538054982)
,p_parent_id=>wwv_flow_imp.id(3488388514806064784)
,p_short_name=>'Create/Edit Employee Tasks (All Employees)'
,p_link=>'f?p=&APP_ID.:157:&SESSION.'
,p_page_id=>157
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3488388514806064784)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3492488358382750450)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3492755653683897544)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3492851287239928810)
,p_parent_id=>wwv_flow_imp.id(3492755653683897544)
,p_short_name=>'Create /Edit Confirmation Movement'
,p_link=>'f?p=&APP_ID.:698:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>698
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3492972254122995900)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3497600344491364475)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3498131003476006109)
,p_parent_id=>wwv_flow_imp.id(5245605296876589108)
,p_short_name=>'Listing of Broadcasts'
,p_link=>'f?p=&FLOW_ID.:90:&SESSION.'
,p_page_id=>90
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3498164734939521496)
,p_parent_id=>wwv_flow_imp.id(3498131003476006109)
,p_short_name=>'Create/Edit Broadcast'
,p_link=>'f?p=&FLOW_ID.:91:&SESSION.'
,p_page_id=>91
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504102283807026746)
,p_parent_id=>wwv_flow_imp.id(3492972254122995900)
,p_short_name=>'Create/Edit Supplemental Movement'
,p_link=>'f?p=&APP_ID.:700:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>700
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504225674924071803)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504390666941145434)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504433759688165218)
,p_parent_id=>wwv_flow_imp.id(3504390666941145434)
,p_short_name=>'Create/Edit Employee Separation'
,p_link=>'f?p=&APP_ID.:1415:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1415
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504493647290211945)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504643035017505270)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504805836464786769)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3504852678904324337)
,p_parent_id=>wwv_flow_imp.id(3516864241740019289)
,p_short_name=>'Create/Edit Change Position'
,p_link=>'f?p=&APP_ID.:51:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>51
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505030822001875699)
,p_short_name=>'Competencies '
,p_link=>'f?p=&APP_ID.:1492:&SESSION.'
,p_page_id=>1492
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505155176458840309)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505185938199063110)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505186774694071239)
,p_parent_id=>wwv_flow_imp.id(3505185938199063110)
,p_short_name=>'Create/Edit Payroll Income Codes'
,p_link=>'f?p=&APP_ID.:1211:&SESSION.::&DEBUG.:::'
,p_page_id=>1211
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505187951245079141)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505189577086095399)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505190795166103447)
,p_parent_id=>wwv_flow_imp.id(3505189577086095399)
,p_short_name=>'Create/Edit Non-Statutory Deduction'
,p_link=>'f?p=&APP_ID.:1297:&SESSION.::&DEBUG.:::'
,p_page_id=>1297
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505192395394114650)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505193494543120415)
,p_parent_id=>wwv_flow_imp.id(3505192395394114650)
,p_short_name=>'Create/Edit Job Related Tasks'
,p_link=>'f?p=&FLOW_ID.:1342:&SESSION.'
,p_page_id=>1342
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505220963981304112)
,p_parent_id=>wwv_flow_imp.id(3505155176458840309)
,p_short_name=>'Create/Edit Leave Roster'
,p_link=>'f?p=&FLOW_ID.:33:&SESSION.'
,p_page_id=>33
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505245076091463603)
,p_short_name=>'Listing of Location Shift Rule'
,p_link=>'f?p=&APP_ID.:62:&SESSION.'
,p_page_id=>62
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3505566087072191608)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3507995703849438554)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3516864241740019289)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3534204878916359674)
,p_parent_id=>wwv_flow_imp.id(3534233404754370708)
,p_short_name=>'Create/Edit Health Surcharge'
,p_link=>'f?p=&APP_ID.:173:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>173
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3534233404754370708)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3536854398693028486)
,p_parent_id=>wwv_flow_imp.id(5245605296876589108)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3537557057055044765)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3537585688053099266)
,p_parent_id=>wwv_flow_imp.id(3492488358382750450)
,p_short_name=>'Create/Edit Change Employment'
,p_link=>'f?p=&APP_ID.:137:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>137
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3541759286095049230)
,p_short_name=>'Listing of Media'
,p_link=>'f?p=&FLOW_ID.:181:&SESSION.'
,p_page_id=>181
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3541765374333086795)
,p_short_name=>'Create/Edit Media'
,p_link=>'f?p=&FLOW_ID.:188:&SESSION.'
,p_page_id=>188
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3549101480586996181)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3550932817443529602)
,p_parent_id=>wwv_flow_imp.id(3555132638058129929)
,p_short_name=>'Create/Edit Grievance Action'
,p_link=>'f?p=&APP_ID.:184:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>184
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3555132638058129929)
,p_parent_id=>wwv_flow_imp.id(3555160516107144807)
,p_short_name=>'Create/Edit Employee Grievance'
,p_link=>'f?p=&APP_ID.:175:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>175
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3555160516107144807)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3557073385247798250)
,p_parent_id=>wwv_flow_imp.id(3557075089878830769)
,p_short_name=>'Create/Edit Health Surcharges'
,p_link=>'f?p=&FLOW_ID.:167:&SESSION.'
,p_page_id=>167
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3557075089878830769)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3557695958404811897)
,p_parent_id=>wwv_flow_imp.id(3504225674924071803)
,p_short_name=>'Create/Edit Movement Extension'
,p_link=>'f?p=&APP_ID.:702:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>702
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3585673392821908436)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3589137438433534257)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624138897268604405)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624225177185163433)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624237438449236119)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624419763051624386)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624433423895787065)
,p_short_name=>'PAYE for Employees By Period'
,p_link=>'f?p=&FLOW_ID.:8011:&SESSION.'
,p_page_id=>8011
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624572521082619674)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624807782737342433)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3624844847033973504)
,p_parent_id=>wwv_flow_imp.id(3624572521082619674)
,p_short_name=>'Employees Above 60 NIB/SS Contribution'
,p_link=>'f?p=&APP_ID.:8013:&SESSION.::&DEBUG.:::'
,p_page_id=>8013
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3632485745869503067)
,p_parent_id=>wwv_flow_imp.id(475952786030541238)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(5245605296876589108)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Administration'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(5813553493281003303)
,p_parent_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Help'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(10766774050268877519)
,p_short_name=>'Home'
