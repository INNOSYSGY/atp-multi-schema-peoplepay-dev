...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3807179017489742028)
,p_lov_name=>'NOTIFY_STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(3807179017489742028)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3807178610847742027)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'ACTIVE'
,p_lov_return_value=>'ACTIVE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3807178202596742026)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'CLOSE'
,p_lov_return_value=>'CLOSE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3807177837836742026)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'OUTSTANDING'
,p_lov_return_value=>'OUTSTANDING'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3807177447429742026)
