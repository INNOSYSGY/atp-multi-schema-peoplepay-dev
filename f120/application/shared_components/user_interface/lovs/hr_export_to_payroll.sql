...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3500236986375031716)
,p_lov_name=>'HR_EXPORT_TO_PAYROLL'
,p_lov_query=>'.'||wwv_flow_imp.id(3500236986375031716)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3500237324032031718)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3541560585606306459)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3500582053561912873)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3500239343939074006)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3500240312692104458)
,p_lov_disp_sequence=>4
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3500241850945121070)
,p_lov_disp_sequence=>4
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3533822472658786028)
,p_lov_disp_sequence=>4
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3270487278796918734)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3384794696196276465)
