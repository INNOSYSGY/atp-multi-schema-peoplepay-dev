...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854414119414718019)
,p_lov_name=>'EARNINGS_TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(3854414119414718019)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854413659862718018)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Regular'
,p_lov_return_value=>'RG'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854413335856718018)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Back Pay'
,p_lov_return_value=>'BK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854412947969718018)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Gratuity'
,p_lov_return_value=>'GT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854412066795718017)
,p_lov_disp_sequence=>5
,p_lov_disp_value=>'Leave Passage'
,p_lov_return_value=>'LP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854411679573718014)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Holiday Pay'
,p_lov_return_value=>'HP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854411339218718014)
