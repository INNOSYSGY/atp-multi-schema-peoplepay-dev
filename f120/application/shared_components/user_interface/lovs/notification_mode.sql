...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3806862898737352691)
,p_lov_name=>'NOTIFICATION_MODE'
,p_lov_query=>'.'||wwv_flow_imp.id(3806862898737352691)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3806862584886352690)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'EMAIL'
,p_lov_return_value=>'EMAIL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3806862094915352690)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'NOTIFICATION'
,p_lov_return_value=>'NOTIFICATION'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3806861768212352690)
