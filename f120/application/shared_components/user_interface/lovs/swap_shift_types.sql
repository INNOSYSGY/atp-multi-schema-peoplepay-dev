...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3356477765053269837)
,p_lov_name=>'SWAP SHIFT TYPES'
,p_lov_query=>'.'||wwv_flow_imp.id(3356477765053269837)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3356478155421269840)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Shift Swap'
,p_lov_return_value=>'SWAP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3356478548644269841)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Shift Drop'
,p_lov_return_value=>'DROP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3356478893198269841)
