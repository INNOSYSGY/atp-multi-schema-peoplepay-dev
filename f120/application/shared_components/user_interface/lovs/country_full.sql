prompt --application/shared_components/user_interface/lovs/country_full
begin
--   Manifest
--     COUNTRY_FULL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3825753402154630130)
,p_lov_name=>'COUNTRY_FULL'
