prompt --application/shared_components/user_interface/lovs/organisation_structure_full
begin
--   Manifest
--     ORGANISATION_STRUCTURE_FULL
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3187005605024534767)
,p_lov_name=>'ORGANISATION_STRUCTURE_FULL'
