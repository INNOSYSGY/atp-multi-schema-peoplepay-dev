...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(675264516032856278)
,p_lov_name=>'INCOME_STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(675264516032856278)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(675264882324856284)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'In Progress'
,p_lov_return_value=>'IP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(675265223959856285)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Closed'
,p_lov_return_value=>'CL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(675265645712856285)
