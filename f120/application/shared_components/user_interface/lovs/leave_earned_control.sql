...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3528661517609368085)
,p_lov_name=>'LEAVE_EARNED_CONTROL'
,p_lov_query=>'.'||wwv_flow_imp.id(3528661517609368085)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3528661876796368089)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Start of Year'
,p_lov_return_value=>'START_OF_YEAR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3528662244905368091)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'End of Year'
,p_lov_return_value=>'END_OF_YEAR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3528662604108368091)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Every Month'
,p_lov_return_value=>'EVERY_MONTH'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(662309422847451636)
