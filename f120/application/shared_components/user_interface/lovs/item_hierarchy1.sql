...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3611501011550327529)
,p_lov_name=>'ITEM_HIERARCHY1'
,p_lov_query=>'.'||wwv_flow_imp.id(3611501011550327529)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3611500573160327524)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'CATEGORY'
,p_lov_return_value=>'CATEGORY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3611500238265327520)
