...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3833322229427513080)
,p_lov_name=>'ORG_POPULATION1'
,p_lov_query=>'.'||wwv_flow_imp.id(3833322229427513080)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3833321773378513079)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'MANUAL'
,p_lov_return_value=>'MANUAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3833321456056513079)
