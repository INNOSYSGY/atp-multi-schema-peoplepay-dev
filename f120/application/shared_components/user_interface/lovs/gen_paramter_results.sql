prompt --application/shared_components/user_interface/lovs/gen_paramter_results
begin
--   Manifest
--     GEN_PARAMTER_RESULTS
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3633766328561223534)
,p_lov_name=>'GEN_PARAMTER_RESULTS'
