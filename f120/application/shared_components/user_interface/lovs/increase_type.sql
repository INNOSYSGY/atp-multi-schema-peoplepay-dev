...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854374819308666785)
,p_lov_name=>'INCREASE_TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(3854374819308666785)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854374383093666785)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Conditional'
,p_lov_return_value=>'CONDITIONAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854373960523666784)
