...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3569781047006942983)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3569781332008942983)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3569780234559942983)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3569781047006942983)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3569780637522942983)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3569763662568942974)
,p_branch_action=>'f?p=&APP_ID.:208:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3569780234559942983)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569768687376942976)
,p_name=>'P206_DECIMAL_CHARACTER'
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_imp.id(3569781047006942983)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569769599224942976)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569770441986942976)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569771323753942977)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569772276881942978)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569774921159942979)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569775865214942979)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569776785965942980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569777624971942980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569778124057942981)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569779416886942982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3569779706962942982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3588940198769859124)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3588940246028859125)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3569778475374942981)
...
,p_when_button_pressed=>wwv_flow_imp.id(3569780234559942983)
,p_associated_item=>wwv_flow_imp.id(3569779416886942982)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3569774054765942979)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(3569780234559942983)
,p_associated_item=>wwv_flow_imp.id(3569778124057942981)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3569767850749942976)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569766312525942975)
,p_event_id=>wwv_flow_imp.id(3569767850749942976)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569766815610942975)
,p_event_id=>wwv_flow_imp.id(3569767850749942976)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569767304990942975)
,p_event_id=>wwv_flow_imp.id(3569767850749942976)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3569773747101942978)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569772721720942978)
,p_event_id=>wwv_flow_imp.id(3569773747101942978)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569773261102942978)
,p_event_id=>wwv_flow_imp.id(3569773747101942978)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3569765981857942975)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569765471928942975)
,p_event_id=>wwv_flow_imp.id(3569765981857942975)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569764501495942974)
,p_event_id=>wwv_flow_imp.id(3569765981857942975)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3569764975548942975)
,p_event_id=>wwv_flow_imp.id(3569765981857942975)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3569763968074942974)
...
,p_process_when_button_id=>wwv_flow_imp.id(3569780234559942983)
,p_internal_uid=>3147971974876946400
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3569682771909521070)
