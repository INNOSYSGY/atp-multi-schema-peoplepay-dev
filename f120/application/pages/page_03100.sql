...
wwv_flow_imp_page.create_page(
 p_id=>3100
,p_name=>'frmProjMAINPAGE'
,p_step_title=>'PeoplePay Project Management ERP'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_imp.id(3607631723795241302)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3449035025811157658)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3525986745523630132)
,p_plug_name=>'PeoplePay Project Management'
...
,p_plug_source=>'Complete Paperless Office Processes for Project Management'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3587332946852552503)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3606808537225514521)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3606808153129514518)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3587340255098725255)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3587340369441725255)
...
,p_owner=>'PUR_INV'
,p_internal_uid=>466844283477528542
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606813134974514550)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606812684816514543)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606812348082514543)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606811960180514542)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606811541917514541)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606811073259514541)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606810743741514541)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606810349298514539)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3606809883930514539)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3587341466179728441)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'460296'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3601016761721776322)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3606801746120439972)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3606796581489370644)
,p_name=>'P3100_MAX_TIP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3601016761721776322)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
'from HR_APU_TIPS',
'WHERE MAIN_MODULES=''Project Management'''))
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3606796930303373255)
,p_name=>'P3100_MIN_TIP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3601016761721776322)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select min(id)',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3606798971408389288)
,p_name=>'P3100_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3449035025811157658)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3606797773997385668)
,p_name=>'set_tip'
,p_event_sequence=>20
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3606797392709385667)
,p_event_id=>wwv_flow_imp.id(3606797773997385668)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P3100_TIPS'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select messages',
'from HR_APU_TIPS',
'where id=floor(dbms_random.value(to_number(:P3100_MIN_TIP),to_number(:P3100_MAX_TIP)))',
'and rownum=1',
'AND MAIN_MODULES=''Project Management'''))
,p_attribute_07=>'P3100_MIN_TIP,P3100_MAX_TIP'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
