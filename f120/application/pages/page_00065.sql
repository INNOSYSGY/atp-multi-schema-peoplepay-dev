...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(674558313329713228)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1006103530958609979)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(676751797823498570)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(676752215699498571)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(423448018380722995)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1008558815700031385)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1008559523089031487)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676755102626498591)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1008558815700031385)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676755519592498592)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676755864713498594)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676756347950498595)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676757129536498597)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(676757542213498598)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(676780190733498694)
,p_branch_name=>'Delete'
,p_branch_action=>'f?p=&APP_ID.:65:&SESSION.::&DEBUG.:65::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(676755519592498592)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(423448457656722999)
,p_branch_name=>'STAY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447176790722986)
,p_name=>'P65_EXPENSE_CODE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(1008559523089031487)
,p_item_source_plug_id=>wwv_flow_imp.id(1008559523089031487)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447230411722987)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447382591722988)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447400662722989)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447493212722990)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447654594722991)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447722712722992)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447874988722993)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(423447988799722994)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008566517817031535)
,p_name=>'P65_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008566939547031540)
,p_name=>'P65_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>40
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008567742740031544)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1008574532216031564)
,p_name=>'P65_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(1008559523089031487)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676775071959498678)
,p_name=>'compute_totals_all'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(676757129536498597)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676775607848498680)
,p_event_id=>wwv_flow_imp.id(676775071959498678)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676776152288498681)
,p_event_id=>wwv_flow_imp.id(676775071959498678)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676776465386498682)
,p_name=>'sum_asat'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676776998300498684)
,p_event_id=>wwv_flow_imp.id(676776465386498682)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat_emp'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676777420316498685)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676777945550498687)
,p_event_id=>wwv_flow_imp.id(676777420316498685)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676778294499498688)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676778763589498690)
,p_event_id=>wwv_flow_imp.id(676778294499498688)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(676779253441498691)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(676779754633498692)
,p_event_id=>wwv_flow_imp.id(676779253441498691)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'sum_asat'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(423448223311722997)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(423448374085722998)
,p_event_id=>wwv_flow_imp.id(423448223311722997)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(676771811223498665)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(1008559523089031487)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(676772919982498669)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(679226440845946171)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(676755864713498594)
,p_internal_uid=>268506482546135971
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(676771376641498663)
