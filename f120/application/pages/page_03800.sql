prompt --application/pages/page_03800
begin
--   Manifest
--     PAGE: 03800
--   Manifest End
...
wwv_flow_imp_page.create_page(
 p_id=>3800
,p_name=>'rptPointofSaleMAINPAGE'
,p_step_title=>'PeoplePay Point of Sale'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_imp.id(3603892778548382660)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3393960061175388162)
,p_plug_name=>'PeoplePay Point of Sale Management'
...
,p_plug_source=>'Complete Paperless Office Processes for Point of Sale Management'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3470911780887860636)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3733944501440386515)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3603951146139360063)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3603950722417360063)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3733951809686559267)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3733951924029559267)
...
,p_owner=>'PUR_INV'
,p_internal_uid=>613455838065362554
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603956531789360087)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603956127060360086)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603955676516360085)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603955326368360085)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603954928539360084)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603954548510360084)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603954154985360083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603953735995360083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3603953278247360082)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3733953020767562453)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'488862'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3747628316309610334)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3603939331591235053)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3603951777990360065)
,p_name=>'P3800_MAX_TIP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3747628316309610334)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
'from HR_APU_TIPS',
'WHERE MAIN_MODULES=''Project Management'''))
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3603952196917360069)
,p_name=>'P3800_MIN_TIP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3747628316309610334)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select min(id)',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3603957560244360091)
,p_name=>'P3800_TIPS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3470911780887860636)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3603949440951360060)
,p_name=>'set_tip'
,p_event_sequence=>20
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3603948868909360060)
,p_event_id=>wwv_flow_imp.id(3603949440951360060)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P3800_TIPS'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select messages',
'from HR_APU_TIPS',
'where id=floor(dbms_random.value(to_number(:P3800_MIN_TIP),to_number(:P3800_MAX_TIP)))',
'and rownum=1',
'AND MAIN_MODULES=''Project Management'''))
,p_attribute_07=>'P3800_MIN_TIP,P3800_MAX_TIP'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
