...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8241222041610368339)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8241223046774368349)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(449482326638128743)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8241223046774368349)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(449481649914128743)
,p_name=>'P9961_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8241222041610368339)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(475626461933445956)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(475626878675445956)
,p_event_id=>wwv_flow_imp.id(475626461933445956)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(475627326091445957)
,p_event_id=>wwv_flow_imp.id(475626461933445956)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(449482724078128744)
...
,p_process_when_button_id=>wwv_flow_imp.id(449482326638128743)
