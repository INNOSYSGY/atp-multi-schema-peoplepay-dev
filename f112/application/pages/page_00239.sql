...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3344467976584937602)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3676102589582559084)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4018667874203802756)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4018667932771802757)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833763871565499393)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833764251529499393)
,p_db_column_name=>'ID'
,p_display_order=>20
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833761953024499390)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833762252381499390)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833762744195499391)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833763100049499391)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833763458738499392)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2833761606825499388)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4020322828865125131)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5326224774566240505)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5736185123422041800)
,p_plug_name=>'Panel Selected'
,p_parent_plug_id=>wwv_flow_imp.id(5326224774566240505)
,p_region_template_options=>'#DEFAULT#:is-expanded:t-Region--accent2:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>40
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6195898921169342462)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2833765110293499397)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4018667874203802756)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2833765775487499398)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5326224774566240505)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2833757942639499377)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3344467976584937602)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2833757468696499375)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833758268862499377)
,p_name=>'P239_INTERVIEW_SESSION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3344467976584937602)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833759238844499379)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833760045699499380)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833766207397499399)
,p_name=>'P239_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5326224774566240505)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833766554399499400)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833767291509499401)
,p_name=>'P239_SELECT_PANEL_MEMBER'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5736185123422041800)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833768193526499404)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833768574458499405)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2833769283570499405)
,p_name=>'P239_FACTOR'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_imp.id(6195898921169342462)
,p_prompt=>'Factor'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833771332763499410)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833771830062499411)
,p_event_id=>wwv_flow_imp.id(2833771332763499410)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833772151822499412)
,p_name=>'show_btn'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833772683523499412)
,p_event_id=>wwv_flow_imp.id(2833772151822499412)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2833765110293499397)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833773200513499413)
,p_event_id=>wwv_flow_imp.id(2833772151822499412)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833773641357499413)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833774071115499413)
,p_event_id=>wwv_flow_imp.id(2833773641357499413)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833774597549499414)
,p_event_id=>wwv_flow_imp.id(2833773641357499413)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833775004570499414)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833775502663499415)
,p_event_id=>wwv_flow_imp.id(2833775004570499414)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2833765775487499398)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833775961401499415)
,p_event_id=>wwv_flow_imp.id(2833775004570499414)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833776353589499415)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833776882711499416)
,p_event_id=>wwv_flow_imp.id(2833776353589499415)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4018667874203802756)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833777260952499416)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833777818624499417)
,p_event_id=>wwv_flow_imp.id(2833777260952499416)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2833757468696499375)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833778334828499417)
,p_event_id=>wwv_flow_imp.id(2833777260952499416)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2833778672750499417)
,p_name=>'show_delete'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833779210371499418)
,p_event_id=>wwv_flow_imp.id(2833778672750499417)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2833757942639499377)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833779730629499418)
,p_event_id=>wwv_flow_imp.id(2833778672750499417)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2833780218707499419)
,p_event_id=>wwv_flow_imp.id(2833778672750499417)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2833770112472499408)
...
,p_process_when_button_id=>wwv_flow_imp.id(2833765775487499398)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2833769698301499406)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2833765110293499397)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2833770534252499409)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2833757942639499377)
,p_internal_uid=>2717986400396185704
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2833770846280499409)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2833757468696499375)
