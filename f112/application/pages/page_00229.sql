...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2666656167862826211)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3076616516718627506)
,p_plug_name=>'Panel Selected'
,p_parent_plug_id=>wwv_flow_imp.id(2666656167862826211)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3536330314465928168)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2666656517751826214)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2666656167862826211)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2666656281674826212)
,p_name=>'P229_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2666656167862826211)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2666656708591826216)
,p_name=>'P229_POSITION_CONFIG_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3076616516718627506)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2667359993400148718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2667360519424155202)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2667361357467155204)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2667362454049159027)
,p_name=>'P229_FACTOR'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_imp.id(3536330314465928168)
,p_prompt=>'Factor'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2666656790296826217)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2666656866359826218)
,p_event_id=>wwv_flow_imp.id(2666656790296826217)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2687946133842273315)
,p_name=>'show_btn'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2687946186349273316)
,p_event_id=>wwv_flow_imp.id(2687946133842273315)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2666656517751826214)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2687946324703273317)
,p_event_id=>wwv_flow_imp.id(2687946133842273315)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2666656958691826219)
...
,p_process_when_button_id=>wwv_flow_imp.id(2666656517751826214)
