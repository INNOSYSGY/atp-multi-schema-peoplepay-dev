...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3141413265866919584)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3141414276246919587)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3141413265866919584)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3141414864482919588)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3141413265866919584)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3141415274567919588)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3141415686493919589)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3141415274567919588)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(126664835596150869)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3141413265866919584)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(126668706857150882)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3141414276246919587)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(126665699639150870)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(126665255563150869)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3141413265866919584)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(126666063545150870)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3141413265866919584)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(126684515750794125)
,p_name=>'P406_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3141413265866919584)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(126684818321798124)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3177775088354312901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3177775501217312902)
,p_name=>'P406_URL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3141413265866919584)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3177775892183312902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3177776256200312902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3177780000831312915)
,p_name=>'P406_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3141414276246919587)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3177781769244312917)
,p_name=>'P406_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3141415274567919588)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(126672948550150900)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(126665255563150869)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126673484641150900)
,p_event_id=>wwv_flow_imp.id(126672948550150900)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126673960873150900)
,p_event_id=>wwv_flow_imp.id(126672948550150900)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(126670697353150896)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126671179710150898)
,p_event_id=>wwv_flow_imp.id(126670697353150896)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126671703788150899)
,p_event_id=>wwv_flow_imp.id(126670697353150896)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(126672050570150899)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126672567891150899)
,p_event_id=>wwv_flow_imp.id(126672050570150899)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(126674403925150900)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(126668706857150882)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126675337693150901)
,p_event_id=>wwv_flow_imp.id(126674403925150900)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126674931011150901)
,p_event_id=>wwv_flow_imp.id(126674403925150900)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(126675827873150901)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126676237550150902)
,p_event_id=>wwv_flow_imp.id(126675827873150901)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(126676816795150902)
,p_event_id=>wwv_flow_imp.id(126675827873150901)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141535857187618818)
,p_name=>'New'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141536025745618819)
,p_event_id=>wwv_flow_imp.id(141535857187618818)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
