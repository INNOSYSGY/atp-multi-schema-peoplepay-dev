...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3415752243704382651)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3415752825338382654)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3415753012179382654)
...
,p_owner=>'JAY.KHAN'
,p_internal_uid=>3489855927281879290
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380542089175465225)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380542882718465225)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380543232242465226)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380543658801465226)
,p_db_column_name=>'ID'
,p_display_order=>8
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380544051811465227)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380544447597465227)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380544875927465228)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380545293064465228)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380545650897465229)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380546098010465229)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380546490928465230)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380546826240465230)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380547222803465231)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380547672067465231)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380548015386465232)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380540829409465223)
...
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(3316814715915867495)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380541253018465224)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380541675146465224)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380548449817465232)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380548868857465233)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380549280112465233)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380549600717465234)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380550029977465234)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380550838272465235)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(367111190381033325)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(367111204846033326)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3415760932270385503)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3419179672740566669)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(26036230473046031)
,p_report_id=>wwv_flow_imp.id(3419179672740566669)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3419180818226575913)
,p_application_user=>'APXWS_ALTERNATIVE'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(26036962258046029)
,p_report_id=>wwv_flow_imp.id(3419180818226575913)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(26037310138046028)
,p_report_id=>wwv_flow_imp.id(3419180818226575913)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'EMP_ID'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3456860548937199430)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'Summary'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(26038073288046025)
,p_report_id=>wwv_flow_imp.id(3456860548937199430)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3446568957219837724)
,p_plug_name=>'Note'
,p_parent_plug_id=>wwv_flow_imp.id(3415752825338382654)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3419202480524152003)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3419204364703152022)
,p_name=>'EMP_ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440311966628165830)
,p_name=>'QUANTITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312051602165831)
,p_name=>'RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312141824165832)
,p_name=>'AMOUNT_PAID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312258118165833)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312354952165834)
,p_name=>'V_PERIOD_END'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312425716165835)
,p_name=>'PAY_OPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312587857165836)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312893679165839)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3440312935547165840)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3419202539898152004)
,p_internal_uid=>3493305455000648640
,p_is_editable=>false
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3419438851622038731)
,p_interactive_grid_id=>wwv_flow_imp.id(3419202539898152004)
,p_static_id=>'389002'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3419439109880038731)
,p_report_id=>wwv_flow_imp.id(3419438851622038731)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3419448589996038769)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3419204364703152022)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>277
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445334096509295029)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3440311966628165830)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445335495587295033)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3440312051602165831)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445336890202295036)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3440312141824165832)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445338271849295041)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3440312258118165833)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445339680048295045)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3440312354952165834)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445341033692295049)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(3440312425716165835)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445342515778295053)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(3440312587857165836)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445376592102465972)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3440312893679165839)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3445377953831465975)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3440312935547165840)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(3380539130013465201)
,p_view_id=>wwv_flow_imp.id(3419439109880038731)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(3440312141824165832)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3419205742598152036)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3419689889766359650)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3376227044348530000)
,p_name=>'LEGACYCODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3376227190685530001)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3387374732232204987)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3421520442355098602)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3421520527477098603)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3421521045432098608)
,p_name=>'INNOCODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3421521155330098609)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3421521233275098610)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3421520326179098601)
,p_internal_uid=>3495623241281595237
,p_is_editable=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3421526526350104799)
,p_interactive_grid_id=>wwv_flow_imp.id(3421520326179098601)
,p_static_id=>'409879'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3421526806660104799)
,p_report_id=>wwv_flow_imp.id(3421526526350104799)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3380646408809486871)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3376227044348530000)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3380647335573486875)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3376227190685530001)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3396780696911389586)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(3387374732232204987)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3421527226470104801)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3421520442355098602)
,p_is_visible=>true
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3421531193876104814)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3421521045432098608)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3421532066210104817)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3421521155330098609)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3421532937468104819)
,p_view_id=>wwv_flow_imp.id(3421526806660104799)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(3421521233275098610)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3812907384285400113)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3812907475477400113)
...
,p_enable_mail_download=>'Y'
,p_owner=>'PUR_INV'
,p_internal_uid=>3887010390579896749
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380572608032465280)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380573092870465281)
,p_db_column_name=>'EMP_ID'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380573449211465281)
,p_db_column_name=>'EMPENT_ID'
,p_display_order=>3
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380573880772465282)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380574242699465283)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380574625211465284)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380575014820465285)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380575418977465285)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380575835132465286)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380576265987465287)
,p_db_column_name=>'PAY_STATUS'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Pay Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380576690411465288)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380577003662465289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380577445691465289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380577886538465290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380578202401465291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380578652294465291)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380579040025465292)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380579401882465292)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380579854759465293)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380580283003465294)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380571867809465279)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380572289346465280)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380571099572465278)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3380571446787465279)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3812909685324400374)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8460100471495118579)
,p_plug_name=>'Errors'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8460100763334118582)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
,p_enable_mail_download=>'Y'
,p_owner=>'RLANGFORD'
,p_internal_uid=>8534203678436615218
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213206203959185288)
,p_db_column_name=>'EARNINGS_PERIOD_ID'
,p_display_order=>30
,p_column_identifier=>'C'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213206634493185289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213206964445185290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213207416256185291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213207812924185291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213208244842185291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213208551742185292)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213209023384185292)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213209402652185293)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213209752408185293)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213210163120185294)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213210553541185294)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2213210987170185295)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8462265292560850056)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26025556932046073)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3415752243704382651)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26038441958046024)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3415752825338382654)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26046172065045996)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3419202480524152003)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26070475160045919)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8460100471495118579)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26025887553046071)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26038830969046023)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3415752825338382654)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26046516570045995)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3419202480524152003)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26070820205045918)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8460100471495118579)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26026341659046070)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26046901562045994)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3419202480524152003)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26026746998046069)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26047319761045993)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(3419202480524152003)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26063060016045942)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(3812907384285400113)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26063460409045941)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(26094974816045863)
...
,p_branch_when_button_id=>wwv_flow_imp.id(26026341659046070)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(26095317744045862)
...
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(26025887553046071)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(368010106493840984)
,p_name=>'P1465_WORK_UNIT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3419205742598152036)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380581930275465240)
,p_name=>'P1465_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3415752825338382654)
,p_prompt=>'Start Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380582299617465242)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380582760832465242)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380607496476465255)
,p_name=>'P1465_START_DATE_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3419202480524152003)
,p_prompt=>'Start Date'
,p_display_as=>'NATIVE_DATE_PICKER_APEX'
,p_cSize=>12
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380607944945465255)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380608293701465256)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380608697636465257)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380657345547465253)
,p_name=>'P1465_EARNINGSPERIOD_PAY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3812907384285400113)
,p_prompt=>'Earnings Period'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380657830810465254)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380658639021465255)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3380659086265465255)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26072848784045910)
,p_name=>'dy_process_pay_data'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(26038441958046024)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26073350929045908)
,p_event_id=>wwv_flow_imp.id(26072848784045910)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26073830287045907)
,p_event_id=>wwv_flow_imp.id(26072848784045910)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(3415752825338382654)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26074381670045906)
,p_event_id=>wwv_flow_imp.id(26072848784045910)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26074714900045905)
,p_name=>'dy_refresh'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26075219199045904)
,p_event_id=>wwv_flow_imp.id(26074714900045905)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26075635783045903)
,p_name=>'dy_refresh1'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26076123246045902)
,p_event_id=>wwv_flow_imp.id(26075635783045903)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26076535448045901)
,p_name=>'delete_data'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(26038830969046023)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26077033362045900)
,p_event_id=>wwv_flow_imp.id(26076535448045901)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26077581981045899)
,p_event_id=>wwv_flow_imp.id(26076535448045901)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26077989980045898)
,p_event_id=>wwv_flow_imp.id(26076535448045901)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26078417676045898)
,p_name=>'reresh3'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26078906730045896)
,p_event_id=>wwv_flow_imp.id(26078417676045898)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26079382729045896)
,p_name=>'refresh1'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26079881055045895)
,p_event_id=>wwv_flow_imp.id(26079382729045896)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3419202480524152003)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26080219797045894)
,p_name=>'refresh2'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26080774521045893)
,p_event_id=>wwv_flow_imp.id(26080219797045894)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26081147193045892)
,p_name=>'refresh3'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26081634059045891)
,p_event_id=>wwv_flow_imp.id(26081147193045892)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26081995633045890)
,p_name=>'refresh4'
,p_event_sequence=>90
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26082503552045889)
,p_event_id=>wwv_flow_imp.id(26081995633045890)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26082937574045888)
,p_name=>'RESET_PROCESS'
,p_event_sequence=>100
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(26046172065045996)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26083432811045887)
,p_event_id=>wwv_flow_imp.id(26082937574045888)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26083974135045886)
,p_event_id=>wwv_flow_imp.id(26082937574045888)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26084350051045885)
,p_name=>'GEN_ENTITLE'
,p_event_sequence=>110
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(26046516570045995)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26084879387045884)
,p_event_id=>wwv_flow_imp.id(26084350051045885)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26085226734045883)
,p_event_id=>wwv_flow_imp.id(26084350051045885)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26085663723045882)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26086124002045881)
,p_event_id=>wwv_flow_imp.id(26085663723045882)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26086559526045880)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26087079754045879)
,p_event_id=>wwv_flow_imp.id(26086559526045880)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26087445431045878)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26087954116045877)
,p_event_id=>wwv_flow_imp.id(26087445431045878)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26088308437045876)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26088798863045875)
,p_event_id=>wwv_flow_imp.id(26088308437045876)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3812907384285400113)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26089262276045875)
,p_name=>'refresh_sum'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26089715756045873)
,p_event_id=>wwv_flow_imp.id(26089262276045875)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26090134574045873)
,p_name=>'import_Dept_Data'
,p_event_sequence=>180
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(26063060016045942)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26090613389045871)
,p_event_id=>wwv_flow_imp.id(26090134574045873)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26091157327045870)
,p_event_id=>wwv_flow_imp.id(26090134574045873)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26091676895045869)
,p_event_id=>wwv_flow_imp.id(26090134574045873)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26092080773045869)
,p_name=>'delete_import'
,p_event_sequence=>190
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(26063460409045941)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26092559787045868)
,p_event_id=>wwv_flow_imp.id(26092080773045869)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26093028125045867)
,p_event_id=>wwv_flow_imp.id(26092080773045869)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26093574496045866)
,p_event_id=>wwv_flow_imp.id(26092080773045869)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26093933615045865)
,p_name=>'SET_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26094421599045864)
,p_event_id=>wwv_flow_imp.id(26093933615045865)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26072044042045913)
...
,p_process_when_button_id=>wwv_flow_imp.id(26038830969046023)
,p_process_success_message=>'System succcessfully deleted the data.'
,p_internal_uid=>100174959144542549
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26054518891045972)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3419689889766359650)
...
,p_attribute_08=>'Y'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>100157433993542608
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26072479356045912)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(26046901562045994)
,p_internal_uid=>100175394458542548
);
