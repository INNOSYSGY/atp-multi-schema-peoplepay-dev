...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3222876396672057633)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3190180663368491132)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3222876396672057633)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3174572918187990463)
,p_name=>'P37_USER_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3222876396672057633)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189799815381431858)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189799907153431859)
,p_name=>'P37_PK_KEY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3222876396672057633)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189799986049431860)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189800087843431861)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189800184330431862)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189800419928431864)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189800470564431865)
,p_name=>'P37_STATUS_M'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3222876396672057633)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3189801569058431876)
,p_name=>'P37_PAGE_NUM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3222876396672057633)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3190181061218491133)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3189800816778431868)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3189800884865431869)
,p_event_id=>wwv_flow_imp.id(3189800816778431868)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3189800947306431870)
,p_event_id=>wwv_flow_imp.id(3189800816778431868)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3189801405291431874)
,p_name=>'hide_record'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3189801469323431875)
,p_event_id=>wwv_flow_imp.id(3189801405291431874)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3190180055198488504)
...
,p_process_when_button_id=>wwv_flow_imp.id(3190180663368491132)
