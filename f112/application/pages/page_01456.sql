...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(261494522615118902)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1055960627102770601)
,p_plug_name=>'OrganisationChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(261494522615118902)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135347430266100623)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(261494522615118902)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135347738753100623)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135348541651100624)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(135348978319100626)
,p_name=>'P1456_ORG_STRUCTURE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(261494522615118902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(135349400052100626)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(135349790433100627)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135350447658100628)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135350991754100628)
,p_event_id=>wwv_flow_imp.id(135350447658100628)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1055960627102770601)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135351475464100629)
,p_event_id=>wwv_flow_imp.id(135350447658100628)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135351865918100629)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135348541651100624)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135352350953100630)
,p_event_id=>wwv_flow_imp.id(135351865918100629)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
