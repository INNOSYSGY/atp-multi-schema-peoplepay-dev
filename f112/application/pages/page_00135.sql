...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182215681555029572)
,p_plug_name=>'Tabs'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182215764445029573)
,p_plug_name=>'RDS'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182215964480029575)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182216197995029578)
,p_plug_name=>'Results Double Time'
,p_parent_plug_id=>wwv_flow_imp.id(3182215964480029575)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3182215993641029576)
,p_name=>'Absent Time'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199663923640589549)
,p_query_column_id=>1
,p_column_alias=>'NULL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182216327713029579)
,p_plug_name=>'Results Absent Time'
,p_parent_plug_id=>wwv_flow_imp.id(3182215993641029576)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3182216104812029577)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199665009773589551)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199665358729589551)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199665736083589552)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199666143353589553)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199666557191589554)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199666963484589554)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199667332477589555)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199667796143589555)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3199668127738589556)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182216401386029580)
,p_plug_name=>'Results Overtime'
,p_parent_plug_id=>wwv_flow_imp.id(3182216104812029577)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3182217581136029591)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3199669204484589557)
,p_name=>'P135_SEARH_OPTION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3182217581136029591)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3199669556743589558)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3199670017974589558)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3199670408463589558)
