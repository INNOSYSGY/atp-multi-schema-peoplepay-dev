...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(32817938311062130334)
...
'    and time_stamp > current_date - to_number(:P10520_TIMEFRAME,''9999999990.99999999999'',''NLS_NUMERIC_CHARACTERS=''''.,'''''')',
'    and userid is not null',
'    and step_id is not null',
'order by time_stamp desc'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P10520_TIMEFRAME'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(32817939303143130335)
,p_name=>'Page Views'
...
,p_internal_uid=>30003451076520616491
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325189678507291274)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325189276957291274)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325188881571291273)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325188413639291273)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325188054501291273)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325187697838291271)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325187234075291271)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325186885241291270)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325186442296291270)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3325186035890291269)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(32817943640948130347)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'216456'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(32817938414159130334)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3325185253885291268)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(32817938311062130334)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3325184598579291266)
,p_name=>'P10520_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(32817938414159130334)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3325184150424291265)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10520_TIMEFRAME'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3325183658762291265)
,p_event_id=>wwv_flow_imp.id(3325184150424291265)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(32817938311062130334)
,p_attribute_01=>'N'
);
