...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245440271444436881)
...
,p_list_id=>wwv_flow_imp.id(135863809387006051)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245284973966843733)
,p_plug_name=>'Chat Sent'
,p_parent_plug_id=>wwv_flow_imp.id(245440271444436881)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245482820378949807)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245485272748949831)
,p_plug_name=>'Forward'
,p_parent_plug_id=>wwv_flow_imp.id(245482820378949807)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245485347881949832)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245485449327949833)
,p_plug_name=>'Delete'
,p_parent_plug_id=>wwv_flow_imp.id(245482820378949807)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245482986285949808)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(245486782365949846)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(245487193706949850)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(248648990569071801)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(248649038746071802)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(248649141378071803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(248649255784071804)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(248649372218071805)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(248655992861072732)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(254354369377826926)
,p_plug_name=>'Notice'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135797674196867352)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(245284973966843733)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135799438402867354)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(245485272748949831)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135800872191867356)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(245485347881949832)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135802270345867357)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(245485449327949833)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135802701570867357)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(245485449327949833)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245303432494843826)
,p_name=>'P4805_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(245440271444436881)
,p_prompt=>'Recipient'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245304399379843820)
,p_name=>'P4805_ENTRY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(245284973966843733)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245507120747949912)
,p_name=>'P4805_UTILITY_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(245482820378949807)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245511793998949941)
,p_name=>'P4805_SENT_TO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(245485272748949831)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245511873937949942)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245512339016949922)
,p_name=>'P4805_GROUP_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(245485347881949832)
,p_prompt=>'Group Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245515477772949954)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(245518483037949952)
,p_name=>'P4805_MSG_TO_DELETE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(245485449327949833)
,p_prompt=>'Message/s'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT COMMENT_TEXT||'' (''||initcap(a.user_name)||'')'' A, a.id B       ',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135818205757867395)
,p_name=>'SAVE_MSG'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135797674196867352)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135818642452867396)
,p_event_id=>wwv_flow_imp.id(135818205757867395)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135819188279867396)
,p_event_id=>wwv_flow_imp.id(135818205757867395)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(245440271444436881)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135819594840867396)
,p_name=>'refresh_chat'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135820093294867397)
,p_event_id=>wwv_flow_imp.id(135819594840867396)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135820578015867397)
,p_event_id=>wwv_flow_imp.id(135819594840867396)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135821018134867397)
,p_name=>'PURGE_CHAT'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135802270345867357)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135821498661867398)
,p_event_id=>wwv_flow_imp.id(135821018134867397)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135822012966867398)
,p_event_id=>wwv_flow_imp.id(135821018134867397)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135822406173867398)
,p_name=>'PURGE_CHAT_ALL'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135802701570867357)
,p_condition_element=>'P4805_RECIPIENT'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135822850998867398)
,p_event_id=>wwv_flow_imp.id(135822406173867398)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135823341063867399)
,p_event_id=>wwv_flow_imp.id(135822406173867398)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135823805617867399)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135824253845867399)
,p_event_id=>wwv_flow_imp.id(135823805617867399)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(135797674196867352)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135824760144867399)
,p_event_id=>wwv_flow_imp.id(135823805617867399)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135825151339867400)
,p_name=>'dyn_forward'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135799438402867354)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135825664878867400)
,p_event_id=>wwv_flow_imp.id(135825151339867400)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135814062316867390)
,p_name=>'create_group'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135800872191867356)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135814574407867392)
,p_event_id=>wwv_flow_imp.id(135814062316867390)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135815032574867393)
,p_name=>'show_group'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135815529377867393)
,p_event_id=>wwv_flow_imp.id(135815032574867393)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(135800872191867356)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135815998968867394)
,p_event_id=>wwv_flow_imp.id(135815032574867393)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135816356733867394)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135817245360867395)
,p_name=>'update_seen'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135817753756867395)
,p_event_id=>wwv_flow_imp.id(135817245360867395)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(135813724099867389)
