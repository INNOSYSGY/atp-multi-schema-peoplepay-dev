...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3235476805346694621)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3319146286937392992)
,p_region_id=>wwv_flow_imp.id(3235476805346694621)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3319146732170392997)
,p_chart_id=>wwv_flow_imp.id(3319146286937392992)
,p_seq=>10
,p_name=>'DEDUCTIONS'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3319147330254392997)
,p_chart_id=>wwv_flow_imp.id(3319146286937392992)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_decimal_places=>0
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3319147898246392997)
,p_chart_id=>wwv_flow_imp.id(3319146286937392992)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3235478096482777215)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3319144242637392988)
,p_region_id=>wwv_flow_imp.id(3235478096482777215)
,p_chart_type=>'pie'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3319144634350392992)
,p_chart_id=>wwv_flow_imp.id(3319144242637392988)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3235479103032931739)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3325356258452662658)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3235479103032931739)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3325355086998662652)
,p_name=>'P1381_PERIOD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3235479103032931739)
,p_prompt=>'Period'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3325355501589662654)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3325355838118662657)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3316025963162423959)
,p_name=>'refresh'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3316025825055423958)
,p_event_id=>wwv_flow_imp.id(3316025963162423959)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3235478096482777215)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3316025731900423957)
,p_event_id=>wwv_flow_imp.id(3316025963162423959)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3235476805346694621)
,p_attribute_01=>'N'
);
