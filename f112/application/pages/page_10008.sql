...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3361590319142962777)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3361590425056962778)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3278942782193191727)
,p_region_id=>wwv_flow_imp.id(3361590425056962778)
,p_chart_type=>'bubble'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3278941161057191723)
,p_chart_id=>wwv_flow_imp.id(3278942782193191727)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3278942398206191724)
,p_chart_id=>wwv_flow_imp.id(3278942782193191727)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3278941768089191724)
,p_chart_id=>wwv_flow_imp.id(3278942782193191727)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5119808612066832081)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3278938969743191708)
,p_name=>'P10008_FILTER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5119808612066832081)
,p_item_default=>'5000'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3280126362827352658)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3278937234848191696)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3280126289386352657)
,p_event_id=>wwv_flow_imp.id(3278937234848191696)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3361590425056962778)
,p_attribute_01=>'N'
);
