...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3921750752392062884)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3925098226298301035)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2918930703881110175)
,p_region_id=>wwv_flow_imp.id(3925098226298301035)
,p_chart_type=>'dial'
,p_width=>'240'
,p_height=>'360'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2918931161583110178)
,p_chart_id=>wwv_flow_imp.id(2918930703881110175)
,p_seq=>10
,p_name=>'Number Hired'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3925098925600301042)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2918932117779110181)
,p_region_id=>wwv_flow_imp.id(3925098925600301042)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2918934368027110184)
,p_chart_id=>wwv_flow_imp.id(2918932117779110181)
,p_seq=>20
,p_name=>'Female'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2918933775920110183)
,p_chart_id=>wwv_flow_imp.id(2918932117779110181)
,p_seq=>30
,p_name=>'Male'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2918932638087110181)
,p_chart_id=>wwv_flow_imp.id(2918932117779110181)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Age'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(2918933222390110183)
,p_chart_id=>wwv_flow_imp.id(2918932117779110181)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3925099220211301045)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(2918935841757110190)
,p_region_id=>wwv_flow_imp.id(3925099220211301045)
,p_chart_type=>'donut'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(2918936309899110191)
,p_chart_id=>wwv_flow_imp.id(2918935841757110190)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3925101400453301067)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4143350690697931768)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2918929593979110172)
,p_name=>'P10003_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3921750752392062884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2918929987118110173)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918937308802110193)
,p_name=>'refr_st'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918937766823110194)
,p_event_id=>wwv_flow_imp.id(2918937308802110193)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4143350690697931768)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918938195228110194)
,p_name=>'refresh_end'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918938673067110195)
,p_event_id=>wwv_flow_imp.id(2918938195228110194)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918939062987110195)
,p_name=>'refr_hr'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918939609766110195)
,p_event_id=>wwv_flow_imp.id(2918939062987110195)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3925098226298301035)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918939972536110196)
,p_name=>'refr_end'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_END_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918940488770110196)
,p_event_id=>wwv_flow_imp.id(2918939972536110196)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918940935967110196)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918941359324110197)
,p_event_id=>wwv_flow_imp.id(2918940935967110196)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3925098925600301042)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918941839343110197)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918942336686110198)
,p_event_id=>wwv_flow_imp.id(2918941839343110197)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3925099220211301045)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918942673793110198)
,p_name=>'refr_age_sex'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918943207540110198)
,p_event_id=>wwv_flow_imp.id(2918942673793110198)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2918943627389110199)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2918944125408110199)
,p_event_id=>wwv_flow_imp.id(2918943627389110199)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2918936930992110192)
