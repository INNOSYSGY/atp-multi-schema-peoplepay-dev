...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3169080201569900907)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(3169080272663900907)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3169080272663900907)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(20445333217328288)
,p_region_id=>wwv_flow_imp.id(3169080272663900907)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(20445419334328289)
,p_card_id=>wwv_flow_imp.id(20445333217328288)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(20551782606722110)
,p_card_id=>wwv_flow_imp.id(20445333217328288)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(20551930348722111)
,p_card_id=>wwv_flow_imp.id(20445333217328288)
,p_action_type=>'BUTTON'
,p_position=>'SECONDARY'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23146445901148715220)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23146446265384715223)
,p_plug_name=>'Search_top'
,p_parent_plug_id=>wwv_flow_imp.id(23146445901148715220)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3169602312938062239)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(23146446265384715223)
,p_button_name=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3169063768913870968)
,p_name=>'P107_ENTRY_SCREEN'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(23146446265384715223)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3169064606805870968)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3169079679804900907)
,p_name=>'P107_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3169080201569900907)
,p_prompt=>'Search'
