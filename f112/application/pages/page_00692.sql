...
,p_group_id=>wwv_flow_imp.id(3297886000196711693)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3233660020066003493)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3233668016973025010)
,p_plug_name=>'Audit'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3300587850736067291)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3300321804917700019)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3300587850736067291)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3300320139835700018)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3300322170768700020)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3300321333811700019)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3300320513722700018)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3300320931422700018)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3300311368002699999)
,p_branch_name=>'CREATE_AGAIN'
,p_branch_action=>'f?p=&APP_ID.:692:&SESSION.::&DEBUG.:692::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3300320513722700018)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3300310931493699999)
,p_branch_name=>'DELETE_BRANCH'
,p_branch_action=>'f?p=&APP_ID.:691:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3300320139835700018)
,p_branch_sequence=>2
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300314248717700004)
,p_name=>'P692_LAST_CHANGED_DATE'
,p_source_data_type=>'TIMESTAMP_LTZ'
,p_is_query_only=>true
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3233668016973025010)
,p_item_source_plug_id=>wwv_flow_imp.id(3233668016973025010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300314617855700005)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300315073592700005)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300315501910700006)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300316137605700007)
,p_name=>'P692_GOVERNMENT'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3233660020066003493)
,p_item_source_plug_id=>wwv_flow_imp.id(3233668016973025010)
,p_use_cache_before_default=>'NO'
,p_item_default=>'N'
,p_prompt=>'Government'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300316582440700008)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300316931177700009)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300317329493700009)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300317721640700011)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300318180297700012)
...
,p_lov=>'.'||wwv_flow_imp.id(3326613138417913795)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>3031561932232085882
,p_item_template_options=>'#DEFAULT#:t-Form-fieldContainer--stretchInputs'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300318544319700013)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300318909511700013)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300319379935700013)
...
,p_lov=>'.'||wwv_flow_imp.id(3326610099987913785)||'.'
,p_lov_display_null=>'YES'
,p_lov_null_text=>'--None--'
,p_cHeight=>1
,p_field_template=>3031561932232085882
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300319745033700017)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300587139008067284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300587499542067287)
,p_name=>'P692_ID_NEXT'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(3233660020066003493)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300587578664067288)
,p_name=>'P692_ID_PREV'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3233660020066003493)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3300587965213067292)
,p_name=>'P692_ORG_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3233660020066003493)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3300313770582700002)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3300313357662700002)
...
,p_when_button_pressed=>wwv_flow_imp.id(3300322170768700020)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3300313075638700001)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(3233668016973025010)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Fetch Row from TBLDEPRECIATION'
,p_internal_uid=>3184528941782386296
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3300312642044700001)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3300312295201700000)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3300320139835700018)
,p_internal_uid=>3184528161345386295
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3300586705915067279)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3300321804917700019)
