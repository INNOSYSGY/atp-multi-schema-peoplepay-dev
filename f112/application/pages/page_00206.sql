...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3263773187665260114)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3263773472667260114)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3263772375218260114)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3263773187665260114)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3263772778181260114)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3263755803227260105)
,p_branch_action=>'f?p=&APP_ID.:208:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3263772375218260114)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263760828035260107)
,p_name=>'P206_DECIMAL_CHARACTER'
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_imp.id(3263773187665260114)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263761739883260107)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263762582645260107)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263763464412260108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263764417540260109)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263767061818260110)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263768005873260110)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263768926624260111)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263769765630260111)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263770264716260112)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263771557545260113)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3263771847621260113)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3282932339428176255)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3282932386687176256)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3263770616033260112)
...
,p_when_button_pressed=>wwv_flow_imp.id(3263772375218260114)
,p_associated_item=>wwv_flow_imp.id(3263771557545260113)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3263766195424260110)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(3263772375218260114)
,p_associated_item=>wwv_flow_imp.id(3263770264716260112)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3263759991408260107)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263758453184260106)
,p_event_id=>wwv_flow_imp.id(3263759991408260107)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263758956269260106)
,p_event_id=>wwv_flow_imp.id(3263759991408260107)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263759445649260106)
,p_event_id=>wwv_flow_imp.id(3263759991408260107)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3263765887760260109)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263764862379260109)
,p_event_id=>wwv_flow_imp.id(3263765887760260109)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263765401761260109)
,p_event_id=>wwv_flow_imp.id(3263765887760260109)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3263758122516260106)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263757612587260106)
,p_event_id=>wwv_flow_imp.id(3263758122516260106)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263756642154260105)
,p_event_id=>wwv_flow_imp.id(3263758122516260106)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3263757116207260106)
,p_event_id=>wwv_flow_imp.id(3263758122516260106)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3263756108733260105)
...
,p_process_when_button_id=>wwv_flow_imp.id(3263772375218260114)
,p_internal_uid=>3147971974876946400
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3263674912567838201)
