...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(169505147317533147)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3083571600451428533)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3083571772361428535)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3083571870594428536)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3083571954063428537)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3083572007553428538)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3083572110986428539)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3083572301706428540)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739224386911491)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739382485911492)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739487294911493)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739583953911494)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739642462911495)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739750277911496)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739871778911497)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126739975139911498)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740031322911499)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740202333911500)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740269284911501)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740353545911502)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740430463911503)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740606312911504)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740696926911505)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126740800176911506)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3126752548203916223)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3126763561767152303)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3126763735085152305)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126763826498152306)
,p_db_column_name=>'REGNO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126763908907152307)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764047524152308)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764123393152309)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764296736152310)
,p_db_column_name=>'SSN'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764316024152311)
,p_db_column_name=>'SURNAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764443709152312)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764570918152313)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764629876152314)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764792123152315)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126764906569152316)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765006253152317)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765011846152318)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765133758152319)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765238870152320)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765315879152321)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765494545152322)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765564042152323)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765628357152324)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765736210152325)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765855195152326)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3126765983764152327)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3327873460219996240)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3327887068421429756)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3327887168937429756)
,p_name=>'eNIS Output'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172086508228972540)
,p_db_column_name=>'REGNO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172086935842972542)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172087342290972543)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172087717776972543)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172088169734972543)
,p_db_column_name=>'SSN'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172088490716972543)
,p_db_column_name=>'SURNAME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172088890982972544)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172089351802972544)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172089705973972544)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172090100623972545)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172090553678972545)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172090968318972545)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172091356502972546)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172091773553972546)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172092154078972546)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172092519555972546)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172092896956972547)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172093380467972547)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172093691479972547)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172094123500972548)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3172094581669972548)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3327888151930434439)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3083571643975428534)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3083571600451428533)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3126763701432152304)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3126763561767152303)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3172081056090972533)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(169505147317533147)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3172081455279972534)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(169505147317533147)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3172081807247972534)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(169505147317533147)
,p_button_name=>'PURGE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3172082241708972534)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(169505147317533147)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3172082608445972535)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(169505147317533147)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3172095353639972552)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3327887068421429756)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3172097530123972555)
...
,p_branch_when_button_id=>wwv_flow_imp.id(3172082241708972534)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24658690410746686)
,p_name=>'P1403_W1'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24658861770746687)
,p_name=>'P1403_W2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
,p_prompt=>'Week 2'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24658956522746688)
,p_name=>'P1403_W3'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
,p_prompt=>'Week 3'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24658991675746689)
,p_name=>'P1403_W4'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
,p_prompt=>'Week 4'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(24659149592746690)
,p_name=>'P1403_W5'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
,p_prompt=>'Week 5'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172083048481972535)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172083421613972535)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172083828788972535)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172084211784972536)
,p_name=>'P1403_EYEAR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
,p_prompt=>'Year'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172084646820972536)
,p_name=>'P1403_MONTH'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3327873460219996240)
,p_prompt=>'Month'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172085036213972536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172085413570972536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3172085882038972537)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3172096540712972553)
,p_name=>'CS6 Form'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3172095353639972552)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3172097012476972554)
,p_event_id=>wwv_flow_imp.id(3172096540712972553)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(24658500471746684)
,p_name=>'Clear'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(24658605963746685)
,p_event_id=>wwv_flow_imp.id(24658500471746684)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Clear'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3172095731463972553)
...
,p_process_when_button_id=>wwv_flow_imp.id(3172081455279972534)
,p_process_success_message=>'Successful execution of eNIS.'
,p_internal_uid=>3056311597607658848
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3172096186866972553)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3172081807247972534)
