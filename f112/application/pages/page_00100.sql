...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3141989917809346772)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3141989839449346739)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189988660430235052)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189989494497235052)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189989865487235053)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189990273285235054)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189989136132235052)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189990736833235054)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189991116344235054)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189991474436235054)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189988289029235049)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3189991861051235055)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3178027175791699744)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3141988714000345636)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314074169935184396)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
,p_name=>'Anniversary '
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314074590031184397)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
,p_name=>'Birthday '
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314074973384184398)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
,p_name=>'Confirmation'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314075395090184399)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
,p_name=>'Gratuity'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314075799062184400)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314076196332184401)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314076587095184401)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314076990561184402)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
,p_name=>'Retirement'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3314077411311184404)
,p_report_id=>wwv_flow_imp.id(3141988714000345636)
,p_name=>'work permit'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3174778817600816165)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3174779288169816174)
,p_report_id=>wwv_flow_imp.id(3174778817600816165)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3217388931163924825)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3217389026849924826)
,p_plug_name=>'NOTIFICATION'
,p_parent_plug_id=>wwv_flow_imp.id(3217388931163924825)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3177578457163604862)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3177577565324604860)
,p_event_id=>wwv_flow_imp.id(3177578457163604862)
,p_event_result=>'TRUE'
