...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9661736701623200493)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9661737706787200503)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(143480441907457076)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(9661737706787200503)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(143479796901457075)
,p_name=>'P99993_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9661736701623200493)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(169280843809012069)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(169281284835012069)
,p_event_id=>wwv_flow_imp.id(169280843809012069)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(169281773513012070)
,p_event_id=>wwv_flow_imp.id(169280843809012069)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(143480837084457076)
...
,p_process_when_button_id=>wwv_flow_imp.id(143480441907457076)
