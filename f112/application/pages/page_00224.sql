...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(142630389530158836)
,p_plug_name=>'bc'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(287657468231858079)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(880856792653255954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(893083269153622078)
,p_plug_name=>'Income Details'
,p_region_name=>'emp_time_incomes'
,p_parent_plug_id=>wwv_flow_imp.id(880856792653255954)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(861805667119075717)
,p_name=>'INCOME_CODE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(866555088171897887)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(872549409613214911)
,p_name=>'START_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(872549471353214912)
,p_name=>'END_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893083483131622080)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893083595195622081)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893083743489622082)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893083776481622083)
,p_name=>'ORGDTL_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893083892192622084)
,p_name=>'EMPENT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893084050086622086)
,p_name=>'RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893084159764622087)
,p_name=>'QUANTITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893084306018622088)
,p_name=>'AMOUNT_PAID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893084527840622090)
,p_name=>'PAYSTATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893084624519622091)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893200491234112942)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893200554743112943)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893200697709112944)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893200814873112945)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893200969683112947)
,p_name=>'APPROVED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893201138103112948)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893201167512112949)
,p_name=>'VERIFIED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893201340270112950)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893201384299112951)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(893201539678112952)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1112003969604363665)
,p_name=>'WEEK_DAY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(893083390864622079)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(893206134193119948)
,p_interactive_grid_id=>wwv_flow_imp.id(893083390864622079)
,p_static_id=>'306825'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(893206317895119948)
,p_report_id=>wwv_flow_imp.id(893206134193119948)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(866559692374900139)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(861805667119075717)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(866577686441900180)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(866555088171897887)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>157
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(877356706341235221)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(872549409613214911)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>162
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(877357612063235224)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(872549471353214912)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>183
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893206812688119949)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(893083483131622080)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893207734146119950)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(893083595195622081)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>117
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893208589978119953)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(893083743489622082)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>196
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893209533800119954)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(893083776481622083)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>275
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893210393528119956)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(893083892192622084)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>136
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893212240346119959)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(893084050086622086)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893213123565119960)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(893084159764622087)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>74
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893213990754119962)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(893084306018622088)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>94
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893215818618119965)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(893084527840622090)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>84
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893216741599119966)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(893084624519622091)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>102
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893217555907119967)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(893200491234112942)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>225
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893218475573119969)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(893200554743112943)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893219386967119970)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(893200697709112944)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893220232907119972)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(893200814873112945)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893221957082119974)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(893200969683112947)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893222886246119976)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(893201138103112948)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893223826060119977)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>24
,p_column_id=>wwv_flow_imp.id(893201167512112949)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893224651837119979)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>25
,p_column_id=>wwv_flow_imp.id(893201340270112950)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893225561402119980)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(893201384299112951)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>153
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(893226537901119981)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(893201539678112952)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>107
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1111147648822828869)
,p_view_id=>wwv_flow_imp.id(893206317895119948)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1112003969604363665)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>71
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(895097868055915233)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(936358645005902299)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(872550308569214920)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933768043005995113)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933769241924995125)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933769319892995126)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933769394595995127)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933769470883995128)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933769819983995131)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REMARKS'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933769967286995133)
,p_name=>'PAY_STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933770072321995134)
,p_name=>'LEAVE_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933990246029157090)
,p_name=>'TRANSACTION_TYPE_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRANSACTION_TYPE_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(933990273227157091)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'STATUS'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(936357204809902285)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(936357445185902287)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(936357561025902288)
,p_name=>'LEAVE_MODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(936358229529902295)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(936358295751902296)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(936358433178902297)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(937980170472414323)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(936358527158902298)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(933764468906993274)
,p_interactive_grid_id=>wwv_flow_imp.id(936358527158902298)
,p_static_id=>'698710'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(933764313857993274)
,p_report_id=>wwv_flow_imp.id(933764468906993274)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(879001210033861415)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(872550308569214920)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>92
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(932237995469201341)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(937980170472414323)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>103
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933744037008993234)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(933769241924995125)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933744884082993236)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(933769319892995126)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933745774116993237)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(933769394595995127)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933746672676993239)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(933769470883995128)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933749447031993243)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(933769819983995131)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>96
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933751230516993247)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(933769967286995133)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>82
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933752120022993249)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(933770072321995134)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>177
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933753033747993250)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(936357204809902285)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933754846181993255)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(936357445185902287)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>128
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933755739510993257)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(936357561025902288)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933762001050993268)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(936358229529902295)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>222
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933762889477993269)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(936358295751902296)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>102
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933763766149993271)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(936358433178902297)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933969222684696628)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(933768043005995113)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>145
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(934314146746320955)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(933990246029157090)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>115
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(934315472257320957)
,p_view_id=>wwv_flow_imp.id(933764313857993274)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(933990273227157091)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>83
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(936613388882748880)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(937622437737720584)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460029451688777039)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460029027940777039)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460028720560777038)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460028308377777038)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460027923052777037)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460027523369777037)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460027061779777037)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460026634743777036)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460026259343777036)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460030272505777040)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460029898156777039)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460025842438777035)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(938066351640718958)
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(951029550405218901)
,p_report_id=>wwv_flow_imp.id(938066351640718958)
,p_pivot_columns=>'DAY_NUMBERC'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(147090454355854377)
,p_pivot_id=>wwv_flow_imp.id(951029550405218901)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(937504306430114642)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(938070380780748167)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460023045394777031)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460022659337777031)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Emp Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460022286073777030)
,p_db_column_name=>'EMP_COMPANY_NO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Emp Company No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460021884733777030)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Emp Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460021423794777029)
,p_db_column_name=>'WKLOCATION_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Work Location'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460020935090777029)
,p_db_column_name=>'DEPARTMENT'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460020598162777028)
,p_db_column_name=>'DESIGNATION'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Designation'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460020155334777028)
,p_db_column_name=>'PAYMENT_TYPE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Payment Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460023993928777032)
,p_db_column_name=>'DAY_NUMBERC'
,p_display_order=>90
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460023521784777031)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460019322643777027)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460019674216777027)
,p_db_column_name=>'CODE_QTY'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(938138265893754982)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(951031626440223701)
,p_report_id=>wwv_flow_imp.id(938138265893754982)
,p_pivot_columns=>'DAY_NUMBERC:INCOME_CODE'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(147095467455854382)
,p_pivot_id=>wwv_flow_imp.id(951031626440223701)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(938018671348717175)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(938018804767717176)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460016551824777023)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460016161779777023)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Emp Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460015705910777022)
,p_db_column_name=>'EMP_COMPANY_NO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Emp Company No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460015273643777022)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Emp Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460014888720777021)
,p_db_column_name=>'WKLOCATION_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Work Location'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460014468664777021)
,p_db_column_name=>'DEPARTMENT'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460014075779777021)
,p_db_column_name=>'DESIGNATION'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Designation'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460013623703777020)
,p_db_column_name=>'PAYMENT_TYPE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Payment Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460013182470777020)
,p_db_column_name=>'ABS_CODE'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Abs Code'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460017422701777024)
,p_db_column_name=>'DAY_NUMBERC'
,p_display_order=>110
,p_column_identifier=>'AP'
,p_column_label=>'Day Numberc'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460016954915777024)
,p_db_column_name=>'ABSENCE_HOURS'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460012762175777019)
,p_db_column_name=>'CODE_QTY'
,p_display_order=>130
,p_column_identifier=>'AR'
,p_column_label=>'Code Qty'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(938137648653754975)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(951030561209221636)
,p_report_id=>wwv_flow_imp.id(938137648653754975)
,p_pivot_columns=>'ABS_CODE'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(147100462129854388)
,p_pivot_id=>wwv_flow_imp.id(951030561209221636)
,p_display_seq=>1
,p_function_name=>'SUM'
,p_column_name=>'ABSENCE_HOURS'
,p_db_column_name=>'PFC1'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(957735457034230973)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(954436622548609773)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(954436679295609774)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(954436779079609775)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957734500238230963)
,p_name=>'DATE_CREATED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957734546938230964)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957734732041230965)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957734831117230966)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957734934439230967)
,p_name=>'HOURS_WORKED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957735032801230968)
,p_name=>'TIME_SOURCE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957735072100230969)
,p_name=>'TIME_OUT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957735141872230970)
,p_name=>'TIME_IN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(957735297236230971)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(957735339294230972)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(953791604398702050)
,p_interactive_grid_id=>wwv_flow_imp.id(957735339294230972)
,p_static_id=>'335594'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(953791416900702049)
,p_report_id=>wwv_flow_imp.id(953791604398702050)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(950468195640177233)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(954436622548609773)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(950469106370177235)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(954436679295609774)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>141.1406
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(950469966349177238)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(954436779079609775)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>108.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953783712522702031)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(957734500238230963)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>145.141
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953784570713702033)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(957734546938230964)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953785475266702035)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(957734732041230965)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>154.14100000000002
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953786379990702037)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(957734831117230966)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>127.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953787266413702039)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(957734934439230967)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953788208346702041)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(957735032801230968)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>90.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953789095261702043)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(957735072100230969)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>148.5156
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953789956230702045)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(957735141872230970)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>161.266
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(953790912586702048)
,p_view_id=>wwv_flow_imp.id(953791416900702049)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(957735297236230971)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.5156
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(966987088692556067)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(956161986479513168)
,p_name=>'OVERRIDE_LLH'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(956164402191513192)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986135535556058)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986298125556059)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986368512556060)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986527436556061)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986660772556063)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986804834556064)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(966986906826556065)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(966986979064556066)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(956361399282676788)
,p_interactive_grid_id=>wwv_flow_imp.id(966986979064556066)
,p_static_id=>'309896'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(956361143553676787)
,p_report_id=>wwv_flow_imp.id(956361399282676788)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(955694263067183097)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(956161986479513168)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956147085534391315)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(956164402191513192)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956354437116676768)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(966986135535556058)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956355375427676770)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(966986298125556059)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956356317160676772)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(966986368512556060)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956357152583676774)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(966986527436556061)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956358883981676778)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(966986660772556063)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956359764195676781)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(966986804834556064)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(956360723575676783)
,p_view_id=>wwv_flow_imp.id(956361143553676787)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(966986906826556065)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(899712368648505978)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(899712504177505979)
,p_plug_name=>'Master Records'
,p_region_name=>'fx'
,p_parent_plug_id=>wwv_flow_imp.id(899712368648505978)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(929836819771986685)
,p_max_row_count=>'1000000'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460086291241777113)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460085858860777112)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460085424345777112)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460085000061777111)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460084564706777111)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460084144421777111)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460083743635777110)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460083297127777110)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460082862730777109)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460082481941777109)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460082049736777109)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460081652825777108)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460081146541777108)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460086687374777113)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460080749970777107)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460080415240777107)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460087061488777114)
,p_db_column_name=>'LH'
,p_display_order=>280
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460078275441777105)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460078644622777105)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460079059942777105)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460079524387777106)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460079937157777106)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460077871766777104)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(460077413411777104)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(930478120164464089)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(899712568239505980)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(876356644641694189)
,p_name=>'TIME_SOURCE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_SOURCE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(880950964222668257)
,p_name=>'PKEY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900523535211226456)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900523755734226458)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900523823057226459)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900523895034226460)
,p_name=>'TIME_IN'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_IN'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900523964526226461)
,p_name=>'TIME_OUT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_OUT'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900524743928226468)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(900524833187226469)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(928178998486953554)
,p_name=>'CALENDAR_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(930313707870086274)
,p_name=>'HOURS_WORKED'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'HOURS_WORKED'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(930436786529462064)
,p_name=>'WKDATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(954885781377564991)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(900523458602226455)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(900573097048247672)
,p_interactive_grid_id=>wwv_flow_imp.id(900523458602226455)
,p_static_id=>'318730'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(900573264353247672)
,p_report_id=>wwv_flow_imp.id(900573097048247672)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(880854193925228556)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(876356644641694189)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(883400095228854485)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(880950964222668257)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>40
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900573763680247674)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(900523535211226456)
,p_is_visible=>false
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900575634074247679)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(900523755734226458)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900576520138247681)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(900523823057226459)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900577443695247683)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(900523895034226460)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>107
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900578267771247686)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(900523964526226461)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>94
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900584618415247702)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(900524743928226468)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>124
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(900585548053247705)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(900524833187226469)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(931565852071694416)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(930436786529462064)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(933984547589120320)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(928178998486953554)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(936021162555949367)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(930313707870086274)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>104
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(954763856686387364)
,p_view_id=>wwv_flow_imp.id(900573264353247672)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(954885781377564991)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(937648864137719504)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147064206504854348)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(287657468231858079)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147112198867854399)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(899712368648505978)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147112629206854399)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147113011420854399)
...
,p_security_scheme=>wwv_flow_imp.id(146746677270719526)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147128261196854416)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(937648864137719504)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147128647217854417)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147129132236854417)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(147129444581854417)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(148776482567115947)
,p_name=>'P224_REPORT_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(937648864137719504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(446240883506953357)
,p_name=>'P224_L_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(287657468231858079)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(446241383096956469)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(446241779327956469)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(446242199147956470)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460099851674777124)
,p_name=>'P224_OVERRIDE_LLH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(966987088692556067)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460130001984777157)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460130366956777158)
,p_name=>'P224_URL'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(937648864137719504)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460130823469777158)
,p_name=>'P224_DYVP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(937648864137719504)
,p_item_default=>'300'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460131226012777159)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460131627685777159)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460132137737777159)
,p_name=>'P224_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(937648864137719504)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460132523238777160)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460132883042777160)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460133264629777161)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460133759935777161)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460134230232777162)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460134586126777162)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(460137660675777171)
,p_name=>'P224_VWFLAG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(899712368648505978)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147136061850854425)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147136614300854426)
,p_event_id=>wwv_flow_imp.id(147136061850854425)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(899712504177505979)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147137081848854426)
,p_event_id=>wwv_flow_imp.id(147136061850854425)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147137567436854427)
,p_event_id=>wwv_flow_imp.id(147136061850854425)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147138031842854427)
,p_name=>'dy_get_mastergrid_data'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(899712504177505979)
,p_bind_type=>'live'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_IG|REGION TYPE|interactivegridselectionchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147138471375854427)
,p_event_id=>wwv_flow_imp.id(147138031842854427)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147139031361854427)
,p_event_id=>wwv_flow_imp.id(147138031842854427)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(899712568239505980)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147139345612854428)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147139908299854428)
,p_event_id=>wwv_flow_imp.id(147139345612854428)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147140256013854428)
,p_name=>'dy_calculate_hoursworked'
,p_event_sequence=>100
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(899712568239505980)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147140822303854428)
,p_event_id=>wwv_flow_imp.id(147140256013854428)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147141185215854429)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147141683424854429)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147142168556854429)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(893083269153622078)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147142691548854429)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(936358645005902299)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147143147348854430)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(936613388882748880)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147143655450854430)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147144207895854430)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(966987088692556067)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147144655280854430)
,p_event_id=>wwv_flow_imp.id(147141185215854429)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(957735457034230973)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147145037580854431)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147145584256854431)
,p_event_id=>wwv_flow_imp.id(147145037580854431)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147145982541854431)
,p_name=>'New'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147146444816854431)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147147006671854432)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147147439625854432)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147147963776854432)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147148505045854432)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(899712368648505978)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147148938303854433)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147149505945854433)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147149994317854433)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'FALSE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147150511645854434)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147150985435854434)
,p_event_id=>wwv_flow_imp.id(147145982541854431)
,p_event_result=>'FALSE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147151373869854434)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147151853607854435)
,p_event_id=>wwv_flow_imp.id(147151373869854434)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147152236771854435)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147152791467854435)
,p_event_id=>wwv_flow_imp.id(147152236771854435)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147153303038854435)
,p_event_id=>wwv_flow_imp.id(147152236771854435)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(938018671348717175)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147153797304854436)
,p_event_id=>wwv_flow_imp.id(147152236771854435)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(937504306430114642)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147154239719854436)
,p_event_id=>wwv_flow_imp.id(147152236771854435)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147154775162854436)
,p_event_id=>wwv_flow_imp.id(147152236771854435)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147155266793854436)
,p_event_id=>wwv_flow_imp.id(147152236771854435)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147155676693854437)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147156179927854437)
,p_event_id=>wwv_flow_imp.id(147155676693854437)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147156666070854437)
,p_event_id=>wwv_flow_imp.id(147155676693854437)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147157099336854437)
,p_name=>'dy_set_caldendar_id'
,p_event_sequence=>290
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(893083269153622078)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147157570483854438)
,p_event_id=>wwv_flow_imp.id(147157099336854437)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147158033127854438)
,p_name=>'set_focus'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147158504669854438)
,p_event_id=>wwv_flow_imp.id(147158033127854438)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147158929563854439)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147159336998854439)
,p_event_id=>wwv_flow_imp.id(147158929563854439)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147159831644854439)
,p_name=>'refresh_emp_id_1'
,p_event_sequence=>350
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(936358645005902299)
,p_triggering_element=>'WORK_DATE'
,p_condition_element_type=>'COLUMN'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147160267660854439)
,p_event_id=>wwv_flow_imp.id(147159831644854439)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147160637246854440)
,p_name=>'dy_set_value'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147161211042854440)
,p_event_id=>wwv_flow_imp.id(147160637246854440)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147161548811854440)
,p_name=>'TIMESHEET_TIMES_OnPreme'
,p_event_sequence=>370
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(147128261196854416)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147162100094854440)
,p_event_id=>wwv_flow_imp.id(147161548811854440)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147162458946854440)
,p_name=>'TIMESHEET_SUMMARY_OnPreme'
,p_event_sequence=>380
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(147128647217854417)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147162946334854441)
,p_event_id=>wwv_flow_imp.id(147162458946854440)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147163345427854441)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147163871169854441)
,p_event_id=>wwv_flow_imp.id(147163345427854441)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147164295290854442)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147164768079854442)
,p_event_id=>wwv_flow_imp.id(147164295290854442)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147165200223854442)
,p_name=>'ref_empid'
,p_event_sequence=>410
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(966987088692556067)
,p_triggering_element=>'WORK_DATE'
,p_condition_element_type=>'COLUMN'
,p_condition_element=>'ENTERED_BY'
,p_triggering_condition_type=>'NOT_NULL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147165712065854442)
,p_event_id=>wwv_flow_imp.id(147165200223854442)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147166093121854442)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147166573807854443)
,p_event_id=>wwv_flow_imp.id(147166093121854442)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147167094948854443)
,p_event_id=>wwv_flow_imp.id(147166093121854442)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147167477074854443)
,p_name=>'set_llh_val'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147168011120854444)
,p_event_id=>wwv_flow_imp.id(147167477074854443)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147168375704854444)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147168867299854444)
,p_event_id=>wwv_flow_imp.id(147168375704854444)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147169272775854444)
,p_name=>'dy_showhide'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147169694818854444)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147170148330854445)
,p_event_id=>wwv_flow_imp.id(147169694818854444)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147170623507854445)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147171056234854445)
,p_event_id=>wwv_flow_imp.id(147170623507854445)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147171527377854445)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147171970151854446)
,p_event_id=>wwv_flow_imp.id(147171527377854445)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147172486149854446)
,p_event_id=>wwv_flow_imp.id(147171527377854445)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147173012748854446)
,p_event_id=>wwv_flow_imp.id(147171527377854445)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147173411444854446)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147173920037854447)
,p_event_id=>wwv_flow_imp.id(147173411444854446)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147174364145854447)
,p_event_id=>wwv_flow_imp.id(147173411444854446)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147174846393854447)
,p_event_id=>wwv_flow_imp.id(147173411444854446)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147175319614854448)
,p_name=>'Preview_Report_Cloud_1_1'
,p_event_sequence=>520
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(147129132236854417)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147175823197854448)
,p_event_id=>wwv_flow_imp.id(147175319614854448)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147176317904854448)
,p_event_id=>wwv_flow_imp.id(147175319614854448)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147176823352854448)
,p_event_id=>wwv_flow_imp.id(147175319614854448)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147177143788854449)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147177723081854449)
,p_event_id=>wwv_flow_imp.id(147177143788854449)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147178114995854449)
,p_name=>'REFRESH_MASTER'
,p_event_sequence=>540
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(147112198867854399)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147178620939854449)
,p_event_id=>wwv_flow_imp.id(147178114995854449)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(147179012366854450)
,p_name=>'dy_open_dialog'
,p_event_sequence=>550
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(147129444581854417)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(147179490371854450)
,p_event_id=>wwv_flow_imp.id(147179012366854450)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_OPEN_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(287657468231858079)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(147135327767854423)
...
,p_process_when_button_id=>wwv_flow_imp.id(147112629206854399)
,p_process_success_message=>'Verifed Timesheet within selected period '
,p_internal_uid=>31351193911540718
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(147135654637854424)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(147064206504854348)
,p_internal_uid=>31350767650540718
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(147134480006854423)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(147134042658854422)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(147133717815854421)
