...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7935214182268685470)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7935215187432685480)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(143474467296445874)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(7935215187432685480)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(143473790572445874)
,p_name=>'P9961_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7935214182268685470)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(169618602591763087)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(169619019333763087)
,p_event_id=>wwv_flow_imp.id(169618602591763087)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(169619466749763088)
,p_event_id=>wwv_flow_imp.id(169618602591763087)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(143474864736445875)
...
,p_process_when_button_id=>wwv_flow_imp.id(143474467296445874)
