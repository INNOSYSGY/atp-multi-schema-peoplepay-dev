...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3269243153360101195)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3324388679397464790)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3171655662404590985)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3269243153360101195)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3171655338533590985)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3171654908767590985)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(139347265801162047)
,p_name=>'P89_PARAMETERS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3269243153360101195)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171651299369590982)
,p_name=>'P89_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3269243153360101195)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171651687410590982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171652089181590982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171652469464590983)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171652904072590983)
...
,p_lov=>'.'||wwv_flow_imp.id(3189714434774310225)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171653316953590983)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171653732602590983)
,p_name=>'P89_ACTIVE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3269243153360101195)
,p_item_default=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171654141914590984)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3171654511136590984)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3178266751871608867)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3171650540181590980)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171649491492590979)
,p_event_id=>wwv_flow_imp.id(3171650540181590980)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171649984353590979)
,p_event_id=>wwv_flow_imp.id(3171650540181590980)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3171649079557590979)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3171654908767590985)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171648594064590978)
,p_event_id=>wwv_flow_imp.id(3171649079557590979)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171648060903590978)
,p_event_id=>wwv_flow_imp.id(3171649079557590979)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3171647731346590978)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171647245634590977)
,p_event_id=>wwv_flow_imp.id(3171647731346590978)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171646701427590977)
,p_event_id=>wwv_flow_imp.id(3171647731346590978)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171646223288590977)
,p_event_id=>wwv_flow_imp.id(3171647731346590978)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3171645811831590977)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3171655338533590985)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171645270211590976)
,p_event_id=>wwv_flow_imp.id(3171645811831590977)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171644815831590976)
,p_event_id=>wwv_flow_imp.id(3171645811831590977)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3171644306453590976)
,p_event_id=>wwv_flow_imp.id(3171645811831590977)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3171650911976590980)
...
,p_process_when_button_id=>wwv_flow_imp.id(3171654908767590985)
