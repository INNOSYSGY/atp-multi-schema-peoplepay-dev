...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1859118811373791093)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1854813493843250078)
,p_plug_name=>'PositionChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(1859118811373791093)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135331993623032442)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1859118811373791093)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135332338438032443)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(135332766270032443)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(135333202248032447)
,p_name=>'P95_POSITION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1859118811373791093)
,p_prompt=>'Position'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(135333608634032448)
,p_name=>'P95_FILTER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1859118811373791093)
,p_item_default=>'2'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135334246671032454)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135334825780032456)
,p_event_id=>wwv_flow_imp.id(135334246671032454)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1854813493843250078)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135335319322032456)
,p_event_id=>wwv_flow_imp.id(135334246671032454)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(135335653282032456)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(135332766270032443)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(135336171160032457)
,p_event_id=>wwv_flow_imp.id(135335653282032456)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
