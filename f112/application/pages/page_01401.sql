...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(96541912083140512)
,p_plug_name=>'RS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(96542051058140513)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3572387026615315203)
,p_plug_name=>'Requirements Generation (Save the data entered in grid before generating)'
,p_parent_plug_id=>wwv_flow_imp.id(96542051058140513)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494414584478478388)
,p_name=>'KEY_VALUE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494414672441478389)
,p_name=>'RULE_OPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494414818557478390)
,p_name=>'RULE_VALUE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494414851057478391)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494414933389478392)
,p_name=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494415070768478393)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3494415176316478394)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3494414441525478387)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3496730364478233401)
,p_interactive_grid_id=>wwv_flow_imp.id(3494414441525478387)
,p_static_id=>'18206'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3496730435925233401)
,p_report_id=>wwv_flow_imp.id(3496730364478233401)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3496730943578233407)
,p_view_id=>wwv_flow_imp.id(3496730435925233401)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3494414584478478388)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>241
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3496731527518233415)
,p_view_id=>wwv_flow_imp.id(3496730435925233401)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3494414672441478389)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>488
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3496731957731233420)
,p_view_id=>wwv_flow_imp.id(3496730435925233401)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3494414818557478390)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>566
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3496732453148233423)
,p_view_id=>wwv_flow_imp.id(3496730435925233401)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3494414851057478391)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>361.0001220703125
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3496732986299233427)
,p_view_id=>wwv_flow_imp.id(3496730435925233401)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3494414933389478392)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3496733509637233432)
,p_view_id=>wwv_flow_imp.id(3496730435925233401)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3494415070768478393)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3586458319100301443)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3586458518812301457)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3572246114219302290)
,p_plug_name=>'Exclusions From Search Results'
,p_parent_plug_id=>wwv_flow_imp.id(3586458518812301457)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3586480042902574289)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3586836721364527473)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(169429695066457751)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3654548933213472389)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3476075524928740333)
,p_plug_name=>'Existing Records Remuneration'
,p_parent_plug_id=>wwv_flow_imp.id(3654548933213472389)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3476075633895740334)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105834792398354958)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105835164682354958)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105835604841354959)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105836001464354960)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105836387597354960)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105836778118354961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105837199479354961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105837585210354962)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105837985325354963)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105838404613354963)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105838752339354964)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105839110654354965)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105839605368354965)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105839947832354966)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105840359756354967)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105840751414354967)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105841200003354968)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105841556569354969)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105841994656354969)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105842376977354970)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3476606837600575515)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3654549008336472390)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3654549119206472391)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105846416721354981)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105846864181354982)
,p_db_column_name=>'ENTITLEMENT_CURRENCY'
,p_display_order=>20
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105847291392354983)
,p_db_column_name=>'EMP_ID'
,p_display_order=>30
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105847666453354984)
,p_db_column_name=>'INCOME_TYPE'
,p_display_order=>40
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105848106510354985)
,p_db_column_name=>'INCOME_CODE_ID'
,p_display_order=>50
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105848498735354985)
,p_db_column_name=>'TAXABLE'
,p_display_order=>60
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105848830231354986)
,p_db_column_name=>'NIS_DEDUCTION'
,p_display_order=>70
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105849243667354987)
,p_db_column_name=>'AMOUNT'
,p_display_order=>80
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105849662267354987)
,p_db_column_name=>'EXPENSE_CODE_ID'
,p_display_order=>90
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105850022996354988)
,p_db_column_name=>'STD_DETAIL_KEY'
,p_display_order=>100
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105850432850354988)
,p_db_column_name=>'ADMIN_STATUS'
,p_display_order=>110
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105850842287354989)
,p_db_column_name=>'PERCENTAGE'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105851249035354990)
,p_db_column_name=>'REMARKS'
,p_display_order=>130
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105851621098354991)
,p_db_column_name=>'QUICK_ENTRY'
,p_display_order=>140
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105852082087354991)
,p_db_column_name=>'START_DATE'
,p_display_order=>150
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105852426751354992)
,p_db_column_name=>'END_DATE'
,p_display_order=>160
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105852840256354993)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>170
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105853280434354993)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>180
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105853686067354994)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>190
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105854038578354995)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>200
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105854360132354996)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3654974911656022159)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3655510791644642801)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3655511012473642803)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105855860179354999)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105856249831354999)
,p_db_column_name=>'EMP_ID'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105856663048355000)
,p_db_column_name=>'START_DATE'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105857101408355000)
,p_db_column_name=>'END_DATE'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'End Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105857468820355000)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105857823858355001)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105858210623355001)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105858666128355002)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105859024491355002)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105859462634355003)
...
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(3326575609416849576)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3655587430398051784)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3676598619865270765)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3676598841933270767)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105861344530355006)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105861792369355007)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105862171763355008)
,p_db_column_name=>'EMP_ID'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105862515835355008)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105862921724355009)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105863330356355009)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105863800027355010)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105864148385355010)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105864525747355011)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105864942116355011)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105865321998355012)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105865778876355012)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105866141922355013)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105866508006355014)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105866980940355014)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105867318717355015)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105867756915355015)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105868205110355016)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105868558905355016)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>26
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105868954035355017)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105869316243355017)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>30
,p_column_identifier=>'AD'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105869721268355018)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105870176205355018)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105870583996355019)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105871006192355019)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105871310583355020)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105871718704355020)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105872207229355021)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105872543038355022)
,p_db_column_name=>'REMARKS'
,p_display_order=>40
,p_column_identifier=>'AN'
,p_column_label=>'Remarks'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105872936693355023)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>41
,p_column_identifier=>'AO'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105873336697355023)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105873773420355024)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>43
,p_column_identifier=>'AQ'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105874127339355024)
,p_db_column_name=>'MACHINE_INSERT'
,p_display_order=>44
,p_column_identifier=>'AR'
,p_column_label=>'Machine Insert'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105874565218355025)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105874972198355025)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105860911481355005)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3567723904148475884)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3105875744627355027)
,p_report_id=>wwv_flow_imp.id(3567723904148475884)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3676602620287271576)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3777339822185249413)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3777339533009249411)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105876863394355030)
,p_db_column_name=>'ENTERED_BY'
,p_display_order=>170
,p_column_identifier=>'AL'
,p_column_label=>'Entered By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105877303427355031)
,p_db_column_name=>'ENTRY_DATE'
,p_display_order=>180
,p_column_identifier=>'AM'
,p_column_label=>'Entry Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105877680501355031)
,p_db_column_name=>'LAST_CHANGED_BY'
,p_display_order=>190
,p_column_identifier=>'AN'
,p_column_label=>'Last Changed By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105878028548355032)
,p_db_column_name=>'LAST_CHANGED_DATE'
,p_display_order=>200
,p_column_identifier=>'AO'
,p_column_label=>'Last Changed Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105878486645355032)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105878895465355033)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105879284519355033)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105879680113355034)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105880070851355035)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105880412037355037)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105880873991355038)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105881272092355038)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3105881612732355039)
,p_db_column_name=>'ID'
,p_display_order=>290
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3774973220131729899)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105860238494355003)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3655510791644642801)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105800946355354906)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3572387026615315203)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105806600256354922)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3586458319100301443)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105817170885354934)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3586480042902574289)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105828711675354946)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3586836721364527473)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105855144214354997)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3654549008336472390)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105801382125354907)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105806931597354922)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3586458319100301443)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105817579141354934)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3586480042902574289)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105829192984354947)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3586836721364527473)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3105843469468354975)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3586458518812301457)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3105930251744355087)
...
,p_branch_when_button_id=>wwv_flow_imp.id(3105806931597354922)
,p_branch_sequence=>1
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3105930611786355087)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3105929823671355086)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105801755440354912)
,p_name=>'P1401_ORGANISATION_RULE'
,p_is_required=>true
,p_item_sequence=>400
,p_item_plug_id=>wwv_flow_imp.id(3572387026615315203)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105802203388354914)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105802596998354914)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105802993427354914)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105803371348354915)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105803736455354915)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105804184804354916)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105804522510354916)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105804970676354917)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105807349207354923)
,p_name=>'P1401_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3586458319100301443)
,p_item_default=>':APP_ORG_ID'
,p_item_default_type=>'EXPRESSION'
,p_item_default_language=>'PLSQL'
,p_prompt=>'Organisation'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105807754858354924)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105808175914354924)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105808586827354925)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105808959568354925)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105809367040354926)
...
,p_lov=>'.'||wwv_flow_imp.id(3326548088606798356)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_grid_label_column_span=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105809788113354926)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105810109874354926)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105810529135354927)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105810996227354927)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105811388858354928)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105811799367354928)
,p_name=>'P1401_AMOUNT'
,p_is_required=>true
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(3586458319100301443)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105812646416354929)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105813044348354930)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105813454781354930)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105813865247354930)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105814729786354931)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105815206519354932)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105816067548354932)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105816481976354933)
,p_name=>'P1401_EARNINGS_PERIOD'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(3654548933213472389)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105817921089354935)
,p_name=>'P1401_ORGANISATION_DED'
,p_is_required=>true
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(3586480042902574289)
,p_item_default=>':APP_ORG_ID'
,p_item_default_type=>'EXPRESSION'
,p_item_default_language=>'PLSQL'
,p_prompt=>'Organisation'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105818337217354935)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105818728465354936)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105819153840354936)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105819524190354936)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105819954410354937)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105820405870354937)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105820771197354938)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105821121921354938)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105821591594354939)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105821938933354939)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105822332909354939)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105822799842354940)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105823174364354940)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105823564751354941)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105823934078354941)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105824405143354941)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105824773786354942)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105825179743354942)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105825583002354943)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105826505723354944)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105826822435354944)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105827303295354945)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105827625132354945)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105828039647354945)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105829552183354947)
,p_name=>'P1401_STAGE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3586836721364527473)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105829942985354948)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105830309206354948)
...
,p_lov=>'.'||wwv_flow_imp.id(3279030349206484256)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_grid_label_column_span=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105830805477354948)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105831111383354949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105832050234354950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105832972392354951)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105833406504354951)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105833752770354952)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105843809793354976)
,p_name=>'P1401_POSITION_LOCATION'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3586458518812301457)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105844219243354977)
,p_name=>'P1401_STAY'
,p_item_sequence=>380
,p_item_plug_id=>wwv_flow_imp.id(3586458518812301457)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105844609674354977)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105845018800354977)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3105845717745354979)
,p_name=>'P1401_EXCLUSION'
,p_item_sequence=>390
,p_item_plug_id=>wwv_flow_imp.id(3572246114219302290)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3105882574700355043)
...
,p_when_button_pressed=>wwv_flow_imp.id(3105806931597354922)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105884411750355046)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105884997959355047)
,p_event_id=>wwv_flow_imp.id(3105884411750355046)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3105806931597354922)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105885408498355048)
,p_event_id=>wwv_flow_imp.id(3105884411750355046)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105885884809355048)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105886387498355049)
,p_event_id=>wwv_flow_imp.id(3105885884809355048)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3586458518812301457)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105886833325355049)
,p_event_id=>wwv_flow_imp.id(3105885884809355048)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105887361135355050)
,p_event_id=>wwv_flow_imp.id(3105885884809355048)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105887817834355050)
,p_event_id=>wwv_flow_imp.id(3105885884809355048)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105888231268355050)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105888756631355051)
,p_event_id=>wwv_flow_imp.id(3105888231268355050)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105889209246355051)
,p_event_id=>wwv_flow_imp.id(3105888231268355050)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105889802879355052)
,p_event_id=>wwv_flow_imp.id(3105888231268355050)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105890267930355052)
,p_event_id=>wwv_flow_imp.id(3105888231268355050)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105890607250355053)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105891171594355053)
,p_event_id=>wwv_flow_imp.id(3105890607250355053)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105891514545355053)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105892057348355054)
,p_event_id=>wwv_flow_imp.id(3105891514545355053)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3105801382125354907)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105892598407355054)
,p_event_id=>wwv_flow_imp.id(3105891514545355053)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105892933602355054)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105893439052355055)
,p_event_id=>wwv_flow_imp.id(3105892933602355054)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105893855592355055)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105894359353355056)
,p_event_id=>wwv_flow_imp.id(3105893855592355055)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105894834919355056)
,p_event_id=>wwv_flow_imp.id(3105893855592355055)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105895382277355057)
,p_event_id=>wwv_flow_imp.id(3105893855592355055)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105895884694355057)
,p_event_id=>wwv_flow_imp.id(3105893855592355055)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105896226474355058)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105896711966355058)
,p_event_id=>wwv_flow_imp.id(3105896226474355058)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3777339822185249413)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105897286117355058)
,p_event_id=>wwv_flow_imp.id(3105896226474355058)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3654549008336472390)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105897788147355059)
,p_event_id=>wwv_flow_imp.id(3105896226474355058)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3476075524928740333)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105898109480355059)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105898609594355060)
,p_event_id=>wwv_flow_imp.id(3105898109480355059)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105899138466355060)
,p_event_id=>wwv_flow_imp.id(3105898109480355059)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105899693328355060)
,p_event_id=>wwv_flow_imp.id(3105898109480355059)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105900043842355061)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105900560493355061)
,p_event_id=>wwv_flow_imp.id(3105900043842355061)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105901014833355062)
,p_event_id=>wwv_flow_imp.id(3105900043842355061)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105901524777355062)
,p_event_id=>wwv_flow_imp.id(3105900043842355061)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105901976187355062)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105902479884355063)
,p_event_id=>wwv_flow_imp.id(3105901976187355062)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105902975939355063)
,p_event_id=>wwv_flow_imp.id(3105901976187355062)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105903469973355064)
,p_event_id=>wwv_flow_imp.id(3105901976187355062)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105903872793355064)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105904337158355065)
,p_event_id=>wwv_flow_imp.id(3105903872793355064)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105904842468355065)
,p_event_id=>wwv_flow_imp.id(3105903872793355064)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105905212985355065)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105905787921355066)
,p_event_id=>wwv_flow_imp.id(3105905212985355065)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105906289873355066)
,p_event_id=>wwv_flow_imp.id(3105905212985355065)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105906678174355066)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105907175864355067)
,p_event_id=>wwv_flow_imp.id(3105906678174355066)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105907705989355067)
,p_event_id=>wwv_flow_imp.id(3105906678174355066)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105908087881355068)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105908508429355068)
,p_event_id=>wwv_flow_imp.id(3105908087881355068)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105909025210355068)
,p_event_id=>wwv_flow_imp.id(3105908087881355068)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105909435303355069)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105909992931355069)
,p_event_id=>wwv_flow_imp.id(3105909435303355069)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105910506732355070)
,p_event_id=>wwv_flow_imp.id(3105909435303355069)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105910881446355070)
,p_name=>'refresh_NIS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105911353185355070)
,p_event_id=>wwv_flow_imp.id(3105910881446355070)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105911883192355071)
,p_event_id=>wwv_flow_imp.id(3105910881446355070)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105912288147355071)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105912793663355072)
,p_event_id=>wwv_flow_imp.id(3105912288147355071)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105913150871355072)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105913678718355073)
,p_event_id=>wwv_flow_imp.id(3105913150871355072)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105914100626355073)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105914513681355073)
,p_event_id=>wwv_flow_imp.id(3105914100626355073)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105914920636355074)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105915410584355074)
,p_event_id=>wwv_flow_imp.id(3105914920636355074)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105915834442355074)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105916334057355075)
,p_event_id=>wwv_flow_imp.id(3105915834442355074)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105916717918355075)
,p_name=>'get_earn_prd'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105917301405355075)
,p_event_id=>wwv_flow_imp.id(3105916717918355075)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105917613312355076)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105918172940355076)
,p_event_id=>wwv_flow_imp.id(3105917613312355076)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105918687391355077)
,p_event_id=>wwv_flow_imp.id(3105917613312355076)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105919181144355077)
,p_event_id=>wwv_flow_imp.id(3105917613312355076)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105919591411355077)
,p_name=>'refresh_pool'
,p_event_sequence=>250
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3777339822185249413)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105920038675355078)
,p_event_id=>wwv_flow_imp.id(3105919591411355077)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105920463918355078)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105920942269355078)
,p_event_id=>wwv_flow_imp.id(3105920463918355078)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3572246114219302290)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105921422215355079)
,p_event_id=>wwv_flow_imp.id(3105920463918355078)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105921874373355079)
,p_name=>'refresh_existing'
,p_event_sequence=>270
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3476075524928740333)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105922349494355080)
,p_event_id=>wwv_flow_imp.id(3105921874373355079)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105922733453355080)
,p_name=>'refresh_results'
,p_event_sequence=>280
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3654549008336472390)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105923289267355080)
,p_event_id=>wwv_flow_imp.id(3105922733453355080)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105923629809355081)
,p_name=>'Execute_generators'
,p_event_sequence=>290
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3105806931597354922)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105924116209355081)
,p_event_id=>wwv_flow_imp.id(3105923629809355081)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105924671338355082)
,p_event_id=>wwv_flow_imp.id(3105923629809355081)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105925157372355082)
,p_event_id=>wwv_flow_imp.id(3105923629809355081)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105925628768355082)
,p_event_id=>wwv_flow_imp.id(3105923629809355081)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105926178336355083)
,p_event_id=>wwv_flow_imp.id(3105923629809355081)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105926523396355083)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105927102741355084)
,p_event_id=>wwv_flow_imp.id(3105926523396355083)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105927495420355084)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105927942614355084)
,p_event_id=>wwv_flow_imp.id(3105927495420355084)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105928476839355085)
,p_event_id=>wwv_flow_imp.id(3105927495420355084)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3105928831554355085)
,p_name=>'setup_lookup'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3105929361241355086)
,p_event_id=>wwv_flow_imp.id(3105928831554355085)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3007601299603217309)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3007601375980217310)
,p_event_id=>wwv_flow_imp.id(3007601299603217309)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3105883243934355044)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3105801382125354907)
,p_process_success_message=>'Successful generation of Employee rules.'
,p_internal_uid=>2990099482412041340
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3105884060707355045)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3105817579141354934)
,p_process_success_message=>'System successfully generated required data.'
,p_internal_uid=>2990098752600041339
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3105805857795354920)
,p_process_sequence=>70
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(3572387026615315203)
