...
,p_group_id=>wwv_flow_imp.id(3079463606019011825)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2602169743452789528)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1032623007758958947)
,p_plug_name=>'Multi Upload'
,p_parent_plug_id=>wwv_flow_imp.id(2602169743452789528)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1032623233566958949)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2602380080546949687)
,p_name=>'Audit'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4595436525912947)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4595330089912946)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(250624884094808)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141035319409300583)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2602380080546949687)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141033346788300581)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1032623233566958949)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141033801380300582)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1032623233566958949)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141032352033300580)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1032623007758958947)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141026046995300573)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2602169743452789528)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141026461815300574)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141026847184300574)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141027271751300574)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(141044261981300591)
...
,p_branch_when_button_id=>wwv_flow_imp.id(141033346788300581)
,p_branch_sequence=>8
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(141043842092300590)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(141044726975300591)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141027648329300574)
,p_name=>'P20_MEDIA_HD_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2602169743452789528)
,p_item_source_plug_id=>wwv_flow_imp.id(1032623233566958949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141028075575300575)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141028459494300575)
,p_name=>'P20_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141028851325300575)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141029244987300575)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141029657029300576)
,p_name=>'P20_STATUS'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141030065496300578)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141030462070300578)
,p_name=>'P20_REMARKS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(2602169743452789528)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141030855303300578)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141031313309300579)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141031725536300579)
,p_name=>'P20_SERVER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(2602169743452789528)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141032771544300581)
,p_name=>'P20_FILE_DATA'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(1032623007758958947)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141034230553300582)
,p_name=>'P20_UPLOAD_DOCUMENT'
,p_source_data_type=>'BLOB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1032623233566958949)
,p_item_source_plug_id=>wwv_flow_imp.id(1032623233566958949)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141034576433300582)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141036077873300583)
,p_name=>'P20_CREATED_BY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2602380080546949687)
,p_item_source_plug_id=>wwv_flow_imp.id(1032623233566958949)
,p_source=>'CREATED_BY'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141040104118300587)
,p_name=>'Execute JavaScript Code'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(141026847184300574)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141040567512300587)
,p_event_id=>wwv_flow_imp.id(141040104118300587)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141041007705300588)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141041453844300588)
,p_event_id=>wwv_flow_imp.id(141041007705300588)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141041998163300588)
,p_event_id=>wwv_flow_imp.id(141041007705300588)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141042411974300588)
,p_name=>'show_comment'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141042899337300589)
,p_event_id=>wwv_flow_imp.id(141042411974300588)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141043401364300589)
,p_event_id=>wwv_flow_imp.id(141042411974300588)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141039661581300587)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(1032623233566958949)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Fetch Row from MEDIA_DETAIL'
,p_internal_uid=>25255527724986882
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141039275327300587)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141038895573300586)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(141035319409300583)
,p_internal_uid=>25254761716986881
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141038526756300586)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(141026461815300574)
,p_process_when=>'P20_TRANSACTION_TYPE_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_internal_uid=>25254392899986881
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141037684697300585)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(141032352033300580)
,p_process_success_message=>'Files uploaded.'
,p_internal_uid=>25253550840986880
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141038044752300586)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(141026046995300573)
