...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3277940795038068324)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3277943189307068329)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3166369511039871692)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3277940795038068324)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3166369946006871693)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3166370360732871693)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3110384415437427198)
,p_name=>'P1501_EMPLOYEE_2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3277940795038068324)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3110384564327427199)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3110384787135427201)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3110385035028427204)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166370735540871693)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166371095629871694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166371525091871694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166371905897871694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166372292260871694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166372776356871695)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166373172887871695)
,p_name=>'P1501_BANK'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3277940795038068324)
,p_prompt=>'Bank'
...
'( select to_nchar(''ALL BANK'') ORGANISATION_NAME,1 id from dual',
'union all',
'select to_nchar(''CHEQUE'') ORGANISATION_NAME,2 id from dual',
'union all',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166373496919871695)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166373918492871695)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166374291742871696)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166374738100871696)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166375158850871696)
,p_name=>'P1501_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(3277940795038068324)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3166375567659871696)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3166377007524871698)
,p_name=>'Preview_Report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3166370360732871693)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166377543289871698)
,p_event_id=>wwv_flow_imp.id(3166377007524871698)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166378035188871699)
,p_event_id=>wwv_flow_imp.id(3166377007524871698)
,p_event_result=>'TRUE'
...
'begin',
'',
' if (:p1501_search_results is not null)  and (:P1501_ALL_EMPLOYEES = ''0'')then',
' ',
...
'',
'v_url_2 :=''f?p=&APP_ID.:403:&APP_SESSION.::NO:403:P403_PARAMETERS,P403_REPORT_PATH:''||''EARNINGS_PERIOD_ID=''||:p1501_earnings_period||''|IN_ORG_ID=''||:p1501_organisation||''|SEARCH_OPTION=''||:p1501_search_option||''|SUPPRESS_DETAILS=''||:p1501_suppress_de'
||'tails||''|SESSION_ID=''||:app_session||''|allEmployees=''||:P1501_ALL_EMPLOYEES||''|BANK=''||:P1501_BANK||'',''||v_report_path;',
'',
'v_url_1 :=pkg_reports.fn_build_report_url(:P1501_REPORT_ID)||:P1501_PARAMETERS;',
'',
'v_url:=''',
...
'</object>',
''';',
':P1501_PARAMETERS := null;',
'',
'return v_url;',
'end;',
''))
,p_attribute_07=>'P1501_BANK, P1501_ALL_EMPLOYEES, P1501_EARNINGS_PERIOD,P1501_EARNINGS_TYPE,P1501_MONTH_YEAR,P1501_ORGANISATION,P1501_PARAMETERS,P1501_REPORT_ID,P1501_SEARCH_OPTION,P1501_SEARCH_RESULTS,P1501_SUPPRESS_DETAILS'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3166378476524871699)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166378951300871699)
,p_event_id=>wwv_flow_imp.id(3166378476524871699)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166379431008871700)
,p_event_id=>wwv_flow_imp.id(3166378476524871699)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
'then',
'-- v_url_1:=''http://apps3.innosysgy.com:8080/Report/showPDF?p2=''||v_report_path||''-IN_ORG_ID=''||:p1501_organisation||''-IN_EMP_ID=''||:P1501_EMPLOYEE_2||''-IN_IND_ID=''||:P1501_DIRECTOR_NAME||''-IN_P_ID=''||:P1501_DIR_POS_ID||''-Sal_start_date=''||replace(:P'
||'1501_DATE_EFFECTIVE,''-'',''*''); ',
...
||'on||''-allEmployees=''||:P1501_ALL_EMPLOYEES||''-BANK=''||:P1501_BANK||''-PERIOD_MONTH_YEAR=''||:P1501_MONTH_YEAR||''-Details=''||:P1501_SUPPRESS_DETAILS;',
'',
'end if;',
'',
...
'return v_url_1;',
'end;'))
,p_attribute_07=>'P1501_BANK, P1501_ALL_EMPLOYEES, P1501_EARNINGS_PERIOD,P1501_EARNINGS_TYPE,P1501_MONTH_YEAR,P1501_ORGANISATION,P1501_PARAMETERS,P1501_REPORT_ID,P1501_SEARCH_OPTION,P1501_SEARCH_RESULTS,P1501_SUPPRESS_DETAILS,P1501_EMPLOYEE_2,P1501_DIRECTOR_NAME,P1501'
||'_DIR_POS_ID,P1501_DATE_EFFECTIVE'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166379925990871700)
,p_event_id=>wwv_flow_imp.id(3166378476524871699)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3166380322605871700)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166380814577871700)
,p_event_id=>wwv_flow_imp.id(3166380322605871700)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166381302992871701)
,p_event_id=>wwv_flow_imp.id(3166380322605871700)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3166381744604871701)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3166369946006871693)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166382276905871701)
,p_event_id=>wwv_flow_imp.id(3166381744604871701)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166382736379871702)
,p_event_id=>wwv_flow_imp.id(3166381744604871701)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3166383288811871702)
,p_event_id=>wwv_flow_imp.id(3166381744604871701)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3110384904946427202)
,p_name=>'Set_pos_id'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3110384935637427203)
,p_event_id=>wwv_flow_imp.id(3110384904946427202)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3166376631873871698)
