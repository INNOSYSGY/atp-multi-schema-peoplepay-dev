...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3356456566132780344)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4236385288323287040)
,p_plug_name=>'Medical History'
,p_parent_plug_id=>wwv_flow_imp.id(3356456566132780344)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4561869467931539833)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4236390493565316859)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3284345512271538884)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(4561869467931539833)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3198076146457605164)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3356456566132780344)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3284344791700538882)
,p_name=>'P10004_START_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4561869467931539833)
,p_prompt=>'Start Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3284345162243538882)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3284264060859021395)
,p_name=>'Submit Page'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3284263949730021394)
,p_event_id=>wwv_flow_imp.id(3284264060859021395)
,p_event_result=>'TRUE'
