...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5945673360424581378)
,p_plug_name=>'Body'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6980634674255325299)
,p_plug_name=>'<span class = "title">Enterprise HRMIS  v9.0 </span>'
,p_region_name=>'custom'
,p_parent_plug_id=>wwv_flow_imp.id(5945673360424581378)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4294969463114594993)
,p_plug_name=>'spacer'
,p_parent_plug_id=>wwv_flow_imp.id(6980634674255325299)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5947798462511442870)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115957502190245782)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(6980634674255325299)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115957962132245782)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115958321928245782)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115962880110245778)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5947798462511442870)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115958752768245781)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525140319488177925)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(6980634674255325299)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525140711149177924)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525141179131177923)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525141556027177922)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525141949192177922)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525142366495177921)
,p_name=>'P101_CODE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(6980634674255325299)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525142765816177921)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1525143640518177920)
,p_name=>'P101_RESET'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(6980634674255325299)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(115963966230245778)
...
,p_when_button_pressed=>wwv_flow_imp.id(115958752768245781)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(115964301722245777)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(115963540721245778)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(115964740436245777)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115967877815245775)
,p_name=>'Reset'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115962880110245778)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115968333340245775)
,p_event_id=>wwv_flow_imp.id(115967877815245775)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115968820082245774)
,p_event_id=>wwv_flow_imp.id(115967877815245775)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115969322971245774)
,p_event_id=>wwv_flow_imp.id(115967877815245775)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115969750954245774)
,p_name=>'Reset_Account'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115957502190245782)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115970232978245774)
,p_event_id=>wwv_flow_imp.id(115969750954245774)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115970721079245773)
,p_event_id=>wwv_flow_imp.id(115969750954245774)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115971263937245773)
,p_event_id=>wwv_flow_imp.id(115969750954245774)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115971767411245773)
,p_event_id=>wwv_flow_imp.id(115969750954245774)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115972182883245773)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115957962132245782)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115972644909245773)
,p_event_id=>wwv_flow_imp.id(115972182883245773)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115973152959245772)
,p_event_id=>wwv_flow_imp.id(115972182883245773)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115973629293245772)
,p_event_id=>wwv_flow_imp.id(115972182883245773)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115974077673245772)
,p_name=>'send mfa code'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115958321928245782)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115974549073245772)
,p_event_id=>wwv_flow_imp.id(115974077673245772)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115975025406245771)
,p_event_id=>wwv_flow_imp.id(115974077673245772)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115975457587245771)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115975902962245771)
,p_event_id=>wwv_flow_imp.id(115975457587245771)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115976440577245771)
,p_event_id=>wwv_flow_imp.id(115975457587245771)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115976816160245771)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115977343170245770)
,p_event_id=>wwv_flow_imp.id(115976816160245771)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(115958321928245782)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115977889587245770)
,p_event_id=>wwv_flow_imp.id(115976816160245771)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115978204749245770)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115978747052245770)
,p_event_id=>wwv_flow_imp.id(115978204749245770)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115979176355245770)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115979627732245769)
,p_event_id=>wwv_flow_imp.id(115979176355245770)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115966205310245776)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115966685660245776)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115958752768245781)
,p_internal_uid=>115966685660245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115965001154245777)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115967457634245775)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115965414851245776)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115957962132245782)
,p_internal_uid=>115965414851245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115965837065245776)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115967079692245776)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
