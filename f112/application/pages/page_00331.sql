...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3299675186664496100)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2642856976535256605)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3299675186664496100)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2642856584809256604)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642857348854256609)
,p_name=>'P331_ORGDTL_ID'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3299675186664496100)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642857793722256610)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642858209742256610)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642858609200256610)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642859001619256611)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642859377376256611)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642859793498256612)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642860201899256612)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642860629383256613)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2642861031321256613)
,p_name=>'P331_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3299675186664496100)
,p_prompt=>'Remarks'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2642861369298256619)
,p_name=>'SHOW_HIDE'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2642861898862256620)
,p_event_id=>wwv_flow_imp.id(2642861369298256619)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2642856584809256604)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2642862345881256621)
,p_event_id=>wwv_flow_imp.id(2642861369298256619)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2642862791975256621)
,p_name=>'run_process'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2642856584809256604)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2642863800269256622)
,p_event_id=>wwv_flow_imp.id(2642862791975256621)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2642863269640256622)
,p_event_id=>wwv_flow_imp.id(2642862791975256621)
,p_event_result=>'TRUE'
