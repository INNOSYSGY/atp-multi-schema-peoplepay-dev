...
begin
--   Manifest
--     PLUGIN: COM_ORACLE_APEX_SLIDETOOLTIP
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4283172638713903532)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5358021284476916036)
,p_plugin_id=>wwv_flow_imp.id(4283172638713903532)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5358021703257916037)
,p_plugin_id=>wwv_flow_imp.id(4283172638713903532)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5358022059327916037)
,p_plugin_id=>wwv_flow_imp.id(4283172638713903532)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5358022496101916037)
,p_plugin_id=>wwv_flow_imp.id(4283172638713903532)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5358023411099916038)
,p_plugin_attribute_id=>wwv_flow_imp.id(5358022496101916037)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5358022895511916037)
,p_plugin_attribute_id=>wwv_flow_imp.id(5358022496101916037)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5358023833649916038)
,p_plugin_id=>wwv_flow_imp.id(4283172638713903532)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(3741603578241130202)
,p_plugin_id=>wwv_flow_imp.id(4283172638713903532)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
