...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(3282128689341696631)
,p_name=>'feature_release'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3282127500162671348)
,p_parent_id=>wwv_flow_imp.id(3282127694986673764)
,p_short_name=>'Release Execution Details'
,p_link=>'f?p=&APP_ID.:2019:&SESSION.::&DEBUG.:::'
,p_page_id=>2019
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3282127694986673764)
,p_parent_id=>wwv_flow_imp.id(3282127979674680860)
,p_short_name=>'Release Execution List'
,p_link=>'f?p=&APP_ID.:2018:&SESSION.::&DEBUG.:::'
,p_page_id=>2018
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3282127979674680860)
,p_parent_id=>wwv_flow_imp.id(3282128389582691429)
,p_short_name=>'Release Configuration'
,p_link=>'f?p=&APP_ID.:2017:&SESSION.::&DEBUG.:::'
,p_page_id=>2017
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3282128204031684758)
,p_parent_id=>wwv_flow_imp.id(3282128389582691429)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3282128389582691429)
,p_parent_id=>wwv_flow_imp.id(3305344717671267540)
,p_short_name=>'Update List'
,p_link=>'f?p=&APP_ID.:2015:&SESSION.::&DEBUG.:::'
,p_page_id=>2015
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3305344717671267540)
