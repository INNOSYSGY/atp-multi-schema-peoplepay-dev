...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(3268981075351389498)
,p_name=>'offences'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3268980466087370048)
,p_parent_id=>wwv_flow_imp.id(3268980674701381226)
,p_short_name=>'Employee Offences'
,p_link=>'f?p=&APP_ID.:1424:&SESSION.::&DEBUG.:::'
,p_page_id=>1424
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3268980674701381226)
,p_parent_id=>wwv_flow_imp.id(3268980870388383288)
,p_short_name=>'Create/Edit Offences'
,p_link=>'f?p=&APP_ID.:1423:&SESSION.::&DEBUG.:::'
,p_page_id=>1423
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3268980870388383288)
