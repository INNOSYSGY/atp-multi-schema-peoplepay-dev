prompt --application/shared_components/security/authorizations/global_add_access
begin
--   Manifest
--     SECURITY SCHEME: GLOBAL_ADD_ACCESS
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3279327656739677336)
,p_name=>'GLOBAL_ADD_ACCESS'
