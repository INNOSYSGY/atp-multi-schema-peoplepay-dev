prompt --application/shared_components/security/authorizations/global_region_view_access
begin
--   Manifest
--     SECURITY SCHEME: GLOBAL_REGION_VIEW_ACCESS
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3279326628142677335)
,p_name=>'GLOBAL_REGION_VIEW_ACCESS'
