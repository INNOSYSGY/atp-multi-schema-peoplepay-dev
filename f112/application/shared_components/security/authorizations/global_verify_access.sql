prompt --application/shared_components/security/authorizations/global_verify_access
begin
--   Manifest
--     SECURITY SCHEME: GLOBAL_VERIFY_ACCESS
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3186659428834827837)
,p_name=>'GLOBAL_VERIFY_ACCESS'
