prompt --application/shared_components/security/authorizations/scrs_delete_access
begin
--   Manifest
--     SECURITY SCHEME: SCRS_DELETE_ACCESS
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3186148703647848796)
,p_name=>'SCRS_DELETE_ACCESS'
