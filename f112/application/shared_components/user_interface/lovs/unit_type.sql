...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3326353120643558003)
,p_lov_name=>'UNIT_TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(3326353120643558003)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326352766275558003)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'METRIC'
,p_lov_return_value=>'METRIC'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326352367212558003)
