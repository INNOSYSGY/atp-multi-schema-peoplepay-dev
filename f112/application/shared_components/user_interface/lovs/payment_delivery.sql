...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3326456618631652866)
,p_lov_name=>'PAYMENT_DELIVERY'
,p_lov_query=>'.'||wwv_flow_imp.id(3326456618631652866)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326456326166652860)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Full Before Delivery'
,p_lov_return_value=>'FBD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326455948928652859)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Partial Before Delivery'
,p_lov_return_value=>'PBD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326455537788652856)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Partial After Delivery'
,p_lov_return_value=>'PAD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326455183051652850)
