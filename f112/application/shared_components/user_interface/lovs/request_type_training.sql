...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(879309922130445252)
,p_lov_name=>'REQUEST_TYPE_TRAINING'
,p_lov_query=>'.'||wwv_flow_imp.id(879309922130445252)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(879310336404445253)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Self'
,p_lov_return_value=>'SELF'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(879310722026445253)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'System'
,p_lov_return_value=>'SYSTEM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(879311190337445253)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Officer'
,p_lov_return_value=>'OFFICER'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(879311562093445254)
