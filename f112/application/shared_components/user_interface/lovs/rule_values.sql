...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(129812261426421924)
,p_lov_name=>'RULE_VALUES'
,p_lov_query=>'.'||wwv_flow_imp.id(129812261426421924)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(129812637069421924)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'YEARS OF SERVICE'
,p_lov_return_value=>'YEARS_OF_SERVICE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(129813095362421925)
