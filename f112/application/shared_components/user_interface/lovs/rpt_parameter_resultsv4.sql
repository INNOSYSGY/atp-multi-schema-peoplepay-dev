prompt --application/shared_components/user_interface/lovs/rpt_parameter_resultsv4
begin
--   Manifest
--     RPT_PARAMETER_RESULTSV4
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3165800652067673462)
,p_lov_name=>'RPT_PARAMETER_RESULTSV4'
