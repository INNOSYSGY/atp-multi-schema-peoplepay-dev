prompt --application/shared_components/user_interface/lovs/training_course_structure_types
begin
--   Manifest
--     TRAINING_COURSE_STRUCTURE_TYPES
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(139158321782251792)
,p_lov_name=>'TRAINING_COURSE_STRUCTURE_TYPES'
