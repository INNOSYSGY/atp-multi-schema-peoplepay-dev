prompt --application/shared_components/user_interface/lovs/rpt_parameter_results
begin
--   Manifest
--     RPT_PARAMETER_RESULTS
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3184449780211386729)
,p_lov_name=>'RPT_PARAMETER_RESULTS'
