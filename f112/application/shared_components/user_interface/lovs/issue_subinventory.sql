prompt --application/shared_components/user_interface/lovs/issue_subinventory
begin
--   Manifest
--     ISSUE_SUBINVENTORY
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3326531325100798330)
,p_lov_name=>'ISSUE_SUBINVENTORY'
...
'WHERE INVENTORY_ITEM_ID=:P610_INVENTORY_ITEM_ID',
'ORDER BY 1',
''))
,p_source_type=>'SQL'
,p_location=>'LOCAL'
