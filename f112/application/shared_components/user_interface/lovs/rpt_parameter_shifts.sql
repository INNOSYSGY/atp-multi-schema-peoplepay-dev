prompt --application/shared_components/user_interface/lovs/rpt_parameter_shifts
begin
--   Manifest
--     RPT_PARAMETER_SHIFTS
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3167602768180748107)
,p_lov_name=>'RPT_PARAMETER_SHIFTS'
