...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3326525472224798321)
,p_lov_name=>'JOB_CLASSIFICATION'
,p_lov_query=>'.'||wwv_flow_imp.id(3326525472224798321)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326525101142798320)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Technical Rated'
,p_lov_return_value=>'Technical'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3326524642169798320)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Non-Technical Rated'
,p_lov_return_value=>'Administrative'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(131616321801884195)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Exempt'
,p_lov_return_value=>'Exempt'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(131616621458884196)
