prompt --application/shared_components/legacy_data_loads/hr_rcm_address
begin
--   Manifest
--     HR_RCM_ADDRESS
--   Manifest End
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3277013685123330481)
,p_name=>'load_address'
,p_owner=>'#OWNER#'
,p_table_name=>'HR_RCM_ADDRESS'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3276924743942314750)
,p_load_table_id=>wwv_flow_imp.id(3277013685123330481)
