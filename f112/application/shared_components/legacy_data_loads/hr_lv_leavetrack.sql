prompt --application/shared_components/legacy_data_loads/hr_lv_leavetrack
begin
--   Manifest
--     HR_LV_LEAVETRACK
--   Manifest End
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3276470047160637746)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3276469740280637741)
,p_load_table_id=>wwv_flow_imp.id(3276470047160637746)
