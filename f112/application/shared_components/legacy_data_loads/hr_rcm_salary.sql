...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3276723047714155127)
,p_name=>'load_salary'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3276722732089155126)
,p_load_table_id=>wwv_flow_imp.id(3276723047714155127)
...
wwv_flow_imp_shared.create_load_table_rule(
 p_id=>wwv_flow_imp.id(3276722385377155125)
,p_load_table_id=>wwv_flow_imp.id(3276723047714155127)
