...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6473224478586943167)
,p_plug_name=>'Body'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7508185792417687088)
,p_plug_name=>'<span class = "title">Enterprise HRMIS  v9.0 </span>'
,p_region_name=>'custom'
,p_parent_plug_id=>wwv_flow_imp.id(6473224478586943167)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4822520581276956782)
,p_plug_name=>'spacer'
,p_parent_plug_id=>wwv_flow_imp.id(7508185792417687088)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6475349580673804659)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643508620352607571)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(7508185792417687088)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643509080294607571)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643509440090607571)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643513998272607567)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(6475349580673804659)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(643509870930607570)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052691437650539714)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7508185792417687088)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052691829311539713)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052692297293539712)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052692674189539711)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052693067354539711)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052693484657539710)
,p_name=>'P101_CODE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(7508185792417687088)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052693883978539710)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2052694758680539709)
,p_name=>'P101_RESET'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(7508185792417687088)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643515084392607567)
...
,p_when_button_pressed=>wwv_flow_imp.id(643509870930607570)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643515419884607566)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643514658883607567)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(643515858598607566)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643518995977607564)
,p_name=>'Reset'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643513998272607567)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643519451502607564)
,p_event_id=>wwv_flow_imp.id(643518995977607564)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643519938244607563)
,p_event_id=>wwv_flow_imp.id(643518995977607564)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643520441133607563)
,p_event_id=>wwv_flow_imp.id(643518995977607564)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643520869116607563)
,p_name=>'Reset_Account'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643508620352607571)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643521351140607563)
,p_event_id=>wwv_flow_imp.id(643520869116607563)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643521839241607562)
,p_event_id=>wwv_flow_imp.id(643520869116607563)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643522382099607562)
,p_event_id=>wwv_flow_imp.id(643520869116607563)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643522885573607562)
,p_event_id=>wwv_flow_imp.id(643520869116607563)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643523301045607562)
,p_name=>'New'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643509080294607571)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643523763071607562)
,p_event_id=>wwv_flow_imp.id(643523301045607562)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643524271121607561)
,p_event_id=>wwv_flow_imp.id(643523301045607562)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643524747455607561)
,p_event_id=>wwv_flow_imp.id(643523301045607562)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643525195835607561)
,p_name=>'send mfa code'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(643509440090607571)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643525667235607561)
,p_event_id=>wwv_flow_imp.id(643525195835607561)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643526143568607560)
,p_event_id=>wwv_flow_imp.id(643525195835607561)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643526575749607560)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643527021124607560)
,p_event_id=>wwv_flow_imp.id(643526575749607560)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643527558739607560)
,p_event_id=>wwv_flow_imp.id(643526575749607560)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643527934322607560)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643528461332607559)
,p_event_id=>wwv_flow_imp.id(643527934322607560)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(643509440090607571)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643529007749607559)
,p_event_id=>wwv_flow_imp.id(643527934322607560)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643529322911607559)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643529865214607559)
,p_event_id=>wwv_flow_imp.id(643529322911607559)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(643530294517607559)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(643530745894607558)
,p_event_id=>wwv_flow_imp.id(643530294517607559)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643517323472607565)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643517803822607565)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(643509870930607570)
,p_internal_uid=>115966685660245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643516119316607566)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643518575796607564)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643516533013607565)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(643509080294607571)
,p_internal_uid=>115965414851245776
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643516955227607565)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(643518197854607565)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
