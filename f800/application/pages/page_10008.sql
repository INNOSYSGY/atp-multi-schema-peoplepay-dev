...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3889141437305324566)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3889141543219324567)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3806493900355553516)
,p_region_id=>wwv_flow_imp.id(3889141543219324567)
,p_chart_type=>'bubble'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3806492279219553512)
,p_chart_id=>wwv_flow_imp.id(3806493900355553516)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3806493516368553513)
,p_chart_id=>wwv_flow_imp.id(3806493900355553516)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3806492886251553513)
,p_chart_id=>wwv_flow_imp.id(3806493900355553516)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5647359730229193870)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3806490087905553497)
,p_name=>'P10008_FILTER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5647359730229193870)
,p_item_default=>'5000'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3807677480989714447)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3806488353010553485)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3807677407548714446)
,p_event_id=>wwv_flow_imp.id(3806488353010553485)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3889141543219324567)
,p_attribute_01=>'N'
);
