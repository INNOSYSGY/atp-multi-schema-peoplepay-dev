...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(670181507692520625)
,p_plug_name=>'bc'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(815208586394219868)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1408407910815617743)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1420634387315983867)
,p_plug_name=>'Income Details'
,p_region_name=>'emp_time_incomes'
,p_parent_plug_id=>wwv_flow_imp.id(1408407910815617743)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1389356785281437506)
,p_name=>'INCOME_CODE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1394106206334259676)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1400100527775576700)
,p_name=>'START_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1400100589515576701)
,p_name=>'END_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420634601293983869)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420634713357983870)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420634861651983871)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420634894643983872)
,p_name=>'ORGDTL_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420635010354983873)
,p_name=>'EMPENT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420635168248983875)
,p_name=>'RATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420635277926983876)
,p_name=>'QUANTITY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420635424180983877)
,p_name=>'AMOUNT_PAID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420635646002983879)
,p_name=>'PAYSTATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420635742681983880)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420751609396474731)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420751672905474732)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420751815871474733)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420751933035474734)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420752087845474736)
,p_name=>'APPROVED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420752256265474737)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420752285674474738)
,p_name=>'VERIFIED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420752458432474739)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420752502461474740)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1420752657840474741)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1639555087766725454)
,p_name=>'WEEK_DAY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1420634509026983868)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1420757252355481737)
,p_interactive_grid_id=>wwv_flow_imp.id(1420634509026983868)
,p_static_id=>'306825'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1420757436057481737)
,p_report_id=>wwv_flow_imp.id(1420757252355481737)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1394110810537261928)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(1389356785281437506)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1394128804604261969)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1394106206334259676)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>157
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1404907824503597010)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1400100527775576700)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>162
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1404908730225597013)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1400100589515576701)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>183
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420757930850481738)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1420634601293983869)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420758852308481739)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1420634713357983870)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>117
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420759708140481742)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1420634861651983871)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>196
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420760651962481743)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1420634894643983872)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>275
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420761511690481745)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1420635010354983873)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>136
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420763358508481748)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(1420635168248983875)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420764241727481749)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1420635277926983876)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>74
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420765108916481751)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(1420635424180983877)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>94
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420766936780481754)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(1420635646002983879)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>84
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420767859761481755)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(1420635742681983880)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>102
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420768674069481756)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(1420751609396474731)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>225
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420769593735481758)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(1420751672905474732)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420770505129481759)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1420751815871474733)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420771351069481761)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(1420751933035474734)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420773075244481763)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(1420752087845474736)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420774004408481765)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>23
,p_column_id=>wwv_flow_imp.id(1420752256265474737)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420774944222481766)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>24
,p_column_id=>wwv_flow_imp.id(1420752285674474738)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420775769999481768)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>25
,p_column_id=>wwv_flow_imp.id(1420752458432474739)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420776679564481769)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(1420752502461474740)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>153
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1420777656063481770)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(1420752657840474741)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>107
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1638698766985190658)
,p_view_id=>wwv_flow_imp.id(1420757436057481737)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1639555087766725454)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>71
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1422648986218277022)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1463909763168264088)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1400101426731576709)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461319161168356902)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461320360087356914)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461320438055356915)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461320512758356916)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461320589046356917)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461320938146356920)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REMARKS'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461321085449356922)
,p_name=>'PAY_STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461321190484356923)
,p_name=>'LEAVE_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461541364191518879)
,p_name=>'TRANSACTION_TYPE_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TRANSACTION_TYPE_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1461541391389518880)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'STATUS'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1463908322972264074)
,p_name=>'ORG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1463908563348264076)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1463908679188264077)
,p_name=>'LEAVE_MODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1463909347692264084)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1463909413914264085)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1463909551341264086)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1465531288634776112)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1463909645321264087)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1461315587069355063)
,p_interactive_grid_id=>wwv_flow_imp.id(1463909645321264087)
,p_static_id=>'698710'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1461315432020355063)
,p_report_id=>wwv_flow_imp.id(1461315587069355063)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1406552328196223204)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1400101426731576709)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>92
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1459789113631563130)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1465531288634776112)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>103
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461295155171355023)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>15
,p_column_id=>wwv_flow_imp.id(1461320360087356914)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461296002245355025)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>14
,p_column_id=>wwv_flow_imp.id(1461320438055356915)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461296892279355026)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1461320512758356916)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461297790839355028)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1461320589046356917)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461300565194355032)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1461320938146356920)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>96
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461302348679355036)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>20
,p_column_id=>wwv_flow_imp.id(1461321085449356922)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>82
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461303238185355038)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1461321190484356923)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>177
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461304151910355039)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(1463908322972264074)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461305964344355044)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1463908563348264076)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>128
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461306857673355046)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1463908679188264077)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461313119213355057)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1463909347692264084)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>222
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461314007640355058)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1463909413914264085)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>102
,p_sort_order=>1
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461314884312355060)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(1463909551341264086)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461520340847058417)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(1461319161168356902)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>145
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461865264908682744)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(1461541364191518879)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>115
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461866590419682746)
,p_view_id=>wwv_flow_imp.id(1461315432020355063)
,p_display_seq=>18
,p_column_id=>wwv_flow_imp.id(1461541391389518880)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>83
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1464164507045110669)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1465173555900082373)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987580569851138828)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987580146103138828)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987579838723138827)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987579426540138827)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987579041215138826)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987578641532138826)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987578179942138826)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987577752906138825)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987577377506138825)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987581390668138829)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987581016319138828)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987576960601138824)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1465617469803080747)
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(1478580668567580690)
,p_report_id=>wwv_flow_imp.id(1465617469803080747)
,p_pivot_columns=>'DAY_NUMBERC'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(674641572518216166)
,p_pivot_id=>wwv_flow_imp.id(1478580668567580690)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1465055424592476431)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1465621498943109956)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987574163557138820)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987573777500138820)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Emp Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987573404236138819)
,p_db_column_name=>'EMP_COMPANY_NO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Emp Company No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987573002896138819)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Emp Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987572541957138818)
,p_db_column_name=>'WKLOCATION_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Work Location'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987572053253138818)
,p_db_column_name=>'DEPARTMENT'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987571716325138817)
,p_db_column_name=>'DESIGNATION'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Designation'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987571273497138817)
,p_db_column_name=>'PAYMENT_TYPE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Payment Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987575112091138821)
,p_db_column_name=>'DAY_NUMBERC'
,p_display_order=>90
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987574639947138820)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987570440806138816)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987570792379138816)
,p_db_column_name=>'CODE_QTY'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1465689384056116771)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(1478582744602585490)
,p_report_id=>wwv_flow_imp.id(1465689384056116771)
,p_pivot_columns=>'DAY_NUMBERC:INCOME_CODE'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(674646585618216171)
,p_pivot_id=>wwv_flow_imp.id(1478582744602585490)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1465569789511078964)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1465569922930078965)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987567669987138812)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987567279942138812)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Emp Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987566824073138811)
,p_db_column_name=>'EMP_COMPANY_NO'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Emp Company No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987566391806138811)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Emp Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987566006883138810)
,p_db_column_name=>'WKLOCATION_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Work Location'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987565586827138810)
,p_db_column_name=>'DEPARTMENT'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987565193942138810)
,p_db_column_name=>'DESIGNATION'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Designation'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987564741866138809)
,p_db_column_name=>'PAYMENT_TYPE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Payment Type'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987564300633138809)
,p_db_column_name=>'ABS_CODE'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Abs Code'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987568540864138813)
,p_db_column_name=>'DAY_NUMBERC'
,p_display_order=>110
,p_column_identifier=>'AP'
,p_column_label=>'Day Numberc'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987568073078138813)
,p_db_column_name=>'ABSENCE_HOURS'
,p_display_order=>120
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987563880338138808)
,p_db_column_name=>'CODE_QTY'
,p_display_order=>130
,p_column_identifier=>'AR'
,p_column_label=>'Code Qty'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1465688766816116764)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(1478581679371583425)
,p_report_id=>wwv_flow_imp.id(1465688766816116764)
,p_pivot_columns=>'ABS_CODE'
,p_row_columns=>'EMP_NAME'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(674651580292216177)
,p_pivot_id=>wwv_flow_imp.id(1478581679371583425)
,p_display_seq=>1
,p_function_name=>'SUM'
,p_column_name=>'ABSENCE_HOURS'
,p_db_column_name=>'PFC1'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1485286575196592762)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1481987740710971562)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1481987797457971563)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1481987897241971564)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485285618400592752)
,p_name=>'DATE_CREATED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485285665100592753)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485285850203592754)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485285949279592755)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485286052601592756)
,p_name=>'HOURS_WORKED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485286150963592757)
,p_name=>'TIME_SOURCE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485286190262592758)
,p_name=>'TIME_OUT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485286260034592759)
,p_name=>'TIME_IN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1485286415398592760)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1485286457456592761)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1481342722561063839)
,p_interactive_grid_id=>wwv_flow_imp.id(1485286457456592761)
,p_static_id=>'335594'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1481342535063063838)
,p_report_id=>wwv_flow_imp.id(1481342722561063839)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1478019313802539022)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(1481987740710971562)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1478020224532539024)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1481987797457971563)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>141.1406
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1478021084511539027)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1481987897241971564)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>108.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481334830685063820)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1485285618400592752)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>145.141
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481335688876063822)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1485285665100592753)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481336593429063824)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1485285850203592754)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>154.14100000000002
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481337498153063826)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1485285949279592755)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>127.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481338384576063828)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1485286052601592756)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481339326509063830)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1485286150963592757)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>90.875
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481340213424063832)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1485286190262592758)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>148.5156
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481341074393063834)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(1485286260034592759)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>161.266
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1481342030749063837)
,p_view_id=>wwv_flow_imp.id(1481342535063063838)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1485286415398592760)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>98.5156
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1494538206854917856)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1483713104641874957)
,p_name=>'OVERRIDE_LLH'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1483715520353874981)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494537253697917847)
,p_name=>'ENTRY_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTRY_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494537416287917848)
,p_name=>'ENTERED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ENTERED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494537486674917849)
,p_name=>'LAST_CHANGED_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494537645598917850)
,p_name=>'LAST_CHANGED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LAST_CHANGED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494537778934917852)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494537922996917853)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1494538024988917854)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1494538097226917855)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1483912517445038577)
,p_interactive_grid_id=>wwv_flow_imp.id(1494538097226917855)
,p_static_id=>'309896'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1483912261716038576)
,p_report_id=>wwv_flow_imp.id(1483912517445038577)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483245381229544886)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1483713104641874957)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483698203696753104)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1483715520353874981)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483905555279038557)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1494537253697917847)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483906493590038559)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1494537416287917848)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483907435323038561)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1494537486674917849)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483908270746038563)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1494537645598917850)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483910002144038567)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1494537778934917852)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483910882358038570)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(1494537922996917853)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1483911841738038572)
,p_view_id=>wwv_flow_imp.id(1483912261716038576)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1494538024988917854)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1427263486810867767)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1427263622339867768)
,p_plug_name=>'Master Records'
,p_region_name=>'fx'
,p_parent_plug_id=>wwv_flow_imp.id(1427263486810867767)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1457387937934348474)
,p_max_row_count=>'1000000'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987637409404138902)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987636977023138901)
,p_db_column_name=>'EMP_ID'
,p_display_order=>20
,p_column_identifier=>'B'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987636542508138901)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987636118224138900)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987635682869138900)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987635262584138900)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987634861798138899)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987634415290138899)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987633980893138898)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987633600104138898)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987633167899138898)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987632770988138897)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987632264704138897)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987637805537138902)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987631868133138896)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987631533403138896)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987638179651138903)
,p_db_column_name=>'LH'
,p_display_order=>280
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987629393604138894)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987629762785138894)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987630178105138894)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987630642550138895)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987631055320138895)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987628989929138893)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(987628531574138893)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1458029238326825878)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1427263686401867769)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1403907762804055978)
,p_name=>'TIME_SOURCE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_SOURCE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1408502082385030046)
,p_name=>'PKEY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428074653373588245)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428074873896588247)
,p_name=>'EMP_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EMP_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428074941219588248)
,p_name=>'WORK_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORK_DATE'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428075013196588249)
,p_name=>'TIME_IN'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_IN'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428075082688588250)
,p_name=>'TIME_OUT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TIME_OUT'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428075862090588257)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1428075951349588258)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1455730116649315343)
,p_name=>'CALENDAR_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1457864826032448063)
,p_name=>'HOURS_WORKED'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'HOURS_WORKED'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1457987904691823853)
,p_name=>'WKDATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1482436899539926780)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(1428074576764588244)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(1428124215210609461)
,p_interactive_grid_id=>wwv_flow_imp.id(1428074576764588244)
,p_static_id=>'318730'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(1428124382515609461)
,p_report_id=>wwv_flow_imp.id(1428124215210609461)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1408405312087590345)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>19
,p_column_id=>wwv_flow_imp.id(1403907762804055978)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1410951213391216274)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(1408502082385030046)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>40
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428124881842609463)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(1428074653373588245)
,p_is_visible=>false
,p_is_frozen=>true
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428126752236609468)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(1428074873896588247)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428127638300609470)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(1428074941219588248)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428128561857609472)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(1428075013196588249)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>107
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428129385933609475)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(1428075082688588250)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>94
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428135736577609491)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(1428075862090588257)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>124
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1428136666215609494)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(1428075951349588258)
,p_is_visible=>false
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1459116970234056205)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>21
,p_column_id=>wwv_flow_imp.id(1457987904691823853)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1461535665751482109)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>22
,p_column_id=>wwv_flow_imp.id(1455730116649315343)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1463572280718311156)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(1457864826032448063)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>104
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(1482314974848749153)
,p_view_id=>wwv_flow_imp.id(1428124382515609461)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(1482436899539926780)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>72
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1465199982300081293)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674615324667216137)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(815208586394219868)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674663317030216188)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1427263486810867767)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674663747369216188)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674664129583216188)
...
,p_security_scheme=>wwv_flow_imp.id(674297795433081315)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674679379359216205)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(1465199982300081293)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674679765380216206)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674680250399216206)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(674680562744216206)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(676327600729477736)
,p_name=>'P224_REPORT_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(1465199982300081293)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973792001669315146)
,p_name=>'P224_L_URL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(815208586394219868)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973792501259318258)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973792897490318258)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(973793317310318259)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987650969837138913)
,p_name=>'P224_OVERRIDE_LLH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1494538206854917856)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987681120147138946)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987681485119138947)
,p_name=>'P224_URL'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(1465199982300081293)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987681941632138947)
,p_name=>'P224_DYVP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(1465199982300081293)
,p_item_default=>'300'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987682344175138948)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987682745848138948)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987683255900138948)
,p_name=>'P224_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(1465199982300081293)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987683641401138949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987684001205138949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987684382792138950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987684878098138950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987685348395138951)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987685704289138951)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(987688778838138960)
,p_name=>'P224_VWFLAG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1427263486810867767)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674687180013216214)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674687732463216215)
,p_event_id=>wwv_flow_imp.id(674687180013216214)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1427263622339867768)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674688200011216215)
,p_event_id=>wwv_flow_imp.id(674687180013216214)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674688685599216216)
,p_event_id=>wwv_flow_imp.id(674687180013216214)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674689150005216216)
,p_name=>'dy_get_mastergrid_data'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1427263622339867768)
,p_bind_type=>'live'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_IG|REGION TYPE|interactivegridselectionchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674689589538216216)
,p_event_id=>wwv_flow_imp.id(674689150005216216)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674690149524216216)
,p_event_id=>wwv_flow_imp.id(674689150005216216)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1427263686401867769)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674690463775216217)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674691026462216217)
,p_event_id=>wwv_flow_imp.id(674690463775216217)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674691374176216217)
,p_name=>'dy_calculate_hoursworked'
,p_event_sequence=>100
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1427263686401867769)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674691940466216217)
,p_event_id=>wwv_flow_imp.id(674691374176216217)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674692303378216218)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674692801587216218)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674693286719216218)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1420634387315983867)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674693809711216218)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1463909763168264088)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674694265511216219)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1464164507045110669)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674694773613216219)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674695326058216219)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1494538206854917856)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674695773443216219)
,p_event_id=>wwv_flow_imp.id(674692303378216218)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1485286575196592762)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674696155743216220)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674696702419216220)
,p_event_id=>wwv_flow_imp.id(674696155743216220)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674697100704216220)
,p_name=>'New'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674697562979216220)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674698124834216221)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674698557788216221)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674699081939216221)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674699623208216221)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1427263486810867767)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674700056466216222)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674700624108216222)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674701112480216222)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'FALSE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674701629808216223)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674702103598216223)
,p_event_id=>wwv_flow_imp.id(674697100704216220)
,p_event_result=>'FALSE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674702492032216223)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674702971770216224)
,p_event_id=>wwv_flow_imp.id(674702492032216223)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674703354934216224)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674703909630216224)
,p_event_id=>wwv_flow_imp.id(674703354934216224)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674704421201216224)
,p_event_id=>wwv_flow_imp.id(674703354934216224)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1465569789511078964)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674704915467216225)
,p_event_id=>wwv_flow_imp.id(674703354934216224)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1465055424592476431)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674705357882216225)
,p_event_id=>wwv_flow_imp.id(674703354934216224)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674705893325216225)
,p_event_id=>wwv_flow_imp.id(674703354934216224)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674706384956216225)
,p_event_id=>wwv_flow_imp.id(674703354934216224)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674706794856216226)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674707298090216226)
,p_event_id=>wwv_flow_imp.id(674706794856216226)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674707784233216226)
,p_event_id=>wwv_flow_imp.id(674706794856216226)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674708217499216226)
,p_name=>'dy_set_caldendar_id'
,p_event_sequence=>290
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1420634387315983867)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674708688646216227)
,p_event_id=>wwv_flow_imp.id(674708217499216226)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674709151290216227)
,p_name=>'set_focus'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674709622832216227)
,p_event_id=>wwv_flow_imp.id(674709151290216227)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674710047726216228)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674710455161216228)
,p_event_id=>wwv_flow_imp.id(674710047726216228)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674710949807216228)
,p_name=>'refresh_emp_id_1'
,p_event_sequence=>350
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1463909763168264088)
,p_triggering_element=>'WORK_DATE'
,p_condition_element_type=>'COLUMN'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674711385823216228)
,p_event_id=>wwv_flow_imp.id(674710949807216228)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674711755409216229)
,p_name=>'dy_set_value'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674712329205216229)
,p_event_id=>wwv_flow_imp.id(674711755409216229)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674712666974216229)
,p_name=>'TIMESHEET_TIMES_OnPreme'
,p_event_sequence=>370
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674679379359216205)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674713218257216229)
,p_event_id=>wwv_flow_imp.id(674712666974216229)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674713577109216229)
,p_name=>'TIMESHEET_SUMMARY_OnPreme'
,p_event_sequence=>380
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674679765380216206)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_display_when_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674714064497216230)
,p_event_id=>wwv_flow_imp.id(674713577109216229)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674714463590216230)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674714989332216230)
,p_event_id=>wwv_flow_imp.id(674714463590216230)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674715413453216231)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674715886242216231)
,p_event_id=>wwv_flow_imp.id(674715413453216231)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674716318386216231)
,p_name=>'ref_empid'
,p_event_sequence=>410
,p_triggering_element_type=>'COLUMN'
,p_triggering_region_id=>wwv_flow_imp.id(1494538206854917856)
,p_triggering_element=>'WORK_DATE'
,p_condition_element_type=>'COLUMN'
,p_condition_element=>'ENTERED_BY'
,p_triggering_condition_type=>'NOT_NULL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674716830228216231)
,p_event_id=>wwv_flow_imp.id(674716318386216231)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674717211284216231)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674717691970216232)
,p_event_id=>wwv_flow_imp.id(674717211284216231)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674718213111216232)
,p_event_id=>wwv_flow_imp.id(674717211284216231)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674718595237216232)
,p_name=>'set_llh_val'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674719129283216233)
,p_event_id=>wwv_flow_imp.id(674718595237216232)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674719493867216233)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674719985462216233)
,p_event_id=>wwv_flow_imp.id(674719493867216233)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674720390938216233)
,p_name=>'dy_showhide'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674720812981216233)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674721266493216234)
,p_event_id=>wwv_flow_imp.id(674720812981216233)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674721741670216234)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674722174397216234)
,p_event_id=>wwv_flow_imp.id(674721741670216234)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674722645540216234)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674723088314216235)
,p_event_id=>wwv_flow_imp.id(674722645540216234)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674723604312216235)
,p_event_id=>wwv_flow_imp.id(674722645540216234)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674724130911216235)
,p_event_id=>wwv_flow_imp.id(674722645540216234)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674724529607216235)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674725038200216236)
,p_event_id=>wwv_flow_imp.id(674724529607216235)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674725482308216236)
,p_event_id=>wwv_flow_imp.id(674724529607216235)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674725964556216236)
,p_event_id=>wwv_flow_imp.id(674724529607216235)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674726437777216237)
,p_name=>'Preview_Report_Cloud_1_1'
,p_event_sequence=>520
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674680250399216206)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674726941360216237)
,p_event_id=>wwv_flow_imp.id(674726437777216237)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674727436067216237)
,p_event_id=>wwv_flow_imp.id(674726437777216237)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674727941515216237)
,p_event_id=>wwv_flow_imp.id(674726437777216237)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674728261951216238)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674728841244216238)
,p_event_id=>wwv_flow_imp.id(674728261951216238)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674729233158216238)
,p_name=>'REFRESH_MASTER'
,p_event_sequence=>540
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674663317030216188)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674729739102216238)
,p_event_id=>wwv_flow_imp.id(674729233158216238)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(674730130529216239)
,p_name=>'dy_open_dialog'
,p_event_sequence=>550
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(674680562744216206)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(674730608534216239)
,p_event_id=>wwv_flow_imp.id(674730130529216239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_OPEN_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(815208586394219868)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674686445930216212)
...
,p_process_when_button_id=>wwv_flow_imp.id(674663747369216188)
,p_process_success_message=>'Verifed Timesheet within selected period '
,p_internal_uid=>31351193911540718
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674686772800216213)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(674615324667216137)
,p_internal_uid=>31350767650540718
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674685598169216212)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674685160821216211)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(674684835978216210)
