...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3750427514834419422)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3717731781530852921)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3750427514834419422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3702124036350352252)
,p_name=>'P37_USER_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3750427514834419422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717350933543793647)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717351025315793648)
,p_name=>'P37_PK_KEY'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3750427514834419422)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717351104211793649)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717351206005793650)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717351302492793651)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717351538090793653)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717351588726793654)
,p_name=>'P37_STATUS_M'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3750427514834419422)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717352687220793665)
,p_name=>'P37_PAGE_NUM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3750427514834419422)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3717732179380852922)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3717351934940793657)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717352003027793658)
,p_event_id=>wwv_flow_imp.id(3717351934940793657)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717352065468793659)
,p_event_id=>wwv_flow_imp.id(3717351934940793657)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3717352523453793663)
,p_name=>'hide_record'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3717352587485793664)
,p_event_id=>wwv_flow_imp.id(3717352523453793663)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3717731173360850293)
...
,p_process_when_button_id=>wwv_flow_imp.id(3717731781530852921)
