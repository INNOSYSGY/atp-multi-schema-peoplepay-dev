...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(663611132400116108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(663612033216116117)
,p_plug_name=>'File Export'
,p_parent_plug_id=>wwv_flow_imp.id(663611132400116108)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(663612233175116119)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612281669116120)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612438101116121)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612545290116122)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612638431116123)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612660012116124)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612763155116125)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(663612887310116126)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(666888275464291156)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663611274859116110)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(663611132400116108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663611210147116109)
,p_name=>'P242_EARNING_PERIOD_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(663611132400116108)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(663611406307116111)
,p_name=>'P242_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(663611132400116108)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663611516432116112)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663611650531116113)
,p_event_id=>wwv_flow_imp.id(663611516432116112)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(665502997866564570)
,p_name=>'EXEUTE_DOWNLOAD'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663611274859116110)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(665503366537564571)
,p_event_id=>wwv_flow_imp.id(665502997866564570)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663611720798116114)
,p_name=>'showbutton'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663611839951116115)
,p_event_id=>wwv_flow_imp.id(663611720798116114)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663611274859116110)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663611902763116116)
,p_event_id=>wwv_flow_imp.id(663611720798116114)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663613032812116127)
,p_name=>'refresh'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P242_EARNING_PERIOD_ID'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663613058186116128)
,p_event_id=>wwv_flow_imp.id(663613032812116127)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(663612033216116117)
,p_attribute_01=>'N'
);
