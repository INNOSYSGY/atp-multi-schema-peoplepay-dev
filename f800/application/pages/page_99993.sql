...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10189287819785562282)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10189288824949562292)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(671031560069818865)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10189288824949562292)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(671030915063818864)
,p_name=>'P99993_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10189287819785562282)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(696831961971373858)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696832402997373858)
,p_event_id=>wwv_flow_imp.id(696831961971373858)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696832891675373859)
,p_event_id=>wwv_flow_imp.id(696831961971373858)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(671031955246818865)
...
,p_process_when_button_id=>wwv_flow_imp.id(671031560069818865)
