...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8462765300431047259)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8462766305595047269)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(671025585458807663)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8462766305595047269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(671024908734807663)
,p_name=>'P9961_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8462765300431047259)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(697169720754124876)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(697170137496124876)
,p_event_id=>wwv_flow_imp.id(697169720754124876)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(697170584912124877)
,p_event_id=>wwv_flow_imp.id(697169720754124876)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(671025982898807664)
...
,p_process_when_button_id=>wwv_flow_imp.id(671025585458807663)
