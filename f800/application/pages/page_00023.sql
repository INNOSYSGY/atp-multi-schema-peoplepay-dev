...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(696980917220819541)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764582182409581630)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854491037508684878)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764934566754741745)
,p_plug_name=>'Query'
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854496470864684883)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3765254662798919679)
,p_plug_name=>'Tools'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--accent13:t-Region--noBorder:t-Region--hiddenOverflow:t-Form--noPadding'
,p_component_template_options=>'#DEFAULT#:u-colors:t-Cards--basic:t-Cards--5cols:t-Cards--animColorFill'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3854503896397684901)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5487022548908249554)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854506102897684923)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(5487022548908249554)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854505678959684918)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3854504158341684903)
