...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(748128551161171295)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(748129238698171295)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668877503461761204)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(748129238698171295)
,p_button_name=>'Print'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668877930247761205)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668878312789761205)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(668878713474761206)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(352002589235877058)
,p_name=>'P3_ADDRESS_TO_TITLE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(748128551161171295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(744745480202345612)
,p_name=>'P3_TITLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(748128551161171295)
,p_prompt=>'Title'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748134585334171358)
,p_name=>'P3_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(748128551161171295)
,p_item_source_plug_id=>wwv_flow_imp.id(748128551161171295)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748134972724171363)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748135409659171364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748135703117171364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748136033953171364)
,p_name=>'P3_EMP_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(748128551161171295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748136433226171365)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(748136890782171365)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668883259192761221)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(668877930247761205)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668883844461761222)
,p_event_id=>wwv_flow_imp.id(668883259192761221)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(668884154659761223)
,p_name=>'print_general_letter'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(668877503461761204)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(668884721427761223)
,p_event_id=>wwv_flow_imp.id(668884154659761223)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668882096981761220)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(748128551161171295)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668882534420761220)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(668882948700761221)
,p_process_sequence=>10
