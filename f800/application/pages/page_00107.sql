...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3696631319732262696)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(3696631390826262696)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3696631390826262696)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(547996451379690077)
,p_region_id=>wwv_flow_imp.id(3696631390826262696)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(547996537496690078)
,p_card_id=>wwv_flow_imp.id(547996451379690077)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(548102900769083899)
,p_card_id=>wwv_flow_imp.id(547996451379690077)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(548103048511083900)
,p_card_id=>wwv_flow_imp.id(547996451379690077)
,p_action_type=>'BUTTON'
,p_position=>'SECONDARY'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23673997019311077009)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23673997383547077012)
,p_plug_name=>'Search_top'
,p_parent_plug_id=>wwv_flow_imp.id(23673997019311077009)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3697153431100424028)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(23673997383547077012)
,p_button_name=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3696614887076232757)
,p_name=>'P107_ENTRY_SCREEN'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(23673997383547077012)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3696615724968232757)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3696630797967262696)
,p_name=>'P107_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3696631319732262696)
,p_prompt=>'Search'
