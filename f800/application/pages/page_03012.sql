...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3774177022116965543)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822268498555444508)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849929491273521496)
,p_region_id=>wwv_flow_imp.id(3822268498555444508)
,p_chart_type=>'donut'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849929049928521493)
,p_chart_id=>wwv_flow_imp.id(3849929491273521496)
,p_seq=>10
,p_name=>'Series 1'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849928467081521490)
,p_chart_id=>wwv_flow_imp.id(3849929491273521496)
,p_seq=>20
,p_name=>'Series 2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822271251255444501)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849927513970521488)
,p_region_id=>wwv_flow_imp.id(3822271251255444501)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849925810435521485)
,p_chart_id=>wwv_flow_imp.id(3849927513970521488)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849925210669521484)
,p_chart_id=>wwv_flow_imp.id(3849927513970521488)
,p_seq=>20
,p_name=>'Series 2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849927080694521487)
,p_chart_id=>wwv_flow_imp.id(3849927513970521488)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849926445787521486)
,p_chart_id=>wwv_flow_imp.id(3849927513970521488)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822273882680444500)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849924362298521483)
,p_region_id=>wwv_flow_imp.id(3822273882680444500)
,p_chart_type=>'line'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849922027872521480)
,p_chart_id=>wwv_flow_imp.id(3849924362298521483)
,p_seq=>10
,p_name=>'Series1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849921391552521479)
,p_chart_id=>wwv_flow_imp.id(3849924362298521483)
,p_seq=>20
,p_name=>'Series2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849923229384521482)
,p_chart_id=>wwv_flow_imp.id(3849924362298521483)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849923785422521482)
,p_chart_id=>wwv_flow_imp.id(3849924362298521483)
,p_axis=>'y2'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849922612864521481)
,p_chart_id=>wwv_flow_imp.id(3849924362298521483)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3822276571455444499)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3849920520623521478)
,p_region_id=>wwv_flow_imp.id(3822276571455444499)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849918813420521473)
,p_chart_id=>wwv_flow_imp.id(3849920520623521478)
,p_seq=>10
,p_name=>'Series1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3849918263189521473)
,p_chart_id=>wwv_flow_imp.id(3849920520623521478)
,p_seq=>20
,p_name=>'Series2'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849919464637521474)
,p_chart_id=>wwv_flow_imp.id(3849920520623521478)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3849920006506521475)
,p_chart_id=>wwv_flow_imp.id(3849920520623521478)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3849931835731521509)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3774177022116965543)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849930187495521500)
,p_name=>'P3012_MONTH_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3774177022116965543)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849930644027521501)
,p_name=>'P3012_YEAR_1'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3774177022116965543)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849931057875521501)
,p_name=>'P3012_MONTH'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3774177022116965543)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3849931478468521504)
,p_name=>'P3012_YEAR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3774177022116965543)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3849917678884521458)
,p_name=>'REFRESHH_ALL'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849917213649521455)
,p_event_id=>wwv_flow_imp.id(3849917678884521458)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822268498555444508)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849916696188521454)
,p_event_id=>wwv_flow_imp.id(3849917678884521458)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822271251255444501)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849916223375521454)
,p_event_id=>wwv_flow_imp.id(3849917678884521458)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822273882680444500)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3849915697815521453)
,p_event_id=>wwv_flow_imp.id(3849917678884521458)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3822276571455444499)
,p_attribute_01=>'N'
);
