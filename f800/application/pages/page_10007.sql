...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4312072934188001839)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3871753556241339626)
,p_plug_name=>'Transfer'
,p_parent_plug_id=>wwv_flow_imp.id(4312072934188001839)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811723296210210279)
,p_region_id=>wwv_flow_imp.id(3871753556241339626)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811721561044210279)
,p_chart_id=>wwv_flow_imp.id(3811723296210210279)
,p_seq=>10
,p_name=>'Transfer'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811722196597210279)
,p_chart_id=>wwv_flow_imp.id(3811723296210210279)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811722745680210279)
,p_chart_id=>wwv_flow_imp.id(3811723296210210279)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4312073084215001840)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811731047720210282)
,p_region_id=>wwv_flow_imp.id(4312073084215001840)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811729340724210282)
,p_chart_id=>wwv_flow_imp.id(3811731047720210282)
,p_seq=>10
,p_name=>'Promotion'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811730584896210282)
,p_chart_id=>wwv_flow_imp.id(3811731047720210282)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811729964061210282)
,p_chart_id=>wwv_flow_imp.id(3811731047720210282)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4349969062158884895)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811728497557210281)
,p_region_id=>wwv_flow_imp.id(4349969062158884895)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811726817750210281)
,p_chart_id=>wwv_flow_imp.id(3811728497557210281)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811727326193210281)
,p_chart_id=>wwv_flow_imp.id(3811728497557210281)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811727960665210281)
,p_chart_id=>wwv_flow_imp.id(3811728497557210281)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4349969608044884900)
,p_plug_name=>'Acting'
,p_parent_plug_id=>wwv_flow_imp.id(4312072934188001839)
,p_region_template_options=>'#DEFAULT#:i-h320:t-Region--noBorder:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3811725900997210280)
,p_region_id=>wwv_flow_imp.id(4349969608044884900)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'none'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3811724195196210280)
,p_chart_id=>wwv_flow_imp.id(3811725900997210280)
,p_seq=>10
,p_name=>'Acting'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811725390241210280)
,p_chart_id=>wwv_flow_imp.id(3811725900997210280)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Quantity'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3811724795402210280)
,p_chart_id=>wwv_flow_imp.id(3811725900997210280)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819133230629146352)
,p_name=>'P10007_END_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4312072934188001839)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3819133424874146353)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682724105125456316)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724216925456317)
,p_event_id=>wwv_flow_imp.id(682724105125456316)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(4349969608044884900)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724265224456318)
,p_event_id=>wwv_flow_imp.id(682724105125456316)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3871753556241339626)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724402713456319)
,p_event_id=>wwv_flow_imp.id(682724105125456316)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4312073084215001840)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724522007456320)
,p_event_id=>wwv_flow_imp.id(682724105125456316)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4349969062158884895)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682724649333456321)
,p_name=>'refresh_end'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724658138456322)
,p_event_id=>wwv_flow_imp.id(682724649333456321)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'refresh_transfer'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724917178456324)
,p_event_id=>wwv_flow_imp.id(682724649333456321)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682724968191456325)
,p_event_id=>wwv_flow_imp.id(682724649333456321)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682725087187456326)
,p_event_id=>wwv_flow_imp.id(682724649333456321)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
