...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3827226304826857889)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3170408094697618394)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3827226304826857889)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3170407702971618393)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170408467016618398)
,p_name=>'P331_ORGDTL_ID'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3827226304826857889)
,p_prompt=>'Work Unit'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170408911884618399)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170409327904618399)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170409727362618399)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170410119781618400)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170410495538618400)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170410911660618401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170411320061618401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170411747545618402)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3170412149483618402)
,p_name=>'P331_REMARKS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3827226304826857889)
,p_prompt=>'Remarks'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3170412487460618408)
,p_name=>'SHOW_HIDE'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170413017024618409)
,p_event_id=>wwv_flow_imp.id(3170412487460618408)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3170407702971618393)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170413464043618410)
,p_event_id=>wwv_flow_imp.id(3170412487460618408)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3170413910137618410)
,p_name=>'run_process'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3170407702971618393)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170414918431618411)
,p_event_id=>wwv_flow_imp.id(3170413910137618410)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3170414387802618411)
,p_event_id=>wwv_flow_imp.id(3170413910137618410)
,p_event_result=>'TRUE'
