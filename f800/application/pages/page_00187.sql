...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3762495241332095699)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3762495051178095697)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3762495241332095699)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3762495132550095698)
,p_name=>'P187_EARNINGS_PERIOD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3762495241332095699)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3762494513653095692)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3762494324729095690)
,p_event_id=>wwv_flow_imp.id(3762494513653095692)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(3762495051178095697)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3762494448099095691)
,p_event_id=>wwv_flow_imp.id(3762494513653095692)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3762494187837095689)
...
,p_process_when_button_id=>wwv_flow_imp.id(3762495051178095697)
