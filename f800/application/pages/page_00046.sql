...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3859117372707523996)
,p_plug_name=>'Test'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3859117408199523997)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3859117372707523996)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3859117573954523998)
...
,p_process_when_button_id=>wwv_flow_imp.id(3859117408199523997)
