...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3791324305827621903)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3791324590829621903)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3791323493380621903)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3791324305827621903)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3791323896343621903)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3791306921389621894)
,p_branch_action=>'f?p=&APP_ID.:208:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3791323493380621903)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791311946197621896)
,p_name=>'P206_DECIMAL_CHARACTER'
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_imp.id(3791324305827621903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791312858045621896)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791313700807621896)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791314582574621897)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791315535702621898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791318179980621899)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791319124035621899)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791320044786621900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791320883792621900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791321382878621901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791322675707621902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3791322965783621902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810483457590538044)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3810483504849538045)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3791321734195621901)
...
,p_when_button_pressed=>wwv_flow_imp.id(3791323493380621903)
,p_associated_item=>wwv_flow_imp.id(3791322675707621902)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3791317313586621899)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(3791323493380621903)
,p_associated_item=>wwv_flow_imp.id(3791321382878621901)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3791311109570621896)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791309571346621895)
,p_event_id=>wwv_flow_imp.id(3791311109570621896)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791310074431621895)
,p_event_id=>wwv_flow_imp.id(3791311109570621896)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791310563811621895)
,p_event_id=>wwv_flow_imp.id(3791311109570621896)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3791317005922621898)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791315980541621898)
,p_event_id=>wwv_flow_imp.id(3791317005922621898)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791316519923621898)
,p_event_id=>wwv_flow_imp.id(3791317005922621898)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3791309240678621895)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791308730749621895)
,p_event_id=>wwv_flow_imp.id(3791309240678621895)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791307760316621894)
,p_event_id=>wwv_flow_imp.id(3791309240678621895)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3791308234369621895)
,p_event_id=>wwv_flow_imp.id(3791309240678621895)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3791307226895621894)
...
,p_process_when_button_id=>wwv_flow_imp.id(3791323493380621903)
,p_internal_uid=>3147971974876946400
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3791226030730199990)
