...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772991389606798670)
...
,p_list_id=>wwv_flow_imp.id(663414927549367840)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(772836092129205522)
,p_plug_name=>'Chat Sent'
,p_parent_plug_id=>wwv_flow_imp.id(772991389606798670)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773033938541311596)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773036390911311620)
,p_plug_name=>'Forward'
,p_parent_plug_id=>wwv_flow_imp.id(773033938541311596)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773036466044311621)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773036567490311622)
,p_plug_name=>'Delete'
,p_parent_plug_id=>wwv_flow_imp.id(773033938541311596)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773034104448311597)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(773037900528311635)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(773038311869311639)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776200108731433590)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776200156908433591)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776200259540433592)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776200373946433593)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(776200490380433594)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(776207111023434521)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(781905487540188715)
,p_plug_name=>'Notice'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663348792359229141)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(772836092129205522)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663350556565229143)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(773036390911311620)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663351990354229145)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(773036466044311621)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663353388508229146)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(773036567490311622)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(663353819733229146)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(773036567490311622)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772854550657205615)
,p_name=>'P4805_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772991389606798670)
,p_prompt=>'Recipient'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(772855517542205609)
,p_name=>'P4805_ENTRY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(772836092129205522)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773058238910311701)
,p_name=>'P4805_UTILITY_RECIPIENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773033938541311596)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773062912161311730)
,p_name=>'P4805_SENT_TO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(773036390911311620)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773062992100311731)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773063457179311711)
,p_name=>'P4805_GROUP_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773036466044311621)
,p_prompt=>'Group Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773066595935311743)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(773069601200311741)
,p_name=>'P4805_MSG_TO_DELETE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(773036567490311622)
,p_prompt=>'Message/s'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT COMMENT_TEXT||'' (''||initcap(a.user_name)||'')'' A, a.id B       ',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663369323920229184)
,p_name=>'SAVE_MSG'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663348792359229141)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663369760615229185)
,p_event_id=>wwv_flow_imp.id(663369323920229184)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663370306442229185)
,p_event_id=>wwv_flow_imp.id(663369323920229184)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(772991389606798670)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663370713003229185)
,p_name=>'refresh_chat'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663371211457229186)
,p_event_id=>wwv_flow_imp.id(663370713003229185)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663371696178229186)
,p_event_id=>wwv_flow_imp.id(663370713003229185)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663372136297229186)
,p_name=>'PURGE_CHAT'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663353388508229146)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663372616824229187)
,p_event_id=>wwv_flow_imp.id(663372136297229186)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663373131129229187)
,p_event_id=>wwv_flow_imp.id(663372136297229186)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663373524336229187)
,p_name=>'PURGE_CHAT_ALL'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663353819733229146)
,p_condition_element=>'P4805_RECIPIENT'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663373969161229187)
,p_event_id=>wwv_flow_imp.id(663373524336229187)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663374459226229188)
,p_event_id=>wwv_flow_imp.id(663373524336229187)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663374923780229188)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663375372008229188)
,p_event_id=>wwv_flow_imp.id(663374923780229188)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663348792359229141)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663375878307229188)
,p_event_id=>wwv_flow_imp.id(663374923780229188)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663376269502229189)
,p_name=>'dyn_forward'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663350556565229143)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663376783041229189)
,p_event_id=>wwv_flow_imp.id(663376269502229189)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663365180479229179)
,p_name=>'create_group'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(663351990354229145)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663365692570229181)
,p_event_id=>wwv_flow_imp.id(663365180479229179)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663366150737229182)
,p_name=>'show_group'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663366647540229182)
,p_event_id=>wwv_flow_imp.id(663366150737229182)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(663351990354229145)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663367117131229183)
,p_event_id=>wwv_flow_imp.id(663366150737229182)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663367474896229183)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(663368363523229184)
,p_name=>'update_seen'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(663368871919229184)
,p_event_id=>wwv_flow_imp.id(663368363523229184)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(663364842262229178)
