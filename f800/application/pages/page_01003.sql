...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697515906904385703)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3794589045672419309)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794579684147401280)
,p_name=>'SURNAME'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794584263271419303)
,p_name=>'REMARKS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794586046723419303)
,p_name=>'FIRST_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794586712805419303)
,p_name=>'AMOUNT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3794587277738419304)
,p_name=>'MOBILE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(3803387088280866039)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(3794588589179419308)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(3794588151841419306)
,p_interactive_grid_id=>wwv_flow_imp.id(3794588589179419308)
,p_static_id=>'17878'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(3794588048755419306)
,p_report_id=>wwv_flow_imp.id(3794588151841419306)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794527996439296812)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(3794579684147401280)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794581699512413889)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(3803387088280866039)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>130
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794583914038419302)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(3794584263271419303)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>350
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794585649092419303)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(3794586046723419303)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794586271684419303)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(3794586712805419303)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>100
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(3794586890706419303)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(3794587277738419304)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>124
);
wwv_flow_imp_page.create_ig_report_aggregate(
 p_id=>wwv_flow_imp.id(3844075640882590095)
,p_view_id=>wwv_flow_imp.id(3794588048755419306)
,p_function=>'SUM'
,p_column_id=>wwv_flow_imp.id(3794586712805419303)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3794579771218401281)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3794589045672419309)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3794580260495401286)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3794580151096401285)
,p_name=>'P1003_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3794589045672419309)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3794580347223401287)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3794580039501401284)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3794580017163401283)
,p_event_id=>wwv_flow_imp.id(3794580039501401284)
,p_event_result=>'TRUE'
