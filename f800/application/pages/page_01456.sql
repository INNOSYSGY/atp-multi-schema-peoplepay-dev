...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(789045640777480691)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1583511745265132390)
,p_plug_name=>'OrganisationChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(789045640777480691)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662898548428462412)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(789045640777480691)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662898856915462412)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662899659813462413)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662900096481462415)
,p_name=>'P1456_ORG_STRUCTURE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(789045640777480691)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662900518214462415)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662900908595462416)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662901565820462417)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662902109916462417)
,p_event_id=>wwv_flow_imp.id(662901565820462417)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1583511745265132390)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662902593626462418)
,p_event_id=>wwv_flow_imp.id(662901565820462417)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662902984080462418)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(662899659813462413)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662903469115462419)
,p_event_id=>wwv_flow_imp.id(662902984080462418)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
