...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4449301870554424673)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452649344460662824)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446481822043471964)
,p_region_id=>wwv_flow_imp.id(4452649344460662824)
,p_chart_type=>'dial'
,p_width=>'240'
,p_height=>'360'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446482279745471967)
,p_chart_id=>wwv_flow_imp.id(3446481822043471964)
,p_seq=>10
,p_name=>'Number Hired'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452650043762662831)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446483235941471970)
,p_region_id=>wwv_flow_imp.id(4452650043762662831)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446485486189471973)
,p_chart_id=>wwv_flow_imp.id(3446483235941471970)
,p_seq=>20
,p_name=>'Female'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446484894082471972)
,p_chart_id=>wwv_flow_imp.id(3446483235941471970)
,p_seq=>30
,p_name=>'Male'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3446483756249471970)
,p_chart_id=>wwv_flow_imp.id(3446483235941471970)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Age'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(3446484340552471972)
,p_chart_id=>wwv_flow_imp.id(3446483235941471970)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452650338373662834)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(3446486959919471979)
,p_region_id=>wwv_flow_imp.id(4452650338373662834)
,p_chart_type=>'donut'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(3446487428061471980)
,p_chart_id=>wwv_flow_imp.id(3446486959919471979)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4452652518615662856)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4670901808860293557)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3446480712141471961)
,p_name=>'P10003_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(4449301870554424673)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3446481105280471962)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446488426964471982)
,p_name=>'refr_st'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446488884985471983)
,p_event_id=>wwv_flow_imp.id(3446488426964471982)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4670901808860293557)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446489313390471983)
,p_name=>'refresh_end'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446489791229471984)
,p_event_id=>wwv_flow_imp.id(3446489313390471983)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446490181149471984)
,p_name=>'refr_hr'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446490727928471984)
,p_event_id=>wwv_flow_imp.id(3446490181149471984)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452649344460662824)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446491090698471985)
,p_name=>'refr_end'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_END_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446491606932471985)
,p_event_id=>wwv_flow_imp.id(3446491090698471985)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446492054129471985)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446492477486471986)
,p_event_id=>wwv_flow_imp.id(3446492054129471985)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452650043762662831)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446492957505471986)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446493454848471987)
,p_event_id=>wwv_flow_imp.id(3446492957505471986)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4452650338373662834)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446493791955471987)
,p_name=>'refr_age_sex'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P10003_START_DATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446494325702471987)
,p_event_id=>wwv_flow_imp.id(3446493791955471987)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3446494745551471988)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3446495243570471988)
,p_event_id=>wwv_flow_imp.id(3446494745551471988)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3446488049154471981)
