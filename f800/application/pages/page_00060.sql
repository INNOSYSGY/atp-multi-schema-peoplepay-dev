...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3726698065153519228)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3726995561862023301)
,p_plug_name=>'TAB'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3730520407899454669)
,p_plug_name=>'Leave  Roster Gantt Chart'
,p_parent_plug_id=>wwv_flow_imp.id(3726995561862023301)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3759833451528851678)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719269252641455730)
,p_plug_name=>'Employee Leave Calendar (select filter options above, Navigate to specific month)'
,p_parent_plug_id=>wwv_flow_imp.id(3759833451528851678)
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3719728756485030420)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3831203688709813251)
,p_plug_name=>'Legend'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3726863099036563759)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3726698065153519228)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3727149971748700281)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3719728756485030420)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3725968412898738242)
,p_name=>'P60_LEAVE_STATUS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3719728756485030420)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3725968555759738243)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727150408583700288)
,p_name=>'P60_PERIOD_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3730520407899454669)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3727150827175700293)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761219207983629249)
,p_name=>'P60_EMPLOYEE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3719728756485030420)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761219657154629262)
,p_name=>'P60_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3719728756485030420)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3761220001484629263)
,p_name=>'P60_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3719728756485030420)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3726995236272023298)
,p_name=>'Submit'
,p_event_sequence=>50
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3726995269038023299)
,p_event_id=>wwv_flow_imp.id(3726995236272023298)
,p_event_result=>'TRUE'
