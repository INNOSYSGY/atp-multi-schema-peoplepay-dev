...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658084248241444241)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658085258621444244)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3658084248241444241)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658085846857444245)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3658084248241444241)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658086256942444245)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3658086668868444246)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3658086256942444245)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694442622018837519)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3658084248241444241)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694445799635837527)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3658085258621444244)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694443061514837520)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3694443408739837520)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3658084248241444241)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3694454000003837536)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694443861743837524)
,p_name=>'P402_REPORT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3658084248241444241)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694444274606837525)
,p_name=>'P402_URL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3658084248241444241)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694444665572837525)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694445029589837525)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694446175308837527)
,p_name=>'P402_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3658085258621444244)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3694447206221837528)
,p_name=>'P402_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3658086256942444245)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694447868960837531)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3694443408739837520)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694448324063837532)
,p_event_id=>wwv_flow_imp.id(3694447868960837531)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3846875063327620349)
,p_event_id=>wwv_flow_imp.id(3694447868960837531)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694448730196837532)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694449212992837532)
,p_event_id=>wwv_flow_imp.id(3694448730196837532)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
'from HR_HCF_LOOKUP where upper(VALUE_DESCRIPTION)=''JASPERSERVER URL'' and org_id=pkg_global_fnts.fn_shareRefOrg(:APP_ORG_ID);',
'',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694449710060837533)
,p_event_id=>wwv_flow_imp.id(3694448730196837532)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694450126864837533)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694450625254837533)
,p_event_id=>wwv_flow_imp.id(3694450126864837533)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694451065484837533)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3694445799635837527)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694451560293837534)
,p_event_id=>wwv_flow_imp.id(3694451065484837533)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694452086304837534)
,p_event_id=>wwv_flow_imp.id(3694451065484837533)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3694452409689837534)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694452962827837534)
,p_event_id=>wwv_flow_imp.id(3694452409689837534)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3694453482849837535)
,p_event_id=>wwv_flow_imp.id(3694452409689837534)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
