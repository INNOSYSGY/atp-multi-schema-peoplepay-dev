...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5012620324590051849)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5012621329754051859)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(671013602322793558)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(5012621329754051859)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(671012886420793558)
,p_name=>'P9914_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(5012620324590051849)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(696826378748340603)
,p_name=>'ShowPDF'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696826847817340604)
,p_event_id=>wwv_flow_imp.id(696826378748340603)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(696827303188340604)
,p_event_id=>wwv_flow_imp.id(696826378748340603)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(671013992295793560)
...
,p_process_when_button_id=>wwv_flow_imp.id(671013602322793558)
