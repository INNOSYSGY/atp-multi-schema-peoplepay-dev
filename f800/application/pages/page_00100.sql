...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3669541035971708561)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3669540957611708528)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717539778592596841)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717540612659596841)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717540983649596842)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717541391447596843)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717540254294596841)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717541854995596843)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717542234506596843)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717542592598596843)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717539407191596838)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3717542979213596844)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3705578293954061533)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3669539832162707425)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841625288097546185)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
,p_name=>'Anniversary '
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841625708193546186)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
,p_name=>'Birthday '
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841626091546546187)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
,p_name=>'Confirmation'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841626513252546188)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
,p_name=>'Gratuity'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841626917224546189)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841627314494546190)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841627705257546190)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841628108723546191)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
,p_name=>'Retirement'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3841628529473546193)
,p_report_id=>wwv_flow_imp.id(3669539832162707425)
,p_name=>'work permit'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3702329935763177954)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3702330406332177963)
,p_report_id=>wwv_flow_imp.id(3702329935763177954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3744940049326286614)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3744940145012286615)
,p_plug_name=>'NOTIFICATION'
,p_parent_plug_id=>wwv_flow_imp.id(3744940049326286614)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3705129575325966651)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3705128683486966649)
,p_event_id=>wwv_flow_imp.id(3705129575325966651)
,p_event_result=>'TRUE'
