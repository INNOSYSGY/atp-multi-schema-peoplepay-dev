...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668964384029281373)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668965394409281376)
,p_plug_name=>'Export'
,p_parent_plug_id=>wwv_flow_imp.id(3668964384029281373)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668965982645281377)
,p_plug_name=>'gg'
,p_parent_plug_id=>wwv_flow_imp.id(3668964384029281373)
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668966392730281377)
,p_plug_name=>'Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3668966804656281378)
,p_plug_name=>'PREVIEW'
,p_region_name=>'PREVIEW'
,p_parent_plug_id=>wwv_flow_imp.id(3668966392730281377)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654215953758512658)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3668964384029281373)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654219825019512671)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3668965394409281376)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654216817801512659)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654216373725512658)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3668964384029281373)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(654217181707512659)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3668964384029281373)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(654235633913155914)
,p_name=>'P406_ORGANISATION'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3668964384029281373)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(654235936484159913)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705326206516674690)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705326619379674691)
,p_name=>'P406_URL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3668964384029281373)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705327010345674691)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705327374362674691)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705331118993674704)
,p_name=>'P406_EXPORT_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3668965394409281376)
,p_prompt=>'Select format'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'P_EXPORT_TYPE'
,p_lov=>'.'||wwv_flow_imp.id(3853995861154014600)||'.'
,p_lov_display_null=>'YES'
,p_cHeight=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3705332887406674706)
,p_name=>'P406_PAGE_URL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(3668966392730281377)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654224066712512689)
,p_name=>'Preview_report_OnPreme'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(654216373725512658)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654224602803512689)
,p_event_id=>wwv_flow_imp.id(654224066712512689)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654225079035512689)
,p_event_id=>wwv_flow_imp.id(654224066712512689)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654221815515512685)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654222297872512687)
,p_event_id=>wwv_flow_imp.id(654221815515512685)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654222821950512688)
,p_event_id=>wwv_flow_imp.id(654221815515512685)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654223168732512688)
,p_name=>'New_preview_report_1'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3750629511945632330)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654223686053512688)
,p_event_id=>wwv_flow_imp.id(654223168732512688)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654225522087512689)
,p_name=>'Export Cloud'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(654219825019512671)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654226455855512690)
,p_event_id=>wwv_flow_imp.id(654225522087512689)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654226049173512690)
,p_event_id=>wwv_flow_imp.id(654225522087512689)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(654226946035512690)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654227355712512691)
,p_event_id=>wwv_flow_imp.id(654226946035512690)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(654227934957512691)
,p_event_id=>wwv_flow_imp.id(654226946035512690)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(669086975349980607)
,p_name=>'New'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(669087143907980608)
,p_event_id=>wwv_flow_imp.id(669086975349980607)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
