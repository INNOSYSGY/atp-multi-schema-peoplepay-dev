...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3119496276156963722)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3119496719294963722)
,p_name=>'P9120_BANK'
,p_item_sequence=>60
,p_item_display_point=>'LEGACY_ORPHAN_COMPONENTS'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3119497107253963723)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(537739646346670180)
