...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3713042372199289817)
,p_name=>'Holiday'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3713042362515289816)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3707880884230249265)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3707880836898249264)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3707880727249249263)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3719468236079431959)
,p_name=>'Alert'
,p_template=>4501440665235496320
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719468305794431960)
,p_query_column_id=>1
,p_column_alias=>'ALERT_TITLE'
,p_column_display_sequence=>1
,p_column_heading=>'Alert Title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719468459395431961)
,p_query_column_id=>2
,p_column_alias=>'ALERT_DESC'
,p_column_display_sequence=>2
,p_column_heading=>'Alert Desc'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3718930334631718743)
,p_query_column_id=>3
,p_column_alias=>'ALERT_ACTION'
,p_column_display_sequence=>4
,p_column_heading=>'Alert Action'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3719751666720151416)
,p_query_column_id=>4
,p_column_alias=>'ALERT_TYPE'
,p_column_display_sequence=>3
,p_column_heading=>'Alert Type'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3762623616125179824)
,p_name=>'Tips'
,p_template=>4501440665235496320
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660347248853288729)
,p_query_column_id=>1
,p_column_alias=>'ALERT_DESC'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660347347565288730)
,p_query_column_id=>2
,p_column_alias=>'ALERT_ACTION'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660347448673288731)
,p_query_column_id=>3
,p_column_alias=>'ALERT_TYPE'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(660347489248288732)
,p_query_column_id=>4
,p_column_alias=>'ALERT_TITLE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3764707604408820249)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3806124068510386128)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(3846620305642177313)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3839566309711473422)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3839525861786355543)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(3839566309711473422)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(624092434122502295)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3819068888025996688)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3839525861786355543)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3804576631588181664)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3854657665196743971)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(624092330915502294)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3831848114345617540)
,p_name=>'P1_IMG_SRC'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3839566309711473422)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3854539849920313206)
,p_name=>'P1_MAX_TIP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3806124068510386128)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select max(id)',
'from HR_APU_TIPS'))
,p_source_type=>'QUERY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3854540269852313207)
,p_name=>'P1_MIN_TIP'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3806124068510386128)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3721372319498827610)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3721372244593827609)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(671859207940386918)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(671859258054386919)
,p_event_id=>wwv_flow_imp.id(671859207940386918)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(624092580401502296)
...
,p_process_when_button_id=>wwv_flow_imp.id(624092434122502295)
