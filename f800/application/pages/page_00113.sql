...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3718567514416849124)
...
,p_plug_source=>'Please set format for <strong>WORK_DATE</strong> Column to <strong>DD-MM-YYYY</strong>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3720263516989333073)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3720263881349333073)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'data_load_def_id', wwv_flow_imp.id(3720242544895333053))).to_clob
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3720264713632333073)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3720263881349333073)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3720264241270333073)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3720265027737333074)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3720265930395333074)
,p_branch_action=>'f?p=&APP_ID.:114:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3720265027737333074)
...
'                                      where name = ''timeclock_loading'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3720266356096333074)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3720265515010333074)
...
,p_process_when_button_id=>wwv_flow_imp.id(3720265027737333074)
,p_internal_uid=>3076930262991657580
);
