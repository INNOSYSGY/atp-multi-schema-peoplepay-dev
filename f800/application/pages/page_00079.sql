...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3709315541669964724)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3755636261761643098)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3755636431948643099)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709315345768964722)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3709315541669964724)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3755635526358643090)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3755636261761643098)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3709315250925964721)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3755635341884643089)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3755636261761643098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(559821158916390339)
,p_name=>'P79_ORGDTL_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3755636431948643099)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(591386999818172196)
,p_name=>'P79_LABEL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3755636431948643099)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(634713579929083397)
,p_name=>'P79_DEF_QUANTITY'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3709315541669964724)
,p_item_default=>'1'
,p_prompt=>'Quantity'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3369484152291798536)
,p_name=>'P79_QUANTITY'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3755636261761643098)
,p_item_default=>'1'
,p_prompt=>'Quantity'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>15
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3369484458742801237)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3708886572756985414)
,p_name=>'P79_RETURN'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(3709315541669964724)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709314785930964717)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709314903168964718)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709315008402964719)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3709315432099964723)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755334753545628040)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755335076397630083)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3755636164030643097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766550258097334002)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766550394298334003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766550468735334004)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3766550705796334006)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3709184437547682340)
,p_name=>'dy_all_eployeee'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3709315250925964721)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3709184032359682335)
,p_event_id=>wwv_flow_imp.id(3709184437547682340)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3709183576272682334)
,p_event_id=>wwv_flow_imp.id(3709184437547682340)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3766551126577334010)
,p_name=>'dy_all_eployeee_sel'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3755635341884643089)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766550954142334009)
,p_event_id=>wwv_flow_imp.id(3766551126577334010)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3766550903206334008)
,p_event_id=>wwv_flow_imp.id(3766551126577334010)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3755636138014643096)
,p_name=>'SHOW_hide'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755635854038643094)
,p_event_id=>wwv_flow_imp.id(3755636138014643096)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3709315541669964724)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755635967450643095)
,p_event_id=>wwv_flow_imp.id(3755636138014643096)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3755635762640643093)
,p_name=>'SHOW_hide_1'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P79_POST_CATEGORY'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755635625380643091)
,p_event_id=>wwv_flow_imp.id(3755635762640643093)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3755636261761643098)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3755635662390643092)
,p_event_id=>wwv_flow_imp.id(3755635762640643093)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3472723678199615597)
,p_name=>'set_clear'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3472723784168615598)
,p_event_id=>wwv_flow_imp.id(3472723678199615597)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(591387072647172197)
