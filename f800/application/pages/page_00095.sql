...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2386669929536152882)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2382364612005611867)
,p_plug_name=>'PositionChart'
,p_region_name=>'org_char'
,p_parent_plug_id=>wwv_flow_imp.id(2386669929536152882)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662883111785394231)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2386669929536152882)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662883456600394232)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(662883884432394232)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662884320410394236)
,p_name=>'P95_POSITION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2386669929536152882)
,p_prompt=>'Position'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(662884726796394237)
,p_name=>'P95_FILTER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2386669929536152882)
,p_item_default=>'2'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662885364833394243)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662885943942394245)
,p_event_id=>wwv_flow_imp.id(662885364833394243)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2382364612005611867)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662886437484394245)
,p_event_id=>wwv_flow_imp.id(662885364833394243)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(662886771444394245)
,p_name=>'New_1s'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(662883884432394232)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(662887289322394246)
,p_event_id=>wwv_flow_imp.id(662886771444394245)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
