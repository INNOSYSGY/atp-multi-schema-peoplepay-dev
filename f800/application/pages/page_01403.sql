...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697056265479894936)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3611122718613790322)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3611122890523790324)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611122988756790325)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611123072225790326)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611123125715790327)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611123229148790328)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3611123419868790329)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290342549273280)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290500648273281)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290605457273282)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290702116273283)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290760625273284)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290868440273285)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654290989941273286)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291093302273287)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291149485273288)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291320496273289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291387447273290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291471708273291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291548626273292)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291724475273293)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291815089273294)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654291918339273295)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3654303666366278012)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3654314679929514092)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3654314853247514094)
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_allow_save_rpt_public=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654314944660514095)
,p_db_column_name=>'REGNO'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315027069514096)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315165686514097)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315241555514098)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315414898514099)
,p_db_column_name=>'SSN'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315434186514100)
,p_db_column_name=>'SURNAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315561871514101)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315689080514102)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315748038514103)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654315910285514104)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316024731514105)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316124415514106)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316130008514107)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316251920514108)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316357032514109)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316434041514110)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316612707514111)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316682204514112)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316746519514113)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316854372514114)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654316973357514115)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3654317101926514116)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3855424578382358029)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3855438186583791545)
,p_plug_name=>'eNIB/SS  Output'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3855438287099791545)
,p_name=>'eNIS Output'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699637626391334329)
,p_db_column_name=>'REGNO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699638054005334331)
,p_db_column_name=>'REMMIT_YEAR'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'2'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699638460453334332)
,p_db_column_name=>'REMMIT_MONTH'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'3'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699638835939334332)
,p_db_column_name=>'FREQUENCY'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'4'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699639287897334332)
,p_db_column_name=>'SSN'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'5'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699639608879334332)
,p_db_column_name=>'SURNAME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'6'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699640009145334333)
,p_db_column_name=>'FIRST_NAME'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'7'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699640469965334333)
,p_db_column_name=>'DATE_OF_PERIOD1'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'8'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699640824136334333)
,p_db_column_name=>'DATE_OF_PERIOD2'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'9'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699641218786334334)
,p_db_column_name=>'DATE_OF_PERIOD3'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'10'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699641671841334334)
,p_db_column_name=>'DATE_OF_PERIOD4'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'11'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699642086481334334)
,p_db_column_name=>'DATE_OF_PERIOD5'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'12'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699642474665334335)
,p_db_column_name=>'WAGES_PERIOD1'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'13'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699642891716334335)
,p_db_column_name=>'WAGES_PERIOD2'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'14'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699643272241334335)
,p_db_column_name=>'WAGES_PERIOD3'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'15'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699643637718334335)
,p_db_column_name=>'WAGES_PERIOD4'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'16'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699644015119334336)
,p_db_column_name=>'WAGES_PERIOD5'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'17'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699644498630334336)
,p_db_column_name=>'EMPLOYEE_CONT_AMOUNT'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'18'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699644809642334336)
,p_db_column_name=>'EMPLOYER_CONT_AMOUNT'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'19'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699645241663334337)
,p_db_column_name=>'LBL_REG_NO'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'20'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3699645699832334337)
,p_db_column_name=>'LBL_MONTH'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'21'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3855439270092796228)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3611122762137790323)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3611122718613790322)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3654314819594514093)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3654314679929514092)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699632174253334322)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697056265479894936)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699632573442334323)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697056265479894936)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699632925410334323)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697056265479894936)
,p_button_name=>'PURGE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699633359871334323)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697056265479894936)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699633726608334324)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(697056265479894936)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3699646471802334341)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3855438186583791545)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3699648648286334344)
...
,p_branch_when_button_id=>wwv_flow_imp.id(3699633359871334323)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552209808573108475)
,p_name=>'P1403_W1'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552209979933108476)
,p_name=>'P1403_W2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
,p_prompt=>'Week 2'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552210074685108477)
,p_name=>'P1403_W3'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
,p_prompt=>'Week 3'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552210109838108478)
,p_name=>'P1403_W4'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
,p_prompt=>'Week 4'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(552210267755108479)
,p_name=>'P1403_W5'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
,p_prompt=>'Week 5'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699634166644334324)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699634539776334324)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699634946951334324)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699635329947334325)
,p_name=>'P1403_EYEAR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
,p_prompt=>'Year'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699635764983334325)
,p_name=>'P1403_MONTH'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3855424578382358029)
,p_prompt=>'Month'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699636154376334325)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699636531733334325)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3699637000201334326)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3699647658875334342)
,p_name=>'CS6 Form'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3699646471802334341)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3699648130639334343)
,p_event_id=>wwv_flow_imp.id(3699647658875334342)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(552209618634108473)
,p_name=>'Clear'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(552209724126108474)
,p_event_id=>wwv_flow_imp.id(552209618634108473)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Clear'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699646849626334342)
...
,p_process_when_button_id=>wwv_flow_imp.id(3699632573442334323)
,p_process_success_message=>'Successful execution of eNIS.'
,p_internal_uid=>3056311597607658848
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3699647305029334342)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3699632925410334323)
