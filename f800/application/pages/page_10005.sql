...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(682725226422456327)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3773252370148799248)
,p_plug_name=>'Filter Bar'
,p_parent_plug_id=>wwv_flow_imp.id(682725226422456327)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3772792866305224558)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3784043096300221457)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(696859603314444324)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3773252370148799248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3779493301630507076)
,p_name=>'P10005_ORG_STRUCTURE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3773252370148799248)
,p_prompt=>'Department'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3780673309238467087)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3814744403025398095)
,p_name=>'P10005_START'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3773252370148799248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3814744747355398096)
,p_name=>'P10005_END'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3773252370148799248)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682725303893456328)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682725399186456329)
,p_event_id=>wwv_flow_imp.id(682725303893456328)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(3784043096300221457)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682725516828456330)
,p_event_id=>wwv_flow_imp.id(682725303893456328)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3772792866305224558)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(682725628570456331)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682725737331456332)
,p_event_id=>wwv_flow_imp.id(682725628570456331)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(682725814586456333)
,p_event_id=>wwv_flow_imp.id(682725628570456331)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
