...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(697515189394385696)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3633951195908110821)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3633951117548110788)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842185752583144867)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842186565423144870)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842186975626144873)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842187335166144873)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842186095726144868)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842187699556144875)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842188105780144875)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842188481746144877)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842185361102144866)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842188904623144890)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3842184883317144866)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3633949992099109685)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842180084819144846)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
,p_name=>'Anniversary '
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842180558634144847)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
,p_name=>'Birthday '
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842180964052144848)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
,p_name=>'Confirmation'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842181287542144849)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
,p_name=>'Gratuity'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842181726587144849)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842182156978144850)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842182570162144851)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842182930248144852)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
,p_name=>'Retirement'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842183322563144853)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
,p_name=>'work permit'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842179771005144845)
,p_report_id=>wwv_flow_imp.id(3633949992099109685)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3666740095699580214)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(3842184167460144858)
,p_report_id=>wwv_flow_imp.id(3666740095699580214)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'DESCRIP'
,p_operator=>'='
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825313316288893353)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825392184110344272)
,p_plug_name=>'Listing of Notification Schedules'
,p_parent_plug_id=>wwv_flow_imp.id(3825313316288893353)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3825392059512344271)
,p_max_row_count=>'1000000'
,p_allow_save_rpt_public=>'Y'
,p_show_nulls_as=>'-'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825392015511344270)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391904227344269)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391778966344268)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391715445344267)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391596057344266)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391512308344265)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391356039344264)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391291448344263)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825391223039344262)
,p_db_column_name=>'ID'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Edit'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3825390917991344259)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3825286526418960888)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3825392270996344273)
,p_plug_name=>'Audit'
,p_parent_plug_id=>wwv_flow_imp.id(3825313316288893353)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3843576755380785745)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825312570572893354)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3825313316288893353)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825312650089893354)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825391095301344261)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825312768390893354)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3825312858409893354)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3825310993901893356)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825307041314893393)
,p_name=>'P308_LAST_CHANGED_BY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3825392270996344273)
,p_item_source_plug_id=>wwv_flow_imp.id(3825313316288893353)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825307515064893393)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825307902670893393)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825308301554893392)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825308676127893392)
,p_name=>'P308_END_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(3825313316288893353)
,p_item_source_plug_id=>wwv_flow_imp.id(3825313316288893353)
,p_use_cache_before_default=>'NO'
,p_prompt=>'End Date'
,p_source=>'END_DATE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825309119763893392)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825309427749893392)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825309891254893392)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825310580589893387)
,p_name=>'P308_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3825390942707344260)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3825390725592344258)
...
,p_when_button_pressed=>wwv_flow_imp.id(3825312858409893354)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3825390721777344257)
...
,p_when_button_pressed=>wwv_flow_imp.id(3825312768390893354)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825306248881893393)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(3825313316288893353)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Fetch Row from HR_APU_NOTIFY_SCHEDULER'
,p_internal_uid=>3181970996863217899
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825305838917893394)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3825305433274893394)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3825312650089893354)
