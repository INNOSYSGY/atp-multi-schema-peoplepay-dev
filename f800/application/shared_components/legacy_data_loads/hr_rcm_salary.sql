...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3804274165876516916)
,p_name=>'load_salary'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804273850251516915)
,p_load_table_id=>wwv_flow_imp.id(3804274165876516916)
...
wwv_flow_imp_shared.create_load_table_rule(
 p_id=>wwv_flow_imp.id(3804273503539516914)
,p_load_table_id=>wwv_flow_imp.id(3804274165876516916)
