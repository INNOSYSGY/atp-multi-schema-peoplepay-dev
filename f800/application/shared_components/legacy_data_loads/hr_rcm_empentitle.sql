...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(3804181168282417173)
,p_name=>'load_oth_ent'
,p_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804180874620417173)
,p_load_table_id=>wwv_flow_imp.id(3804181168282417173)
...
wwv_flow_imp_shared.create_load_table_lookup(
 p_id=>wwv_flow_imp.id(3804089897044379200)
,p_load_table_id=>wwv_flow_imp.id(3804181168282417173)
