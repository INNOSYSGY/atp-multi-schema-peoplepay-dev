...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(3658953083636861235)
,p_name=>'TimeclockAPI'
,p_static_id=>'Timeclock_API'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(3658951346558861233)
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(3658953256460861235)
,p_web_src_module_id=>wwv_flow_imp.id(3658953083636861235)
,p_operation=>'GET'
