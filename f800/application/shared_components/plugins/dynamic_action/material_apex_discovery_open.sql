...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3768186369985696883)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768186086335696881)
,p_plugin_id=>wwv_flow_imp.id(3768186369985696883)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768185720959696881)
,p_plugin_id=>wwv_flow_imp.id(3768186369985696883)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768185252827696881)
,p_plugin_id=>wwv_flow_imp.id(3768186369985696883)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3768184947371696881)
,p_plugin_id=>wwv_flow_imp.id(3768186369985696883)
,p_attribute_scope=>'COMPONENT'
