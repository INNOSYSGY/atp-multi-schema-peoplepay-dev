...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4810723756876265321)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885572402639277825)
,p_plugin_id=>wwv_flow_imp.id(4810723756876265321)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885572821420277826)
,p_plugin_id=>wwv_flow_imp.id(4810723756876265321)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885573177490277826)
,p_plugin_id=>wwv_flow_imp.id(4810723756876265321)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885573614264277826)
,p_plugin_id=>wwv_flow_imp.id(4810723756876265321)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885574529262277827)
,p_plugin_attribute_id=>wwv_flow_imp.id(5885573614264277826)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885574013674277826)
,p_plugin_attribute_id=>wwv_flow_imp.id(5885573614264277826)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5885574951812277827)
,p_plugin_id=>wwv_flow_imp.id(4810723756876265321)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4269154696403491991)
,p_plugin_id=>wwv_flow_imp.id(4810723756876265321)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
