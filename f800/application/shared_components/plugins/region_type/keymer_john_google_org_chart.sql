...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(662890064208394262)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662890361822394266)
,p_plugin_id=>wwv_flow_imp.id(662890064208394262)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662890759411394267)
,p_plugin_id=>wwv_flow_imp.id(662890064208394262)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662891181090394268)
,p_plugin_id=>wwv_flow_imp.id(662890064208394262)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662891553686394268)
,p_plugin_id=>wwv_flow_imp.id(662890064208394262)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(662891981440394268)
,p_plugin_attribute_id=>wwv_flow_imp.id(662891553686394268)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(662892465156394269)
,p_plugin_attribute_id=>wwv_flow_imp.id(662891553686394268)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(662892976455394269)
,p_plugin_attribute_id=>wwv_flow_imp.id(662891553686394268)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662893542478394269)
,p_plugin_id=>wwv_flow_imp.id(662890064208394262)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(662894161921394275)
,p_plugin_id=>wwv_flow_imp.id(662890064208394262)
,p_name=>'SOURCE_SQL'
