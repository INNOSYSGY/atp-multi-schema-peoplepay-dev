prompt --application/shared_components/plugins/process_type/uc_download_files
begin
--   Manifest
--     PLUGIN: UC_DOWNLOAD_FILES
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(644844793578253863)
,p_plugin_type=>'PROCESS TYPE'
,p_name=>'UC_DOWNLOAD_FILES'
,p_display_name=>'UC - Download File(s)'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_PROC'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('PROCESS TYPE','UC_DOWNLOAD_FILES'),'')
...
,p_version_scn=>44430555473111
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>The <strong>UC - Download File(s)</strong> process plug-in enables the downloading of one or multiple database-stored BLOBs or CLOBs directly through the browser. You don''t have to worry about setting HTTP headers, converting CLOBs to BLOBs or zip'
||'ping the files. It''s all done for you. Just specify which files to download via a SQL query, or a more dynamic PL/SQL code block. Multiple files are zipped automatically, but a single file can optionally be zipped as well.</p>',
'',
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(644844930743253860)
,p_plugin_id=>wwv_flow_imp.id(644844793578253863)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(644845382207253859)
,p_plugin_attribute_id=>wwv_flow_imp.id(644844930743253860)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(644845865592253859)
,p_plugin_attribute_id=>wwv_flow_imp.id(644844930743253860)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(644846366425253858)
,p_plugin_id=>wwv_flow_imp.id(644844793578253863)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(644844930743253860)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(644846788630253858)
,p_plugin_id=>wwv_flow_imp.id(644844793578253863)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(644847115855253857)
,p_plugin_id=>wwv_flow_imp.id(644844793578253863)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(644847514437253857)
,p_plugin_id=>wwv_flow_imp.id(644844793578253863)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(644847979050253856)
,p_plugin_attribute_id=>wwv_flow_imp.id(644847514437253857)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(644848444671253856)
,p_plugin_attribute_id=>wwv_flow_imp.id(644847514437253857)
,p_display_sequence=>20
