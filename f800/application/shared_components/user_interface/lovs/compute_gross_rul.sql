...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(657356023881783708)
,p_lov_name=>'COMPUTE_GROSS_RUL'
,p_lov_query=>'.'||wwv_flow_imp.id(657356023881783708)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(657356421326783709)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Basic Pay'
,p_lov_return_value=>'''BASIC_PAY'''
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(657356792035783709)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Hourly Rate'
,p_lov_return_value=>'''HOURLY_RATE'''
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(657357218467783709)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Daily Rate'
,p_lov_return_value=>'''DAILY_RATE'''
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(657357644967783709)
