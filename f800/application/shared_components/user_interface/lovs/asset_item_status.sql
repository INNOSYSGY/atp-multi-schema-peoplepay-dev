...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854214838648306325)
,p_lov_name=>'ASSET_ITEM_STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(3854214838648306325)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854214466023306324)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Active'
,p_lov_return_value=>'ACTIVE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854214085681306324)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Not Working'
,p_lov_return_value=>'NOT_WORKING'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854213702367306323)
