...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3511808308068554267)
,p_lov_name=>'AFFECT_SALARY'
,p_lov_query=>'.'||wwv_flow_imp.id(3511808308068554267)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3511808984946554274)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Deduction'
,p_lov_return_value=>'DEDUCTION'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3511808609775554272)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Payment'
,p_lov_return_value=>'PAYMENT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3517629212809540363)
