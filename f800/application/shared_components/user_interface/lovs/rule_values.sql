...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(657363379588783713)
,p_lov_name=>'RULE_VALUES'
,p_lov_query=>'.'||wwv_flow_imp.id(657363379588783713)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(657363755231783713)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'YEARS OF SERVICE'
,p_lov_return_value=>'YEARS_OF_SERVICE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(657364213524783714)
