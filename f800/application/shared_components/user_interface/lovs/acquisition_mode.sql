...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3854230143817306358)
,p_lov_name=>'ACQUISITION_MODE'
,p_lov_query=>'.'||wwv_flow_imp.id(3854230143817306358)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854229846496306355)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Regular Budget'
,p_lov_return_value=>'BR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854229516230306346)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Project Budget'
,p_lov_return_value=>'BP'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854229097098306346)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Adhoc/Miscellaneous'
,p_lov_return_value=>'AM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854228679999306346)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'Emergency'
,p_lov_return_value=>'EM'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3854228310311306346)
