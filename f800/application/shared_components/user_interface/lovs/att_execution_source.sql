...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(556413465129535804)
,p_lov_name=>'ATT_EXECUTION_SOURCE'
,p_lov_query=>'.'||wwv_flow_imp.id(556413465129535804)||'.'
,p_location=>'STATIC'
,p_version_scn=>44429675465004
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(556413125942535803)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Earnings Period'
,p_lov_return_value=>'EARNINGS_PERIOD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(556412727120535802)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Organisation'
,p_lov_return_value=>'ORGANISATION'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(556412283314535801)
