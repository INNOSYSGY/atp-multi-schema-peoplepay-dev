prompt --application/shared_components/navigation/search_config/welfare_search
begin
--   Manifest
--     SEARCH CONFIG: Welfare_Search
--   Manifest End
...
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(533941295350348401)
,p_label=>'Welfare_Search'
,p_static_id=>'welfare_search'
...
'    ''Welfare'' Subtitle,',
'    listagg(''Item: '' || welfareitem.VALUE_DESCRIPTION || '', Purpose: ''|| empitem.PURPOSE_REMARKS_REASONS_REPLACEMENT || '', Start Period: '' || empitem.START_PERIOD,''; '')',
'    within group(',
