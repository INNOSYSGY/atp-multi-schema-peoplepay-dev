prompt --application/shared_components/navigation/search_config/employee_leave_track
begin
--   Manifest
--     SEARCH CONFIG: Employee_Leave_Track
--   Manifest End
...
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(533984777521302350)
,p_label=>'Employee_Leave_Track'
,p_static_id=>'employee_leave_track'
...
'    listagg(''Leave Type: '' || LEAVE_DESCRIPTION || '' Year:'' ||COMPANY_YEAR ||'', bfw: ''|| BROUGHT_FWD|| '', Used:'' || USED|| '' Pending: ''||PENDING ,''; '')',
'    within group(',
...
'group by lvtrk.emp_ID,a.id,  SALUTATION||'' ''||nvl(A.FIRST_NAME, '''')||'' ''||INITCAP(A.SURNAME) ,emp_company_no',
'',
'',
''))
