prompt --application/shared_components/security/authorizations/global_view_access
begin
--   Manifest
--     SECURITY SCHEME: GLOBAL_VIEW_ACCESS
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3806877419215039124)
,p_name=>'GLOBAL_VIEW_ACCESS'
